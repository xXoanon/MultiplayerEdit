...
CustomSFXCell::CustomSFXCell(char const* identifier, float width, float height) : CustomSFXCell(geode::CutoffConstructor, sizeof(CustomSFXCell)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13CustomSFXCellC2EPKcff")), tulip::hook::TulipConvention::Default);
