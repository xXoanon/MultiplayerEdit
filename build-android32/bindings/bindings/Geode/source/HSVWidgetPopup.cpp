...
auto HSVWidgetPopup::create(cocos2d::ccHSVValue hsv, HSVWidgetDelegate* delegate, gd::string title) -> decltype(create(hsv, delegate, title)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN14HSVWidgetPopup6createEN7cocos2d10ccHSVValueEP17HSVWidgetDelegateSs")), tulip::hook::TulipConvention::Default);
...
auto HSVWidgetPopup::init(cocos2d::ccHSVValue hsv, HSVWidgetDelegate* delegate, gd::string title) -> decltype(init(hsv, delegate, title)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN14HSVWidgetPopup4initEN7cocos2d10ccHSVValueEP17HSVWidgetDelegateSs")), tulip::hook::TulipConvention::Default);
