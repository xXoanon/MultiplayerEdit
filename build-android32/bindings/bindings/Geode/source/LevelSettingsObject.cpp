...
auto LevelSettingsObject::objectFromString(gd::string const& str) -> decltype(objectFromString(str)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN19LevelSettingsObject16objectFromStringERKSs")), tulip::hook::TulipConvention::Default);
