...
auto MusicBrowser::setTextPopupClosed(SetTextPopup* popup, gd::string text) -> decltype(setTextPopupClosed(popup, text)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN12MusicBrowser18setTextPopupClosedEP12SetTextPopupSs")), tulip::hook::TulipConvention::Default);
