...
cocos2d::CCActionInstant::CCActionInstant() : cocos2d::CCActionInstant(geode::CutoffConstructor, sizeof(cocos2d::CCActionInstant)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d15CCActionInstantC2Ev")), tulip::hook::TulipConvention::Default);
