...
cocos2d::extension::CCControlHuePicker::CCControlHuePicker() : cocos2d::extension::CCControlHuePicker(geode::CutoffConstructor, sizeof(cocos2d::extension::CCControlHuePicker)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension18CCControlHuePickerC2Ev")), tulip::hook::TulipConvention::Default);
...
cocos2d::extension::CCControlHuePicker::~CCControlHuePicker() {
	...
	if (!geode::DestructorLock::isLocked(this)) {
		using FunctionType = void(*)(cocos2d::extension::CCControlHuePicker*);
		static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension18CCControlHuePickerD2Ev")), tulip::hook::TulipConvention::Default);
		reinterpret_cast<FunctionType>(func)(this);
