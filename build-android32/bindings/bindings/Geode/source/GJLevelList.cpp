...
auto GJLevelList::parseListLevels(gd::string str) -> decltype(parseListLevels(str)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN11GJLevelList15parseListLevelsESs")), tulip::hook::TulipConvention::Default);
