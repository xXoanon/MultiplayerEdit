...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCPlace> : ModifyBase<ModifyDerive<Der, cocos2d::CCPlace>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCPlace::update)), Default, cocos2d::CCPlace, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCPlace::copyWithZone)), Default, cocos2d::CCPlace, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCPlace::initWithPosition)), Default, cocos2d::CCPlace, initWithPosition, cocos2d::CCPoint const&)
		}
	};
}
