...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSpeed> : ModifyBase<ModifyDerive<Der, cocos2d::CCSpeed>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d7CCSpeedD2Ev")), Default, cocos2d::CCSpeed)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCSpeed::copyWithZone)), Default, cocos2d::CCSpeed, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCSpeed::isDone)), Default, cocos2d::CCSpeed, isDone, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCSpeed::startWithTarget)), Default, cocos2d::CCSpeed, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCSpeed::stop)), Default, cocos2d::CCSpeed, stop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCSpeed::step)), Default, cocos2d::CCSpeed, step, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCSpeed::reverse)), Default, cocos2d::CCSpeed, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCActionInterval*, float>::func(&cocos2d::CCSpeed::initWithAction)), Default, cocos2d::CCSpeed, initWithAction, cocos2d::CCActionInterval*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCActionInterval*>::func(&cocos2d::CCSpeed::setInnerAction)), Default, cocos2d::CCSpeed, setInnerAction, cocos2d::CCActionInterval*)
		}
	};
}
