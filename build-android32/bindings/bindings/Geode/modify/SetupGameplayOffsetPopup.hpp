...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupGameplayOffsetPopup> : ModifyBase<ModifyDerive<Der, SetupGameplayOffsetPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<EffectGameObject*, cocos2d::CCArray*>::func(&SetupGameplayOffsetPopup::create)), Default, SetupGameplayOffsetPopup, create, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int, float&>::func(&SetupGameplayOffsetPopup::updateInputValue)), Default, SetupGameplayOffsetPopup, updateInputValue, int, float&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int, float>::func(&SetupGameplayOffsetPopup::updateInputNode)), Default, SetupGameplayOffsetPopup, updateInputNode, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int, float>::func(&SetupGameplayOffsetPopup::triggerValueFromSliderValue)), Default, SetupGameplayOffsetPopup, triggerValueFromSliderValue, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int, float>::func(&SetupGameplayOffsetPopup::triggerSliderValueFromValue)), Default, SetupGameplayOffsetPopup, triggerSliderValueFromValue, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCObject*>::func(&SetupGameplayOffsetPopup::onCustomToggleTriggerValue)), Default, SetupGameplayOffsetPopup, onCustomToggleTriggerValue, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<EffectGameObject*, cocos2d::CCArray*>::func(&SetupGameplayOffsetPopup::init)), Default, SetupGameplayOffsetPopup, init, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupGameplayOffsetPopup::onDefaultValues)), Default, SetupGameplayOffsetPopup, onDefaultValues, cocos2d::CCObject*)
		}
	};
}
