...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCActionEase> : ModifyBase<ModifyDerive<Der, cocos2d::CCActionEase>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCActionEaseD2Ev")), Default, cocos2d::CCActionEase)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCActionEase::copyWithZone)), Default, cocos2d::CCActionEase, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCActionEase::startWithTarget)), Default, cocos2d::CCActionEase, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCActionEase::stop)), Default, cocos2d::CCActionEase, stop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCActionEase::update)), Default, cocos2d::CCActionEase, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCActionEase::reverse)), Default, cocos2d::CCActionEase, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCActionEase::getInnerAction)), Default, cocos2d::CCActionEase, getInnerAction, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCActionInterval*>::func(&cocos2d::CCActionEase::initWithAction)), Default, cocos2d::CCActionEase, initWithAction, cocos2d::CCActionInterval*)
		}
	};
}
