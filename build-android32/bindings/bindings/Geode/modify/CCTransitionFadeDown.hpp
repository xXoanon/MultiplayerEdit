...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionFadeDown> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionFadeDown>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCTransitionFadeDownC2Ev")), Default, cocos2d::CCTransitionFadeDown, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCTransitionFadeDownD2Ev")), Default, cocos2d::CCTransitionFadeDown)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSize const&>::func(&cocos2d::CCTransitionFadeDown::actionWithSize)), Default, cocos2d::CCTransitionFadeDown, actionWithSize, cocos2d::CCSize const&)
		}
	};
}
