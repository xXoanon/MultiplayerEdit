...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FMOD::DSP> : ModifyBase<ModifyDerive<Der, FMOD::DSP>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int*, unsigned int*>::func(&FMOD::DSP::getCPUUsage)), Default, FMOD::DSP, getCPUUsage, unsigned int*, unsigned int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void**>::func(&FMOD::DSP::getUserData)), Default, FMOD::DSP, getUserData, void**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_DSP_CALLBACK>::func(&FMOD::DSP::setCallback)), Default, FMOD::DSP, setCallback, FMOD_DSP_CALLBACK)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void*>::func(&FMOD::DSP::setUserData)), Default, FMOD::DSP, setUserData, void*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::DSP::getNumInputs)), Default, FMOD::DSP, getNumInputs, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*, float*, float*>::func(&FMOD::DSP::getWetDryMix)), Default, FMOD::DSP, getWetDryMix, float*, float*, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float>::func(&FMOD::DSP::setWetDryMix)), Default, FMOD::DSP, setWetDryMix, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool, bool>::func(&FMOD::DSP::disconnectAll)), Default, FMOD::DSP, disconnectAll, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::DSP::getNumOutputs)), Default, FMOD::DSP, getNumOutputs, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::DSP*, FMOD::DSPConnection*>::func(&FMOD::DSP::disconnectFrom)), Default, FMOD::DSP, disconnectFrom, FMOD::DSP*, FMOD::DSPConnection*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_DSP_METERING_INFO*, FMOD_DSP_METERING_INFO*>::func(&FMOD::DSP::getMeteringInfo)), Default, FMOD::DSP, getMeteringInfo, FMOD_DSP_METERING_INFO*, FMOD_DSP_METERING_INFO*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int*, char*, int>::func(&FMOD::DSP::getParameterInt)), Default, FMOD::DSP, getParameterInt, int, int*, char*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::System**>::func(&FMOD::DSP::getSystemObject)), Default, FMOD::DSP, getSystemObject, FMOD::System**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int>::func(&FMOD::DSP::setParameterInt)), Default, FMOD::DSP, setParameterInt, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int*, int*, FMOD_SPEAKERMODE*>::func(&FMOD::DSP::getChannelFormat)), Default, FMOD::DSP, getChannelFormat, unsigned int*, int*, FMOD_SPEAKERMODE*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::DSP::getNumParameters)), Default, FMOD::DSP, getNumParameters, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, bool*, char*, int>::func(&FMOD::DSP::getParameterBool)), Default, FMOD::DSP, getParameterBool, int, bool*, char*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, void**, unsigned int*, char*, int>::func(&FMOD::DSP::getParameterData)), Default, FMOD::DSP, getParameterData, int, void**, unsigned int*, char*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, FMOD_DSP_PARAMETER_DESC**>::func(&FMOD::DSP::getParameterInfo)), Default, FMOD::DSP, getParameterInfo, int, FMOD_DSP_PARAMETER_DESC**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, int, FMOD_SPEAKERMODE>::func(&FMOD::DSP::setChannelFormat)), Default, FMOD::DSP, setChannelFormat, unsigned int, int, FMOD_SPEAKERMODE)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, bool>::func(&FMOD::DSP::setParameterBool)), Default, FMOD::DSP, setParameterBool, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, void*, unsigned int>::func(&FMOD::DSP::setParameterData)), Default, FMOD::DSP, setParameterData, int, void*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void*, bool>::func(&FMOD::DSP::showConfigDialog)), Default, FMOD::DSP, showConfigDialog, void*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, float*, char*, int>::func(&FMOD::DSP::getParameterFloat)), Default, FMOD::DSP, getParameterFloat, int, float*, char*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, float>::func(&FMOD::DSP::setParameterFloat)), Default, FMOD::DSP, setParameterFloat, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool*, bool*>::func(&FMOD::DSP::getMeteringEnabled)), Default, FMOD::DSP, getMeteringEnabled, bool*, bool*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool, bool>::func(&FMOD::DSP::setMeteringEnabled)), Default, FMOD::DSP, setMeteringEnabled, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int*>::func(&FMOD::DSP::getDataParameterIndex)), Default, FMOD::DSP, getDataParameterIndex, int, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, int, FMOD_SPEAKERMODE, unsigned int*, int*, FMOD_SPEAKERMODE*>::func(&FMOD::DSP::getOutputChannelFormat)), Default, FMOD::DSP, getOutputChannelFormat, unsigned int, int, FMOD_SPEAKERMODE, unsigned int*, int*, FMOD_SPEAKERMODE*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMOD::DSP::reset)), Default, FMOD::DSP, reset, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool*>::func(&FMOD::DSP::getIdle)), Default, FMOD::DSP, getIdle, bool*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char*, unsigned int*, int*, int*, int*>::func(&FMOD::DSP::getInfo)), Default, FMOD::DSP, getInfo, char*, unsigned int*, int*, int*, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_DSP_TYPE*>::func(&FMOD::DSP::getType)), Default, FMOD::DSP, getType, FMOD_DSP_TYPE*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMOD::DSP::release)), Default, FMOD::DSP, release, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::DSP*, FMOD::DSPConnection**, FMOD_DSPCONNECTION_TYPE>::func(&FMOD::DSP::addInput)), Default, FMOD::DSP, addInput, FMOD::DSP*, FMOD::DSPConnection**, FMOD_DSPCONNECTION_TYPE)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, FMOD::DSP**, FMOD::DSPConnection**>::func(&FMOD::DSP::getInput)), Default, FMOD::DSP, getInput, int, FMOD::DSP**, FMOD::DSPConnection**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool*>::func(&FMOD::DSP::getActive)), Default, FMOD::DSP, getActive, bool*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool*>::func(&FMOD::DSP::getBypass)), Default, FMOD::DSP, getBypass, bool*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, FMOD::DSP**, FMOD::DSPConnection**>::func(&FMOD::DSP::getOutput)), Default, FMOD::DSP, getOutput, int, FMOD::DSP**, FMOD::DSPConnection**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&FMOD::DSP::setActive)), Default, FMOD::DSP, setActive, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&FMOD::DSP::setBypass)), Default, FMOD::DSP, setBypass, bool)
		}
	};
}
