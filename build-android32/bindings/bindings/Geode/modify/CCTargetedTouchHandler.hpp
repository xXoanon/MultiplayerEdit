...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTargetedTouchHandler> : ModifyBase<ModifyDerive<Der, cocos2d::CCTargetedTouchHandler>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d22CCTargetedTouchHandlerD2Ev")), Default, cocos2d::CCTargetedTouchHandler)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTargetedTouchHandler::getClaimedTouches)), Default, cocos2d::CCTargetedTouchHandler, getClaimedTouches, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTouchDelegate*, int, bool>::func(&cocos2d::CCTargetedTouchHandler::initWithDelegate)), Default, cocos2d::CCTargetedTouchHandler, initWithDelegate, cocos2d::CCTouchDelegate*, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTargetedTouchHandler::isSwallowsTouches)), Default, cocos2d::CCTargetedTouchHandler, isSwallowsTouches, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCTargetedTouchHandler::setSwallowsTouches)), Default, cocos2d::CCTargetedTouchHandler, setSwallowsTouches, bool)
		}
	};
}
