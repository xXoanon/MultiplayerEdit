...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCBlink> : ModifyBase<ModifyDerive<Der, cocos2d::CCBlink>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCBlink::copyWithZone)), Default, cocos2d::CCBlink, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCBlink::update)), Default, cocos2d::CCBlink, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCBlink::startWithTarget)), Default, cocos2d::CCBlink, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCBlink::stop)), Default, cocos2d::CCBlink, stop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCBlink::reverse)), Default, cocos2d::CCBlink, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, unsigned int>::func(&cocos2d::CCBlink::initWithDuration)), Default, cocos2d::CCBlink, initWithDuration, float, unsigned int)
		}
	};
}
