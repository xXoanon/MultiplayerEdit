...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCKeypadDispatcher> : ModifyBase<ModifyDerive<Der, cocos2d::CCKeypadDispatcher>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d18CCKeypadDispatcherC2Ev")), Default, cocos2d::CCKeypadDispatcher, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d18CCKeypadDispatcherD2Ev")), Default, cocos2d::CCKeypadDispatcher)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCKeypadDelegate*>::func(&cocos2d::CCKeypadDispatcher::addDelegate)), Default, cocos2d::CCKeypadDispatcher, addDelegate, cocos2d::CCKeypadDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::ccKeypadMSGType>::func(&cocos2d::CCKeypadDispatcher::dispatchKeypadMSG)), Default, cocos2d::CCKeypadDispatcher, dispatchKeypadMSG, cocos2d::ccKeypadMSGType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCKeypadDelegate*>::func(&cocos2d::CCKeypadDispatcher::forceAddDelegate)), Default, cocos2d::CCKeypadDispatcher, forceAddDelegate, cocos2d::CCKeypadDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCKeypadDelegate*>::func(&cocos2d::CCKeypadDispatcher::forceRemoveDelegate)), Default, cocos2d::CCKeypadDispatcher, forceRemoveDelegate, cocos2d::CCKeypadDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCKeypadDelegate*>::func(&cocos2d::CCKeypadDispatcher::removeDelegate)), Default, cocos2d::CCKeypadDispatcher, removeDelegate, cocos2d::CCKeypadDelegate*)
		}
	};
}
