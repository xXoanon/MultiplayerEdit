...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTMXObjectGroup> : ModifyBase<ModifyDerive<Der, cocos2d::CCTMXObjectGroup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d16CCTMXObjectGroupC2Ev")), Default, cocos2d::CCTMXObjectGroup, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d16CCTMXObjectGroupD2Ev")), Default, cocos2d::CCTMXObjectGroup)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTMXObjectGroup::getProperties)), Default, cocos2d::CCTMXObjectGroup, getProperties, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCDictionary*>::func(&cocos2d::CCTMXObjectGroup::setProperties)), Default, cocos2d::CCTMXObjectGroup, setProperties, cocos2d::CCDictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTMXObjectGroup::getObjects)), Default, cocos2d::CCTMXObjectGroup, getObjects, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCArray*>::func(&cocos2d::CCTMXObjectGroup::setObjects)), Default, cocos2d::CCTMXObjectGroup, setObjects, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCTMXObjectGroup::objectNamed)), Default, cocos2d::CCTMXObjectGroup, objectNamed, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCTMXObjectGroup::propertyNamed)), Default, cocos2d::CCTMXObjectGroup, propertyNamed, char const*)
		}
	};
}
