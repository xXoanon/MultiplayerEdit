...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCSpritePart> : ModifyBase<ModifyDerive<Der, CCSpritePart>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTexture2D*>::func(&CCSpritePart::create)), Default, CCSpritePart, create, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&CCSpritePart::createWithSpriteFrameName)), Default, CCSpritePart, createWithSpriteFrameName, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&CCSpritePart::setVisible)), Default, CCSpritePart, setVisible, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN12CCSpritePart12frameChangedESs")), Default, CCSpritePart, frameChanged, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&CCSpritePart::getBeingUsed)), Default, CCSpritePart, getBeingUsed, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&CCSpritePart::hideInactive)), Default, CCSpritePart, hideInactive, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&CCSpritePart::markAsNotBeingUsed)), Default, CCSpritePart, markAsNotBeingUsed, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&CCSpritePart::resetTextureRect)), Default, CCSpritePart, resetTextureRect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&CCSpritePart::setBeingUsed)), Default, CCSpritePart, setBeingUsed, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN12CCSpritePart18updateDisplayFrameESs")), Default, CCSpritePart, updateDisplayFrame, gd::string)
		}
	};
}
