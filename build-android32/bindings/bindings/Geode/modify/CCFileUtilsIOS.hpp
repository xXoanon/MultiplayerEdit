...
namespace geode::modifier {
	...
	template<class Der>
	struct ModifyDerive<Der, cocos2d::CCFileUtilsIOS> : ModifyBase<ModifyDerive<Der, cocos2d::CCFileUtilsIOS>> {
        using BaseModify = ModifyBase<ModifyDerive<Der, cocos2d::CCFileUtilsIOS>>;
		using ModifyBase<ModifyDerive<Der, cocos2d::CCFileUtilsIOS>>::ModifyBase;
		using Base = cocos2d::CCFileUtilsIOS;
        using Derived = Der;
		void apply() override {
