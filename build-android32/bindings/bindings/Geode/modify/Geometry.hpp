...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FMOD::Geometry> : ModifyBase<ModifyDerive<Der, FMOD::Geometry>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, bool, int, FMOD_VECTOR const*, int*>::func(&FMOD::Geometry::addPolygon)), Default, FMOD::Geometry, addPolygon, float, float, bool, int, FMOD_VECTOR const*, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_VECTOR*>::func(&FMOD::Geometry::getPosition)), Default, FMOD::Geometry, getPosition, FMOD_VECTOR*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_VECTOR*, FMOD_VECTOR*>::func(&FMOD::Geometry::getRotation)), Default, FMOD::Geometry, getRotation, FMOD_VECTOR*, FMOD_VECTOR*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void**>::func(&FMOD::Geometry::getUserData)), Default, FMOD::Geometry, getUserData, void**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_VECTOR const*>::func(&FMOD::Geometry::setPosition)), Default, FMOD::Geometry, setPosition, FMOD_VECTOR const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_VECTOR const*, FMOD_VECTOR const*>::func(&FMOD::Geometry::setRotation)), Default, FMOD::Geometry, setRotation, FMOD_VECTOR const*, FMOD_VECTOR const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void*>::func(&FMOD::Geometry::setUserData)), Default, FMOD::Geometry, setUserData, void*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*, int*>::func(&FMOD::Geometry::getMaxPolygons)), Default, FMOD::Geometry, getMaxPolygons, int*, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::Geometry::getNumPolygons)), Default, FMOD::Geometry, getNumPolygons, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int, FMOD_VECTOR*>::func(&FMOD::Geometry::getPolygonVertex)), Default, FMOD::Geometry, getPolygonVertex, int, int, FMOD_VECTOR*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int, FMOD_VECTOR const*>::func(&FMOD::Geometry::setPolygonVertex)), Default, FMOD::Geometry, setPolygonVertex, int, int, FMOD_VECTOR const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, float*, float*, bool*>::func(&FMOD::Geometry::getPolygonAttributes)), Default, FMOD::Geometry, getPolygonAttributes, int, float*, float*, bool*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, float, float, bool>::func(&FMOD::Geometry::setPolygonAttributes)), Default, FMOD::Geometry, setPolygonAttributes, int, float, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int*>::func(&FMOD::Geometry::getPolygonNumVertices)), Default, FMOD::Geometry, getPolygonNumVertices, int, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void*, int*>::func(&FMOD::Geometry::save)), Default, FMOD::Geometry, save, void*, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMOD::Geometry::release)), Default, FMOD::Geometry, release, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_VECTOR*>::func(&FMOD::Geometry::getScale)), Default, FMOD::Geometry, getScale, FMOD_VECTOR*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_VECTOR const*>::func(&FMOD::Geometry::setScale)), Default, FMOD::Geometry, setScale, FMOD_VECTOR const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool*>::func(&FMOD::Geometry::getActive)), Default, FMOD::Geometry, getActive, bool*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&FMOD::Geometry::setActive)), Default, FMOD::Geometry, setActive, bool)
		}
	};
}
