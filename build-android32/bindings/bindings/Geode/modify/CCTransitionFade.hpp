...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionFade> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionFade>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d16CCTransitionFadeC2Ev")), Default, cocos2d::CCTransitionFade, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d16CCTransitionFadeD2Ev")), Default, cocos2d::CCTransitionFade)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionFade::onEnter)), Default, cocos2d::CCTransitionFade, onEnter, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionFade::onExit)), Default, cocos2d::CCTransitionFade, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float, cocos2d::CCScene*>::func(&cocos2d::CCTransitionFade::initWithDuration)), Default, cocos2d::CCTransitionFade, initWithDuration, float, cocos2d::CCScene*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float, cocos2d::CCScene*, cocos2d::ccColor3B const&>::func(&cocos2d::CCTransitionFade::initWithDuration)), Default, cocos2d::CCTransitionFade, initWithDuration, float, cocos2d::CCScene*, cocos2d::ccColor3B const&)
		}
	};
}
