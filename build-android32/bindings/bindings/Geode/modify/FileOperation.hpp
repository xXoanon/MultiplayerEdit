...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FileOperation> : ModifyBase<ModifyDerive<Der, FileOperation>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FileOperation::getFilePath)), Default, FileOperation, getFilePath, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FileOperation::readFile)), Default, FileOperation, readFile, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FileOperation::saveFile)), Default, FileOperation, saveFile, )
		}
	};
}
