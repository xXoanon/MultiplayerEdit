...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCShaderCache> : ModifyBase<ModifyDerive<Der, cocos2d::CCShaderCache>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d13CCShaderCacheC2Ev")), Default, cocos2d::CCShaderCache, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d13CCShaderCacheD2Ev")), Default, cocos2d::CCShaderCache)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCGLProgram*, char const*>::func(&cocos2d::CCShaderCache::addProgram)), Default, cocos2d::CCShaderCache, addProgram, cocos2d::CCGLProgram*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCShaderCache::init)), Default, cocos2d::CCShaderCache, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCGLProgram*, int>::func(&cocos2d::CCShaderCache::loadDefaultShader)), Default, cocos2d::CCShaderCache, loadDefaultShader, cocos2d::CCGLProgram*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCShaderCache::loadDefaultShaders)), Default, cocos2d::CCShaderCache, loadDefaultShaders, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCShaderCache::programForKey)), Default, cocos2d::CCShaderCache, programForKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCShaderCache::reloadDefaultShaders)), Default, cocos2d::CCShaderCache, reloadDefaultShaders, )
		}
	};
}
