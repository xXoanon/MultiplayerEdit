...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FMOD::System> : ModifyBase<ModifyDerive<Der, FMOD::System>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, FMOD::Channel**>::func(&FMOD::System::getChannel)), Default, FMOD::System, getChannel, int, FMOD::Channel**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int*>::func(&FMOD::System::getVersion)), Default, FMOD::System, getVersion, unsigned int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, unsigned int*, unsigned int>::func(&FMOD::System::loadPlugin)), Default, FMOD::System, loadPlugin, char const*, unsigned int*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMOD::System::recordStop)), Default, FMOD::System, recordStop, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, unsigned int, FMOD_CREATESOUNDEXINFO*, FMOD::Sound**>::func(&FMOD::System::createSound)), Default, FMOD::System, createSound, char const*, unsigned int, FMOD_CREATESOUNDEXINFO*, FMOD::Sound**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_CPU_USAGE*>::func(&FMOD::System::getCPUUsage)), Default, FMOD::System, getCPUUsage, FMOD_CPU_USAGE*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void**>::func(&FMOD::System::getUserData)), Default, FMOD::System, getUserData, void**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, bool*>::func(&FMOD::System::isRecording)), Default, FMOD::System, isRecording, int, bool*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMOD::System::mixerResume)), Default, FMOD::System, mixerResume, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, FMOD::Sound*, bool>::func(&FMOD::System::recordStart)), Default, FMOD::System, recordStart, int, FMOD::Sound*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_DSP_DESCRIPTION const*, unsigned int*>::func(&FMOD::System::registerDSP)), Default, FMOD::System, registerDSP, FMOD_DSP_DESCRIPTION const*, unsigned int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_SYSTEM_CALLBACK, unsigned int>::func(&FMOD::System::setCallback)), Default, FMOD::System, setCallback, FMOD_SYSTEM_CALLBACK, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void*>::func(&FMOD::System::setUserData)), Default, FMOD::System, setUserData, void*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, unsigned int, FMOD_CREATESOUNDEXINFO*, FMOD::Sound**>::func(&FMOD::System::createStream)), Default, FMOD::System, createStream, char const*, unsigned int, FMOD_CREATESOUNDEXINFO*, FMOD::Sound**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<long long*, long long*, long long*>::func(&FMOD::System::getFileUsage)), Default, FMOD::System, getFileUsage, long long*, long long*, long long*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void const*, int, FMOD::Geometry**>::func(&FMOD::System::loadGeometry)), Default, FMOD::System, loadGeometry, void const*, int, FMOD::Geometry**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMOD::System::mixerSuspend)), Default, FMOD::System, mixerSuspend, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&FMOD::System::unloadPlugin)), Default, FMOD::System, unloadPlugin, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*, float*, float*>::func(&FMOD::System::get3DSettings)), Default, FMOD::System, get3DSettings, float*, float*, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, char*, int, FMOD_GUID*, int*, FMOD_SPEAKERMODE*, int*>::func(&FMOD::System::getDriverInfo)), Default, FMOD::System, getDriverInfo, int, char*, int, FMOD_GUID*, int*, FMOD_SPEAKERMODE*, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::System::getNumDrivers)), Default, FMOD::System, getNumDrivers, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_PLUGINTYPE, int*>::func(&FMOD::System::getNumPlugins)), Default, FMOD::System, getNumPlugins, FMOD_PLUGINTYPE, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, FMOD_PLUGINTYPE*, char*, int, unsigned int*>::func(&FMOD::System::getPluginInfo)), Default, FMOD::System, getPluginInfo, unsigned int, FMOD_PLUGINTYPE*, char*, int, unsigned int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_CODEC_DESCRIPTION*, unsigned int*, unsigned int>::func(&FMOD::System::registerCodec)), Default, FMOD::System, registerCodec, FMOD_CODEC_DESCRIPTION*, unsigned int*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float>::func(&FMOD::System::set3DSettings)), Default, FMOD::System, set3DSettings, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_FILE_OPEN_CALLBACK, FMOD_FILE_CLOSE_CALLBACK, FMOD_FILE_READ_CALLBACK, FMOD_FILE_SEEK_CALLBACK, FMOD_FILE_ASYNCREAD_CALLBACK, FMOD_FILE_ASYNCCANCEL_CALLBACK, int>::func(&FMOD::System::setFileSystem)), Default, FMOD::System, setFileSystem, FMOD_FILE_OPEN_CALLBACK, FMOD_FILE_CLOSE_CALLBACK, FMOD_FILE_READ_CALLBACK, FMOD_FILE_SEEK_CALLBACK, FMOD_FILE_ASYNCREAD_CALLBACK, FMOD_FILE_ASYNCCANCEL_CALLBACK, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&FMOD::System::setPluginPath)), Default, FMOD::System, setPluginPath, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int, FMOD::Geometry**>::func(&FMOD::System::createGeometry)), Default, FMOD::System, createGeometry, int, int, FMOD::Geometry**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::Reverb3D**>::func(&FMOD::System::createReverb3D)), Default, FMOD::System, createReverb3D, FMOD::Reverb3D**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_OUTPUT_DESCRIPTION const*, unsigned int*>::func(&FMOD::System::registerOutput)), Default, FMOD::System, registerOutput, FMOD_OUTPUT_DESCRIPTION const*, unsigned int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_DSP_TYPE, FMOD::DSP**>::func(&FMOD::System::createDSPByType)), Default, FMOD::System, createDSPByType, FMOD_DSP_TYPE, FMOD::DSP**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, int, unsigned int*>::func(&FMOD::System::getNestedPlugin)), Default, FMOD::System, getNestedPlugin, unsigned int, int, unsigned int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char*, int>::func(&FMOD::System::getNetworkProxy)), Default, FMOD::System, getNetworkProxy, char*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void**>::func(&FMOD::System::getOutputHandle)), Default, FMOD::System, getOutputHandle, void**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_PLUGINTYPE, int, unsigned int*>::func(&FMOD::System::getPluginHandle)), Default, FMOD::System, getPluginHandle, FMOD_PLUGINTYPE, int, unsigned int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&FMOD::System::setNetworkProxy)), Default, FMOD::System, setNetworkProxy, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_FILE_OPEN_CALLBACK, FMOD_FILE_CLOSE_CALLBACK, FMOD_FILE_READ_CALLBACK, FMOD_FILE_SEEK_CALLBACK>::func(&FMOD::System::attachFileSystem)), Default, FMOD::System, attachFileSystem, FMOD_FILE_OPEN_CALLBACK, FMOD_FILE_CLOSE_CALLBACK, FMOD_FILE_READ_CALLBACK, FMOD_FILE_SEEK_CALLBACK)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, FMOD::SoundGroup**>::func(&FMOD::System::createSoundGroup)), Default, FMOD::System, createSoundGroup, char const*, FMOD::SoundGroup**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int*, int*>::func(&FMOD::System::getDSPBufferSize)), Default, FMOD::System, getDSPBufferSize, unsigned int*, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_DSP_TYPE, FMOD_DSP_DESCRIPTION const**>::func(&FMOD::System::getDSPInfoByType)), Default, FMOD::System, getDSPInfoByType, FMOD_DSP_TYPE, FMOD_DSP_DESCRIPTION const**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, int>::func(&FMOD::System::setDSPBufferSize)), Default, FMOD::System, setDSPBufferSize, unsigned int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, FMOD::DSP**>::func(&FMOD::System::createDSPByPlugin)), Default, FMOD::System, createDSPByPlugin, unsigned int, FMOD::DSP**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::System::get3DNumListeners)), Default, FMOD::System, get3DNumListeners, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::System::getNetworkTimeout)), Default, FMOD::System, getNetworkTimeout, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int*>::func(&FMOD::System::getOutputByPlugin)), Default, FMOD::System, getOutputByPlugin, unsigned int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, unsigned int*>::func(&FMOD::System::getRecordPosition)), Default, FMOD::System, getRecordPosition, int, unsigned int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*, FMOD_SPEAKERMODE*, int*>::func(&FMOD::System::getSoftwareFormat)), Default, FMOD::System, getSoftwareFormat, int*, FMOD_SPEAKERMODE*, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMOD::System::set3DNumListeners)), Default, FMOD::System, set3DNumListeners, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMOD::System::setNetworkTimeout)), Default, FMOD::System, setNetworkTimeout, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&FMOD::System::setOutputByPlugin)), Default, FMOD::System, setOutputByPlugin, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, FMOD_SPEAKERMODE, int>::func(&FMOD::System::setSoftwareFormat)), Default, FMOD::System, setSoftwareFormat, int, FMOD_SPEAKERMODE, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, FMOD::ChannelGroup**>::func(&FMOD::System::createChannelGroup)), Default, FMOD::System, createChannelGroup, char const*, FMOD::ChannelGroup**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*, int*>::func(&FMOD::System::getChannelsPlaying)), Default, FMOD::System, getChannelsPlaying, int*, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, FMOD_DSP_DESCRIPTION const**>::func(&FMOD::System::getDSPInfoByPlugin)), Default, FMOD::System, getDSPInfoByPlugin, unsigned int, FMOD_DSP_DESCRIPTION const**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_SPEAKER, float*, float*, bool*>::func(&FMOD::System::getSpeakerPosition)), Default, FMOD::System, getSpeakerPosition, FMOD_SPEAKER, float*, float*, bool*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_SPEAKER, float, float, bool>::func(&FMOD::System::setSpeakerPosition)), Default, FMOD::System, setSpeakerPosition, FMOD_SPEAKER, float, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_ADVANCEDSETTINGS*>::func(&FMOD::System::getAdvancedSettings)), Default, FMOD::System, getAdvancedSettings, FMOD_ADVANCEDSETTINGS*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_SPEAKERMODE, FMOD_SPEAKERMODE, float*, int>::func(&FMOD::System::getDefaultMixMatrix)), Default, FMOD::System, getDefaultMixMatrix, FMOD_SPEAKERMODE, FMOD_SPEAKERMODE, float*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*>::func(&FMOD::System::getGeometrySettings)), Default, FMOD::System, getGeometrySettings, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::SoundGroup**>::func(&FMOD::System::getMasterSoundGroup)), Default, FMOD::System, getMasterSoundGroup, FMOD::SoundGroup**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, int*>::func(&FMOD::System::getNumNestedPlugins)), Default, FMOD::System, getNumNestedPlugins, unsigned int, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, char*, int, FMOD_GUID*, int*, FMOD_SPEAKERMODE*, int*, unsigned int*>::func(&FMOD::System::getRecordDriverInfo)), Default, FMOD::System, getRecordDriverInfo, int, char*, int, FMOD_GUID*, int*, FMOD_SPEAKERMODE*, int*, unsigned int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*, int*>::func(&FMOD::System::getRecordNumDrivers)), Default, FMOD::System, getRecordNumDrivers, int*, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, FMOD_REVERB_PROPERTIES*>::func(&FMOD::System::getReverbProperties)), Default, FMOD::System, getReverbProperties, int, FMOD_REVERB_PROPERTIES*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::System::getSoftwareChannels)), Default, FMOD::System, getSoftwareChannels, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int*, unsigned int*>::func(&FMOD::System::getStreamBufferSize)), Default, FMOD::System, getStreamBufferSize, unsigned int*, unsigned int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_ADVANCEDSETTINGS*>::func(&FMOD::System::setAdvancedSettings)), Default, FMOD::System, setAdvancedSettings, FMOD_ADVANCEDSETTINGS*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&FMOD::System::setGeometrySettings)), Default, FMOD::System, setGeometrySettings, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, FMOD_REVERB_PROPERTIES const*>::func(&FMOD::System::setReverbProperties)), Default, FMOD::System, setReverbProperties, int, FMOD_REVERB_PROPERTIES const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMOD::System::setSoftwareChannels)), Default, FMOD::System, setSoftwareChannels, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, unsigned int>::func(&FMOD::System::setStreamBufferSize)), Default, FMOD::System, setStreamBufferSize, unsigned int, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_VECTOR const*, FMOD_VECTOR const*, float*, float*>::func(&FMOD::System::getGeometryOcclusion)), Default, FMOD::System, getGeometryOcclusion, FMOD_VECTOR const*, FMOD_VECTOR const*, float*, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_3D_ROLLOFF_CALLBACK>::func(&FMOD::System::set3DRolloffCallback)), Default, FMOD::System, set3DRolloffCallback, FMOD_3D_ROLLOFF_CALLBACK)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::ChannelGroup**>::func(&FMOD::System::getMasterChannelGroup)), Default, FMOD::System, getMasterChannelGroup, FMOD::ChannelGroup**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_SPEAKERMODE, int*>::func(&FMOD::System::getSpeakerModeChannels)), Default, FMOD::System, getSpeakerModeChannels, FMOD_SPEAKERMODE, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, FMOD_VECTOR*, FMOD_VECTOR*, FMOD_VECTOR*, FMOD_VECTOR*>::func(&FMOD::System::get3DListenerAttributes)), Default, FMOD::System, get3DListenerAttributes, int, FMOD_VECTOR*, FMOD_VECTOR*, FMOD_VECTOR*, FMOD_VECTOR*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, FMOD_VECTOR const*, FMOD_VECTOR const*, FMOD_VECTOR const*, FMOD_VECTOR const*>::func(&FMOD::System::set3DListenerAttributes)), Default, FMOD::System, set3DListenerAttributes, int, FMOD_VECTOR const*, FMOD_VECTOR const*, FMOD_VECTOR const*, FMOD_VECTOR const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_PORT_TYPE, unsigned long long, FMOD::ChannelGroup*, bool>::func(&FMOD::System::attachChannelGroupToPort)), Default, FMOD::System, attachChannelGroupToPort, FMOD_PORT_TYPE, unsigned long long, FMOD::ChannelGroup*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::ChannelGroup*>::func(&FMOD::System::detachChannelGroupFromPort)), Default, FMOD::System, detachChannelGroupFromPort, FMOD::ChannelGroup*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, unsigned int, void*>::func(&FMOD::System::init)), Default, FMOD::System, init, int, unsigned int, void*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMOD::System::close)), Default, FMOD::System, close, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMOD::System::update)), Default, FMOD::System, update, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMOD::System::lockDSP)), Default, FMOD::System, lockDSP, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::DSP*, FMOD::ChannelGroup*, bool, FMOD::Channel**>::func(&FMOD::System::playDSP)), Default, FMOD::System, playDSP, FMOD::DSP*, FMOD::ChannelGroup*, bool, FMOD::Channel**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMOD::System::release)), Default, FMOD::System, release, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_DSP_DESCRIPTION const*, FMOD::DSP**>::func(&FMOD::System::createDSP)), Default, FMOD::System, createDSP, FMOD_DSP_DESCRIPTION const*, FMOD::DSP**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::System::getDriver)), Default, FMOD::System, getDriver, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_OUTPUTTYPE*>::func(&FMOD::System::getOutput)), Default, FMOD::System, getOutput, FMOD_OUTPUTTYPE*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::Sound*, FMOD::ChannelGroup*, bool, FMOD::Channel**>::func(&FMOD::System::playSound)), Default, FMOD::System, playSound, FMOD::Sound*, FMOD::ChannelGroup*, bool, FMOD::Channel**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMOD::System::setDriver)), Default, FMOD::System, setDriver, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_OUTPUTTYPE>::func(&FMOD::System::setOutput)), Default, FMOD::System, setOutput, FMOD_OUTPUTTYPE)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMOD::System::unlockDSP)), Default, FMOD::System, unlockDSP, )
		}
	};
}
