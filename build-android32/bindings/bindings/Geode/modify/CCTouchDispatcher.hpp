...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTouchDispatcher> : ModifyBase<ModifyDerive<Der, cocos2d::CCTouchDispatcher>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d17CCTouchDispatcherD2Ev")), Default, cocos2d::CCTouchDispatcher)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSet*, cocos2d::CCEvent*>::func(&cocos2d::CCTouchDispatcher::touchesBegan)), Default, cocos2d::CCTouchDispatcher, touchesBegan, cocos2d::CCSet*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSet*, cocos2d::CCEvent*>::func(&cocos2d::CCTouchDispatcher::touchesMoved)), Default, cocos2d::CCTouchDispatcher, touchesMoved, cocos2d::CCSet*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSet*, cocos2d::CCEvent*>::func(&cocos2d::CCTouchDispatcher::touchesEnded)), Default, cocos2d::CCTouchDispatcher, touchesEnded, cocos2d::CCSet*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSet*, cocos2d::CCEvent*>::func(&cocos2d::CCTouchDispatcher::touchesCancelled)), Default, cocos2d::CCTouchDispatcher, touchesCancelled, cocos2d::CCSet*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTouchDelegate*, int, bool>::func(&cocos2d::CCTouchDispatcher::addPrioTargetedDelegate)), Default, cocos2d::CCTouchDispatcher, addPrioTargetedDelegate, cocos2d::CCTouchDelegate*, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTouchDelegate*, int>::func(&cocos2d::CCTouchDispatcher::addStandardDelegate)), Default, cocos2d::CCTouchDispatcher, addStandardDelegate, cocos2d::CCTouchDelegate*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTouchDelegate*, int, bool>::func(&cocos2d::CCTouchDispatcher::addTargetedDelegate)), Default, cocos2d::CCTouchDispatcher, addTargetedDelegate, cocos2d::CCTouchDelegate*, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&cocos2d::CCTouchDispatcher::decrementForcePrio)), Default, cocos2d::CCTouchDispatcher, decrementForcePrio, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTouchDelegate*>::func(&cocos2d::CCTouchDispatcher::findHandler)), Default, cocos2d::CCTouchDispatcher, findHandler, cocos2d::CCTouchDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*, cocos2d::CCTouchDelegate*>::func(&cocos2d::CCTouchDispatcher::findHandler)), Default, cocos2d::CCTouchDispatcher, findHandler, cocos2d::CCArray*, cocos2d::CCTouchDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTouchHandler*, cocos2d::CCArray*>::func(&cocos2d::CCTouchDispatcher::forceAddHandler)), Default, cocos2d::CCTouchDispatcher, forceAddHandler, cocos2d::CCTouchHandler*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTouchDispatcher::forceRemoveAllDelegates)), Default, cocos2d::CCTouchDispatcher, forceRemoveAllDelegates, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTouchDelegate*>::func(&cocos2d::CCTouchDispatcher::forceRemoveDelegate)), Default, cocos2d::CCTouchDispatcher, forceRemoveDelegate, cocos2d::CCTouchDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&cocos2d::CCTouchDispatcher::incrementForcePrio)), Default, cocos2d::CCTouchDispatcher, incrementForcePrio, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTouchDispatcher::init)), Default, cocos2d::CCTouchDispatcher, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTouchDispatcher::isDispatchEvents)), Default, cocos2d::CCTouchDispatcher, isDispatchEvents, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTouchDispatcher::isUsingForcePrio)), Default, cocos2d::CCTouchDispatcher, isUsingForcePrio, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*>::func(&cocos2d::CCTouchDispatcher::rearrangeHandlers)), Default, cocos2d::CCTouchDispatcher, rearrangeHandlers, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, int>::func(&cocos2d::CCTouchDispatcher::registerForcePrio)), Default, cocos2d::CCTouchDispatcher, registerForcePrio, cocos2d::CCObject*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTouchDispatcher::removeAllDelegates)), Default, cocos2d::CCTouchDispatcher, removeAllDelegates, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTouchDelegate*>::func(&cocos2d::CCTouchDispatcher::removeDelegate)), Default, cocos2d::CCTouchDispatcher, removeDelegate, cocos2d::CCTouchDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCTouchDispatcher::setDispatchEvents)), Default, cocos2d::CCTouchDispatcher, setDispatchEvents, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, cocos2d::CCTouchDelegate*>::func(&cocos2d::CCTouchDispatcher::setPriority)), Default, cocos2d::CCTouchDispatcher, setPriority, int, cocos2d::CCTouchDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSet*, cocos2d::CCEvent*, unsigned int>::func(&cocos2d::CCTouchDispatcher::touches)), Default, cocos2d::CCTouchDispatcher, touches, cocos2d::CCSet*, cocos2d::CCEvent*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCTouchDispatcher::unregisterForcePrio)), Default, cocos2d::CCTouchDispatcher, unregisterForcePrio, cocos2d::CCObject*)
		}
	};
}
