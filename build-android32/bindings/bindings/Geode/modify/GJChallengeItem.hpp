...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJChallengeItem> : ModifyBase<ModifyDerive<Der, GJChallengeItem>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJChallengeItem::create)), Default, GJChallengeItem, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15GJChallengeItem6createE15GJChallengeTypeiiiSs")), Default, GJChallengeItem, create, GJChallengeType, int, int, int, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15GJChallengeItem16createFromStringESs")), Default, GJChallengeItem, createFromString, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<DS_Dictionary*>::func(&GJChallengeItem::createWithCoder)), Default, GJChallengeItem, createWithCoder, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<DS_Dictionary*>::func(&GJChallengeItem::encodeWithCoder)), Default, GJChallengeItem, encodeWithCoder, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJChallengeItem::canEncode)), Default, GJChallengeItem, canEncode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<DS_Dictionary*>::func(&GJChallengeItem::dataLoaded)), Default, GJChallengeItem, dataLoaded, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJChallengeItem::incrementCount)), Default, GJChallengeItem, incrementCount, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15GJChallengeItem4initE15GJChallengeTypeiiiSs")), Default, GJChallengeItem, init, GJChallengeType, int, int, int, gd::string)
