...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCJumpTiles3D> : ModifyBase<ModifyDerive<Der, cocos2d::CCJumpTiles3D>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCJumpTiles3D::copyWithZone)), Default, cocos2d::CCJumpTiles3D, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCJumpTiles3D::update)), Default, cocos2d::CCJumpTiles3D, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, cocos2d::CCSize const&, unsigned int, float>::func(&cocos2d::CCJumpTiles3D::initWithDuration)), Default, cocos2d::CCJumpTiles3D, initWithDuration, float, cocos2d::CCSize const&, unsigned int, float)
		}
	};
}
