...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretLayer3> : ModifyBase<ModifyDerive<Der, SecretLayer3>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN12SecretLayer3D2Ev")), Default, SecretLayer3)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretLayer3::create)), Default, SecretLayer3, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretLayer3::scene)), Default, SecretLayer3, scene, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&SecretLayer3::init)), Default, SecretLayer3, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&SecretLayer3::onExit)), Default, SecretLayer3, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&SecretLayer3::keyBackClicked)), Default, SecretLayer3, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<DialogLayer*>::func(&SecretLayer3::dialogClosed)), Default, SecretLayer3, dialogClosed, DialogLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretLayer3::animateEyes)), Default, SecretLayer3, animateEyes, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretLayer3::firstInteractionStep1)), Default, SecretLayer3, firstInteractionStep1, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretLayer3::firstInteractionStep2)), Default, SecretLayer3, firstInteractionStep2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretLayer3::firstInteractionStep3)), Default, SecretLayer3, firstInteractionStep3, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretLayer3::firstInteractionStep4)), Default, SecretLayer3, firstInteractionStep4, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SecretLayer3::onBack)), Default, SecretLayer3, onBack, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SecretLayer3::onChest01)), Default, SecretLayer3, onChest01, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SecretLayer3::onChest02)), Default, SecretLayer3, onChest02, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SecretLayer3::onClick)), Default, SecretLayer3, onClick, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretLayer3::revealStep1)), Default, SecretLayer3, revealStep1, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretLayer3::revealStep2)), Default, SecretLayer3, revealStep2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretLayer3::revealStep3)), Default, SecretLayer3, revealStep3, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretLayer3::revealStep4)), Default, SecretLayer3, revealStep4, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretLayer3::revealStep5)), Default, SecretLayer3, revealStep5, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretLayer3::showUnlockDialog)), Default, SecretLayer3, showUnlockDialog, )
		}
	};
}
