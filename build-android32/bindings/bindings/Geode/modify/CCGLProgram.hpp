...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCGLProgram> : ModifyBase<ModifyDerive<Der, cocos2d::CCGLProgram>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCGLProgramC2Ev")), Default, cocos2d::CCGLProgram, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCGLProgramD2Ev")), Default, cocos2d::CCGLProgram)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, unsigned int>::func(&cocos2d::CCGLProgram::addAttribute)), Default, cocos2d::CCGLProgram, addAttribute, char const*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int*, unsigned int, char const*>::func(&cocos2d::CCGLProgram::compileShader)), Default, cocos2d::CCGLProgram, compileShader, unsigned int*, unsigned int, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCGLProgram::description)), Default, cocos2d::CCGLProgram, description, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCGLProgram::fragmentShaderLog)), Default, cocos2d::CCGLProgram, fragmentShaderLog, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCGLProgram::getUniformLocationForName)), Default, cocos2d::CCGLProgram, getUniformLocationForName, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, char const*>::func(&cocos2d::CCGLProgram::initWithVertexShaderByteArray)), Default, cocos2d::CCGLProgram, initWithVertexShaderByteArray, char const*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, char const*>::func(&cocos2d::CCGLProgram::initWithVertexShaderFilename)), Default, cocos2d::CCGLProgram, initWithVertexShaderFilename, char const*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCGLProgram::link)), Default, cocos2d::CCGLProgram, link, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, GLInfoFunction, GLLogFunction>::func(&cocos2d::CCGLProgram::logForOpenGLObject)), Default, cocos2d::CCGLProgram, logForOpenGLObject, unsigned int, GLInfoFunction, GLLogFunction)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCGLProgram::programLog)), Default, cocos2d::CCGLProgram, programLog, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCGLProgram::reset)), Default, cocos2d::CCGLProgram, reset, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, float>::func(&cocos2d::CCGLProgram::setUniformLocationWith1f)), Default, cocos2d::CCGLProgram, setUniformLocationWith1f, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int>::func(&cocos2d::CCGLProgram::setUniformLocationWith1i)), Default, cocos2d::CCGLProgram, setUniformLocationWith1i, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, float, float>::func(&cocos2d::CCGLProgram::setUniformLocationWith2f)), Default, cocos2d::CCGLProgram, setUniformLocationWith2f, int, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, float*, unsigned int>::func(&cocos2d::CCGLProgram::setUniformLocationWith2fv)), Default, cocos2d::CCGLProgram, setUniformLocationWith2fv, int, float*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int, int>::func(&cocos2d::CCGLProgram::setUniformLocationWith2i)), Default, cocos2d::CCGLProgram, setUniformLocationWith2i, int, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int*, unsigned int>::func(&cocos2d::CCGLProgram::setUniformLocationWith2iv)), Default, cocos2d::CCGLProgram, setUniformLocationWith2iv, int, int*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, float, float, float>::func(&cocos2d::CCGLProgram::setUniformLocationWith3f)), Default, cocos2d::CCGLProgram, setUniformLocationWith3f, int, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, float*, unsigned int>::func(&cocos2d::CCGLProgram::setUniformLocationWith3fv)), Default, cocos2d::CCGLProgram, setUniformLocationWith3fv, int, float*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int, int, int>::func(&cocos2d::CCGLProgram::setUniformLocationWith3i)), Default, cocos2d::CCGLProgram, setUniformLocationWith3i, int, int, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int*, unsigned int>::func(&cocos2d::CCGLProgram::setUniformLocationWith3iv)), Default, cocos2d::CCGLProgram, setUniformLocationWith3iv, int, int*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, float, float, float, float>::func(&cocos2d::CCGLProgram::setUniformLocationWith4f)), Default, cocos2d::CCGLProgram, setUniformLocationWith4f, int, float, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, float*, unsigned int>::func(&cocos2d::CCGLProgram::setUniformLocationWith4fv)), Default, cocos2d::CCGLProgram, setUniformLocationWith4fv, int, float*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int, int, int, int>::func(&cocos2d::CCGLProgram::setUniformLocationWith4i)), Default, cocos2d::CCGLProgram, setUniformLocationWith4i, int, int, int, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int*, unsigned int>::func(&cocos2d::CCGLProgram::setUniformLocationWith4iv)), Default, cocos2d::CCGLProgram, setUniformLocationWith4iv, int, int*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, float*, unsigned int>::func(&cocos2d::CCGLProgram::setUniformLocationWithMatrix3fv)), Default, cocos2d::CCGLProgram, setUniformLocationWithMatrix3fv, int, float*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, float*, unsigned int>::func(&cocos2d::CCGLProgram::setUniformLocationWithMatrix4fv)), Default, cocos2d::CCGLProgram, setUniformLocationWithMatrix4fv, int, float*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCGLProgram::setUniformsForBuiltins)), Default, cocos2d::CCGLProgram, setUniformsForBuiltins, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, void*, unsigned int>::func(&cocos2d::CCGLProgram::updateUniformLocation)), Default, cocos2d::CCGLProgram, updateUniformLocation, int, void*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCGLProgram::updateUniforms)), Default, cocos2d::CCGLProgram, updateUniforms, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCGLProgram::use)), Default, cocos2d::CCGLProgram, use, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCGLProgram::vertexShaderLog)), Default, cocos2d::CCGLProgram, vertexShaderLog, )
		}
	};
}
