...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::extension::CCControlColourPicker> : ModifyBase<ModifyDerive<Der, cocos2d::extension::CCControlColourPicker>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension21CCControlColourPickerD2Ev")), Default, cocos2d::extension::CCControlColourPicker)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCControlColourPicker::init)), Default, cocos2d::extension::CCControlColourPicker, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*, cocos2d::CCEvent*>::func(&cocos2d::extension::CCControlColourPicker::ccTouchBegan)), Default, cocos2d::extension::CCControlColourPicker, ccTouchBegan, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor3B const&>::func(&cocos2d::extension::CCControlColourPicker::setColorValue)), Default, cocos2d::extension::CCControlColourPicker, setColorValue, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, unsigned int>::func(&cocos2d::extension::CCControlColourPicker::colourSliderValueChanged)), Default, cocos2d::extension::CCControlColourPicker, colourSliderValueChanged, cocos2d::CCObject*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(cocos2d::extension::CCControlColourPicker, getColorValue, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, unsigned int>::func(&cocos2d::extension::CCControlColourPicker::hueSliderValueChanged)), Default, cocos2d::extension::CCControlColourPicker, hueSliderValueChanged, cocos2d::CCObject*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCControlColourPicker::updateControlPicker)), Default, cocos2d::extension::CCControlColourPicker, updateControlPicker, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCControlColourPicker::updateHueAndControlPicker)), Default, cocos2d::extension::CCControlColourPicker, updateHueAndControlPicker, )
		}
	};
}
