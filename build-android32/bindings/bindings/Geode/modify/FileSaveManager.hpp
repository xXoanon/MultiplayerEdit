...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FileSaveManager> : ModifyBase<ModifyDerive<Der, FileSaveManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FileSaveManager::sharedState)), Default, FileSaveManager, sharedState, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&FileSaveManager::init)), Default, FileSaveManager, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&FileSaveManager::firstLoad)), Default, FileSaveManager, firstLoad, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FileSaveManager::getStoreData)), Default, FileSaveManager, getStoreData, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&FileSaveManager::loadDataFromFile)), Default, FileSaveManager, loadDataFromFile, char const*)
		}
	};
}
