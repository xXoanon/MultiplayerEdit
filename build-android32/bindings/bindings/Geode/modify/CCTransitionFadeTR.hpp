...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionFadeTR> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionFadeTR>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d18CCTransitionFadeTRC2Ev")), Default, cocos2d::CCTransitionFadeTR, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d18CCTransitionFadeTRD2Ev")), Default, cocos2d::CCTransitionFadeTR)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionFadeTR::onEnter)), Default, cocos2d::CCTransitionFadeTR, onEnter, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionFadeTR::sceneOrder)), Default, cocos2d::CCTransitionFadeTR, sceneOrder, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSize const&>::func(&cocos2d::CCTransitionFadeTR::actionWithSize)), Default, cocos2d::CCTransitionFadeTR, actionWithSize, cocos2d::CCSize const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCActionInterval*>::func(&cocos2d::CCTransitionFadeTR::easeActionWithAction)), Default, cocos2d::CCTransitionFadeTR, easeActionWithAction, cocos2d::CCActionInterval*)
		}
	};
}
