...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCFadeIn> : ModifyBase<ModifyDerive<Der, cocos2d::CCFadeIn>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCFadeIn::copyWithZone)), Default, cocos2d::CCFadeIn, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCFadeIn::update)), Default, cocos2d::CCFadeIn, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCFadeIn::reverse)), Default, cocos2d::CCFadeIn, reverse, )
		}
	};
}
