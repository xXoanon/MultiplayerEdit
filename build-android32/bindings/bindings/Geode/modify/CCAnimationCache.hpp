...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCAnimationCache> : ModifyBase<ModifyDerive<Der, cocos2d::CCAnimationCache>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d16CCAnimationCacheC2Ev")), Default, cocos2d::CCAnimationCache, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d16CCAnimationCacheD2Ev")), Default, cocos2d::CCAnimationCache)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCAnimation*, const char*>::func(&cocos2d::CCAnimationCache::addAnimation)), Default, cocos2d::CCAnimationCache, addAnimation, cocos2d::CCAnimation*, const char*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCDictionary*, const char*>::func(&cocos2d::CCAnimationCache::addAnimationsWithDictionary)), Default, cocos2d::CCAnimationCache, addAnimationsWithDictionary, cocos2d::CCDictionary*, const char*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const char*>::func(&cocos2d::CCAnimationCache::addAnimationsWithFile)), Default, cocos2d::CCAnimationCache, addAnimationsWithFile, const char*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const char*>::func(&cocos2d::CCAnimationCache::animationByName)), Default, cocos2d::CCAnimationCache, animationByName, const char*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCAnimationCache::init)), Default, cocos2d::CCAnimationCache, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCDictionary*>::func(&cocos2d::CCAnimationCache::parseVersion1)), Default, cocos2d::CCAnimationCache, parseVersion1, cocos2d::CCDictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCDictionary*>::func(&cocos2d::CCAnimationCache::parseVersion2)), Default, cocos2d::CCAnimationCache, parseVersion2, cocos2d::CCDictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const char*>::func(&cocos2d::CCAnimationCache::removeAnimationByName)), Default, cocos2d::CCAnimationCache, removeAnimationByName, const char*)
		}
	};
}
