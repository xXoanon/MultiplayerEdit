...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupPulsePopup> : ModifyBase<ModifyDerive<Der, SetupPulsePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<EffectGameObject*, cocos2d::CCArray*>::func(&SetupPulsePopup::create)), Default, SetupPulsePopup, create, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&SetupPulsePopup::show)), Default, SetupPulsePopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&SetupPulsePopup::determineStartValues)), Default, SetupPulsePopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCObject*>::func(&SetupPulsePopup::onClose)), Default, SetupPulsePopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<CCTextInputNode*>::func(&SetupPulsePopup::textChanged)), Default, SetupPulsePopup, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor3B>::func(&SetupPulsePopup::colorValueChanged)), Default, SetupPulsePopup, colorValueChanged, cocos2d::ccColor3B)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<CCTextInputNode*>::func(&SetupPulsePopup::textInputOpened)), Default, SetupPulsePopup, textInputOpened, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GJSpecialColorSelect*, int>::func(&SetupPulsePopup::colorSelectClosed)), Default, SetupPulsePopup, colorSelectClosed, GJSpecialColorSelect*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPulsePopup::getColorValue)), Default, SetupPulsePopup, getColorValue, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<EffectGameObject*, cocos2d::CCArray*>::func(&SetupPulsePopup::init)), Default, SetupPulsePopup, init, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupPulsePopup::onCopy)), Default, SetupPulsePopup, onCopy, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupPulsePopup::onExclusive)), Default, SetupPulsePopup, onExclusive, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupPulsePopup::onGroupMainOnly)), Default, SetupPulsePopup, onGroupMainOnly, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupPulsePopup::onGroupSecondaryOnly)), Default, SetupPulsePopup, onGroupSecondaryOnly, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupPulsePopup::onHSVLegacyMode)), Default, SetupPulsePopup, onHSVLegacyMode, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupPulsePopup::onPaste)), Default, SetupPulsePopup, onPaste, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupPulsePopup::onSelectPulseMode)), Default, SetupPulsePopup, onSelectPulseMode, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupPulsePopup::onSelectSpecialColor)), Default, SetupPulsePopup, onSelectSpecialColor, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupPulsePopup::onSelectSpecialTargetID)), Default, SetupPulsePopup, onSelectSpecialTargetID, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupPulsePopup::onSelectTargetMode)), Default, SetupPulsePopup, onSelectTargetMode, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupPulsePopup::onUpdateCopyColor)), Default, SetupPulsePopup, onUpdateCopyColor, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupPulsePopup::onUpdateCustomColor)), Default, SetupPulsePopup, onUpdateCustomColor, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::ccColor3B>::func(&SetupPulsePopup::selectColor)), Default, SetupPulsePopup, selectColor, cocos2d::ccColor3B)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupPulsePopup::sliderChanged)), Default, SetupPulsePopup, sliderChanged, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPulsePopup::updateColorLabels)), Default, SetupPulsePopup, updateColorLabels, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPulsePopup::updateColorValue)), Default, SetupPulsePopup, updateColorValue, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPulsePopup::updateCopyColor)), Default, SetupPulsePopup, updateCopyColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPulsePopup::updateCopyColorTextInputLabel)), Default, SetupPulsePopup, updateCopyColorTextInputLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&SetupPulsePopup::updateFadeInLabel)), Default, SetupPulsePopup, updateFadeInLabel, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPulsePopup::updateFadeInTime)), Default, SetupPulsePopup, updateFadeInTime, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&SetupPulsePopup::updateFadeOutLabel)), Default, SetupPulsePopup, updateFadeOutLabel, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPulsePopup::updateFadeOutTime)), Default, SetupPulsePopup, updateFadeOutTime, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPulsePopup::updateGroupMainOnly)), Default, SetupPulsePopup, updateGroupMainOnly, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPulsePopup::updateGroupSecondaryOnly)), Default, SetupPulsePopup, updateGroupSecondaryOnly, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&SetupPulsePopup::updateHoldLabel)), Default, SetupPulsePopup, updateHoldLabel, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPulsePopup::updateHoldTime)), Default, SetupPulsePopup, updateHoldTime, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPulsePopup::updateHSVValue)), Default, SetupPulsePopup, updateHSVValue, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPulsePopup::updatePulseMode)), Default, SetupPulsePopup, updatePulseMode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPulsePopup::updatePulseTargetType)), Default, SetupPulsePopup, updatePulseTargetType, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPulsePopup::updateTargetID)), Default, SetupPulsePopup, updateTargetID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPulsePopup::updateTextInputLabel)), Default, SetupPulsePopup, updateTextInputLabel, )
		}
	};
}
