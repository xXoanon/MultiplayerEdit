...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSpriteFrameCache> : ModifyBase<ModifyDerive<Der, cocos2d::CCSpriteFrameCache>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d18CCSpriteFrameCacheD2Ev")), Default, cocos2d::CCSpriteFrameCache)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSpriteFrame*, char const*>::func(&cocos2d::CCSpriteFrameCache::addSpriteFrame)), Default, cocos2d::CCSpriteFrameCache, addSpriteFrame, cocos2d::CCSpriteFrame*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCDictionary*, cocos2d::CCTexture2D*>::func(&cocos2d::CCSpriteFrameCache::addSpriteFramesWithDictionary)), Default, cocos2d::CCSpriteFrameCache, addSpriteFramesWithDictionary, cocos2d::CCDictionary*, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCSpriteFrameCache::addSpriteFramesWithFile)), Default, cocos2d::CCSpriteFrameCache, addSpriteFramesWithFile, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, char const*>::func(&cocos2d::CCSpriteFrameCache::addSpriteFramesWithFile)), Default, cocos2d::CCSpriteFrameCache, addSpriteFramesWithFile, char const*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, cocos2d::CCTexture2D*>::func(&cocos2d::CCSpriteFrameCache::addSpriteFramesWithFile)), Default, cocos2d::CCSpriteFrameCache, addSpriteFramesWithFile, char const*, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSpriteFrameCache::init)), Default, cocos2d::CCSpriteFrameCache, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCSpriteFrameCache::removeSpriteFrameByName)), Default, cocos2d::CCSpriteFrameCache, removeSpriteFrameByName, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSpriteFrameCache::removeSpriteFrames)), Default, cocos2d::CCSpriteFrameCache, removeSpriteFrames, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCDictionary*>::func(&cocos2d::CCSpriteFrameCache::removeSpriteFramesFromDictionary)), Default, cocos2d::CCSpriteFrameCache, removeSpriteFramesFromDictionary, cocos2d::CCDictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCSpriteFrameCache::removeSpriteFramesFromFile)), Default, cocos2d::CCSpriteFrameCache, removeSpriteFramesFromFile, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTexture2D*>::func(&cocos2d::CCSpriteFrameCache::removeSpriteFramesFromTexture)), Default, cocos2d::CCSpriteFrameCache, removeSpriteFramesFromTexture, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSpriteFrameCache::removeUnusedSpriteFrames)), Default, cocos2d::CCSpriteFrameCache, removeUnusedSpriteFrames, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCSpriteFrameCache::spriteFrameByName)), Default, cocos2d::CCSpriteFrameCache, spriteFrameByName, char const*)
		}
	};
}
