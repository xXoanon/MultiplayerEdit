...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCOrbitCamera> : ModifyBase<ModifyDerive<Der, cocos2d::CCOrbitCamera>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCOrbitCamera::copyWithZone)), Default, cocos2d::CCOrbitCamera, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCOrbitCamera::update)), Default, cocos2d::CCOrbitCamera, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCOrbitCamera::startWithTarget)), Default, cocos2d::CCOrbitCamera, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float, float, float, float, float>::func(&cocos2d::CCOrbitCamera::initWithDuration)), Default, cocos2d::CCOrbitCamera, initWithDuration, float, float, float, float, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*, float*, float*>::func(&cocos2d::CCOrbitCamera::sphericalRadius)), Default, cocos2d::CCOrbitCamera, sphericalRadius, float*, float*, float*)
		}
	};
}
