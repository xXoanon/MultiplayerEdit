...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJBigSprite> : ModifyBase<ModifyDerive<Der, GJBigSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJBigSprite::create)), Default, GJBigSprite, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJBigSprite::init)), Default, GJBigSprite, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&GJBigSprite::finishedLoadingSpriteAsync)), Default, GJBigSprite, finishedLoadingSpriteAsync, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN11GJBigSprite15loadSpriteAsyncESsi")), Default, GJBigSprite, loadSpriteAsync, gd::string, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJBigSprite::unloadAll)), Default, GJBigSprite, unloadAll, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN11GJBigSprite12unloadSpriteESsi")), Default, GJBigSprite, unloadSprite, gd::string, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJBigSprite::updateSpriteVisibility)), Default, GJBigSprite, updateSpriteVisibility, )
		}
	};
}
