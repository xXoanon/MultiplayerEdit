...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTiledGrid3D> : ModifyBase<ModifyDerive<Der, cocos2d::CCTiledGrid3D>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d13CCTiledGrid3DC2Ev")), Default, cocos2d::CCTiledGrid3D, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d13CCTiledGrid3DD2Ev")), Default, cocos2d::CCTiledGrid3D)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTiledGrid3D::blit)), Default, cocos2d::CCTiledGrid3D, blit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTiledGrid3D::reuse)), Default, cocos2d::CCTiledGrid3D, reuse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTiledGrid3D::calculateVertexPoints)), Default, cocos2d::CCTiledGrid3D, calculateVertexPoints, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCTiledGrid3D::originalTile)), Default, cocos2d::CCTiledGrid3D, originalTile, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&, cocos2d::ccQuad3 const&>::func(&cocos2d::CCTiledGrid3D::setTile)), Default, cocos2d::CCTiledGrid3D, setTile, cocos2d::CCPoint const&, cocos2d::ccQuad3 const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCTiledGrid3D::tile)), Default, cocos2d::CCTiledGrid3D, tile, cocos2d::CCPoint const&)
		}
	};
}
