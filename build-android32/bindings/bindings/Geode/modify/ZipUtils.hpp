...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::ZipUtils> : ModifyBase<ModifyDerive<Der, cocos2d::ZipUtils>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d8ZipUtils15base64DecodeEncERKSsSs")), Default, cocos2d::ZipUtils, base64DecodeEnc, gd::string const&, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d8ZipUtils15base64EncodeEncERKSsSs")), Default, cocos2d::ZipUtils, base64EncodeEnc, gd::string const&, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d8ZipUtils15base64URLDecodeERKSs")), Default, cocos2d::ZipUtils, base64URLDecode, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d8ZipUtils15base64URLEncodeERKSs")), Default, cocos2d::ZipUtils, base64URLEncode, gd::string const&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d8ZipUtils14compressStringERKSsbi")), Default, cocos2d::ZipUtils, compressString, gd::string const&, bool, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d8ZipUtils16decompressStringERKSsbi")), Default, cocos2d::ZipUtils, decompressString, gd::string const&, bool, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(cocos2d::ZipUtils, encryptDecrypt, gd::string const&, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(cocos2d::ZipUtils, encryptDecryptWKey, gd::string const&, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d8ZipUtils9hexToCharERKSs")), Default, cocos2d::ZipUtils, hexToChar, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d8ZipUtils9urlDecodeERKSs")), Default, cocos2d::ZipUtils, urlDecode, gd::string const&)
		}
	};
}
