...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionFadeUp> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionFadeUp>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d18CCTransitionFadeUpC2Ev")), Default, cocos2d::CCTransitionFadeUp, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d18CCTransitionFadeUpD2Ev")), Default, cocos2d::CCTransitionFadeUp)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSize const&>::func(&cocos2d::CCTransitionFadeUp::actionWithSize)), Default, cocos2d::CCTransitionFadeUp, actionWithSize, cocos2d::CCSize const&)
		}
	};
}
