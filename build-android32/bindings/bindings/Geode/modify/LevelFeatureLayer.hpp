...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LevelFeatureLayer> : ModifyBase<ModifyDerive<Der, LevelFeatureLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&LevelFeatureLayer::create)), Default, LevelFeatureLayer, create, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&LevelFeatureLayer::keyBackClicked)), Default, LevelFeatureLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&LevelFeatureLayer::init)), Default, LevelFeatureLayer, init, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&LevelFeatureLayer::onClose)), Default, LevelFeatureLayer, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&LevelFeatureLayer::onDown)), Default, LevelFeatureLayer, onDown, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&LevelFeatureLayer::onDown2)), Default, LevelFeatureLayer, onDown2, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&LevelFeatureLayer::onRemoveValues)), Default, LevelFeatureLayer, onRemoveValues, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&LevelFeatureLayer::onSetEpicOnly)), Default, LevelFeatureLayer, onSetEpicOnly, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&LevelFeatureLayer::onSetFeatured)), Default, LevelFeatureLayer, onSetFeatured, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&LevelFeatureLayer::onToggleEpic)), Default, LevelFeatureLayer, onToggleEpic, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&LevelFeatureLayer::onUp)), Default, LevelFeatureLayer, onUp, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&LevelFeatureLayer::onUp2)), Default, LevelFeatureLayer, onUp2, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&LevelFeatureLayer::updateStars)), Default, LevelFeatureLayer, updateStars, )
		}
	};
}
