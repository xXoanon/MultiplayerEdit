...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FMOD::Sound> : ModifyBase<ModifyDerive<Der, FMOD::Sound>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*, int*>::func(&FMOD::Sound::getNumTags)), Default, FMOD::Sound, getNumTags, int*, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*, int*>::func(&FMOD::Sound::getDefaults)), Default, FMOD::Sound, getDefaults, float*, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, FMOD::Sound**>::func(&FMOD::Sound::getSubSound)), Default, FMOD::Sound, getSubSound, int, FMOD::Sound**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void**>::func(&FMOD::Sound::getUserData)), Default, FMOD::Sound, getUserData, void**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, int>::func(&FMOD::Sound::setDefaults)), Default, FMOD::Sound, setDefaults, float, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void*>::func(&FMOD::Sound::setUserData)), Default, FMOD::Sound, setUserData, void*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, unsigned int, char const*, FMOD_SYNCPOINT**>::func(&FMOD::Sound::addSyncPoint)), Default, FMOD::Sound, addSyncPoint, unsigned int, unsigned int, char const*, FMOD_SYNCPOINT**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::Sound::getLoopCount)), Default, FMOD::Sound, getLoopCount, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_OPENSTATE*, unsigned int*, bool*, bool*>::func(&FMOD::Sound::getOpenState)), Default, FMOD::Sound, getOpenState, FMOD_OPENSTATE*, unsigned int*, bool*, bool*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, FMOD_SYNCPOINT**>::func(&FMOD::Sound::getSyncPoint)), Default, FMOD::Sound, getSyncPoint, int, FMOD_SYNCPOINT**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMOD::Sound::setLoopCount)), Default, FMOD::Sound, setLoopCount, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int*, unsigned int, unsigned int*, unsigned int>::func(&FMOD::Sound::getLoopPoints)), Default, FMOD::Sound, getLoopPoints, unsigned int*, unsigned int, unsigned int*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*>::func(&FMOD::Sound::getMusicSpeed)), Default, FMOD::Sound, getMusicSpeed, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::SoundGroup**>::func(&FMOD::Sound::getSoundGroup)), Default, FMOD::Sound, getSoundGroup, FMOD::SoundGroup**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, unsigned int, unsigned int, unsigned int>::func(&FMOD::Sound::setLoopPoints)), Default, FMOD::Sound, setLoopPoints, unsigned int, unsigned int, unsigned int, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&FMOD::Sound::setMusicSpeed)), Default, FMOD::Sound, setMusicSpeed, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::SoundGroup*>::func(&FMOD::Sound::setSoundGroup)), Default, FMOD::Sound, setSoundGroup, FMOD::SoundGroup*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_SYNCPOINT*>::func(&FMOD::Sound::deleteSyncPoint)), Default, FMOD::Sound, deleteSyncPoint, FMOD_SYNCPOINT*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::Sound::getNumSubSounds)), Default, FMOD::Sound, getNumSubSounds, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::System**>::func(&FMOD::Sound::getSystemObject)), Default, FMOD::Sound, getSystemObject, FMOD::System**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::Sound::getNumSyncPoints)), Default, FMOD::Sound, getNumSyncPoints, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_SYNCPOINT*, char*, int, unsigned int*, unsigned int>::func(&FMOD::Sound::getSyncPointInfo)), Default, FMOD::Sound, getSyncPointInfo, FMOD_SYNCPOINT*, char*, int, unsigned int*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*, float*, float*>::func(&FMOD::Sound::get3DConeSettings)), Default, FMOD::Sound, get3DConeSettings, float*, float*, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::Sound**>::func(&FMOD::Sound::getSubSoundParent)), Default, FMOD::Sound, getSubSoundParent, FMOD::Sound**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float>::func(&FMOD::Sound::set3DConeSettings)), Default, FMOD::Sound, set3DConeSettings, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_VECTOR**, int*>::func(&FMOD::Sound::get3DCustomRolloff)), Default, FMOD::Sound, get3DCustomRolloff, FMOD_VECTOR**, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_VECTOR*, int>::func(&FMOD::Sound::set3DCustomRolloff)), Default, FMOD::Sound, set3DCustomRolloff, FMOD_VECTOR*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*, float*>::func(&FMOD::Sound::get3DMinMaxDistance)), Default, FMOD::Sound, get3DMinMaxDistance, float*, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::Sound::getMusicNumChannels)), Default, FMOD::Sound, getMusicNumChannels, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float>::func(&FMOD::Sound::set3DMinMaxDistance)), Default, FMOD::Sound, set3DMinMaxDistance, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, float*>::func(&FMOD::Sound::getMusicChannelVolume)), Default, FMOD::Sound, getMusicChannelVolume, int, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, float>::func(&FMOD::Sound::setMusicChannelVolume)), Default, FMOD::Sound, setMusicChannelVolume, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, unsigned int, void**, void**, unsigned int*, unsigned int*>::func(&FMOD::Sound::lock)), Default, FMOD::Sound, lock, unsigned int, unsigned int, void**, void**, unsigned int*, unsigned int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, int, FMOD_TAG*>::func(&FMOD::Sound::getTag)), Default, FMOD::Sound, getTag, char const*, int, FMOD_TAG*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void*, void*, unsigned int, unsigned int>::func(&FMOD::Sound::unlock)), Default, FMOD::Sound, unlock, void*, void*, unsigned int, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int*>::func(&FMOD::Sound::getMode)), Default, FMOD::Sound, getMode, unsigned int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char*, int>::func(&FMOD::Sound::getName)), Default, FMOD::Sound, getName, char*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMOD::Sound::release)), Default, FMOD::Sound, release, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&FMOD::Sound::setMode)), Default, FMOD::Sound, setMode, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void*, unsigned int, unsigned int*>::func(&FMOD::Sound::readData)), Default, FMOD::Sound, readData, void*, unsigned int, unsigned int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&FMOD::Sound::seekData)), Default, FMOD::Sound, seekData, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_SOUND_TYPE*, FMOD_SOUND_FORMAT*, int*, int*>::func(&FMOD::Sound::getFormat)), Default, FMOD::Sound, getFormat, FMOD_SOUND_TYPE*, FMOD_SOUND_FORMAT*, int*, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int*, unsigned int>::func(&FMOD::Sound::getLength)), Default, FMOD::Sound, getLength, unsigned int*, unsigned int)
		}
	};
}
