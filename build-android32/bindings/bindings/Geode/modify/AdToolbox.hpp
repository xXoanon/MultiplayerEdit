...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AdToolbox> : ModifyBase<ModifyDerive<Der, AdToolbox>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&AdToolbox::cacheInterstitial)), Default, AdToolbox, cacheInterstitial, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&AdToolbox::cacheRewardedVideo)), Default, AdToolbox, cacheRewardedVideo, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&AdToolbox::disableBanner)), Default, AdToolbox, disableBanner, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&AdToolbox::enableBanner)), Default, AdToolbox, enableBanner, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&AdToolbox::enableBannerNoRefresh)), Default, AdToolbox, enableBannerNoRefresh, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&AdToolbox::hasCachedInterstitial)), Default, AdToolbox, hasCachedInterstitial, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&AdToolbox::hasCachedRewardedVideo)), Default, AdToolbox, hasCachedRewardedVideo, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&AdToolbox::isShowingAd)), Default, AdToolbox, isShowingAd, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&AdToolbox::queueRefreshBanner)), Default, AdToolbox, queueRefreshBanner, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&AdToolbox::setupAds)), Default, AdToolbox, setupAds, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&AdToolbox::showDebug)), Default, AdToolbox, showDebug, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&AdToolbox::showInterstitial)), Default, AdToolbox, showInterstitial, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&AdToolbox::showRewardedVideo)), Default, AdToolbox, showRewardedVideo, )
		}
	};
}
