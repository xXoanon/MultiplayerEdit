...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCCatmullRomBy> : ModifyBase<ModifyDerive<Der, cocos2d::CCCatmullRomBy>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, cocos2d::CCPointArray*>::func(&cocos2d::CCCatmullRomBy::initWithDuration)), Default, cocos2d::CCCatmullRomBy, initWithDuration, float, cocos2d::CCPointArray*)
		}
	};
}
