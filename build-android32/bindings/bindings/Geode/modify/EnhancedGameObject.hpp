...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EnhancedGameObject> : ModifyBase<ModifyDerive<Der, EnhancedGameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&EnhancedGameObject::create)), Default, EnhancedGameObject, create, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&EnhancedGameObject::customSetup)), Default, EnhancedGameObject, customSetup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&EnhancedGameObject::resetObject)), Default, EnhancedGameObject, resetObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&EnhancedGameObject::deactivateObject)), Default, EnhancedGameObject, deactivateObject, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN18EnhancedGameObject17customObjectSetupERSt6vectorISsSaISsEERS0_IPvSaIS4_EE")), Default, EnhancedGameObject, customObjectSetup, gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GJBaseGameLayer*>::func(&EnhancedGameObject::getSaveString)), Default, EnhancedGameObject, getSaveString, GJBaseGameLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&EnhancedGameObject::triggerActivated)), Default, EnhancedGameObject, triggerActivated, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&EnhancedGameObject::restoreObject)), Default, EnhancedGameObject, restoreObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&EnhancedGameObject::animationTriggered)), Default, EnhancedGameObject, animationTriggered, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<PlayerObject*>::func(&EnhancedGameObject::activatedByPlayer)), Default, EnhancedGameObject, activatedByPlayer, PlayerObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<PlayerObject*>::func(&EnhancedGameObject::hasBeenActivatedByPlayer)), Default, EnhancedGameObject, hasBeenActivatedByPlayer, PlayerObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&EnhancedGameObject::hasBeenActivated)), Default, EnhancedGameObject, hasBeenActivated, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&EnhancedGameObject::saveActiveColors)), Default, EnhancedGameObject, saveActiveColors, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&EnhancedGameObject::canAllowMultiActivate)), Default, EnhancedGameObject, canAllowMultiActivate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&EnhancedGameObject::getHasSyncedAnimation)), Default, EnhancedGameObject, getHasSyncedAnimation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&EnhancedGameObject::getHasRotateAction)), Default, EnhancedGameObject, getHasRotateAction, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&EnhancedGameObject::canMultiActivate)), Default, EnhancedGameObject, canMultiActivate, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int>::func(&EnhancedGameObject::powerOnObject)), Default, EnhancedGameObject, powerOnObject, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&EnhancedGameObject::powerOffObject)), Default, EnhancedGameObject, powerOffObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(EnhancedGameObject, stateSensitiveOff, GJBaseGameLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float, int>::func(&EnhancedGameObject::updateSyncedAnimation)), Default, EnhancedGameObject, updateSyncedAnimation, float, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&EnhancedGameObject::updateAnimateOnTrigger)), Default, EnhancedGameObject, updateAnimateOnTrigger, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, int>::func(&EnhancedGameObject::createRotateAction)), Default, EnhancedGameObject, createRotateAction, float, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&EnhancedGameObject::init)), Default, EnhancedGameObject, init, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&EnhancedGameObject::previewAnimateOnTrigger)), Default, EnhancedGameObject, previewAnimateOnTrigger, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&EnhancedGameObject::refreshRotateAction)), Default, EnhancedGameObject, refreshRotateAction, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&EnhancedGameObject::resetSyncedAnimation)), Default, EnhancedGameObject, resetSyncedAnimation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&EnhancedGameObject::setupAnimationVariables)), Default, EnhancedGameObject, setupAnimationVariables, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&EnhancedGameObject::triggerAnimation)), Default, EnhancedGameObject, triggerAnimation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&EnhancedGameObject::updateRotateAction)), Default, EnhancedGameObject, updateRotateAction, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&EnhancedGameObject::updateState)), Default, EnhancedGameObject, updateState, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&EnhancedGameObject::updateUserCoin)), Default, EnhancedGameObject, updateUserCoin, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&EnhancedGameObject::waitForAnimationTrigger)), Default, EnhancedGameObject, waitForAnimationTrigger, )
		}
	};
}
