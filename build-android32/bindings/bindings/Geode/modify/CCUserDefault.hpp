...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCUserDefault> : ModifyBase<ModifyDerive<Der, cocos2d::CCUserDefault>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d13CCUserDefaultC2Ev")), Default, cocos2d::CCUserDefault, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d13CCUserDefaultD2Ev")), Default, cocos2d::CCUserDefault)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCUserDefault::flush)), Default, cocos2d::CCUserDefault, flush, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCUserDefault::getBoolForKey)), Default, cocos2d::CCUserDefault, getBoolForKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, bool>::func(&cocos2d::CCUserDefault::getBoolForKey)), Default, cocos2d::CCUserDefault, getBoolForKey, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCUserDefault::getDoubleForKey)), Default, cocos2d::CCUserDefault, getDoubleForKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, double>::func(&cocos2d::CCUserDefault::getDoubleForKey)), Default, cocos2d::CCUserDefault, getDoubleForKey, char const*, double)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCUserDefault::getFloatForKey)), Default, cocos2d::CCUserDefault, getFloatForKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, float>::func(&cocos2d::CCUserDefault::getFloatForKey)), Default, cocos2d::CCUserDefault, getFloatForKey, char const*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCUserDefault::getIntegerForKey)), Default, cocos2d::CCUserDefault, getIntegerForKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, int>::func(&cocos2d::CCUserDefault::getIntegerForKey)), Default, cocos2d::CCUserDefault, getIntegerForKey, char const*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCUserDefault::getStringForKey)), Default, cocos2d::CCUserDefault, getStringForKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d13CCUserDefault15getStringForKeyEPKcRKSs")), Default, cocos2d::CCUserDefault, getStringForKey, char const*, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, bool>::func(&cocos2d::CCUserDefault::setBoolForKey)), Default, cocos2d::CCUserDefault, setBoolForKey, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, double>::func(&cocos2d::CCUserDefault::setDoubleForKey)), Default, cocos2d::CCUserDefault, setDoubleForKey, char const*, double)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, float>::func(&cocos2d::CCUserDefault::setFloatForKey)), Default, cocos2d::CCUserDefault, setFloatForKey, char const*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, int>::func(&cocos2d::CCUserDefault::setIntegerForKey)), Default, cocos2d::CCUserDefault, setIntegerForKey, char const*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d13CCUserDefault15setStringForKeyEPKcRKSs")), Default, cocos2d::CCUserDefault, setStringForKey, char const*, gd::string const&)
		}
	};
}
