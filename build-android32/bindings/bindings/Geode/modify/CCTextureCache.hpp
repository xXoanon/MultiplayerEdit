...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTextureCache> : ModifyBase<ModifyDerive<Der, cocos2d::CCTextureCache>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d14CCTextureCacheC2Ev")), Default, cocos2d::CCTextureCache, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d14CCTextureCacheD2Ev")), Default, cocos2d::CCTextureCache)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCTextureCache::addETCImage)), Default, cocos2d::CCTextureCache, addETCImage, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, bool>::func(&cocos2d::CCTextureCache::addImage)), Default, cocos2d::CCTextureCache, addImage, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler, int, cocos2d::CCTexture2DPixelFormat>::func(&cocos2d::CCTextureCache::addImageAsync)), Default, cocos2d::CCTextureCache, addImageAsync, char const*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler, int, cocos2d::CCTexture2DPixelFormat)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCTextureCache::addImageAsyncCallBack)), Default, cocos2d::CCTextureCache, addImageAsyncCallBack, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCTextureCache::addPVRImage)), Default, cocos2d::CCTextureCache, addPVRImage, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCImage*, char const*>::func(&cocos2d::CCTextureCache::addUIImage)), Default, cocos2d::CCTextureCache, addUIImage, cocos2d::CCImage*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTextureCache::description)), Default, cocos2d::CCTextureCache, description, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTextureCache::dumpCachedTextureInfo)), Default, cocos2d::CCTextureCache, dumpCachedTextureInfo, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTextureCache::prepareAsyncLoading)), Default, cocos2d::CCTextureCache, prepareAsyncLoading, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCTextureCache::reloadTexture)), Default, cocos2d::CCTextureCache, reloadTexture, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTextureCache::removeAllTextures)), Default, cocos2d::CCTextureCache, removeAllTextures, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTexture2D*>::func(&cocos2d::CCTextureCache::removeTexture)), Default, cocos2d::CCTextureCache, removeTexture, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCTextureCache::removeTextureForKey)), Default, cocos2d::CCTextureCache, removeTextureForKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTextureCache::removeUnusedTextures)), Default, cocos2d::CCTextureCache, removeUnusedTextures, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTextureCache::snapshotTextures)), Default, cocos2d::CCTextureCache, snapshotTextures, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCTextureCache::textureForKey)), Default, cocos2d::CCTextureCache, textureForKey, char const*)
		}
	};
}
