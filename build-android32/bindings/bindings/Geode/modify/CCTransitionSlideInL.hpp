...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionSlideInL> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionSlideInL>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCTransitionSlideInLC2Ev")), Default, cocos2d::CCTransitionSlideInL, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCTransitionSlideInLD2Ev")), Default, cocos2d::CCTransitionSlideInL)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionSlideInL::onEnter)), Default, cocos2d::CCTransitionSlideInL, onEnter, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionSlideInL::sceneOrder)), Default, cocos2d::CCTransitionSlideInL, sceneOrder, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionSlideInL::initScenes)), Default, cocos2d::CCTransitionSlideInL, initScenes, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionSlideInL::action)), Default, cocos2d::CCTransitionSlideInL, action, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCActionInterval*>::func(&cocos2d::CCTransitionSlideInL::easeActionWithAction)), Default, cocos2d::CCTransitionSlideInL, easeActionWithAction, cocos2d::CCActionInterval*)
		}
	};
}
