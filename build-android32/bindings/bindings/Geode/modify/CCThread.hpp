...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCThread> : ModifyBase<ModifyDerive<Der, cocos2d::CCThread>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d8CCThreadD2Ev")), Default, cocos2d::CCThread)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCThread::createAutoreleasePool)), Default, cocos2d::CCThread, createAutoreleasePool, )
		}
	};
}
