...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionRotoZoom> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionRotoZoom>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCTransitionRotoZoomC2Ev")), Default, cocos2d::CCTransitionRotoZoom, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCTransitionRotoZoomD2Ev")), Default, cocos2d::CCTransitionRotoZoom)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionRotoZoom::onEnter)), Default, cocos2d::CCTransitionRotoZoom, onEnter, )
		}
	};
}
