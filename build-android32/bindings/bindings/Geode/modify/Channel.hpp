...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FMOD::Channel> : ModifyBase<ModifyDerive<Der, FMOD::Channel>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int*, unsigned int>::func(&FMOD::Channel::getPosition)), Default, FMOD::Channel, getPosition, unsigned int*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::Channel::getPriority)), Default, FMOD::Channel, getPriority, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, unsigned int>::func(&FMOD::Channel::setPosition)), Default, FMOD::Channel, setPosition, unsigned int, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMOD::Channel::setPriority)), Default, FMOD::Channel, setPriority, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*>::func(&FMOD::Channel::getFrequency)), Default, FMOD::Channel, getFrequency, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::Channel::getLoopCount)), Default, FMOD::Channel, getLoopCount, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&FMOD::Channel::setFrequency)), Default, FMOD::Channel, setFrequency, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMOD::Channel::setLoopCount)), Default, FMOD::Channel, setLoopCount, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int*, unsigned int, unsigned int*, unsigned int>::func(&FMOD::Channel::getLoopPoints)), Default, FMOD::Channel, getLoopPoints, unsigned int*, unsigned int, unsigned int*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, unsigned int, unsigned int, unsigned int>::func(&FMOD::Channel::setLoopPoints)), Default, FMOD::Channel, setLoopPoints, unsigned int, unsigned int, unsigned int, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::ChannelGroup**>::func(&FMOD::Channel::getChannelGroup)), Default, FMOD::Channel, getChannelGroup, FMOD::ChannelGroup**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::Sound**>::func(&FMOD::Channel::getCurrentSound)), Default, FMOD::Channel, getCurrentSound, FMOD::Sound**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::ChannelGroup*>::func(&FMOD::Channel::setChannelGroup)), Default, FMOD::Channel, setChannelGroup, FMOD::ChannelGroup*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::Channel::getIndex)), Default, FMOD::Channel, getIndex, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool*>::func(&FMOD::Channel::isVirtual)), Default, FMOD::Channel, isVirtual, bool*)
		}
	};
}
