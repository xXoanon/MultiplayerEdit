...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCGrid3DAction> : ModifyBase<ModifyDerive<Der, cocos2d::CCGrid3DAction>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCGrid3DAction::getGrid)), Default, cocos2d::CCGrid3DAction, getGrid, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCGrid3DAction::originalVertex)), Default, cocos2d::CCGrid3DAction, originalVertex, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&, cocos2d::ccVertex3F const&>::func(&cocos2d::CCGrid3DAction::setVertex)), Default, cocos2d::CCGrid3DAction, setVertex, cocos2d::CCPoint const&, cocos2d::ccVertex3F const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCGrid3DAction::vertex)), Default, cocos2d::CCGrid3DAction, vertex, cocos2d::CCPoint const&)
		}
	};
}
