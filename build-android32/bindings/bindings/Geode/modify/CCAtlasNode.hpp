...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCAtlasNode> : ModifyBase<ModifyDerive<Der, cocos2d::CCAtlasNode>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCAtlasNodeC2Ev")), Default, cocos2d::CCAtlasNode, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCAtlasNodeD2Ev")), Default, cocos2d::CCAtlasNode)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCAtlasNode::getTextureAtlas)), Default, cocos2d::CCAtlasNode, getTextureAtlas, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTextureAtlas*>::func(&cocos2d::CCAtlasNode::setTextureAtlas)), Default, cocos2d::CCAtlasNode, setTextureAtlas, cocos2d::CCTextureAtlas*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCAtlasNode::getBlendFunc)), Default, cocos2d::CCAtlasNode, getBlendFunc, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccBlendFunc>::func(&cocos2d::CCAtlasNode::setBlendFunc)), Default, cocos2d::CCAtlasNode, setBlendFunc, cocos2d::ccBlendFunc)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCAtlasNode::getQuadsToDraw)), Default, cocos2d::CCAtlasNode, getQuadsToDraw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned int>::func(&cocos2d::CCAtlasNode::setQuadsToDraw)), Default, cocos2d::CCAtlasNode, setQuadsToDraw, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCAtlasNode::updateAtlasValues)), Default, cocos2d::CCAtlasNode, updateAtlasValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCAtlasNode::draw)), Default, cocos2d::CCAtlasNode, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCAtlasNode::getTexture)), Default, cocos2d::CCAtlasNode, getTexture, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTexture2D*>::func(&cocos2d::CCAtlasNode::setTexture)), Default, cocos2d::CCAtlasNode, setTexture, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCAtlasNode::isOpacityModifyRGB)), Default, cocos2d::CCAtlasNode, isOpacityModifyRGB, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::CCAtlasNode::setOpacityModifyRGB)), Default, cocos2d::CCAtlasNode, setOpacityModifyRGB, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCAtlasNode::getColor)), Default, cocos2d::CCAtlasNode, getColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor3B const&>::func(&cocos2d::CCAtlasNode::setColor)), Default, cocos2d::CCAtlasNode, setColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned char>::func(&cocos2d::CCAtlasNode::setOpacity)), Default, cocos2d::CCAtlasNode, setOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCAtlasNode::calculateMaxItems)), Default, cocos2d::CCAtlasNode, calculateMaxItems, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTexture2D*, unsigned int, unsigned int, unsigned int>::func(&cocos2d::CCAtlasNode::initWithTexture)), Default, cocos2d::CCAtlasNode, initWithTexture, cocos2d::CCTexture2D*, unsigned int, unsigned int, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, unsigned int, unsigned int, unsigned int>::func(&cocos2d::CCAtlasNode::initWithTileFile)), Default, cocos2d::CCAtlasNode, initWithTileFile, char const*, unsigned int, unsigned int, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCAtlasNode::setIgnoreContentScaleFactor)), Default, cocos2d::CCAtlasNode, setIgnoreContentScaleFactor, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCAtlasNode::updateBlendFunc)), Default, cocos2d::CCAtlasNode, updateBlendFunc, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCAtlasNode::updateOpacityModifyRGB)), Default, cocos2d::CCAtlasNode, updateOpacityModifyRGB, )
		}
	};
}
