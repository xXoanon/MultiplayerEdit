...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSAXParser> : ModifyBase<ModifyDerive<Der, cocos2d::CCSAXParser>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCSAXParserC2Ev")), Default, cocos2d::CCSAXParser, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCSAXParserD2Ev")), Default, cocos2d::CCSAXParser)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCSAXParser::init)), Default, cocos2d::CCSAXParser, init, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCSAXParser::parse)), Default, cocos2d::CCSAXParser, parse, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, unsigned int>::func(&cocos2d::CCSAXParser::parse)), Default, cocos2d::CCSAXParser, parse, char const*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSAXDelegator*>::func(&cocos2d::CCSAXParser::setDelegator)), Default, cocos2d::CCSAXParser, setDelegator, cocos2d::CCSAXDelegator*)
		}
	};
}
