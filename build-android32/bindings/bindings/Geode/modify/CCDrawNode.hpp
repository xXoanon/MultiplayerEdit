...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCDrawNode> : ModifyBase<ModifyDerive<Der, cocos2d::CCDrawNode>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d10CCDrawNodeC2Ev")), Default, cocos2d::CCDrawNode, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d10CCDrawNodeD2Ev")), Default, cocos2d::CCDrawNode)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCDrawNode::init)), Default, cocos2d::CCDrawNode, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCDrawNode::draw)), Default, cocos2d::CCDrawNode, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDrawNode::clear)), Default, cocos2d::CCDrawNode, clear, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDrawNode::disableDrawArea)), Default, cocos2d::CCDrawNode, disableDrawArea, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&, cocos2d::CCPoint const&, float, unsigned int, cocos2d::_ccColor4F const&, float>::func(&cocos2d::CCDrawNode::drawArchLikeHalfCircle)), Default, cocos2d::CCDrawNode, drawArchLikeHalfCircle, cocos2d::CCPoint const&, cocos2d::CCPoint const&, float, unsigned int, cocos2d::_ccColor4F const&, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&, float, cocos2d::ccColor4F const&, float, cocos2d::ccColor4F const&, unsigned int>::func(&cocos2d::CCDrawNode::drawCircle)), Default, cocos2d::CCDrawNode, drawCircle, cocos2d::CCPoint const&, float, cocos2d::ccColor4F const&, float, cocos2d::ccColor4F const&, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&, cocos2d::CCPoint const&, cocos2d::CCPoint const&, cocos2d::CCPoint const&, unsigned int, cocos2d::ccColor4F const&, float>::func(&cocos2d::CCDrawNode::drawCubicBezier)), Default, cocos2d::CCDrawNode, drawCubicBezier, cocos2d::CCPoint const&, cocos2d::CCPoint const&, cocos2d::CCPoint const&, cocos2d::CCPoint const&, unsigned int, cocos2d::ccColor4F const&, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&, cocos2d::CCPoint const&, cocos2d::CCPoint const&, cocos2d::CCPoint const&, unsigned int, cocos2d::ccColor4F const&, float, unsigned int, unsigned int>::func(&cocos2d::CCDrawNode::drawCubicBezierDashed)), Default, cocos2d::CCDrawNode, drawCubicBezierDashed, cocos2d::CCPoint const&, cocos2d::CCPoint const&, cocos2d::CCPoint const&, cocos2d::CCPoint const&, unsigned int, cocos2d::ccColor4F const&, float, unsigned int, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&, float, cocos2d::ccColor4F const&>::func(&cocos2d::CCDrawNode::drawDot)), Default, cocos2d::CCDrawNode, drawDot, cocos2d::CCPoint const&, float, cocos2d::ccColor4F const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint*, unsigned int, float, cocos2d::ccColor4F const&>::func(&cocos2d::CCDrawNode::drawLines)), Default, cocos2d::CCDrawNode, drawLines, cocos2d::CCPoint*, unsigned int, float, cocos2d::ccColor4F const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint*, unsigned int, cocos2d::ccColor4F const&, float, cocos2d::ccColor4F const&, cocos2d::BorderAlignment>::func(&cocos2d::CCDrawNode::drawPolygon)), Default, cocos2d::CCDrawNode, drawPolygon, cocos2d::CCPoint*, unsigned int, cocos2d::ccColor4F const&, float, cocos2d::ccColor4F const&, cocos2d::BorderAlignment)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&, cocos2d::CCPoint const&, cocos2d::CCPoint const&, cocos2d::CCPoint const&, unsigned int, cocos2d::ccColor4F const&, float>::func(&cocos2d::CCDrawNode::drawPreciseCubicBezier)), Default, cocos2d::CCDrawNode, drawPreciseCubicBezier, cocos2d::CCPoint const&, cocos2d::CCPoint const&, cocos2d::CCPoint const&, cocos2d::CCPoint const&, unsigned int, cocos2d::ccColor4F const&, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCRect const&, cocos2d::ccColor4F const&, float, cocos2d::ccColor4F const&, cocos2d::BorderAlignment>::func(&cocos2d::CCDrawNode::drawRect)), Default, cocos2d::CCDrawNode, drawRect, cocos2d::CCRect const&, cocos2d::ccColor4F const&, float, cocos2d::ccColor4F const&, cocos2d::BorderAlignment)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&, cocos2d::CCPoint const&, float, cocos2d::ccColor4F const&>::func(&cocos2d::CCDrawNode::drawSegment)), Default, cocos2d::CCDrawNode, drawSegment, cocos2d::CCPoint const&, cocos2d::CCPoint const&, float, cocos2d::ccColor4F const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&, cocos2d::CCPoint const&, float, cocos2d::ccColor4F const&, bool, bool>::func(&cocos2d::CCDrawNode::drawSegmentEx)), Default, cocos2d::CCDrawNode, drawSegmentEx, cocos2d::CCPoint const&, cocos2d::CCPoint const&, float, cocos2d::ccColor4F const&, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCRect&>::func(&cocos2d::CCDrawNode::enableDrawArea)), Default, cocos2d::CCDrawNode, enableDrawArea, cocos2d::CCRect&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCDrawNode::ensureCapacity)), Default, cocos2d::CCDrawNode, ensureCapacity, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDrawNode::getBlendFunc)), Default, cocos2d::CCDrawNode, getBlendFunc, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCRect const&, cocos2d::CCPoint const&, float>::func(&cocos2d::CCDrawNode::is_circle_on_screen)), Default, cocos2d::CCDrawNode, is_circle_on_screen, cocos2d::CCRect const&, cocos2d::CCPoint const&, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCRect const&, cocos2d::CCPoint const&, cocos2d::CCPoint const&>::func(&cocos2d::CCDrawNode::is_segment_on_screen)), Default, cocos2d::CCDrawNode, is_segment_on_screen, cocos2d::CCRect const&, cocos2d::CCPoint const&, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCDrawNode::listenBackToForeground)), Default, cocos2d::CCDrawNode, listenBackToForeground, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDrawNode::render)), Default, cocos2d::CCDrawNode, render, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::ccBlendFunc const&>::func(&cocos2d::CCDrawNode::setBlendFunc)), Default, cocos2d::CCDrawNode, setBlendFunc, cocos2d::ccBlendFunc const&)
		}
	};
}
