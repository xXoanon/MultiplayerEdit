...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionProgressOutIn> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionProgressOutIn>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCRenderTexture*>::func(&cocos2d::CCTransitionProgressOutIn::progressTimerNodeWithRenderTexture)), Default, cocos2d::CCTransitionProgressOutIn, progressTimerNodeWithRenderTexture, cocos2d::CCRenderTexture*)
		}
	};
}
