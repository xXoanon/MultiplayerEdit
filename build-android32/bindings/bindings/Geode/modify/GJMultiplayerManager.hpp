...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJMultiplayerManager> : ModifyBase<ModifyDerive<Der, GJMultiplayerManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJMultiplayerManager::sharedState)), Default, GJMultiplayerManager, sharedState, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJMultiplayerManager::init)), Default, GJMultiplayerManager, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN20GJMultiplayerManager10addCommentESsi")), Default, GJMultiplayerManager, addComment, gd::string, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&GJMultiplayerManager::addDLToActive)), Default, GJMultiplayerManager, addDLToActive, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, cocos2d::CCObject*>::func(&GJMultiplayerManager::addDLToActive)), Default, GJMultiplayerManager, addDLToActive, char const*, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN20GJMultiplayerManager19createAndAddCommentESsi")), Default, GJMultiplayerManager, createAndAddComment, gd::string, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<DS_Dictionary*>::func(&GJMultiplayerManager::dataLoaded)), Default, GJMultiplayerManager, dataLoaded, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<DS_Dictionary*>::func(&GJMultiplayerManager::encodeDataTo)), Default, GJMultiplayerManager, encodeDataTo, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJMultiplayerManager::exitLobby)), Default, GJMultiplayerManager, exitLobby, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJMultiplayerManager::firstSetup)), Default, GJMultiplayerManager, firstSetup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJMultiplayerManager::getBasePostString)), Default, GJMultiplayerManager, getBasePostString, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&GJMultiplayerManager::getDLObject)), Default, GJMultiplayerManager, getDLObject, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJMultiplayerManager::getLastCommentIDForGame)), Default, GJMultiplayerManager, getLastCommentIDForGame, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN20GJMultiplayerManager8handleItEbSsSs10GJHttpType")), Default, GJMultiplayerManager, handleIt, bool, gd::string, gd::string, GJHttpType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN20GJMultiplayerManager15handleItDelayedEbSsSs10GJHttpType")), Default, GJMultiplayerManager, handleItDelayed, bool, gd::string, gd::string, GJHttpType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCNode*, void*>::func(&GJMultiplayerManager::handleItND)), Default, GJMultiplayerManager, handleItND, cocos2d::CCNode*, void*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&GJMultiplayerManager::isDLActive)), Default, GJMultiplayerManager, isDLActive, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJMultiplayerManager::joinLobby)), Default, GJMultiplayerManager, joinLobby, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN20GJMultiplayerManager20onExitLobbyCompletedESsSs")), Default, GJMultiplayerManager, onExitLobbyCompleted, gd::string, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN20GJMultiplayerManager20onJoinLobbyCompletedESsSs")), Default, GJMultiplayerManager, onJoinLobbyCompleted, gd::string, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::extension::CCHttpClient*, cocos2d::extension::CCHttpResponse*>::func(&GJMultiplayerManager::onProcessHttpRequestCompleted)), Default, GJMultiplayerManager, onProcessHttpRequestCompleted, cocos2d::extension::CCHttpClient*, cocos2d::extension::CCHttpResponse*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN20GJMultiplayerManager24onUploadCommentCompletedESsSs")), Default, GJMultiplayerManager, onUploadCommentCompleted, gd::string, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN20GJMultiplayerManager18ProcessHttpRequestESsSsSs10GJHttpType")), Default, GJMultiplayerManager, ProcessHttpRequest, gd::string, gd::string, gd::string, GJHttpType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&GJMultiplayerManager::removeDLFromActive)), Default, GJMultiplayerManager, removeDLFromActive, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN20GJMultiplayerManager13uploadCommentESsi")), Default, GJMultiplayerManager, uploadComment, gd::string, int)
		}
	};
}
