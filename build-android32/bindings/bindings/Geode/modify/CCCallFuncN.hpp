...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCCallFuncN> : ModifyBase<ModifyDerive<Der, cocos2d::CCCallFuncN>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCObject*, cocos2d::SEL_CallFuncN>::func(&cocos2d::CCCallFuncN::initWithTarget)), Default, cocos2d::CCCallFuncN, initWithTarget, cocos2d::CCObject*, cocos2d::SEL_CallFuncN)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCCallFuncN::copyWithZone)), Default, cocos2d::CCCallFuncN, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCCallFuncN::execute)), Default, cocos2d::CCCallFuncN, execute, )
		}
	};
}
