...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FMOD::SoundGroup> : ModifyBase<ModifyDerive<Der, FMOD::SoundGroup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void**>::func(&FMOD::SoundGroup::getUserData)), Default, FMOD::SoundGroup, getUserData, void**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void*>::func(&FMOD::SoundGroup::setUserData)), Default, FMOD::SoundGroup, setUserData, void*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::SoundGroup::getNumSounds)), Default, FMOD::SoundGroup, getNumSounds, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::SoundGroup::getMaxAudible)), Default, FMOD::SoundGroup, getMaxAudible, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::SoundGroup::getNumPlaying)), Default, FMOD::SoundGroup, getNumPlaying, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMOD::SoundGroup::setMaxAudible)), Default, FMOD::SoundGroup, setMaxAudible, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::System**>::func(&FMOD::SoundGroup::getSystemObject)), Default, FMOD::SoundGroup, getSystemObject, FMOD::System**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*>::func(&FMOD::SoundGroup::getMuteFadeSpeed)), Default, FMOD::SoundGroup, getMuteFadeSpeed, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&FMOD::SoundGroup::setMuteFadeSpeed)), Default, FMOD::SoundGroup, setMuteFadeSpeed, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_SOUNDGROUP_BEHAVIOR*>::func(&FMOD::SoundGroup::getMaxAudibleBehavior)), Default, FMOD::SoundGroup, getMaxAudibleBehavior, FMOD_SOUNDGROUP_BEHAVIOR*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_SOUNDGROUP_BEHAVIOR>::func(&FMOD::SoundGroup::setMaxAudibleBehavior)), Default, FMOD::SoundGroup, setMaxAudibleBehavior, FMOD_SOUNDGROUP_BEHAVIOR)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMOD::SoundGroup::stop)), Default, FMOD::SoundGroup, stop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char*, int>::func(&FMOD::SoundGroup::getName)), Default, FMOD::SoundGroup, getName, char*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMOD::SoundGroup::release)), Default, FMOD::SoundGroup, release, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, FMOD::Sound**>::func(&FMOD::SoundGroup::getSound)), Default, FMOD::SoundGroup, getSound, int, FMOD::Sound**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*>::func(&FMOD::SoundGroup::getVolume)), Default, FMOD::SoundGroup, getVolume, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&FMOD::SoundGroup::setVolume)), Default, FMOD::SoundGroup, setVolume, float)
		}
	};
}
