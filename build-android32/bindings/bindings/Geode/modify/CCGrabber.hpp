...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCGrabber> : ModifyBase<ModifyDerive<Der, cocos2d::CCGrabber>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9CCGrabberC2Ev")), Default, cocos2d::CCGrabber, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9CCGrabberD2Ev")), Default, cocos2d::CCGrabber)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTexture2D*>::func(&cocos2d::CCGrabber::afterRender)), Default, cocos2d::CCGrabber, afterRender, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTexture2D*>::func(&cocos2d::CCGrabber::beforeRender)), Default, cocos2d::CCGrabber, beforeRender, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTexture2D*>::func(&cocos2d::CCGrabber::grab)), Default, cocos2d::CCGrabber, grab, cocos2d::CCTexture2D*)
		}
	};
}
