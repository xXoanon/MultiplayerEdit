...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJMoreGamesLayer> : ModifyBase<ModifyDerive<Der, GJMoreGamesLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJMoreGamesLayer::create)), Default, GJMoreGamesLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJMoreGamesLayer::customSetup)), Default, GJMoreGamesLayer, customSetup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJMoreGamesLayer::getMoreGamesList)), Default, GJMoreGamesLayer, getMoreGamesList, )
		}
	};
}
