...
namespace geode::modifier {
	...
	#ifndef GEODE_STATICS_isAnyPersistentPlaying
		#define GEODE_STATICS_isAnyPersistentPlaying
		GEODE_AS_STATIC_FUNCTION(isAnyPersistentPlaying) 
	#endif
	...
	struct ModifyDerive<Der, FMODAudioEngine> : ModifyBase<ModifyDerive<Der, FMODAudioEngine>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngineD2Ev")), Default, FMODAudioEngine)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(FMODAudioEngine, get, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::pitchForIdx)), Default, FMODAudioEngine, pitchForIdx, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMODReverbPreset>::func(&FMODAudioEngine::reverbToString)), Default, FMODAudioEngine, reverbToString, FMODReverbPreset)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::sharedEngine)), Default, FMODAudioEngine, sharedEngine, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&FMODAudioEngine::update)), Default, FMODAudioEngine, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::activateQueuedMusic)), Default, FMODAudioEngine, activateQueuedMusic, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::channelForChannelID)), Default, FMODAudioEngine, channelForChannelID, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::channelForUniqueID)), Default, FMODAudioEngine, channelForUniqueID, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::channelIDForUniqueID)), Default, FMODAudioEngine, channelIDForUniqueID, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, FMODSound*>::func(&FMODAudioEngine::channelLinkSound)), Default, FMODAudioEngine, channelLinkSound, int, FMODSound*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::Channel*, bool>::func(&FMODAudioEngine::channelStopped)), Default, FMODAudioEngine, channelStopped, FMOD::Channel*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::channelUnlinkSound)), Default, FMODAudioEngine, channelUnlinkSound, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::clearAllAudio)), Default, FMODAudioEngine, clearAllAudio, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::countActiveEffects)), Default, FMODAudioEngine, countActiveEffects, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::countActiveMusic)), Default, FMODAudioEngine, countActiveMusic, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine12createStreamESs")), Default, FMODAudioEngine, createStream, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::disableMetering)), Default, FMODAudioEngine, disableMetering, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::enableMetering)), Default, FMODAudioEngine, enableMetering, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&FMODAudioEngine::fadeInBackgroundMusic)), Default, FMODAudioEngine, fadeInBackgroundMusic, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, int>::func(&FMODAudioEngine::fadeInMusic)), Default, FMODAudioEngine, fadeInMusic, float, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, int, float, float>::func(&FMODAudioEngine::fadeMusic)), Default, FMODAudioEngine, fadeMusic, float, int, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, int>::func(&FMODAudioEngine::fadeOutMusic)), Default, FMODAudioEngine, fadeOutMusic, float, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::getActiveMusic)), Default, FMODAudioEngine, getActiveMusic, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::getActiveMusicChannel)), Default, FMODAudioEngine, getActiveMusicChannel, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::getBackgroundMusicVolume)), Default, FMODAudioEngine, getBackgroundMusicVolume, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, bool>::func(&FMODAudioEngine::getChannelGroup)), Default, FMODAudioEngine, getChannelGroup, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::getEffectsVolume)), Default, FMODAudioEngine, getEffectsVolume, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::getFMODStatus)), Default, FMODAudioEngine, getFMODStatus, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::getMeteringValue)), Default, FMODAudioEngine, getMeteringValue, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::getMusicChannelID)), Default, FMODAudioEngine, getMusicChannelID, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::getMusicLengthMS)), Default, FMODAudioEngine, getMusicLengthMS, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::getMusicTime)), Default, FMODAudioEngine, getMusicTime, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::getMusicTimeMS)), Default, FMODAudioEngine, getMusicTimeMS, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::getNextChannelID)), Default, FMODAudioEngine, getNextChannelID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<AudioTargetType>::func(&FMODAudioEngine::getTweenContainer)), Default, FMODAudioEngine, getTweenContainer, AudioTargetType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::isAnyPersistentPlaying)), Default, FMODAudioEngine, isAnyPersistentPlaying, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::isChannelStopping)), Default, FMODAudioEngine, isChannelStopping, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine14isEffectLoadedESs")), Default, FMODAudioEngine, isEffectLoaded, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::isMusicPlaying)), Default, FMODAudioEngine, isMusicPlaying, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine14isMusicPlayingESsi")), Default, FMODAudioEngine, isMusicPlaying, gd::string, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine24isPersistentMatchPlayingESsi")), Default, FMODAudioEngine, isPersistentMatchPlaying, gd::string, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::Sound*>::func(&FMODAudioEngine::isSoundReady)), Default, FMODAudioEngine, isSoundReady, FMOD::Sound*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine14lengthForSoundESs")), Default, FMODAudioEngine, lengthForSound, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine16loadAndPlayMusicESsji")), Default, FMODAudioEngine, loadAndPlayMusic, gd::string, unsigned int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMODAudioState&>::func(&FMODAudioEngine::loadAudioState)), Default, FMODAudioEngine, loadAudioState, FMODAudioState&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine9loadMusicESs")), Default, FMODAudioEngine, loadMusic, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine9loadMusicESsfffbiib")), Default, FMODAudioEngine, loadMusic, gd::string, float, float, float, bool, int, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::pauseAllAudio)), Default, FMODAudioEngine, pauseAllAudio, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::pauseAllEffects)), Default, FMODAudioEngine, pauseAllEffects, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&FMODAudioEngine::pauseAllMusic)), Default, FMODAudioEngine, pauseAllMusic, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&FMODAudioEngine::pauseEffect)), Default, FMODAudioEngine, pauseEffect, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::pauseMusic)), Default, FMODAudioEngine, pauseMusic, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine10playEffectESs")), Default, FMODAudioEngine, playEffect, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine10playEffectESsfff")), Default, FMODAudioEngine, playEffect, gd::string, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine18playEffectAdvancedESsffffbbiiiibibbiifi")), Default, FMODAudioEngine, playEffectAdvanced, gd::string, float, float, float, float, bool, bool, int, int, int, int, bool, int, bool, bool, int, int, float, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine15playEffectAsyncESs")), Default, FMODAudioEngine, playEffectAsync, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine9playMusicESsbfi")), Default, FMODAudioEngine, playMusic, gd::string, bool, float, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine13preloadEffectESs")), Default, FMODAudioEngine, preloadEffect, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine18preloadEffectAsyncESs")), Default, FMODAudioEngine, preloadEffectAsync, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine12preloadMusicESsbi")), Default, FMODAudioEngine, preloadMusic, gd::string, bool, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_RESULT>::func(&FMODAudioEngine::printResult)), Default, FMODAudioEngine, printResult, FMOD_RESULT)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine27queuedEffectFinishedLoadingESs")), Default, FMODAudioEngine, queuedEffectFinishedLoading, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine15queuePlayEffectESsffffbbiiiibibifi")), Default, FMODAudioEngine, queuePlayEffect, gd::string, float, float, float, float, bool, bool, int, int, int, int, bool, int, bool, int, float, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine15queueStartMusicESsfffbiiiiibibb")), Default, FMODAudioEngine, queueStartMusic, gd::string, float, float, float, bool, int, int, int, int, int, bool, int, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::Channel*, int, int>::func(&FMODAudioEngine::registerChannel)), Default, FMODAudioEngine, registerChannel, FMOD::Channel*, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::releaseRemovedSounds)), Default, FMODAudioEngine, releaseRemovedSounds, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::resumeAllAudio)), Default, FMODAudioEngine, resumeAllAudio, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::resumeAllEffects)), Default, FMODAudioEngine, resumeAllEffects, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::resumeAllMusic)), Default, FMODAudioEngine, resumeAllMusic, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::resumeAudio)), Default, FMODAudioEngine, resumeAudio, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&FMODAudioEngine::resumeEffect)), Default, FMODAudioEngine, resumeEffect, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::resumeMusic)), Default, FMODAudioEngine, resumeMusic, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMODAudioState&>::func(&FMODAudioEngine::saveAudioState)), Default, FMODAudioEngine, saveAudioState, FMODAudioState&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&FMODAudioEngine::setBackgroundMusicVolume)), Default, FMODAudioEngine, setBackgroundMusicVolume, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, AudioTargetType, float>::func(&FMODAudioEngine::setChannelPitch)), Default, FMODAudioEngine, setChannelPitch, int, AudioTargetType, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, AudioTargetType, float>::func(&FMODAudioEngine::setChannelVolume)), Default, FMODAudioEngine, setChannelVolume, int, AudioTargetType, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, AudioTargetType, float>::func(&FMODAudioEngine::setChannelVolumeMod)), Default, FMODAudioEngine, setChannelVolumeMod, int, AudioTargetType, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&FMODAudioEngine::setEffectsVolume)), Default, FMODAudioEngine, setEffectsVolume, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, bool, int>::func(&FMODAudioEngine::setMusicTimeMS)), Default, FMODAudioEngine, setMusicTimeMS, unsigned int, bool, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::setup)), Default, FMODAudioEngine, setup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::setupAudioEngine)), Default, FMODAudioEngine, setupAudioEngine, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::start)), Default, FMODAudioEngine, start, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int, int, int, bool, int, bool, bool>::func(&FMODAudioEngine::startMusic)), Default, FMODAudioEngine, startMusic, int, int, int, int, bool, int, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::stop)), Default, FMODAudioEngine, stop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::stopAllEffects)), Default, FMODAudioEngine, stopAllEffects, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&FMODAudioEngine::stopAllMusic)), Default, FMODAudioEngine, stopAllMusic, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::Channel*>::func(&FMODAudioEngine::stopAndGetFade)), Default, FMODAudioEngine, stopAndGetFade, FMOD::Channel*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::stopAndRemoveMusic)), Default, FMODAudioEngine, stopAndRemoveMusic, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::stopChannel)), Default, FMODAudioEngine, stopChannel, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::Channel*, bool, float>::func(&FMODAudioEngine::stopChannel)), Default, FMODAudioEngine, stopChannel, FMOD::Channel*, bool, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, AudioTargetType, bool, float>::func(&FMODAudioEngine::stopChannel)), Default, FMODAudioEngine, stopChannel, int, AudioTargetType, bool, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, AudioTargetType, AudioModType>::func(&FMODAudioEngine::stopChannelTween)), Default, FMODAudioEngine, stopChannelTween, int, AudioTargetType, AudioModType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, AudioTargetType>::func(&FMODAudioEngine::stopChannelTweens)), Default, FMODAudioEngine, stopChannelTweens, int, AudioTargetType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::stopMusic)), Default, FMODAudioEngine, stopMusic, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine17stopMusicNotInSetERSt13unordered_setIiSt4hashIiESt8equal_toIiESaIiEE")), Default, FMODAudioEngine, stopMusicNotInSet, gd::unordered_set<int>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine11storeEffectEPN4FMOD5SoundESs")), Default, FMODAudioEngine, storeEffect, FMOD::Sound*, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int>::func(&FMODAudioEngine::swapMusicIndex)), Default, FMODAudioEngine, swapMusicIndex, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::testFunction)), Default, FMODAudioEngine, testFunction, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMODQueuedMusic>::func(&FMODAudioEngine::triggerQueuedMusic)), Default, FMODAudioEngine, triggerQueuedMusic, FMODQueuedMusic)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::unloadAllEffects)), Default, FMODAudioEngine, unloadAllEffects, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine12unloadEffectESs")), Default, FMODAudioEngine, unloadEffect, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FMODAudioEngine::unregisterChannel)), Default, FMODAudioEngine, unregisterChannel, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::updateBackgroundFade)), Default, FMODAudioEngine, updateBackgroundFade, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, AudioTargetType, AudioModType, float, float>::func(&FMODAudioEngine::updateChannel)), Default, FMODAudioEngine, updateChannel, int, AudioTargetType, AudioModType, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&FMODAudioEngine::updateChannelTweens)), Default, FMODAudioEngine, updateChannelTweens, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::updateMetering)), Default, FMODAudioEngine, updateMetering, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::updateQueuedEffects)), Default, FMODAudioEngine, updateQueuedEffects, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::updateQueuedMusic)), Default, FMODAudioEngine, updateQueuedMusic, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMODReverbPreset, bool>::func(&FMODAudioEngine::updateReverb)), Default, FMODAudioEngine, updateReverb, FMODReverbPreset, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODAudioEngine::updateTemporaryEffects)), Default, FMODAudioEngine, updateTemporaryEffects, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::Sound*>::func(&FMODAudioEngine::waitUntilSoundReady)), Default, FMODAudioEngine, waitUntilSoundReady, FMOD::Sound*)
		}
	};
}
