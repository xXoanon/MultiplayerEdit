...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, PlayerCheckpoint> : ModifyBase<ModifyDerive<Der, PlayerCheckpoint>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&PlayerCheckpoint::create)), Default, PlayerCheckpoint, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&PlayerCheckpoint::init)), Default, PlayerCheckpoint, init, )
		}
	};
}
