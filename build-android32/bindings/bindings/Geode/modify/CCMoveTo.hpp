...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCMoveTo> : ModifyBase<ModifyDerive<Der, cocos2d::CCMoveTo>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCMoveTo::copyWithZone)), Default, cocos2d::CCMoveTo, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCMoveTo::startWithTarget)), Default, cocos2d::CCMoveTo, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, cocos2d::CCPoint const&>::func(&cocos2d::CCMoveTo::initWithDuration)), Default, cocos2d::CCMoveTo, initWithDuration, float, cocos2d::CCPoint const&)
		}
	};
}
