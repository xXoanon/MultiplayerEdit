...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCEaseSineOut> : ModifyBase<ModifyDerive<Der, cocos2d::CCEaseSineOut>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCEaseSineOut::copyWithZone)), Default, cocos2d::CCEaseSineOut, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCEaseSineOut::update)), Default, cocos2d::CCEaseSineOut, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCEaseSineOut::reverse)), Default, cocos2d::CCEaseSineOut, reverse, )
		}
	};
}
