...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCGridBase> : ModifyBase<ModifyDerive<Der, cocos2d::CCGridBase>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d10CCGridBaseD2Ev")), Default, cocos2d::CCGridBase)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCGridBase::blit)), Default, cocos2d::CCGridBase, blit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCGridBase::reuse)), Default, cocos2d::CCGridBase, reuse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCGridBase::calculateVertexPoints)), Default, cocos2d::CCGridBase, calculateVertexPoints, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCGridBase::afterDraw)), Default, cocos2d::CCGridBase, afterDraw, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCGridBase::beforeDraw)), Default, cocos2d::CCGridBase, beforeDraw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSize const&>::func(&cocos2d::CCGridBase::initWithSize)), Default, cocos2d::CCGridBase, initWithSize, cocos2d::CCSize const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSize const&, cocos2d::CCTexture2D*, bool>::func(&cocos2d::CCGridBase::initWithSize)), Default, cocos2d::CCGridBase, initWithSize, cocos2d::CCSize const&, cocos2d::CCTexture2D*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCGridBase::set2DProjection)), Default, cocos2d::CCGridBase, set2DProjection, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCGridBase::setActive)), Default, cocos2d::CCGridBase, setActive, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCGridBase::setTextureFlipped)), Default, cocos2d::CCGridBase, setTextureFlipped, bool)
		}
	};
}
