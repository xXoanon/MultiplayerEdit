...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCMenuItemImage> : ModifyBase<ModifyDerive<Der, cocos2d::CCMenuItemImage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCMenuItemImage::init)), Default, cocos2d::CCMenuItemImage, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, char const*, char const*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler>::func(&cocos2d::CCMenuItemImage::initWithNormalImage)), Default, cocos2d::CCMenuItemImage, initWithNormalImage, char const*, char const*, char const*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSpriteFrame*>::func(&cocos2d::CCMenuItemImage::setDisabledSpriteFrame)), Default, cocos2d::CCMenuItemImage, setDisabledSpriteFrame, cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSpriteFrame*>::func(&cocos2d::CCMenuItemImage::setNormalSpriteFrame)), Default, cocos2d::CCMenuItemImage, setNormalSpriteFrame, cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSpriteFrame*>::func(&cocos2d::CCMenuItemImage::setSelectedSpriteFrame)), Default, cocos2d::CCMenuItemImage, setSelectedSpriteFrame, cocos2d::CCSpriteFrame*)
		}
	};
}
