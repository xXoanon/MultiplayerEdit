...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTextureETC> : ModifyBase<ModifyDerive<Der, cocos2d::CCTextureETC>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCTextureETCC2Ev")), Default, cocos2d::CCTextureETC, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCTextureETCD2Ev")), Default, cocos2d::CCTextureETC)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTextureETC::getHeight)), Default, cocos2d::CCTextureETC, getHeight, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTextureETC::getName)), Default, cocos2d::CCTextureETC, getName, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTextureETC::getWidth)), Default, cocos2d::CCTextureETC, getWidth, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCTextureETC::initWithFile)), Default, cocos2d::CCTextureETC, initWithFile, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCTextureETC::loadTexture)), Default, cocos2d::CCTextureETC, loadTexture, char const*)
		}
	};
}
