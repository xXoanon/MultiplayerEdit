...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCScriptEngineManager> : ModifyBase<ModifyDerive<Der, cocos2d::CCScriptEngineManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d21CCScriptEngineManagerD2Ev")), Default, cocos2d::CCScriptEngineManager)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCScriptEngineManager::removeScriptEngine)), Default, cocos2d::CCScriptEngineManager, removeScriptEngine, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCScriptEngineProtocol*>::func(&cocos2d::CCScriptEngineManager::setScriptEngine)), Default, cocos2d::CCScriptEngineManager, setScriptEngine, cocos2d::CCScriptEngineProtocol*)
		}
	};
}
