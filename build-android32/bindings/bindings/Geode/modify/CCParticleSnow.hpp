...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCParticleSnow> : ModifyBase<ModifyDerive<Der, cocos2d::CCParticleSnow>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned int>::func(&cocos2d::CCParticleSnow::initWithTotalParticles)), Default, cocos2d::CCParticleSnow, initWithTotalParticles, unsigned int)
		}
	};
}
