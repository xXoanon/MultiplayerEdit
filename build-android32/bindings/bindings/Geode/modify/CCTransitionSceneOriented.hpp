...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionSceneOriented> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionSceneOriented>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d25CCTransitionSceneOrientedC2Ev")), Default, cocos2d::CCTransitionSceneOriented, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d25CCTransitionSceneOrientedD2Ev")), Default, cocos2d::CCTransitionSceneOriented)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float, cocos2d::CCScene*, cocos2d::tOrientation>::func(&cocos2d::CCTransitionSceneOriented::initWithDuration)), Default, cocos2d::CCTransitionSceneOriented, initWithDuration, float, cocos2d::CCScene*, cocos2d::tOrientation)
		}
	};
}
