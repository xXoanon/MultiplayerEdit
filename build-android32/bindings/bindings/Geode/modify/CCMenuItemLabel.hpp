...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCMenuItemLabel> : ModifyBase<ModifyDerive<Der, cocos2d::CCMenuItemLabel>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d15CCMenuItemLabelD2Ev")), Default, cocos2d::CCMenuItemLabel)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCMenuItemLabel::getDisabledColor)), Default, cocos2d::CCMenuItemLabel, getDisabledColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor3B const&>::func(&cocos2d::CCMenuItemLabel::setDisabledColor)), Default, cocos2d::CCMenuItemLabel, setDisabledColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCMenuItemLabel::getLabel)), Default, cocos2d::CCMenuItemLabel, getLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCMenuItemLabel::setLabel)), Default, cocos2d::CCMenuItemLabel, setLabel, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCMenuItemLabel::activate)), Default, cocos2d::CCMenuItemLabel, activate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCMenuItemLabel::selected)), Default, cocos2d::CCMenuItemLabel, selected, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCMenuItemLabel::unselected)), Default, cocos2d::CCMenuItemLabel, unselected, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::CCMenuItemLabel::setEnabled)), Default, cocos2d::CCMenuItemLabel, setEnabled, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCNode*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler>::func(&cocos2d::CCMenuItemLabel::initWithLabel)), Default, cocos2d::CCMenuItemLabel, initWithLabel, cocos2d::CCNode*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCMenuItemLabel::setString)), Default, cocos2d::CCMenuItemLabel, setString, char const*)
		}
	};
}
