...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCRotateBy> : ModifyBase<ModifyDerive<Der, cocos2d::CCRotateBy>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCRotateBy::copyWithZone)), Default, cocos2d::CCRotateBy, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCRotateBy::update)), Default, cocos2d::CCRotateBy, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCRotateBy::startWithTarget)), Default, cocos2d::CCRotateBy, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCRotateBy::reverse)), Default, cocos2d::CCRotateBy, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float>::func(&cocos2d::CCRotateBy::initWithDuration)), Default, cocos2d::CCRotateBy, initWithDuration, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float>::func(&cocos2d::CCRotateBy::initWithDuration)), Default, cocos2d::CCRotateBy, initWithDuration, float, float, float)
		}
	};
}
