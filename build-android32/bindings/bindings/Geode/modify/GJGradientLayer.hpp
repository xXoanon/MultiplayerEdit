...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJGradientLayer> : ModifyBase<ModifyDerive<Der, GJGradientLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJGradientLayer::create)), Default, GJGradientLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJGradientLayer::init)), Default, GJGradientLayer, init, )
		}
	};
}
