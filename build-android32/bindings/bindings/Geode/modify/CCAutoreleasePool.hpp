...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCAutoreleasePool> : ModifyBase<ModifyDerive<Der, cocos2d::CCAutoreleasePool>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d17CCAutoreleasePoolC2Ev")), Default, cocos2d::CCAutoreleasePool, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d17CCAutoreleasePoolD2Ev")), Default, cocos2d::CCAutoreleasePool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCAutoreleasePool::addObject)), Default, cocos2d::CCAutoreleasePool, addObject, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCAutoreleasePool::clear)), Default, cocos2d::CCAutoreleasePool, clear, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCAutoreleasePool::removeObject)), Default, cocos2d::CCAutoreleasePool, removeObject, cocos2d::CCObject*)
		}
	};
}
