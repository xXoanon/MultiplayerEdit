...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCLayerGradient> : ModifyBase<ModifyDerive<Der, cocos2d::CCLayerGradient>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLayerGradient::init)), Default, cocos2d::CCLayerGradient, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLayerGradient::visit)), Default, cocos2d::CCLayerGradient, visit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLayerGradient::updateColor)), Default, cocos2d::CCLayerGradient, updateColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor4B const&, cocos2d::ccColor4B const&>::func(&cocos2d::CCLayerGradient::initWithColor)), Default, cocos2d::CCLayerGradient, initWithColor, cocos2d::ccColor4B const&, cocos2d::ccColor4B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor4B const&, cocos2d::ccColor4B const&, cocos2d::CCPoint const&>::func(&cocos2d::CCLayerGradient::initWithColor)), Default, cocos2d::CCLayerGradient, initWithColor, cocos2d::ccColor4B const&, cocos2d::ccColor4B const&, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLayerGradient::getStartColor)), Default, cocos2d::CCLayerGradient, getStartColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor3B const&>::func(&cocos2d::CCLayerGradient::setStartColor)), Default, cocos2d::CCLayerGradient, setStartColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLayerGradient::getEndColor)), Default, cocos2d::CCLayerGradient, getEndColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor3B const&>::func(&cocos2d::CCLayerGradient::setEndColor)), Default, cocos2d::CCLayerGradient, setEndColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLayerGradient::getStartOpacity)), Default, cocos2d::CCLayerGradient, getStartOpacity, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned char>::func(&cocos2d::CCLayerGradient::setStartOpacity)), Default, cocos2d::CCLayerGradient, setStartOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLayerGradient::getEndOpacity)), Default, cocos2d::CCLayerGradient, getEndOpacity, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned char>::func(&cocos2d::CCLayerGradient::setEndOpacity)), Default, cocos2d::CCLayerGradient, setEndOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLayerGradient::getVector)), Default, cocos2d::CCLayerGradient, getVector, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCLayerGradient::setVector)), Default, cocos2d::CCLayerGradient, setVector, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::CCLayerGradient::setCompressedInterpolation)), Default, cocos2d::CCLayerGradient, setCompressedInterpolation, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLayerGradient::isCompressedInterpolation)), Default, cocos2d::CCLayerGradient, isCompressedInterpolation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::ccColor3B const&, unsigned char, cocos2d::ccColor3B const&, unsigned char, cocos2d::CCPoint const&>::func(&cocos2d::CCLayerGradient::setValues)), Default, cocos2d::CCLayerGradient, setValues, cocos2d::ccColor3B const&, unsigned char, cocos2d::ccColor3B const&, unsigned char, cocos2d::CCPoint const&)
		}
	};
}
