...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionSplitRows> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionSplitRows>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d21CCTransitionSplitRowsC2Ev")), Default, cocos2d::CCTransitionSplitRows, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d21CCTransitionSplitRowsD2Ev")), Default, cocos2d::CCTransitionSplitRows)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionSplitRows::action)), Default, cocos2d::CCTransitionSplitRows, action, )
		}
	};
}
