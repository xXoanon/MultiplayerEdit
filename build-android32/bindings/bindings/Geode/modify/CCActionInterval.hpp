...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCActionInterval> : ModifyBase<ModifyDerive<Der, cocos2d::CCActionInterval>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCActionInterval::copyWithZone)), Default, cocos2d::CCActionInterval, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCActionInterval::isDone)), Default, cocos2d::CCActionInterval, isDone, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCActionInterval::startWithTarget)), Default, cocos2d::CCActionInterval, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCActionInterval::step)), Default, cocos2d::CCActionInterval, step, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCActionInterval::reverse)), Default, cocos2d::CCActionInterval, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCActionInterval::getAmplitudeRate)), Default, cocos2d::CCActionInterval, getAmplitudeRate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCActionInterval::initWithDuration)), Default, cocos2d::CCActionInterval, initWithDuration, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCActionInterval::setAmplitudeRate)), Default, cocos2d::CCActionInterval, setAmplitudeRate, float)
		}
	};
}
