...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, VideoOptionsLayer> : ModifyBase<ModifyDerive<Der, VideoOptionsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&VideoOptionsLayer::create)), Default, VideoOptionsLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&VideoOptionsLayer::init)), Default, VideoOptionsLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&VideoOptionsLayer::keyBackClicked)), Default, VideoOptionsLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN17VideoOptionsLayer18createToggleButtonESsMN7cocos2d8CCObjectEFvPS1_EbPNS0_6CCMenuENS0_7CCPointEffbPNS0_7CCArrayE")), Default, VideoOptionsLayer, createToggleButton, gd::string, cocos2d::SEL_MenuHandler, bool, cocos2d::CCMenu*, cocos2d::CCPoint, float, float, bool, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&VideoOptionsLayer::onAdvanced)), Default, VideoOptionsLayer, onAdvanced, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&VideoOptionsLayer::onApply)), Default, VideoOptionsLayer, onApply, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&VideoOptionsLayer::onBorderless)), Default, VideoOptionsLayer, onBorderless, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&VideoOptionsLayer::onBorderlessFix)), Default, VideoOptionsLayer, onBorderlessFix, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&VideoOptionsLayer::onClose)), Default, VideoOptionsLayer, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&VideoOptionsLayer::onFullscreen)), Default, VideoOptionsLayer, onFullscreen, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&VideoOptionsLayer::onInfo)), Default, VideoOptionsLayer, onInfo, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&VideoOptionsLayer::onResolutionNext)), Default, VideoOptionsLayer, onResolutionNext, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&VideoOptionsLayer::onResolutionPrev)), Default, VideoOptionsLayer, onResolutionPrev, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&VideoOptionsLayer::onTextureQualityNext)), Default, VideoOptionsLayer, onTextureQualityNext, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&VideoOptionsLayer::onTextureQualityPrev)), Default, VideoOptionsLayer, onTextureQualityPrev, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&VideoOptionsLayer::reloadMenu)), Default, VideoOptionsLayer, reloadMenu, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&VideoOptionsLayer::toggleResolution)), Default, VideoOptionsLayer, toggleResolution, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&VideoOptionsLayer::updateResolution)), Default, VideoOptionsLayer, updateResolution, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&VideoOptionsLayer::updateTextureQuality)), Default, VideoOptionsLayer, updateTextureQuality, int)
		}
	};
}
