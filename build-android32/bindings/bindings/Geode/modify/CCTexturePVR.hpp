...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTexturePVR> : ModifyBase<ModifyDerive<Der, cocos2d::CCTexturePVR>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCTexturePVRC2Ev")), Default, cocos2d::CCTexturePVR, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCTexturePVRD2Ev")), Default, cocos2d::CCTexturePVR)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTexturePVR::createGLTexture)), Default, cocos2d::CCTexturePVR, createGLTexture, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCTexturePVR::initWithContentsOfFile)), Default, cocos2d::CCTexturePVR, initWithContentsOfFile, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned char*, unsigned int>::func(&cocos2d::CCTexturePVR::unpackPVRv2Data)), Default, cocos2d::CCTexturePVR, unpackPVRv2Data, unsigned char*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned char*, unsigned int>::func(&cocos2d::CCTexturePVR::unpackPVRv3Data)), Default, cocos2d::CCTexturePVR, unpackPVRv3Data, unsigned char*, unsigned int)
		}
	};
}
