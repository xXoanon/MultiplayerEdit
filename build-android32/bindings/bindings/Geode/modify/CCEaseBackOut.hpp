...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCEaseBackOut> : ModifyBase<ModifyDerive<Der, cocos2d::CCEaseBackOut>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCEaseBackOut::copyWithZone)), Default, cocos2d::CCEaseBackOut, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCEaseBackOut::update)), Default, cocos2d::CCEaseBackOut, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCEaseBackOut::reverse)), Default, cocos2d::CCEaseBackOut, reverse, )
		}
	};
}
