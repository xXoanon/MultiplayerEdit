...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCFileUtils> : ModifyBase<ModifyDerive<Der, cocos2d::CCFileUtils>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCFileUtilsC2Ev")), Default, cocos2d::CCFileUtils, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCFileUtilsD2Ev")), Default, cocos2d::CCFileUtils)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<char const*>::func(&cocos2d::CCFileUtils::addSearchPath)), Default, cocos2d::CCFileUtils, addSearchPath, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<char const*>::func(&cocos2d::CCFileUtils::addSearchResolutionsOrder)), Default, cocos2d::CCFileUtils, addSearchResolutionsOrder, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCFileUtils9addSuffixESsSs")), Default, cocos2d::CCFileUtils, addSuffix, gd::string, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCFileUtils31createCCArrayWithContentsOfFileERKSs")), Default, cocos2d::CCFileUtils, createCCArrayWithContentsOfFile, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCFileUtils36createCCDictionaryWithContentsOfFileERKSs")), Default, cocos2d::CCFileUtils, createCCDictionaryWithContentsOfFile, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<char const*, bool>::func(&cocos2d::CCFileUtils::fullPathForFilename)), Default, cocos2d::CCFileUtils, fullPathForFilename, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<char const*, char const*>::func(&cocos2d::CCFileUtils::fullPathFromRelativeFile)), Default, cocos2d::CCFileUtils, fullPathFromRelativeFile, char const*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<char const*, char const*, unsigned long*>::func(&cocos2d::CCFileUtils::getFileData)), Default, cocos2d::CCFileUtils, getFileData, char const*, char const*, unsigned long*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<char const*, char const*, unsigned long*>::func(&cocos2d::CCFileUtils::getFileDataFromZip)), Default, cocos2d::CCFileUtils, getFileDataFromZip, char const*, char const*, unsigned long*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCFileUtils34getFullPathForDirectoryAndFilenameERKSsS1_")), Default, cocos2d::CCFileUtils, getFullPathForDirectoryAndFilename, gd::string const&, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<char const*>::func(&cocos2d::CCFileUtils::getNewFilename)), Default, cocos2d::CCFileUtils, getNewFilename, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCFileUtils18getPathForFilenameERKSsS1_S1_")), Default, cocos2d::CCFileUtils, getPathForFilename, gd::string const&, gd::string const&, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCFileUtils::getSearchPaths)), Default, cocos2d::CCFileUtils, getSearchPaths, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCFileUtils::getSearchResolutionsOrder)), Default, cocos2d::CCFileUtils, getSearchResolutionsOrder, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCFileUtils::getWritablePath2)), Default, cocos2d::CCFileUtils, getWritablePath2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCFileUtils::init)), Default, cocos2d::CCFileUtils, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCFileUtils14isAbsolutePathERKSs")), Default, cocos2d::CCFileUtils, isAbsolutePath, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCFileUtils::isPopupNotify)), Default, cocos2d::CCFileUtils, isPopupNotify, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<char const*>::func(&cocos2d::CCFileUtils::loadFilenameLookupDictionaryFromFile)), Default, cocos2d::CCFileUtils, loadFilenameLookupDictionaryFromFile, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCFileUtils::purgeCachedEntries)), Default, cocos2d::CCFileUtils, purgeCachedEntries, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<char const*>::func(&cocos2d::CCFileUtils::removeFullPath)), Default, cocos2d::CCFileUtils, removeFullPath, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<char const*>::func(&cocos2d::CCFileUtils::removeSearchPath)), Default, cocos2d::CCFileUtils, removeSearchPath, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCDictionary*>::func(&cocos2d::CCFileUtils::setFilenameLookupDictionary)), Default, cocos2d::CCFileUtils, setFilenameLookupDictionary, cocos2d::CCDictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::CCFileUtils::setPopupNotify)), Default, cocos2d::CCFileUtils, setPopupNotify, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCFileUtils14setSearchPathsERKSt6vectorISsSaISsEE")), Default, cocos2d::CCFileUtils, setSearchPaths, gd::vector<gd::string> const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCFileUtils25setSearchResolutionsOrderERKSt6vectorISsSaISsEE")), Default, cocos2d::CCFileUtils, setSearchResolutionsOrder, gd::vector<gd::string> const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCFileUtils::shouldUseHD)), Default, cocos2d::CCFileUtils, shouldUseHD, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCFileUtils11writeToFileEPNS_12CCDictionaryERKSs")), Default, cocos2d::CCFileUtils, writeToFile, cocos2d::CCDictionary*, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCFileUtils::removeAllPaths)), Default, cocos2d::CCFileUtils, removeAllPaths, )
		}
	};
}
