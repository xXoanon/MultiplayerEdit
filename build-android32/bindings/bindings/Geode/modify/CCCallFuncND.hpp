...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCCallFuncND> : ModifyBase<ModifyDerive<Der, cocos2d::CCCallFuncND>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCObject*, cocos2d::SEL_CallFuncND, void*>::func(&cocos2d::CCCallFuncND::initWithTarget)), Default, cocos2d::CCCallFuncND, initWithTarget, cocos2d::CCObject*, cocos2d::SEL_CallFuncND, void*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCCallFuncND::copyWithZone)), Default, cocos2d::CCCallFuncND, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCCallFuncND::execute)), Default, cocos2d::CCCallFuncND, execute, )
		}
	};
}
