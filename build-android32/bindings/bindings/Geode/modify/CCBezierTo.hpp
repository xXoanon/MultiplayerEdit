...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCBezierTo> : ModifyBase<ModifyDerive<Der, cocos2d::CCBezierTo>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCBezierTo::copyWithZone)), Default, cocos2d::CCBezierTo, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCBezierTo::startWithTarget)), Default, cocos2d::CCBezierTo, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, cocos2d::ccBezierConfig const&>::func(&cocos2d::CCBezierTo::initWithDuration)), Default, cocos2d::CCBezierTo, initWithDuration, float, cocos2d::ccBezierConfig const&)
		}
	};
}
