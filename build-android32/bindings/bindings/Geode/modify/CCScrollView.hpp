...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::extension::CCScrollView> : ModifyBase<ModifyDerive<Der, cocos2d::extension::CCScrollView>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension12CCScrollViewC2Ev")), Default, cocos2d::extension::CCScrollView, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension12CCScrollViewD2Ev")), Default, cocos2d::extension::CCScrollView)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCScrollView::init)), Default, cocos2d::extension::CCScrollView, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCScrollView::registerWithTouchDispatcher)), Default, cocos2d::extension::CCScrollView, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*, cocos2d::CCEvent*>::func(&cocos2d::extension::CCScrollView::ccTouchBegan)), Default, cocos2d::extension::CCScrollView, ccTouchBegan, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*, cocos2d::CCEvent*>::func(&cocos2d::extension::CCScrollView::ccTouchMoved)), Default, cocos2d::extension::CCScrollView, ccTouchMoved, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*, cocos2d::CCEvent*>::func(&cocos2d::extension::CCScrollView::ccTouchEnded)), Default, cocos2d::extension::CCScrollView, ccTouchEnded, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*, cocos2d::CCEvent*>::func(&cocos2d::extension::CCScrollView::ccTouchCancelled)), Default, cocos2d::extension::CCScrollView, ccTouchCancelled, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSize const&>::func(&cocos2d::extension::CCScrollView::setContentSize)), Default, cocos2d::extension::CCScrollView, setContentSize, cocos2d::CCSize const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCScrollView::getContentSize)), Default, cocos2d::extension::CCScrollView, getContentSize, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCScrollView::visit)), Default, cocos2d::extension::CCScrollView, visit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*, int, int>::func(&cocos2d::extension::CCScrollView::addChild)), Default, cocos2d::extension::CCScrollView, addChild, cocos2d::CCNode*, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*, int>::func(&cocos2d::extension::CCScrollView::addChild)), Default, cocos2d::extension::CCScrollView, addChild, cocos2d::CCNode*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::extension::CCScrollView::addChild)), Default, cocos2d::extension::CCScrollView, addChild, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::extension::CCScrollView::setTouchEnabled)), Default, cocos2d::extension::CCScrollView, setTouchEnabled, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCScrollView::afterDraw)), Default, cocos2d::extension::CCScrollView, afterDraw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCScrollView::beforeDraw)), Default, cocos2d::extension::CCScrollView, beforeDraw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::extension::CCScrollView::deaccelerateScrolling)), Default, cocos2d::extension::CCScrollView, deaccelerateScrolling, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCScrollView::getContainer)), Default, cocos2d::extension::CCScrollView, getContainer, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCScrollView::getContentOffset)), Default, cocos2d::extension::CCScrollView, getContentOffset, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&cocos2d::extension::CCScrollView::getScriptHandler)), Default, cocos2d::extension::CCScrollView, getScriptHandler, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCScrollView::getViewRect)), Default, cocos2d::extension::CCScrollView, getViewRect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCScrollView::getZoomScale)), Default, cocos2d::extension::CCScrollView, getZoomScale, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSize, cocos2d::CCNode*>::func(&cocos2d::extension::CCScrollView::initWithViewSize)), Default, cocos2d::extension::CCScrollView, initWithViewSize, cocos2d::CCSize, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::extension::CCScrollView::isNodeVisible)), Default, cocos2d::extension::CCScrollView, isNodeVisible, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCScrollView::maxContainerOffset)), Default, cocos2d::extension::CCScrollView, maxContainerOffset, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCScrollView::minContainerOffset)), Default, cocos2d::extension::CCScrollView, minContainerOffset, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::extension::CCScrollView::pause)), Default, cocos2d::extension::CCScrollView, pause, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::extension::CCScrollView::performedAnimatedScroll)), Default, cocos2d::extension::CCScrollView, performedAnimatedScroll, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int>::func(&cocos2d::extension::CCScrollView::registerScriptHandler)), Default, cocos2d::extension::CCScrollView, registerScriptHandler, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::extension::CCScrollView::relocateContainer)), Default, cocos2d::extension::CCScrollView, relocateContainer, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::extension::CCScrollView::resume)), Default, cocos2d::extension::CCScrollView, resume, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::extension::CCScrollView::setContainer)), Default, cocos2d::extension::CCScrollView, setContainer, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint, bool>::func(&cocos2d::extension::CCScrollView::setContentOffset)), Default, cocos2d::extension::CCScrollView, setContentOffset, cocos2d::CCPoint, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint, float>::func(&cocos2d::extension::CCScrollView::setContentOffsetInDuration)), Default, cocos2d::extension::CCScrollView, setContentOffsetInDuration, cocos2d::CCPoint, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSize>::func(&cocos2d::extension::CCScrollView::setViewSize)), Default, cocos2d::extension::CCScrollView, setViewSize, cocos2d::CCSize)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::extension::CCScrollView::setZoomScale)), Default, cocos2d::extension::CCScrollView, setZoomScale, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, bool>::func(&cocos2d::extension::CCScrollView::setZoomScale)), Default, cocos2d::extension::CCScrollView, setZoomScale, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float>::func(&cocos2d::extension::CCScrollView::setZoomScaleInDuration)), Default, cocos2d::extension::CCScrollView, setZoomScaleInDuration, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::extension::CCScrollView::stoppedAnimatedScroll)), Default, cocos2d::extension::CCScrollView, stoppedAnimatedScroll, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&cocos2d::extension::CCScrollView::unregisterScriptHandler)), Default, cocos2d::extension::CCScrollView, unregisterScriptHandler, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCScrollView::updateInset)), Default, cocos2d::extension::CCScrollView, updateInset, )
		}
	};
}
