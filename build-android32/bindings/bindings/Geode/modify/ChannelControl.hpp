...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FMOD::ChannelControl> : ModifyBase<ModifyDerive<Der, FMOD::ChannelControl>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*>::func(&FMOD::ChannelControl::get3DLevel)), Default, FMOD::ChannelControl, get3DLevel, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::ChannelControl::getNumDSPs)), Default, FMOD::ChannelControl, getNumDSPs, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&FMOD::ChannelControl::set3DLevel)), Default, FMOD::ChannelControl, set3DLevel, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*>::func(&FMOD::ChannelControl::get3DSpread)), Default, FMOD::ChannelControl, get3DSpread, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned long long*, unsigned long long*>::func(&FMOD::ChannelControl::getDSPClock)), Default, FMOD::ChannelControl, getDSPClock, unsigned long long*, unsigned long long*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::DSP*, int*>::func(&FMOD::ChannelControl::getDSPIndex)), Default, FMOD::ChannelControl, getDSPIndex, FMOD::DSP*, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void**>::func(&FMOD::ChannelControl::getUserData)), Default, FMOD::ChannelControl, getUserData, void**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&FMOD::ChannelControl::set3DSpread)), Default, FMOD::ChannelControl, set3DSpread, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_CHANNELCONTROL_CALLBACK>::func(&FMOD::ChannelControl::setCallback)), Default, FMOD::ChannelControl, setCallback, FMOD_CHANNELCONTROL_CALLBACK)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::DSP*, int>::func(&FMOD::ChannelControl::setDSPIndex)), Default, FMOD::ChannelControl, setDSPIndex, FMOD::DSP*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void*>::func(&FMOD::ChannelControl::setUserData)), Default, FMOD::ChannelControl, setUserData, void*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned long long, float>::func(&FMOD::ChannelControl::addFadePoint)), Default, FMOD::ChannelControl, addFadePoint, unsigned long long, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*, int*, int*, int>::func(&FMOD::ChannelControl::getMixMatrix)), Default, FMOD::ChannelControl, getMixMatrix, float*, int*, int*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*, int, int, int>::func(&FMOD::ChannelControl::setMixMatrix)), Default, FMOD::ChannelControl, setMixMatrix, float*, int, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*>::func(&FMOD::ChannelControl::getAudibility)), Default, FMOD::ChannelControl, getAudibility, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int*, unsigned long long*, float*>::func(&FMOD::ChannelControl::getFadePoints)), Default, FMOD::ChannelControl, getFadePoints, unsigned int*, unsigned long long*, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool*>::func(&FMOD::ChannelControl::getVolumeRamp)), Default, FMOD::ChannelControl, getVolumeRamp, bool*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&FMOD::ChannelControl::setVolumeRamp)), Default, FMOD::ChannelControl, setVolumeRamp, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*, float*>::func(&FMOD::ChannelControl::get3DOcclusion)), Default, FMOD::ChannelControl, get3DOcclusion, float*, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*>::func(&FMOD::ChannelControl::getLowPassGain)), Default, FMOD::ChannelControl, getLowPassGain, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float>::func(&FMOD::ChannelControl::set3DOcclusion)), Default, FMOD::ChannelControl, set3DOcclusion, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&FMOD::ChannelControl::setLowPassGain)), Default, FMOD::ChannelControl, setLowPassGain, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_VECTOR*, FMOD_VECTOR*>::func(&FMOD::ChannelControl::get3DAttributes)), Default, FMOD::ChannelControl, get3DAttributes, FMOD_VECTOR*, FMOD_VECTOR*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::System**>::func(&FMOD::ChannelControl::getSystemObject)), Default, FMOD::ChannelControl, getSystemObject, FMOD::System**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_VECTOR const*, FMOD_VECTOR const*>::func(&FMOD::ChannelControl::set3DAttributes)), Default, FMOD::ChannelControl, set3DAttributes, FMOD_VECTOR const*, FMOD_VECTOR const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned long long, unsigned long long>::func(&FMOD::ChannelControl::removeFadePoints)), Default, FMOD::ChannelControl, removeFadePoints, unsigned long long, unsigned long long)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned long long, float>::func(&FMOD::ChannelControl::setFadePointRamp)), Default, FMOD::ChannelControl, setFadePointRamp, unsigned long long, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*, float*, float*>::func(&FMOD::ChannelControl::get3DConeSettings)), Default, FMOD::ChannelControl, get3DConeSettings, float*, float*, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*>::func(&FMOD::ChannelControl::get3DDopplerLevel)), Default, FMOD::ChannelControl, get3DDopplerLevel, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float>::func(&FMOD::ChannelControl::set3DConeSettings)), Default, FMOD::ChannelControl, set3DConeSettings, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&FMOD::ChannelControl::set3DDopplerLevel)), Default, FMOD::ChannelControl, set3DDopplerLevel, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*, int>::func(&FMOD::ChannelControl::setMixLevelsInput)), Default, FMOD::ChannelControl, setMixLevelsInput, float*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_VECTOR**, int*>::func(&FMOD::ChannelControl::get3DCustomRolloff)), Default, FMOD::ChannelControl, get3DCustomRolloff, FMOD_VECTOR**, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_VECTOR*, int>::func(&FMOD::ChannelControl::set3DCustomRolloff)), Default, FMOD::ChannelControl, set3DCustomRolloff, FMOD_VECTOR*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float, float, float, float, float, float>::func(&FMOD::ChannelControl::setMixLevelsOutput)), Default, FMOD::ChannelControl, setMixLevelsOutput, float, float, float, float, float, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool*, float*, float*>::func(&FMOD::ChannelControl::get3DDistanceFilter)), Default, FMOD::ChannelControl, get3DDistanceFilter, bool*, float*, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*, float*>::func(&FMOD::ChannelControl::get3DMinMaxDistance)), Default, FMOD::ChannelControl, get3DMinMaxDistance, float*, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, float*>::func(&FMOD::ChannelControl::getReverbProperties)), Default, FMOD::ChannelControl, getReverbProperties, int, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool, float, float>::func(&FMOD::ChannelControl::set3DDistanceFilter)), Default, FMOD::ChannelControl, set3DDistanceFilter, bool, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float>::func(&FMOD::ChannelControl::set3DMinMaxDistance)), Default, FMOD::ChannelControl, set3DMinMaxDistance, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, float>::func(&FMOD::ChannelControl::setReverbProperties)), Default, FMOD::ChannelControl, setReverbProperties, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_VECTOR*>::func(&FMOD::ChannelControl::get3DConeOrientation)), Default, FMOD::ChannelControl, get3DConeOrientation, FMOD_VECTOR*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_VECTOR*>::func(&FMOD::ChannelControl::set3DConeOrientation)), Default, FMOD::ChannelControl, set3DConeOrientation, FMOD_VECTOR*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMOD::ChannelControl::stop)), Default, FMOD::ChannelControl, stop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, FMOD::DSP*>::func(&FMOD::ChannelControl::addDSP)), Default, FMOD::ChannelControl, addDSP, int, FMOD::DSP*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, FMOD::DSP**>::func(&FMOD::ChannelControl::getDSP)), Default, FMOD::ChannelControl, getDSP, int, FMOD::DSP**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&FMOD::ChannelControl::setPan)), Default, FMOD::ChannelControl, setPan, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int*>::func(&FMOD::ChannelControl::getMode)), Default, FMOD::ChannelControl, getMode, unsigned int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool*>::func(&FMOD::ChannelControl::getMute)), Default, FMOD::ChannelControl, getMute, bool*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&FMOD::ChannelControl::setMode)), Default, FMOD::ChannelControl, setMode, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&FMOD::ChannelControl::setMute)), Default, FMOD::ChannelControl, setMute, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned long long*, unsigned long long*, bool*>::func(&FMOD::ChannelControl::getDelay)), Default, FMOD::ChannelControl, getDelay, unsigned long long*, unsigned long long*, bool*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*>::func(&FMOD::ChannelControl::getPitch)), Default, FMOD::ChannelControl, getPitch, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned long long, unsigned long long, bool>::func(&FMOD::ChannelControl::setDelay)), Default, FMOD::ChannelControl, setDelay, unsigned long long, unsigned long long, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&FMOD::ChannelControl::setPitch)), Default, FMOD::ChannelControl, setPitch, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool*>::func(&FMOD::ChannelControl::getPaused)), Default, FMOD::ChannelControl, getPaused, bool*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*>::func(&FMOD::ChannelControl::getVolume)), Default, FMOD::ChannelControl, getVolume, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool*>::func(&FMOD::ChannelControl::isPlaying)), Default, FMOD::ChannelControl, isPlaying, bool*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::DSP*>::func(&FMOD::ChannelControl::removeDSP)), Default, FMOD::ChannelControl, removeDSP, FMOD::DSP*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&FMOD::ChannelControl::setPaused)), Default, FMOD::ChannelControl, setPaused, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&FMOD::ChannelControl::setVolume)), Default, FMOD::ChannelControl, setVolume, float)
		}
	};
}
