...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionShrinkGrow> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionShrinkGrow>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d22CCTransitionShrinkGrowC2Ev")), Default, cocos2d::CCTransitionShrinkGrow, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d22CCTransitionShrinkGrowD2Ev")), Default, cocos2d::CCTransitionShrinkGrow)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionShrinkGrow::onEnter)), Default, cocos2d::CCTransitionShrinkGrow, onEnter, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCActionInterval*>::func(&cocos2d::CCTransitionShrinkGrow::easeActionWithAction)), Default, cocos2d::CCTransitionShrinkGrow, easeActionWithAction, cocos2d::CCActionInterval*)
		}
	};
}
