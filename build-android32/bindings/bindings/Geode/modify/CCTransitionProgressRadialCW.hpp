...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionProgressRadialCW> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionProgressRadialCW>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCRenderTexture*>::func(&cocos2d::CCTransitionProgressRadialCW::progressTimerNodeWithRenderTexture)), Default, cocos2d::CCTransitionProgressRadialCW, progressTimerNodeWithRenderTexture, cocos2d::CCRenderTexture*)
		}
	};
}
