...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionMoveInT> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionMoveInT>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d19CCTransitionMoveInTC2Ev")), Default, cocos2d::CCTransitionMoveInT, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d19CCTransitionMoveInTD2Ev")), Default, cocos2d::CCTransitionMoveInT)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionMoveInT::initScenes)), Default, cocos2d::CCTransitionMoveInT, initScenes, )
		}
	};
}
