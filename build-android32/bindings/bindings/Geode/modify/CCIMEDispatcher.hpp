...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCIMEDispatcher> : ModifyBase<ModifyDerive<Der, cocos2d::CCIMEDispatcher>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d15CCIMEDispatcherC2Ev")), Default, cocos2d::CCIMEDispatcher, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d15CCIMEDispatcherD2Ev")), Default, cocos2d::CCIMEDispatcher)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCIMEDelegate*>::func(&cocos2d::CCIMEDispatcher::addDelegate)), Default, cocos2d::CCIMEDispatcher, addDelegate, cocos2d::CCIMEDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCIMEDelegate*>::func(&cocos2d::CCIMEDispatcher::attachDelegateWithIME)), Default, cocos2d::CCIMEDispatcher, attachDelegateWithIME, cocos2d::CCIMEDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCIMEDelegate*>::func(&cocos2d::CCIMEDispatcher::detachDelegateWithIME)), Default, cocos2d::CCIMEDispatcher, detachDelegateWithIME, cocos2d::CCIMEDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCIMEDispatcher::dispatchDeleteBackward)), Default, cocos2d::CCIMEDispatcher, dispatchDeleteBackward, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCIMEDispatcher::dispatchDeleteForward)), Default, cocos2d::CCIMEDispatcher, dispatchDeleteForward, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, int, cocos2d::enumKeyCodes>::func(&cocos2d::CCIMEDispatcher::dispatchInsertText)), Default, cocos2d::CCIMEDispatcher, dispatchInsertText, char const*, int, cocos2d::enumKeyCodes)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCIMEKeyboardNotificationInfo&>::func(&cocos2d::CCIMEDispatcher::dispatchKeyboardDidHide)), Default, cocos2d::CCIMEDispatcher, dispatchKeyboardDidHide, cocos2d::CCIMEKeyboardNotificationInfo&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCIMEKeyboardNotificationInfo&>::func(&cocos2d::CCIMEDispatcher::dispatchKeyboardDidShow)), Default, cocos2d::CCIMEDispatcher, dispatchKeyboardDidShow, cocos2d::CCIMEKeyboardNotificationInfo&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCIMEDispatcher::dispatchKeyboardWillHide)), Default, cocos2d::CCIMEDispatcher, dispatchKeyboardWillHide, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCIMEKeyboardNotificationInfo&>::func(&cocos2d::CCIMEDispatcher::dispatchKeyboardWillHide)), Default, cocos2d::CCIMEDispatcher, dispatchKeyboardWillHide, cocos2d::CCIMEKeyboardNotificationInfo&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCIMEKeyboardNotificationInfo&>::func(&cocos2d::CCIMEDispatcher::dispatchKeyboardWillShow)), Default, cocos2d::CCIMEDispatcher, dispatchKeyboardWillShow, cocos2d::CCIMEKeyboardNotificationInfo&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCIMEDispatcher::getContentText)), Default, cocos2d::CCIMEDispatcher, getContentText, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCIMEDispatcher::hasDelegate)), Default, cocos2d::CCIMEDispatcher, hasDelegate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCIMEDelegate*>::func(&cocos2d::CCIMEDispatcher::removeDelegate)), Default, cocos2d::CCIMEDispatcher, removeDelegate, cocos2d::CCIMEDelegate*)
		}
	};
}
