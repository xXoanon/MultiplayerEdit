...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCDisplayLinkDirector> : ModifyBase<ModifyDerive<Der, cocos2d::CCDisplayLinkDirector>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<double>::func(&cocos2d::CCDisplayLinkDirector::setAnimationInterval)), Default, cocos2d::CCDisplayLinkDirector, setAnimationInterval, double)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCDisplayLinkDirector::stopAnimation)), Default, cocos2d::CCDisplayLinkDirector, stopAnimation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCDisplayLinkDirector::startAnimation)), Default, cocos2d::CCDisplayLinkDirector, startAnimation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCDisplayLinkDirector::mainLoop)), Default, cocos2d::CCDisplayLinkDirector, mainLoop, )
		}
	};
}
