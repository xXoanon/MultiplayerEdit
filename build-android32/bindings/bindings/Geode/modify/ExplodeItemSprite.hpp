...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ExplodeItemSprite> : ModifyBase<ModifyDerive<Der, ExplodeItemSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&ExplodeItemSprite::create)), Default, ExplodeItemSprite, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&ExplodeItemSprite::init)), Default, ExplodeItemSprite, init, )
		}
	};
}
