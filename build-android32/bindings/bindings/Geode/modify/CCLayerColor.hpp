...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCLayerColor> : ModifyBase<ModifyDerive<Der, cocos2d::CCLayerColor>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCLayerColorC2Ev")), Default, cocos2d::CCLayerColor, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCLayerColorD2Ev")), Default, cocos2d::CCLayerColor)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLayerColor::init)), Default, cocos2d::CCLayerColor, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSize const&>::func(&cocos2d::CCLayerColor::setContentSize)), Default, cocos2d::CCLayerColor, setContentSize, cocos2d::CCSize const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLayerColor::draw)), Default, cocos2d::CCLayerColor, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor4B const&, float, float>::func(&cocos2d::CCLayerColor::initWithColor)), Default, cocos2d::CCLayerColor, initWithColor, cocos2d::ccColor4B const&, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor4B const&>::func(&cocos2d::CCLayerColor::initWithColor)), Default, cocos2d::CCLayerColor, initWithColor, cocos2d::ccColor4B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLayerColor::updateColor)), Default, cocos2d::CCLayerColor, updateColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor3B const&>::func(&cocos2d::CCLayerColor::setColor)), Default, cocos2d::CCLayerColor, setColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned char>::func(&cocos2d::CCLayerColor::setOpacity)), Default, cocos2d::CCLayerColor, setOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccBlendFunc>::func(&cocos2d::CCLayerColor::setBlendFunc)), Default, cocos2d::CCLayerColor, setBlendFunc, cocos2d::ccBlendFunc)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLayerColor::getBlendFunc)), Default, cocos2d::CCLayerColor, getBlendFunc, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint, cocos2d::CCPoint, cocos2d::CCPoint>::func(&cocos2d::CCLayerColor::addToVertices)), Default, cocos2d::CCLayerColor, addToVertices, cocos2d::CCPoint, cocos2d::CCPoint, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCLayerColor::changeHeight)), Default, cocos2d::CCLayerColor, changeHeight, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCLayerColor::changeWidth)), Default, cocos2d::CCLayerColor, changeWidth, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float>::func(&cocos2d::CCLayerColor::changeWidthAndHeight)), Default, cocos2d::CCLayerColor, changeWidthAndHeight, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint, cocos2d::CCPoint, cocos2d::CCPoint>::func(&cocos2d::CCLayerColor::setVertices)), Default, cocos2d::CCLayerColor, setVertices, cocos2d::CCPoint, cocos2d::CCPoint, cocos2d::CCPoint)
		}
	};
}
