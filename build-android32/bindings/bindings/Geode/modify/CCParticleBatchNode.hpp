...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCParticleBatchNode> : ModifyBase<ModifyDerive<Der, cocos2d::CCParticleBatchNode>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d19CCParticleBatchNodeC2Ev")), Default, cocos2d::CCParticleBatchNode, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d19CCParticleBatchNodeD2Ev")), Default, cocos2d::CCParticleBatchNode)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCParticleBatchNode::addChild)), Default, cocos2d::CCParticleBatchNode, addChild, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*, int>::func(&cocos2d::CCParticleBatchNode::addChild)), Default, cocos2d::CCParticleBatchNode, addChild, cocos2d::CCNode*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*, int, int>::func(&cocos2d::CCParticleBatchNode::addChild)), Default, cocos2d::CCParticleBatchNode, addChild, cocos2d::CCNode*, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*, bool>::func(&cocos2d::CCParticleBatchNode::removeChild)), Default, cocos2d::CCParticleBatchNode, removeChild, cocos2d::CCNode*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*, int>::func(&cocos2d::CCParticleBatchNode::reorderChild)), Default, cocos2d::CCParticleBatchNode, reorderChild, cocos2d::CCNode*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::CCParticleBatchNode::removeAllChildrenWithCleanup)), Default, cocos2d::CCParticleBatchNode, removeAllChildrenWithCleanup, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleBatchNode::draw)), Default, cocos2d::CCParticleBatchNode, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleBatchNode::getTexture)), Default, cocos2d::CCParticleBatchNode, getTexture, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTexture2D*>::func(&cocos2d::CCParticleBatchNode::setTexture)), Default, cocos2d::CCParticleBatchNode, setTexture, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccBlendFunc>::func(&cocos2d::CCParticleBatchNode::setBlendFunc)), Default, cocos2d::CCParticleBatchNode, setBlendFunc, cocos2d::ccBlendFunc)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleBatchNode::getBlendFunc)), Default, cocos2d::CCParticleBatchNode, getBlendFunc, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleBatchNode::visit)), Default, cocos2d::CCParticleBatchNode, visit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCParticleSystem*, int, int>::func(&cocos2d::CCParticleBatchNode::addChildHelper)), Default, cocos2d::CCParticleBatchNode, addChildHelper, cocos2d::CCParticleSystem*, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCParticleBatchNode::disableParticle)), Default, cocos2d::CCParticleBatchNode, disableParticle, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int*, unsigned int*, cocos2d::CCNode*, int>::func(&cocos2d::CCParticleBatchNode::getCurrentIndex)), Default, cocos2d::CCParticleBatchNode, getCurrentIndex, unsigned int*, unsigned int*, cocos2d::CCNode*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCParticleBatchNode::increaseAtlasCapacityTo)), Default, cocos2d::CCParticleBatchNode, increaseAtlasCapacityTo, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, unsigned int>::func(&cocos2d::CCParticleBatchNode::initWithFile)), Default, cocos2d::CCParticleBatchNode, initWithFile, char const*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTexture2D*, unsigned int>::func(&cocos2d::CCParticleBatchNode::initWithTexture)), Default, cocos2d::CCParticleBatchNode, initWithTexture, cocos2d::CCTexture2D*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCParticleSystem*, unsigned int>::func(&cocos2d::CCParticleBatchNode::insertChild)), Default, cocos2d::CCParticleBatchNode, insertChild, cocos2d::CCParticleSystem*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, bool>::func(&cocos2d::CCParticleBatchNode::removeChildAtIndex)), Default, cocos2d::CCParticleBatchNode, removeChildAtIndex, unsigned int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&cocos2d::CCParticleBatchNode::searchNewPositionInChildrenForZ)), Default, cocos2d::CCParticleBatchNode, searchNewPositionInChildrenForZ, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleBatchNode::updateAllAtlasIndexes)), Default, cocos2d::CCParticleBatchNode, updateAllAtlasIndexes, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleBatchNode::updateBlendFunc)), Default, cocos2d::CCParticleBatchNode, updateBlendFunc, )
		}
	};
}
