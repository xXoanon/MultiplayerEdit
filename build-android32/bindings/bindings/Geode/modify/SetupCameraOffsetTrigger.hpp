...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupCameraOffsetTrigger> : ModifyBase<ModifyDerive<Der, SetupCameraOffsetTrigger>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<CameraTriggerGameObject*, cocos2d::CCArray*>::func(&SetupCameraOffsetTrigger::create)), Default, SetupCameraOffsetTrigger, create, CameraTriggerGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&SetupCameraOffsetTrigger::determineStartValues)), Default, SetupCameraOffsetTrigger, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCObject*>::func(&SetupCameraOffsetTrigger::onClose)), Default, SetupCameraOffsetTrigger, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<CCTextInputNode*>::func(&SetupCameraOffsetTrigger::textChanged)), Default, SetupCameraOffsetTrigger, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<ConfigureValuePopup*, float>::func(&SetupCameraOffsetTrigger::valuePopupClosed)), Default, SetupCameraOffsetTrigger, valuePopupClosed, ConfigureValuePopup*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<CameraTriggerGameObject*, cocos2d::CCArray*>::func(&SetupCameraOffsetTrigger::init)), Default, SetupCameraOffsetTrigger, init, CameraTriggerGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupCameraOffsetTrigger::onEasing)), Default, SetupCameraOffsetTrigger, onEasing, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupCameraOffsetTrigger::onEasingRate)), Default, SetupCameraOffsetTrigger, onEasingRate, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupCameraOffsetTrigger::onTargetMode)), Default, SetupCameraOffsetTrigger, onTargetMode, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&SetupCameraOffsetTrigger::posFromSliderValue)), Default, SetupCameraOffsetTrigger, posFromSliderValue, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupCameraOffsetTrigger::sliderChanged)), Default, SetupCameraOffsetTrigger, sliderChanged, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&SetupCameraOffsetTrigger::sliderValueFromPos)), Default, SetupCameraOffsetTrigger, sliderValueFromPos, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupCameraOffsetTrigger::sliderXChanged)), Default, SetupCameraOffsetTrigger, sliderXChanged, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupCameraOffsetTrigger::sliderYChanged)), Default, SetupCameraOffsetTrigger, sliderYChanged, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupCameraOffsetTrigger::toggleEasingRateVisibility)), Default, SetupCameraOffsetTrigger, toggleEasingRateVisibility, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupCameraOffsetTrigger::updateDuration)), Default, SetupCameraOffsetTrigger, updateDuration, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&SetupCameraOffsetTrigger::updateDurLabel)), Default, SetupCameraOffsetTrigger, updateDurLabel, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupCameraOffsetTrigger::updateEasingLabel)), Default, SetupCameraOffsetTrigger, updateEasingLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupCameraOffsetTrigger::updateEasingRateLabel)), Default, SetupCameraOffsetTrigger, updateEasingRateLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupCameraOffsetTrigger::updateMoveCommandEasing)), Default, SetupCameraOffsetTrigger, updateMoveCommandEasing, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupCameraOffsetTrigger::updateMoveCommandEasingRate)), Default, SetupCameraOffsetTrigger, updateMoveCommandEasingRate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupCameraOffsetTrigger::updateMoveCommandPosX)), Default, SetupCameraOffsetTrigger, updateMoveCommandPosX, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupCameraOffsetTrigger::updateMoveCommandPosY)), Default, SetupCameraOffsetTrigger, updateMoveCommandPosY, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupCameraOffsetTrigger::updateValueXLabel)), Default, SetupCameraOffsetTrigger, updateValueXLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupCameraOffsetTrigger::updateValueYLabel)), Default, SetupCameraOffsetTrigger, updateValueYLabel, )
		}
	};
}
