...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSpriteBatchNode> : ModifyBase<ModifyDerive<Der, cocos2d::CCSpriteBatchNode>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d17CCSpriteBatchNodeC2Ev")), Default, cocos2d::CCSpriteBatchNode, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d17CCSpriteBatchNodeD2Ev")), Default, cocos2d::CCSpriteBatchNode)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCSpriteBatchNode::init)), Default, cocos2d::CCSpriteBatchNode, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCSpriteBatchNode::addChild)), Default, cocos2d::CCSpriteBatchNode, addChild, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*, int>::func(&cocos2d::CCSpriteBatchNode::addChild)), Default, cocos2d::CCSpriteBatchNode, addChild, cocos2d::CCNode*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*, int, int>::func(&cocos2d::CCSpriteBatchNode::addChild)), Default, cocos2d::CCSpriteBatchNode, addChild, cocos2d::CCNode*, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*, bool>::func(&cocos2d::CCSpriteBatchNode::removeChild)), Default, cocos2d::CCSpriteBatchNode, removeChild, cocos2d::CCNode*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::CCSpriteBatchNode::removeAllChildrenWithCleanup)), Default, cocos2d::CCSpriteBatchNode, removeAllChildrenWithCleanup, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*, int>::func(&cocos2d::CCSpriteBatchNode::reorderChild)), Default, cocos2d::CCSpriteBatchNode, reorderChild, cocos2d::CCNode*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCSpriteBatchNode::sortAllChildren)), Default, cocos2d::CCSpriteBatchNode, sortAllChildren, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCSpriteBatchNode::draw)), Default, cocos2d::CCSpriteBatchNode, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCSpriteBatchNode::visit)), Default, cocos2d::CCSpriteBatchNode, visit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccBlendFunc>::func(&cocos2d::CCSpriteBatchNode::setBlendFunc)), Default, cocos2d::CCSpriteBatchNode, setBlendFunc, cocos2d::ccBlendFunc)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCSpriteBatchNode::getBlendFunc)), Default, cocos2d::CCSpriteBatchNode, getBlendFunc, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCSpriteBatchNode::getTexture)), Default, cocos2d::CCSpriteBatchNode, getTexture, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTexture2D*>::func(&cocos2d::CCSpriteBatchNode::setTexture)), Default, cocos2d::CCSpriteBatchNode, setTexture, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSprite*, unsigned int, int>::func(&cocos2d::CCSpriteBatchNode::addSpriteWithoutQuad)), Default, cocos2d::CCSpriteBatchNode, addSpriteWithoutQuad, cocos2d::CCSprite*, unsigned int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSprite*>::func(&cocos2d::CCSpriteBatchNode::appendChild)), Default, cocos2d::CCSpriteBatchNode, appendChild, cocos2d::CCSprite*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSprite*, int>::func(&cocos2d::CCSpriteBatchNode::atlasIndexForChild)), Default, cocos2d::CCSpriteBatchNode, atlasIndexForChild, cocos2d::CCSprite*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSpriteBatchNode::getAtlasCapacity)), Default, cocos2d::CCSpriteBatchNode, getAtlasCapacity, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSpriteBatchNode::getUsedAtlasCapacity)), Default, cocos2d::CCSpriteBatchNode, getUsedAtlasCapacity, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSprite*>::func(&cocos2d::CCSpriteBatchNode::highestAtlasIndexInChild)), Default, cocos2d::CCSpriteBatchNode, highestAtlasIndexInChild, cocos2d::CCSprite*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSpriteBatchNode::increaseAtlasCapacity)), Default, cocos2d::CCSpriteBatchNode, increaseAtlasCapacity, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCSpriteBatchNode::increaseAtlasCapacity)), Default, cocos2d::CCSpriteBatchNode, increaseAtlasCapacity, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, unsigned int>::func(&cocos2d::CCSpriteBatchNode::initWithFile)), Default, cocos2d::CCSpriteBatchNode, initWithFile, char const*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTexture2D*, unsigned int>::func(&cocos2d::CCSpriteBatchNode::initWithTexture)), Default, cocos2d::CCSpriteBatchNode, initWithTexture, cocos2d::CCTexture2D*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSprite*, unsigned int>::func(&cocos2d::CCSpriteBatchNode::insertChild)), Default, cocos2d::CCSpriteBatchNode, insertChild, cocos2d::CCSprite*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSprite*, unsigned int>::func(&cocos2d::CCSpriteBatchNode::insertQuadFromSprite)), Default, cocos2d::CCSpriteBatchNode, insertQuadFromSprite, cocos2d::CCSprite*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSprite*>::func(&cocos2d::CCSpriteBatchNode::lowestAtlasIndexInChild)), Default, cocos2d::CCSpriteBatchNode, lowestAtlasIndexInChild, cocos2d::CCSprite*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSpriteBatchNode::manualSortAllChildren)), Default, cocos2d::CCSpriteBatchNode, manualSortAllChildren, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSprite*, unsigned int>::func(&cocos2d::CCSpriteBatchNode::rebuildIndexInOrder)), Default, cocos2d::CCSpriteBatchNode, rebuildIndexInOrder, cocos2d::CCSprite*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, bool>::func(&cocos2d::CCSpriteBatchNode::removeChildAtIndex)), Default, cocos2d::CCSpriteBatchNode, removeChildAtIndex, unsigned int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSprite*>::func(&cocos2d::CCSpriteBatchNode::removeSpriteFromAtlas)), Default, cocos2d::CCSpriteBatchNode, removeSpriteFromAtlas, cocos2d::CCSprite*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCSpriteBatchNode::reorderBatch)), Default, cocos2d::CCSpriteBatchNode, reorderBatch, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int>::func(&cocos2d::CCSpriteBatchNode::swap)), Default, cocos2d::CCSpriteBatchNode, swap, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSprite*, int*>::func(&cocos2d::CCSpriteBatchNode::updateAtlasIndex)), Default, cocos2d::CCSpriteBatchNode, updateAtlasIndex, cocos2d::CCSprite*, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSpriteBatchNode::updateBlendFunc)), Default, cocos2d::CCSpriteBatchNode, updateBlendFunc, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSprite*, unsigned int>::func(&cocos2d::CCSpriteBatchNode::updateQuadFromSprite)), Default, cocos2d::CCSpriteBatchNode, updateQuadFromSprite, cocos2d::CCSprite*, unsigned int)
		}
	};
}
