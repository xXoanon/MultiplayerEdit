...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCAnimation> : ModifyBase<ModifyDerive<Der, cocos2d::CCAnimation>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCAnimationC2Ev")), Default, cocos2d::CCAnimation, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCAnimationD2Ev")), Default, cocos2d::CCAnimation)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCAnimation::copyWithZone)), Default, cocos2d::CCAnimation, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCAnimation::getDuration)), Default, cocos2d::CCAnimation, getDuration, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSpriteFrame*>::func(&cocos2d::CCAnimation::addSpriteFrame)), Default, cocos2d::CCAnimation, addSpriteFrame, cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCAnimation::addSpriteFrameWithFileName)), Default, cocos2d::CCAnimation, addSpriteFrameWithFileName, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTexture2D*, cocos2d::CCRect const&>::func(&cocos2d::CCAnimation::addSpriteFrameWithTexture)), Default, cocos2d::CCAnimation, addSpriteFrameWithTexture, cocos2d::CCTexture2D*, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCAnimation::init)), Default, cocos2d::CCAnimation, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*, float, unsigned int>::func(&cocos2d::CCAnimation::initWithAnimationFrames)), Default, cocos2d::CCAnimation, initWithAnimationFrames, cocos2d::CCArray*, float, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*, float>::func(&cocos2d::CCAnimation::initWithSpriteFrames)), Default, cocos2d::CCAnimation, initWithSpriteFrames, cocos2d::CCArray*, float)
		}
	};
}
