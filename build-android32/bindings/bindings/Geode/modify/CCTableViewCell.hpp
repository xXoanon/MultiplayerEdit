...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::extension::CCTableViewCell> : ModifyBase<ModifyDerive<Der, cocos2d::extension::CCTableViewCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned int>::func(&cocos2d::extension::CCTableViewCell::setObjectID)), Default, cocos2d::extension::CCTableViewCell, setObjectID, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCTableViewCell::getObjectID)), Default, cocos2d::extension::CCTableViewCell, getObjectID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCTableViewCell::getIdx)), Default, cocos2d::extension::CCTableViewCell, getIdx, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCTableViewCell::reset)), Default, cocos2d::extension::CCTableViewCell, reset, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::extension::CCTableViewCell::setIdx)), Default, cocos2d::extension::CCTableViewCell, setIdx, unsigned int)
		}
	};
}
