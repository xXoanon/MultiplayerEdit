...
namespace geode::modifier {
	...
	#ifndef GEODE_STATICS_strikeRandom
		#define GEODE_STATICS_strikeRandom
		GEODE_AS_STATIC_FUNCTION(strikeRandom) 
	#endif

	#ifndef GEODE_STATICS_strikeWithSeed
		#define GEODE_STATICS_strikeWithSeed
		GEODE_AS_STATIC_FUNCTION(strikeWithSeed) 
	#endif
	...
	struct ModifyDerive<Der, cocos2d::CCLightning> : ModifyBase<ModifyDerive<Der, cocos2d::CCLightning>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCLightningC2Ev")), Default, cocos2d::CCLightning, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCLightningD2Ev")), Default, cocos2d::CCLightning)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint>::func(&cocos2d::CCLightning::lightningWithStrikePoint)), Default, cocos2d::CCLightning, lightningWithStrikePoint, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint, cocos2d::CCPoint, float>::func(&cocos2d::CCLightning::lightningWithStrikePoint)), Default, cocos2d::CCLightning, lightningWithStrikePoint, cocos2d::CCPoint, cocos2d::CCPoint, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLightning::draw)), Default, cocos2d::CCLightning, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLightning::isOpacityModifyRGB)), Default, cocos2d::CCLightning, isOpacityModifyRGB, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::CCLightning::setOpacityModifyRGB)), Default, cocos2d::CCLightning, setOpacityModifyRGB, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLightning::getOpacity)), Default, cocos2d::CCLightning, getOpacity, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLightning::getDisplayedOpacity)), Default, cocos2d::CCLightning, getDisplayedOpacity, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned char>::func(&cocos2d::CCLightning::setOpacity)), Default, cocos2d::CCLightning, setOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned char>::func(&cocos2d::CCLightning::updateDisplayedOpacity)), Default, cocos2d::CCLightning, updateDisplayedOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLightning::isCascadeOpacityEnabled)), Default, cocos2d::CCLightning, isCascadeOpacityEnabled, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::CCLightning::setCascadeOpacityEnabled)), Default, cocos2d::CCLightning, setCascadeOpacityEnabled, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLightning::getColor)), Default, cocos2d::CCLightning, getColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLightning::getDisplayedColor)), Default, cocos2d::CCLightning, getDisplayedColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor3B const&>::func(&cocos2d::CCLightning::setColor)), Default, cocos2d::CCLightning, setColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor3B const&>::func(&cocos2d::CCLightning::updateDisplayedColor)), Default, cocos2d::CCLightning, updateDisplayedColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLightning::isCascadeColorEnabled)), Default, cocos2d::CCLightning, isCascadeColorEnabled, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::CCLightning::setCascadeColorEnabled)), Default, cocos2d::CCLightning, setCascadeColorEnabled, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint>::func(&cocos2d::CCLightning::initWithStrikePoint)), Default, cocos2d::CCLightning, initWithStrikePoint, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint, cocos2d::CCPoint, float>::func(&cocos2d::CCLightning::initWithStrikePoint)), Default, cocos2d::CCLightning, initWithStrikePoint, cocos2d::CCPoint, cocos2d::CCPoint, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCLightning::strike)), Default, cocos2d::CCLightning, strike, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCLightning::strikeFinished)), Default, cocos2d::CCLightning, strikeFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCLightning::strikeRandom)), Default, cocos2d::CCLightning, strikeRandom, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<uint64_t>::func(&cocos2d::CCLightning::strikeWithSeed)), Default, cocos2d::CCLightning, strikeWithSeed, uint64_t)
		}
	};
}
