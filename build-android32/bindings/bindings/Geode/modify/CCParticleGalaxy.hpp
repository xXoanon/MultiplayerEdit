...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCParticleGalaxy> : ModifyBase<ModifyDerive<Der, cocos2d::CCParticleGalaxy>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned int>::func(&cocos2d::CCParticleGalaxy::initWithTotalParticles)), Default, cocos2d::CCParticleGalaxy, initWithTotalParticles, unsigned int)
		}
	};
}
