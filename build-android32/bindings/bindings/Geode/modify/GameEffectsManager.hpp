...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameEffectsManager> : ModifyBase<ModifyDerive<Der, GameEffectsManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<PlayLayer*>::func(&GameEffectsManager::create)), Default, GameEffectsManager, create, PlayLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCParticleSystemQuad*, int>::func(&GameEffectsManager::addParticleEffect)), Default, GameEffectsManager, addParticleEffect, cocos2d::CCParticleSystemQuad*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<PlayLayer*>::func(&GameEffectsManager::init)), Default, GameEffectsManager, init, PlayLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCParticleSystemQuad*, float>::func(&GameEffectsManager::scaleParticle)), Default, GameEffectsManager, scaleParticle, cocos2d::CCParticleSystemQuad*, float)
		}
	};
}
