...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCParticleFlower> : ModifyBase<ModifyDerive<Der, cocos2d::CCParticleFlower>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned int>::func(&cocos2d::CCParticleFlower::initWithTotalParticles)), Default, cocos2d::CCParticleFlower, initWithTotalParticles, unsigned int)
		}
	};
}
