...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCFadeOutTRTiles> : ModifyBase<ModifyDerive<Der, cocos2d::CCFadeOutTRTiles>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSize const&, float>::func(&cocos2d::CCFadeOutTRTiles::testFunc)), Default, cocos2d::CCFadeOutTRTiles, testFunc, cocos2d::CCSize const&, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCPoint const&, float>::func(&cocos2d::CCFadeOutTRTiles::transformTile)), Default, cocos2d::CCFadeOutTRTiles, transformTile, cocos2d::CCPoint const&, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCFadeOutTRTiles::update)), Default, cocos2d::CCFadeOutTRTiles, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCFadeOutTRTiles::turnOffTile)), Default, cocos2d::CCFadeOutTRTiles, turnOffTile, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCFadeOutTRTiles::turnOnTile)), Default, cocos2d::CCFadeOutTRTiles, turnOnTile, cocos2d::CCPoint const&)
		}
	};
}
