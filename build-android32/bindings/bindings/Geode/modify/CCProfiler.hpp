...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCProfiler> : ModifyBase<ModifyDerive<Der, cocos2d::CCProfiler>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d10CCProfilerD2Ev")), Default, cocos2d::CCProfiler)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCProfiler::createAndAddTimerWithName)), Default, cocos2d::CCProfiler, createAndAddTimerWithName, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCProfiler::displayTimers)), Default, cocos2d::CCProfiler, displayTimers, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCProfiler::init)), Default, cocos2d::CCProfiler, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCProfiler::releaseAllTimers)), Default, cocos2d::CCProfiler, releaseAllTimers, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCProfiler::releaseTimer)), Default, cocos2d::CCProfiler, releaseTimer, char const*)
		}
	};
}
