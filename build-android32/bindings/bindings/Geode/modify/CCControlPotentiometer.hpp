...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::extension::CCControlPotentiometer> : ModifyBase<ModifyDerive<Der, cocos2d::extension::CCControlPotentiometer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension22CCControlPotentiometerC2Ev")), Default, cocos2d::extension::CCControlPotentiometer, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension22CCControlPotentiometerD2Ev")), Default, cocos2d::extension::CCControlPotentiometer)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::extension::CCControlPotentiometer::setEnabled)), Default, cocos2d::extension::CCControlPotentiometer, setEnabled, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*>::func(&cocos2d::extension::CCControlPotentiometer::isTouchInside)), Default, cocos2d::extension::CCControlPotentiometer, isTouchInside, cocos2d::CCTouch*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*, cocos2d::CCEvent*>::func(&cocos2d::extension::CCControlPotentiometer::ccTouchBegan)), Default, cocos2d::extension::CCControlPotentiometer, ccTouchBegan, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*, cocos2d::CCEvent*>::func(&cocos2d::extension::CCControlPotentiometer::ccTouchMoved)), Default, cocos2d::extension::CCControlPotentiometer, ccTouchMoved, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*, cocos2d::CCEvent*>::func(&cocos2d::extension::CCControlPotentiometer::ccTouchEnded)), Default, cocos2d::extension::CCControlPotentiometer, ccTouchEnded, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint, cocos2d::CCPoint, cocos2d::CCPoint, cocos2d::CCPoint>::func(&cocos2d::extension::CCControlPotentiometer::angleInDegreesBetweenLineFromPoint_toPoint_toLineFromPoint_toPoint)), Default, cocos2d::extension::CCControlPotentiometer, angleInDegreesBetweenLineFromPoint_toPoint_toLineFromPoint_toPoint, cocos2d::CCPoint, cocos2d::CCPoint, cocos2d::CCPoint, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint, cocos2d::CCPoint>::func(&cocos2d::extension::CCControlPotentiometer::distanceBetweenPointAndPoint)), Default, cocos2d::extension::CCControlPotentiometer, distanceBetweenPointAndPoint, cocos2d::CCPoint, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCControlPotentiometer::getMaximumValue)), Default, cocos2d::extension::CCControlPotentiometer, getMaximumValue, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCControlPotentiometer::getMinimumValue)), Default, cocos2d::extension::CCControlPotentiometer, getMinimumValue, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCControlPotentiometer::getValue)), Default, cocos2d::extension::CCControlPotentiometer, getValue, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSprite*, cocos2d::CCProgressTimer*, cocos2d::CCSprite*>::func(&cocos2d::extension::CCControlPotentiometer::initWithTrackSprite_ProgressTimer_ThumbSprite)), Default, cocos2d::extension::CCControlPotentiometer, initWithTrackSprite_ProgressTimer_ThumbSprite, cocos2d::CCSprite*, cocos2d::CCProgressTimer*, cocos2d::CCSprite*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint>::func(&cocos2d::extension::CCControlPotentiometer::potentiometerBegan)), Default, cocos2d::extension::CCControlPotentiometer, potentiometerBegan, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint>::func(&cocos2d::extension::CCControlPotentiometer::potentiometerEnded)), Default, cocos2d::extension::CCControlPotentiometer, potentiometerEnded, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint>::func(&cocos2d::extension::CCControlPotentiometer::potentiometerMoved)), Default, cocos2d::extension::CCControlPotentiometer, potentiometerMoved, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::extension::CCControlPotentiometer::setMaximumValue)), Default, cocos2d::extension::CCControlPotentiometer, setMaximumValue, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::extension::CCControlPotentiometer::setMinimumValue)), Default, cocos2d::extension::CCControlPotentiometer, setMinimumValue, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::extension::CCControlPotentiometer::setValue)), Default, cocos2d::extension::CCControlPotentiometer, setValue, float)
		}
	};
}
