...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::extension::CCHttpClient> : ModifyBase<ModifyDerive<Der, cocos2d::extension::CCHttpClient>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension12CCHttpClientC2Ev")), Default, cocos2d::extension::CCHttpClient, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension12CCHttpClientD2Ev")), Default, cocos2d::extension::CCHttpClient)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCHttpClient::availableThreadCount)), Default, cocos2d::extension::CCHttpClient, availableThreadCount, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::extension::CCHttpClient::dispatchResponseCallbacks)), Default, cocos2d::extension::CCHttpClient, dispatchResponseCallbacks, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::extension::CCHttpRequest*>::func(&cocos2d::extension::CCHttpClient::send)), Default, cocos2d::extension::CCHttpClient, send, cocos2d::extension::CCHttpRequest*)
		}
	};
}
