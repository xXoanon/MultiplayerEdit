...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupCameraRotatePopup> : ModifyBase<ModifyDerive<Der, SetupCameraRotatePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<EffectGameObject*, cocos2d::CCArray*>::func(&SetupCameraRotatePopup::create)), Default, SetupCameraRotatePopup, create, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&SetupCameraRotatePopup::determineStartValues)), Default, SetupCameraRotatePopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCObject*>::func(&SetupCameraRotatePopup::onClose)), Default, SetupCameraRotatePopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<CCTextInputNode*>::func(&SetupCameraRotatePopup::textChanged)), Default, SetupCameraRotatePopup, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<ConfigureValuePopup*, float>::func(&SetupCameraRotatePopup::valuePopupClosed)), Default, SetupCameraRotatePopup, valuePopupClosed, ConfigureValuePopup*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<EffectGameObject*, cocos2d::CCArray*>::func(&SetupCameraRotatePopup::init)), Default, SetupCameraRotatePopup, init, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupCameraRotatePopup::onEasing)), Default, SetupCameraRotatePopup, onEasing, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupCameraRotatePopup::onEasingRate)), Default, SetupCameraRotatePopup, onEasingRate, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupCameraRotatePopup::sliderChanged)), Default, SetupCameraRotatePopup, sliderChanged, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupCameraRotatePopup::sliderDegreesChanged)), Default, SetupCameraRotatePopup, sliderDegreesChanged, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupCameraRotatePopup::toggleEasingRateVisibility)), Default, SetupCameraRotatePopup, toggleEasingRateVisibility, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupCameraRotatePopup::updateCommandDegrees)), Default, SetupCameraRotatePopup, updateCommandDegrees, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupCameraRotatePopup::updateDegreesLabel)), Default, SetupCameraRotatePopup, updateDegreesLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupCameraRotatePopup::updateDuration)), Default, SetupCameraRotatePopup, updateDuration, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&SetupCameraRotatePopup::updateDurLabel)), Default, SetupCameraRotatePopup, updateDurLabel, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupCameraRotatePopup::updateEasingLabel)), Default, SetupCameraRotatePopup, updateEasingLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupCameraRotatePopup::updateEasingRateLabel)), Default, SetupCameraRotatePopup, updateEasingRateLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupCameraRotatePopup::updateMoveCommandEasing)), Default, SetupCameraRotatePopup, updateMoveCommandEasing, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupCameraRotatePopup::updateMoveCommandEasingRate)), Default, SetupCameraRotatePopup, updateMoveCommandEasingRate, )
		}
	};
}
