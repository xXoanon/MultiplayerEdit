...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionZoomFlipX> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionZoomFlipX>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d21CCTransitionZoomFlipXC2Ev")), Default, cocos2d::CCTransitionZoomFlipX, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d21CCTransitionZoomFlipXD2Ev")), Default, cocos2d::CCTransitionZoomFlipX)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionZoomFlipX::onEnter)), Default, cocos2d::CCTransitionZoomFlipX, onEnter, )
		}
	};
}
