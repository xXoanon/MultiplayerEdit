...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionMoveInB> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionMoveInB>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d19CCTransitionMoveInBC2Ev")), Default, cocos2d::CCTransitionMoveInB, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d19CCTransitionMoveInBD2Ev")), Default, cocos2d::CCTransitionMoveInB)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionMoveInB::initScenes)), Default, cocos2d::CCTransitionMoveInB, initScenes, )
		}
	};
}
