...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCLayerMultiplex> : ModifyBase<ModifyDerive<Der, cocos2d::CCLayerMultiplex>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d16CCLayerMultiplexC2Ev")), Default, cocos2d::CCLayerMultiplex, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d16CCLayerMultiplexD2Ev")), Default, cocos2d::CCLayerMultiplex)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCLayer*>::func(&cocos2d::CCLayerMultiplex::addLayer)), Default, cocos2d::CCLayerMultiplex, addLayer, cocos2d::CCLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*>::func(&cocos2d::CCLayerMultiplex::initWithArray)), Default, cocos2d::CCLayerMultiplex, initWithArray, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCLayer*, va_list>::func(&cocos2d::CCLayerMultiplex::initWithLayers)), Default, cocos2d::CCLayerMultiplex, initWithLayers, cocos2d::CCLayer*, va_list)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCLayerMultiplex::switchTo)), Default, cocos2d::CCLayerMultiplex, switchTo, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCLayerMultiplex::switchToAndReleaseMe)), Default, cocos2d::CCLayerMultiplex, switchToAndReleaseMe, unsigned int)
		}
	};
}
