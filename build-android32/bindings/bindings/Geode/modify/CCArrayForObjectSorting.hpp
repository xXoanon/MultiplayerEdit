...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::extension::CCArrayForObjectSorting> : ModifyBase<ModifyDerive<Der, cocos2d::extension::CCArrayForObjectSorting>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::extension::CCSortableObject*>::func(&cocos2d::extension::CCArrayForObjectSorting::indexOfSortedObject)), Default, cocos2d::extension::CCArrayForObjectSorting, indexOfSortedObject, cocos2d::extension::CCSortableObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::extension::CCSortableObject*>::func(&cocos2d::extension::CCArrayForObjectSorting::insertSortedObject)), Default, cocos2d::extension::CCArrayForObjectSorting, insertSortedObject, cocos2d::extension::CCSortableObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::extension::CCArrayForObjectSorting::objectWithObjectID)), Default, cocos2d::extension::CCArrayForObjectSorting, objectWithObjectID, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::extension::CCSortableObject*>::func(&cocos2d::extension::CCArrayForObjectSorting::removeSortedObject)), Default, cocos2d::extension::CCArrayForObjectSorting, removeSortedObject, cocos2d::extension::CCSortableObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, cocos2d::extension::CCSortableObject*>::func(&cocos2d::extension::CCArrayForObjectSorting::setObjectID_ofSortedObject)), Default, cocos2d::extension::CCArrayForObjectSorting, setObjectID_ofSortedObject, unsigned int, cocos2d::extension::CCSortableObject*)
		}
	};
}
