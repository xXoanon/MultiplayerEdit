...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCDictionary> : ModifyBase<ModifyDerive<Der, cocos2d::CCDictionary>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCDictionaryC2Ev")), Default, cocos2d::CCDictionary, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCDictionaryD2Ev")), Default, cocos2d::CCDictionary)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCDictionary::copyWithZone)), Default, cocos2d::CCDictionary, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCDataVisitor&>::func(&cocos2d::CCDictionary::acceptVisitor)), Default, cocos2d::CCDictionary, acceptVisitor, cocos2d::CCDataVisitor&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDictionary::allKeys)), Default, cocos2d::CCDictionary, allKeys, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCDictionary::allKeysForObject)), Default, cocos2d::CCDictionary, allKeysForObject, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCDictionary10charForKeyERKSs")), Default, cocos2d::CCDictionary, charForKey, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDictionary::count)), Default, cocos2d::CCDictionary, count, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDictionary::getFirstKey)), Default, cocos2d::CCDictionary, getFirstKey, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCDictionary12objectForKeyERKSs")), Default, cocos2d::CCDictionary, objectForKey, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<intptr_t>::func(&cocos2d::CCDictionary::objectForKey)), Default, cocos2d::CCDictionary, objectForKey, intptr_t)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDictionary::randomObject)), Default, cocos2d::CCDictionary, randomObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDictionary::removeAllObjects)), Default, cocos2d::CCDictionary, removeAllObjects, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCDictElement*>::func(&cocos2d::CCDictionary::removeObjectForElememt)), Default, cocos2d::CCDictionary, removeObjectForElememt, cocos2d::CCDictElement*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCDictionary18removeObjectForKeyERKSs")), Default, cocos2d::CCDictionary, removeObjectForKey, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<intptr_t>::func(&cocos2d::CCDictionary::removeObjectForKey)), Default, cocos2d::CCDictionary, removeObjectForKey, intptr_t)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*>::func(&cocos2d::CCDictionary::removeObjectsForKeys)), Default, cocos2d::CCDictionary, removeObjectsForKeys, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCDictionary9setObjectEPNS_8CCObjectERKSs")), Default, cocos2d::CCDictionary, setObject, cocos2d::CCObject*, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, intptr_t>::func(&cocos2d::CCDictionary::setObject)), Default, cocos2d::CCDictionary, setObject, cocos2d::CCObject*, intptr_t)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCDictionary15setObjectUnSafeEPNS_8CCObjectERKSs")), Default, cocos2d::CCDictionary, setObjectUnSafe, cocos2d::CCObject*, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, intptr_t>::func(&cocos2d::CCDictionary::setObjectUnSafe)), Default, cocos2d::CCDictionary, setObjectUnSafe, cocos2d::CCObject*, intptr_t)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCDictionary11valueForKeyERKSs")), Default, cocos2d::CCDictionary, valueForKey, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<intptr_t>::func(&cocos2d::CCDictionary::valueForKey)), Default, cocos2d::CCDictionary, valueForKey, intptr_t)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCDictionary::writeToFile)), Default, cocos2d::CCDictionary, writeToFile, char const*)
		}
	};
}
