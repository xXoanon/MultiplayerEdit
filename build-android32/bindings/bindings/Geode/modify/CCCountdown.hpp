...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCCountdown> : ModifyBase<ModifyDerive<Der, CCCountdown>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&CCCountdown::create)), Default, CCCountdown, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&CCCountdown::init)), Default, CCCountdown, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned char>::func(&CCCountdown::setOpacity)), Default, CCCountdown, setOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&CCCountdown::lapFinished)), Default, CCCountdown, lapFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, cocos2d::SEL_CallFunc, cocos2d::CCNode*>::func(&CCCountdown::startTimerWithSeconds)), Default, CCCountdown, startTimerWithSeconds, float, cocos2d::SEL_CallFunc, cocos2d::CCNode*)
		}
	};
}
