...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupPortalPopup> : ModifyBase<ModifyDerive<Der, SetupPortalPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<EffectGameObject*, cocos2d::CCArray*>::func(&SetupPortalPopup::create)), Default, SetupPortalPopup, create, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&SetupPortalPopup::keyBackClicked)), Default, SetupPortalPopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPortalPopup::determineStartValues)), Default, SetupPortalPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<EffectGameObject*, cocos2d::CCArray*>::func(&SetupPortalPopup::init)), Default, SetupPortalPopup, init, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupPortalPopup::onClose)), Default, SetupPortalPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupPortalPopup::onEditCameraSettings)), Default, SetupPortalPopup, onEditCameraSettings, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupPortalPopup::onUnboundMode)), Default, SetupPortalPopup, onUnboundMode, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupPortalPopup::sliderChanged)), Default, SetupPortalPopup, sliderChanged, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPortalPopup::updateCameraEasing)), Default, SetupPortalPopup, updateCameraEasing, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPortalPopup::updateCameraEasingLabel)), Default, SetupPortalPopup, updateCameraEasingLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPortalPopup::updateCameraPadding)), Default, SetupPortalPopup, updateCameraPadding, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPortalPopup::updateCameraPaddingLabel)), Default, SetupPortalPopup, updateCameraPaddingLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupPortalPopup::updateItemVisibility)), Default, SetupPortalPopup, updateItemVisibility, )
		}
	};
}
