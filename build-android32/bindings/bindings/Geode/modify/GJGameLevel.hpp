...
namespace geode::modifier {
	...
	#ifndef GEODE_STATICS_isPlatformer
		#define GEODE_STATICS_isPlatformer
		GEODE_AS_STATIC_FUNCTION(isPlatformer) 
	#endif
	...
	struct ModifyDerive<Der, GJGameLevel> : ModifyBase<ModifyDerive<Der, GJGameLevel>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN11GJGameLevelD2Ev")), Default, GJGameLevel)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJGameLevel::create)), Default, GJGameLevel, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCDictionary*, bool>::func(&GJGameLevel::create)), Default, GJGameLevel, create, cocos2d::CCDictionary*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<DS_Dictionary*>::func(&GJGameLevel::createWithCoder)), Default, GJGameLevel, createWithCoder, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<DemonDifficultyType>::func(&GJGameLevel::demonIconForDifficulty)), Default, GJGameLevel, demonIconForDifficulty, DemonDifficultyType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, bool>::func(&GJGameLevel::getLengthKey)), Default, GJGameLevel, getLengthKey, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJGameLevel::lengthKeyToString)), Default, GJGameLevel, lengthKeyToString, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<DS_Dictionary*>::func(&GJGameLevel::encodeWithCoder)), Default, GJGameLevel, encodeWithCoder, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJGameLevel::canEncode)), Default, GJGameLevel, canEncode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJGameLevel::init)), Default, GJGameLevel, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJGameLevel::areCoinsVerified)), Default, GJGameLevel, areCoinsVerified, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<GJGameLevel*>::func(&GJGameLevel::copyLevelInfo)), Default, GJGameLevel, copyLevelInfo, GJGameLevel*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<DS_Dictionary*>::func(&GJGameLevel::dataLoaded)), Default, GJGameLevel, dataLoaded, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJGameLevel::generateSettingsString)), Default, GJGameLevel, generateSettingsString, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJGameLevel::getAudioFileName)), Default, GJGameLevel, getAudioFileName, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJGameLevel::getAverageDifficulty)), Default, GJGameLevel, getAverageDifficulty, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJGameLevel::getCoinKey)), Default, GJGameLevel, getCoinKey, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJGameLevel::getLastBuildPageForTab)), Default, GJGameLevel, getLastBuildPageForTab, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJGameLevel::getListSnapshot)), Default, GJGameLevel, getListSnapshot, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJGameLevel::getNormalPercent)), Default, GJGameLevel, getNormalPercent, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJGameLevel::getSongName)), Default, GJGameLevel, getSongName, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJGameLevel::getUnpackedLevelDescription)), Default, GJGameLevel, getUnpackedLevelDescription, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<GJGameLevel*>::func(&GJGameLevel::handleStatsConflict)), Default, GJGameLevel, handleStatsConflict, GJGameLevel*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJGameLevel::isPlatformer)), Default, GJGameLevel, isPlatformer, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJGameLevel::levelWasAltered)), Default, GJGameLevel, levelWasAltered, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJGameLevel::levelWasSubmitted)), Default, GJGameLevel, levelWasSubmitted, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN11GJGameLevel19parseSettingsStringESs")), Default, GJGameLevel, parseSettingsString, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN11GJGameLevel12saveNewScoreEiiiiiSsb")), Default, GJGameLevel, saveNewScore, int, int, int, int, int, gd::string, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, bool, int, int, bool>::func(&GJGameLevel::savePercentage)), Default, GJGameLevel, savePercentage, int, bool, int, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN11GJGameLevel19scoreStringToVectorERSsRSt6vectorIiSaIiEE")), Default, GJGameLevel, scoreStringToVector, gd::string&, gd::vector<int>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN11GJGameLevel19scoreVectorToStringERSt6vectorIiSaIiEEi")), Default, GJGameLevel, scoreVectorToString, gd::vector<int>&, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int>::func(&GJGameLevel::setLastBuildPageForTab)), Default, GJGameLevel, setLastBuildPageForTab, int, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJGameLevel::setNormalPercent)), Default, GJGameLevel, setNormalPercent, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJGameLevel::shouldCheatReset)), Default, GJGameLevel, shouldCheatReset, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int>::func(&GJGameLevel::storeNewLocalScore)), Default, GJGameLevel, storeNewLocalScore, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJGameLevel::unverifyCoins)), Default, GJGameLevel, unverifyCoins, )
		}
	};
}
