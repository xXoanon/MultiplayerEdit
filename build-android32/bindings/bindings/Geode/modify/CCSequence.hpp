...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSequence> : ModifyBase<ModifyDerive<Der, cocos2d::CCSequence>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d10CCSequenceD2Ev")), Default, cocos2d::CCSequence)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCSequence::copyWithZone)), Default, cocos2d::CCSequence, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCSequence::update)), Default, cocos2d::CCSequence, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCSequence::startWithTarget)), Default, cocos2d::CCSequence, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCSequence::stop)), Default, cocos2d::CCSequence, stop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCSequence::reverse)), Default, cocos2d::CCSequence, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCFiniteTimeAction*, cocos2d::CCFiniteTimeAction*>::func(&cocos2d::CCSequence::initWithTwoActions)), Default, cocos2d::CCSequence, initWithTwoActions, cocos2d::CCFiniteTimeAction*, cocos2d::CCFiniteTimeAction*)
		}
	};
}
