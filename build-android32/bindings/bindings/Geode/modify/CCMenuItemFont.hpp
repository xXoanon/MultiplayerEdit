...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCMenuItemFont> : ModifyBase<ModifyDerive<Der, cocos2d::CCMenuItemFont>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCMenuItemFont::fontNameObj)), Default, cocos2d::CCMenuItemFont, fontNameObj, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCMenuItemFont::fontSizeObj)), Default, cocos2d::CCMenuItemFont, fontSizeObj, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler>::func(&cocos2d::CCMenuItemFont::initWithString)), Default, cocos2d::CCMenuItemFont, initWithString, char const*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCMenuItemFont::recreateLabel)), Default, cocos2d::CCMenuItemFont, recreateLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCMenuItemFont::setFontNameObj)), Default, cocos2d::CCMenuItemFont, setFontNameObj, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCMenuItemFont::setFontSizeObj)), Default, cocos2d::CCMenuItemFont, setFontSizeObj, unsigned int)
		}
	};
}
