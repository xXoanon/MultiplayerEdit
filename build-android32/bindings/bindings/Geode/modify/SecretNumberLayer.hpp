...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretNumberLayer> : ModifyBase<ModifyDerive<Der, SecretNumberLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretNumberLayer::create)), Default, SecretNumberLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&SecretNumberLayer::init)), Default, SecretNumberLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&SecretNumberLayer::playNumberEffect)), Default, SecretNumberLayer, playNumberEffect, int)
		}
	};
}
