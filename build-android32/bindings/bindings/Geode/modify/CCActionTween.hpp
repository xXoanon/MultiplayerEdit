...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCActionTween> : ModifyBase<ModifyDerive<Der, cocos2d::CCActionTween>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCActionTween::update)), Default, cocos2d::CCActionTween, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCActionTween::startWithTarget)), Default, cocos2d::CCActionTween, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCActionTween::reverse)), Default, cocos2d::CCActionTween, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, char const*, float, float>::func(&cocos2d::CCActionTween::initWithDuration)), Default, cocos2d::CCActionTween, initWithDuration, float, char const*, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCActionTween::updateTargetValue)), Default, cocos2d::CCActionTween, updateTargetValue, float)
		}
	};
}
