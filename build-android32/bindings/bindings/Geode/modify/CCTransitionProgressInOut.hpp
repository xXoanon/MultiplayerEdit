...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionProgressInOut> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionProgressInOut>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCRenderTexture*>::func(&cocos2d::CCTransitionProgressInOut::progressTimerNodeWithRenderTexture)), Default, cocos2d::CCTransitionProgressInOut, progressTimerNodeWithRenderTexture, cocos2d::CCRenderTexture*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionProgressInOut::sceneOrder)), Default, cocos2d::CCTransitionProgressInOut, sceneOrder, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionProgressInOut::setupTransition)), Default, cocos2d::CCTransitionProgressInOut, setupTransition, )
		}
	};
}
