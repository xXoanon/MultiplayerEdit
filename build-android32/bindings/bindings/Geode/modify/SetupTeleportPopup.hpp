...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupTeleportPopup> : ModifyBase<ModifyDerive<Der, SetupTeleportPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<TeleportPortalObject*, cocos2d::CCArray*, int, bool>::func(&SetupTeleportPopup::create)), Default, SetupTeleportPopup, create, TeleportPortalObject*, cocos2d::CCArray*, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&SetupTeleportPopup::determineStartValues)), Default, SetupTeleportPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&SetupTeleportPopup::updateDefaultTriggerValues)), Default, SetupTeleportPopup, updateDefaultTriggerValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int, float>::func(&SetupTeleportPopup::valueDidChange)), Default, SetupTeleportPopup, valueDidChange, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<TeleportPortalObject*, cocos2d::CCArray*, int, bool>::func(&SetupTeleportPopup::init)), Default, SetupTeleportPopup, init, TeleportPortalObject*, cocos2d::CCArray*, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupTeleportPopup::onTeleportGravity)), Default, SetupTeleportPopup, onTeleportGravity, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&SetupTeleportPopup::updateTeleportGravityState)), Default, SetupTeleportPopup, updateTeleportGravityState, int)
		}
	};
}
