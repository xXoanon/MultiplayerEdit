...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSkewBy> : ModifyBase<ModifyDerive<Der, cocos2d::CCSkewBy>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCSkewBy::startWithTarget)), Default, cocos2d::CCSkewBy, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCSkewBy::reverse)), Default, cocos2d::CCSkewBy, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float, float, float>::func(&cocos2d::CCSkewBy::initWithDuration)), Default, cocos2d::CCSkewBy, initWithDuration, float, float, float)
		}
	};
}
