...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTouchDelegate> : ModifyBase<ModifyDerive<Der, cocos2d::CCTouchDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int>::func(&cocos2d::CCTouchDelegate::setPreviousPriority)), Default, cocos2d::CCTouchDelegate, setPreviousPriority, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTouchDelegate::getPreviousPriority)), Default, cocos2d::CCTouchDelegate, getPreviousPriority, )
		}
	};
}
