...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionProgress> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionProgress>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCTransitionProgressC2Ev")), Default, cocos2d::CCTransitionProgress, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionProgress::onEnter)), Default, cocos2d::CCTransitionProgress, onEnter, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionProgress::onExit)), Default, cocos2d::CCTransitionProgress, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCRenderTexture*>::func(&cocos2d::CCTransitionProgress::progressTimerNodeWithRenderTexture)), Default, cocos2d::CCTransitionProgress, progressTimerNodeWithRenderTexture, cocos2d::CCRenderTexture*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionProgress::setupTransition)), Default, cocos2d::CCTransitionProgress, setupTransition, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionProgress::sceneOrder)), Default, cocos2d::CCTransitionProgress, sceneOrder, )
		}
	};
}
