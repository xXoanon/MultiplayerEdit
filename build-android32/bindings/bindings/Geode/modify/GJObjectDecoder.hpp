...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJObjectDecoder> : ModifyBase<ModifyDerive<Der, GJObjectDecoder>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJObjectDecoder::sharedDecoder)), Default, GJObjectDecoder, sharedDecoder, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJObjectDecoder::init)), Default, GJObjectDecoder, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int, DS_Dictionary*>::func(&GJObjectDecoder::getDecodedObject)), Default, GJObjectDecoder, getDecodedObject, int, DS_Dictionary*)
		}
	};
}
