...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, KeyframeObject> : ModifyBase<ModifyDerive<Der, KeyframeObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN14KeyframeObject11setupSplineERSt6vectorIPS_SaIS1_EE")), Default, KeyframeObject, setupSpline, gd::vector<KeyframeObject*>&)
		}
	};
}
