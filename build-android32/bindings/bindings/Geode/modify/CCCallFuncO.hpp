...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCCallFuncO> : ModifyBase<ModifyDerive<Der, cocos2d::CCCallFuncO>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCCallFuncOC2Ev")), Default, cocos2d::CCCallFuncO, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCCallFuncOD2Ev")), Default, cocos2d::CCCallFuncO)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCCallFuncO::copyWithZone)), Default, cocos2d::CCCallFuncO, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCCallFuncO::execute)), Default, cocos2d::CCCallFuncO, execute, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCObject*, cocos2d::SEL_MenuHandler, cocos2d::CCObject*>::func(&cocos2d::CCCallFuncO::initWithTarget)), Default, cocos2d::CCCallFuncO, initWithTarget, cocos2d::CCObject*, cocos2d::SEL_MenuHandler, cocos2d::CCObject*)
		}
	};
}
