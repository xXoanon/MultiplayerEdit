...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, DS_Dictionary> : ModifyBase<ModifyDerive<Der, DS_Dictionary>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13DS_DictionaryC2Ev")), Default, DS_Dictionary, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13DS_Dictionary24addBoolValuesToMapForKeyERSt3mapISsbSt4lessISsESaISt4pairIKSsbEEEPKcb")), Default, DS_Dictionary, addBoolValuesToMapForKey, gd::map<gd::string, bool>&, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13DS_Dictionary31addBoolValuesToMapForKeySpecialERSt3mapISsbSt4lessISsESaISt4pairIKSsbEEEPKcb")), Default, DS_Dictionary, addBoolValuesToMapForKeySpecial, gd::map<gd::string, bool>&, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&DS_Dictionary::checkCompatibility)), Default, DS_Dictionary, checkCompatibility, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13DS_Dictionary21cleanStringWhiteSpaceERKSs")), Default, DS_Dictionary, cleanStringWhiteSpace, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, bool, int>::func(&DS_Dictionary::decodeObjectForKey)), Default, DS_Dictionary, decodeObjectForKey, char const*, bool, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&DS_Dictionary::getAllKeys)), Default, DS_Dictionary, getAllKeys, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, bool>::func(&DS_Dictionary::getArrayForKey)), Default, DS_Dictionary, getArrayForKey, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&DS_Dictionary::getBoolForKey)), Default, DS_Dictionary, getBoolForKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, bool>::func(&DS_Dictionary::getDictForKey)), Default, DS_Dictionary, getDictForKey, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&DS_Dictionary::getFloatForKey)), Default, DS_Dictionary, getFloatForKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&DS_Dictionary::getIndexOfKey)), Default, DS_Dictionary, getIndexOfKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&DS_Dictionary::getIndexOfKeyWithClosestAlphaNumericalMatch)), Default, DS_Dictionary, getIndexOfKeyWithClosestAlphaNumericalMatch, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&DS_Dictionary::getIntegerForKey)), Default, DS_Dictionary, getIntegerForKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&DS_Dictionary::getKey)), Default, DS_Dictionary, getKey, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&DS_Dictionary::getNumKeys)), Default, DS_Dictionary, getNumKeys, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&DS_Dictionary::getObjectForKey)), Default, DS_Dictionary, getObjectForKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&DS_Dictionary::getRectArrayForKey)), Default, DS_Dictionary, getRectArrayForKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&DS_Dictionary::getRectForKey)), Default, DS_Dictionary, getRectForKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&DS_Dictionary::getStringArrayForKey)), Default, DS_Dictionary, getStringArrayForKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&DS_Dictionary::getStringForKey)), Default, DS_Dictionary, getStringForKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&DS_Dictionary::getVec2ArrayForKey)), Default, DS_Dictionary, getVec2ArrayForKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&DS_Dictionary::getVec2ForKey)), Default, DS_Dictionary, getVec2ForKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&DS_Dictionary::loadRootSubDictFromCompressedFile)), Default, DS_Dictionary, loadRootSubDictFromCompressedFile, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&DS_Dictionary::loadRootSubDictFromFile)), Default, DS_Dictionary, loadRootSubDictFromFile, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13DS_Dictionary25loadRootSubDictFromStringERKSs")), Default, DS_Dictionary, loadRootSubDictFromString, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13DS_Dictionary14rectFromStringERKSsRN7cocos2d6CCRectE")), Default, DS_Dictionary, rectFromString, gd::string const&, cocos2d::CCRect&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&DS_Dictionary::removeAllKeys)), Default, DS_Dictionary, removeAllKeys, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&DS_Dictionary::removeKey)), Default, DS_Dictionary, removeKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&DS_Dictionary::removeKey)), Default, DS_Dictionary, removeKey, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&DS_Dictionary::saveRootSubDictToCompressedFile)), Default, DS_Dictionary, saveRootSubDictToCompressedFile, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&DS_Dictionary::saveRootSubDictToFile)), Default, DS_Dictionary, saveRootSubDictToFile, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&DS_Dictionary::saveRootSubDictToString)), Default, DS_Dictionary, saveRootSubDictToString, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, cocos2d::CCArray*>::func(&DS_Dictionary::setArrayForKey)), Default, DS_Dictionary, setArrayForKey, char const*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, bool>::func(&DS_Dictionary::setBoolForKey)), Default, DS_Dictionary, setBoolForKey, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, bool, bool>::func(&DS_Dictionary::setBoolForKey)), Default, DS_Dictionary, setBoolForKey, char const*, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13DS_Dictionary16setBoolMapForKeyEPKcRSt3mapISsbSt4lessISsESaISt4pairIKSsbEEE")), Default, DS_Dictionary, setBoolMapForKey, char const*, gd::map<gd::string, bool>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, cocos2d::CCDictionary*>::func(&DS_Dictionary::setDictForKey)), Default, DS_Dictionary, setDictForKey, char const*, cocos2d::CCDictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, float>::func(&DS_Dictionary::setFloatForKey)), Default, DS_Dictionary, setFloatForKey, char const*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, float, bool>::func(&DS_Dictionary::setFloatForKey)), Default, DS_Dictionary, setFloatForKey, char const*, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, int>::func(&DS_Dictionary::setIntegerForKey)), Default, DS_Dictionary, setIntegerForKey, char const*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, int, bool>::func(&DS_Dictionary::setIntegerForKey)), Default, DS_Dictionary, setIntegerForKey, char const*, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, cocos2d::CCObject*>::func(&DS_Dictionary::setObjectForKey)), Default, DS_Dictionary, setObjectForKey, char const*, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13DS_Dictionary18setRectArrayForKeyEPKcRKSt6vectorI7cocos2d6CCRectSaIS4_EE")), Default, DS_Dictionary, setRectArrayForKey, char const*, gd::vector<cocos2d::CCRect> const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13DS_Dictionary18setRectArrayForKeyEPKcRKSt6vectorI7cocos2d6CCRectSaIS4_EEb")), Default, DS_Dictionary, setRectArrayForKey, char const*, gd::vector<cocos2d::CCRect> const&, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, cocos2d::CCRect const&>::func(&DS_Dictionary::setRectForKey)), Default, DS_Dictionary, setRectForKey, char const*, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, cocos2d::CCRect const&, bool>::func(&DS_Dictionary::setRectForKey)), Default, DS_Dictionary, setRectForKey, char const*, cocos2d::CCRect const&, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13DS_Dictionary20setStringArrayForKeyEPKcRKSt6vectorISsSaISsEE")), Default, DS_Dictionary, setStringArrayForKey, char const*, gd::vector<gd::string> const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13DS_Dictionary20setStringArrayForKeyEPKcRKSt6vectorISsSaISsEEb")), Default, DS_Dictionary, setStringArrayForKey, char const*, gd::vector<gd::string> const&, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13DS_Dictionary15setStringForKeyEPKcRKSs")), Default, DS_Dictionary, setStringForKey, char const*, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13DS_Dictionary15setStringForKeyEPKcRKSsb")), Default, DS_Dictionary, setStringForKey, char const*, gd::string const&, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&DS_Dictionary::setSubDictForKey)), Default, DS_Dictionary, setSubDictForKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, bool, bool>::func(&DS_Dictionary::setSubDictForKey)), Default, DS_Dictionary, setSubDictForKey, char const*, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13DS_Dictionary18setVec2ArrayForKeyEPKcRKSt6vectorI7cocos2d7CCPointSaIS4_EE")), Default, DS_Dictionary, setVec2ArrayForKey, char const*, gd::vector<cocos2d::CCPoint> const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13DS_Dictionary18setVec2ArrayForKeyEPKcRKSt6vectorI7cocos2d7CCPointSaIS4_EEb")), Default, DS_Dictionary, setVec2ArrayForKey, char const*, gd::vector<cocos2d::CCPoint> const&, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, cocos2d::CCPoint const&>::func(&DS_Dictionary::setVec2ForKey)), Default, DS_Dictionary, setVec2ForKey, char const*, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, cocos2d::CCPoint const&, bool>::func(&DS_Dictionary::setVec2ForKey)), Default, DS_Dictionary, setVec2ForKey, char const*, cocos2d::CCPoint const&, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13DS_Dictionary5splitERKSsPKcRSt6vectorISsSaISsEE")), Default, DS_Dictionary, split, gd::string const&, char const*, gd::vector<gd::string>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13DS_Dictionary13splitWithFormERKSsRSt6vectorISsSaISsEE")), Default, DS_Dictionary, splitWithForm, gd::string const&, gd::vector<gd::string>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&DS_Dictionary::stepBackToRootSubDict)), Default, DS_Dictionary, stepBackToRootSubDict, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&DS_Dictionary::stepIntoSubDictWithKey)), Default, DS_Dictionary, stepIntoSubDictWithKey, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&DS_Dictionary::stepOutOfSubDict)), Default, DS_Dictionary, stepOutOfSubDict, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13DS_Dictionary14vec2FromStringERKSsRN7cocos2d7CCPointE")), Default, DS_Dictionary, vec2FromString, gd::string const&, cocos2d::CCPoint&)
		}
	};
}
