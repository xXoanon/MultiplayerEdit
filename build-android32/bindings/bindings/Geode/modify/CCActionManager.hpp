...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCActionManager> : ModifyBase<ModifyDerive<Der, cocos2d::CCActionManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d15CCActionManagerC2Ev")), Default, cocos2d::CCActionManager, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d15CCActionManagerD2Ev")), Default, cocos2d::CCActionManager)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCActionManager::update)), Default, cocos2d::CCActionManager, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::_hashElement*>::func(&cocos2d::CCActionManager::actionAllocWithHashElement)), Default, cocos2d::CCActionManager, actionAllocWithHashElement, cocos2d::_hashElement*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCAction*, cocos2d::CCNode*, bool>::func(&cocos2d::CCActionManager::addAction)), Default, cocos2d::CCActionManager, addAction, cocos2d::CCAction*, cocos2d::CCNode*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::_hashElement*>::func(&cocos2d::CCActionManager::deleteHashElement)), Default, cocos2d::CCActionManager, deleteHashElement, cocos2d::_hashElement*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, cocos2d::CCObject*>::func(&cocos2d::CCActionManager::getActionByTag)), Default, cocos2d::CCActionManager, getActionByTag, unsigned int, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCActionManager::numberOfRunningActionsInTarget)), Default, cocos2d::CCActionManager, numberOfRunningActionsInTarget, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCActionManager::pauseAllRunningActions)), Default, cocos2d::CCActionManager, pauseAllRunningActions, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCActionManager::pauseTarget)), Default, cocos2d::CCActionManager, pauseTarget, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCAction*>::func(&cocos2d::CCActionManager::removeAction)), Default, cocos2d::CCActionManager, removeAction, cocos2d::CCAction*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, cocos2d::_hashElement*>::func(&cocos2d::CCActionManager::removeActionAtIndex)), Default, cocos2d::CCActionManager, removeActionAtIndex, unsigned int, cocos2d::_hashElement*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, cocos2d::CCObject*>::func(&cocos2d::CCActionManager::removeActionByTag)), Default, cocos2d::CCActionManager, removeActionByTag, unsigned int, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCActionManager::removeAllActions)), Default, cocos2d::CCActionManager, removeAllActions, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCActionManager::removeAllActionsFromTarget)), Default, cocos2d::CCActionManager, removeAllActionsFromTarget, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCActionManager::resumeTarget)), Default, cocos2d::CCActionManager, resumeTarget, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSet*>::func(&cocos2d::CCActionManager::resumeTargets)), Default, cocos2d::CCActionManager, resumeTargets, cocos2d::CCSet*)
		}
	};
}
