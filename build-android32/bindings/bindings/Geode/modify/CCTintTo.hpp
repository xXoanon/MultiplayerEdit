...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTintTo> : ModifyBase<ModifyDerive<Der, cocos2d::CCTintTo>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCTintTo::copyWithZone)), Default, cocos2d::CCTintTo, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCTintTo::update)), Default, cocos2d::CCTintTo, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCTintTo::startWithTarget)), Default, cocos2d::CCTintTo, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, unsigned char, unsigned char, unsigned char>::func(&cocos2d::CCTintTo::initWithDuration)), Default, cocos2d::CCTintTo, initWithDuration, float, unsigned char, unsigned char, unsigned char)
		}
	};
}
