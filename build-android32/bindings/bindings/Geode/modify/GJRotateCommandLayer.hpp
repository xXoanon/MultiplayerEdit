...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJRotateCommandLayer> : ModifyBase<ModifyDerive<Der, GJRotateCommandLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<EffectGameObject*, cocos2d::CCArray*>::func(&GJRotateCommandLayer::create)), Default, GJRotateCommandLayer, create, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJRotateCommandLayer::determineStartValues)), Default, GJRotateCommandLayer, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCObject*>::func(&GJRotateCommandLayer::onClose)), Default, GJRotateCommandLayer, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<CCTextInputNode*>::func(&GJRotateCommandLayer::textChanged)), Default, GJRotateCommandLayer, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<ConfigureValuePopup*, float>::func(&GJRotateCommandLayer::valuePopupClosed)), Default, GJRotateCommandLayer, valuePopupClosed, ConfigureValuePopup*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<EffectGameObject*, cocos2d::CCArray*>::func(&GJRotateCommandLayer::init)), Default, GJRotateCommandLayer, init, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&GJRotateCommandLayer::onEasing)), Default, GJRotateCommandLayer, onEasing, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&GJRotateCommandLayer::onEasingRate)), Default, GJRotateCommandLayer, onEasingRate, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&GJRotateCommandLayer::onFollowRotation)), Default, GJRotateCommandLayer, onFollowRotation, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&GJRotateCommandLayer::onLockRotation)), Default, GJRotateCommandLayer, onLockRotation, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&GJRotateCommandLayer::onUpdateGroupID)), Default, GJRotateCommandLayer, onUpdateGroupID, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&GJRotateCommandLayer::onUpdateGroupID2)), Default, GJRotateCommandLayer, onUpdateGroupID2, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&GJRotateCommandLayer::sliderChanged)), Default, GJRotateCommandLayer, sliderChanged, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&GJRotateCommandLayer::sliderDegreesChanged)), Default, GJRotateCommandLayer, sliderDegreesChanged, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&GJRotateCommandLayer::sliderTimesChanged)), Default, GJRotateCommandLayer, sliderTimesChanged, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJRotateCommandLayer::toggleEasingRateVisibility)), Default, GJRotateCommandLayer, toggleEasingRateVisibility, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJRotateCommandLayer::updateCommandDegrees)), Default, GJRotateCommandLayer, updateCommandDegrees, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJRotateCommandLayer::updateCommandTimes)), Default, GJRotateCommandLayer, updateCommandTimes, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJRotateCommandLayer::updateDegreesLabel)), Default, GJRotateCommandLayer, updateDegreesLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJRotateCommandLayer::updateDuration)), Default, GJRotateCommandLayer, updateDuration, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&GJRotateCommandLayer::updateDurLabel)), Default, GJRotateCommandLayer, updateDurLabel, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJRotateCommandLayer::updateEasingLabel)), Default, GJRotateCommandLayer, updateEasingLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJRotateCommandLayer::updateEasingRateLabel)), Default, GJRotateCommandLayer, updateEasingRateLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJRotateCommandLayer::updateMoveCommandEasing)), Default, GJRotateCommandLayer, updateMoveCommandEasing, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJRotateCommandLayer::updateMoveCommandEasingRate)), Default, GJRotateCommandLayer, updateMoveCommandEasingRate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJRotateCommandLayer::updateTargetGroupID)), Default, GJRotateCommandLayer, updateTargetGroupID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJRotateCommandLayer::updateTargetGroupID2)), Default, GJRotateCommandLayer, updateTargetGroupID2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJRotateCommandLayer::updateTextInputLabel)), Default, GJRotateCommandLayer, updateTextInputLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJRotateCommandLayer::updateTextInputLabel2)), Default, GJRotateCommandLayer, updateTextInputLabel2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJRotateCommandLayer::updateTimesLabel)), Default, GJRotateCommandLayer, updateTimesLabel, )
		}
	};
}
