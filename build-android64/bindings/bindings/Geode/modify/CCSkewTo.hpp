...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSkewTo> : ModifyBase<ModifyDerive<Der, cocos2d::CCSkewTo>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d8CCSkewToC2Ev")), Default, cocos2d::CCSkewTo, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCSkewTo::copyWithZone)), Default, cocos2d::CCSkewTo, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCSkewTo::update)), Default, cocos2d::CCSkewTo, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCSkewTo::startWithTarget)), Default, cocos2d::CCSkewTo, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float, float, float>::func(&cocos2d::CCSkewTo::initWithDuration)), Default, cocos2d::CCSkewTo, initWithDuration, float, float, float)
		}
	};
}
