...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FMODLevelVisualizer> : ModifyBase<ModifyDerive<Der, FMODLevelVisualizer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMODLevelVisualizer::create)), Default, FMODLevelVisualizer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&FMODLevelVisualizer::init)), Default, FMODLevelVisualizer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float>::func(&FMODLevelVisualizer::updateVisualizer)), Default, FMODLevelVisualizer, updateVisualizer, float, float, float)
		}
	};
}
