...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCReverseTime> : ModifyBase<ModifyDerive<Der, cocos2d::CCReverseTime>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d13CCReverseTimeC2Ev")), Default, cocos2d::CCReverseTime, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d13CCReverseTimeD2Ev")), Default, cocos2d::CCReverseTime)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCReverseTime::copyWithZone)), Default, cocos2d::CCReverseTime, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCReverseTime::startWithTarget)), Default, cocos2d::CCReverseTime, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCReverseTime::stop)), Default, cocos2d::CCReverseTime, stop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCReverseTime::update)), Default, cocos2d::CCReverseTime, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCReverseTime::reverse)), Default, cocos2d::CCReverseTime, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCFiniteTimeAction*>::func(&cocos2d::CCReverseTime::initWithAction)), Default, cocos2d::CCReverseTime, initWithAction, cocos2d::CCFiniteTimeAction*)
		}
	};
}
