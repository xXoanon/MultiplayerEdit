...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCPointArray> : ModifyBase<ModifyDerive<Der, cocos2d::CCPointArray>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCPointArrayC2Ev")), Default, cocos2d::CCPointArray, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCPointArrayD2Ev")), Default, cocos2d::CCPointArray)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCPointArray::copyWithZone)), Default, cocos2d::CCPointArray, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint>::func(&cocos2d::CCPointArray::addControlPoint)), Default, cocos2d::CCPointArray, addControlPoint, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCPointArray::count)), Default, cocos2d::CCPointArray, count, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCPointArray::getControlPointAtIndex)), Default, cocos2d::CCPointArray, getControlPointAtIndex, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCPointArray::getControlPoints)), Default, cocos2d::CCPointArray, getControlPoints, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCPointArray::initWithCapacity)), Default, cocos2d::CCPointArray, initWithCapacity, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint&, unsigned int>::func(&cocos2d::CCPointArray::insertControlPoint)), Default, cocos2d::CCPointArray, insertControlPoint, cocos2d::CCPoint&, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCPointArray::removeControlPointAtIndex)), Default, cocos2d::CCPointArray, removeControlPointAtIndex, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint&, unsigned int>::func(&cocos2d::CCPointArray::replaceControlPoint)), Default, cocos2d::CCPointArray, replaceControlPoint, cocos2d::CCPoint&, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCPointArray::reverse)), Default, cocos2d::CCPointArray, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCPointArray::reverseInline)), Default, cocos2d::CCPointArray, reverseInline, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCPointArray16setControlPointsEPSt6vectorIPNS_7CCPointESaIS2_EE")), Default, cocos2d::CCPointArray, setControlPoints, gd::vector<cocos2d::CCPoint*>*)
		}
	};
}
