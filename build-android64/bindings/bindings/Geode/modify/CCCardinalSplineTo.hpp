...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCCardinalSplineTo> : ModifyBase<ModifyDerive<Der, cocos2d::CCCardinalSplineTo>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d18CCCardinalSplineToC2Ev")), Default, cocos2d::CCCardinalSplineTo, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d18CCCardinalSplineToD2Ev")), Default, cocos2d::CCCardinalSplineTo)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCCardinalSplineTo::copyWithZone)), Default, cocos2d::CCCardinalSplineTo, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCCardinalSplineTo::startWithTarget)), Default, cocos2d::CCCardinalSplineTo, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCCardinalSplineTo::update)), Default, cocos2d::CCCardinalSplineTo, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCCardinalSplineTo::reverse)), Default, cocos2d::CCCardinalSplineTo, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCPoint&>::func(&cocos2d::CCCardinalSplineTo::updatePosition)), Default, cocos2d::CCCardinalSplineTo, updatePosition, cocos2d::CCPoint&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, cocos2d::CCPointArray*, float>::func(&cocos2d::CCCardinalSplineTo::initWithDuration)), Default, cocos2d::CCCardinalSplineTo, initWithDuration, float, cocos2d::CCPointArray*, float)
		}
	};
}
