...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCParticleExplosion> : ModifyBase<ModifyDerive<Der, cocos2d::CCParticleExplosion>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned int>::func(&cocos2d::CCParticleExplosion::initWithTotalParticles)), Default, cocos2d::CCParticleExplosion, initWithTotalParticles, unsigned int)
		}
	};
}
