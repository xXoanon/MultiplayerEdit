...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCParticleFireworks> : ModifyBase<ModifyDerive<Der, cocos2d::CCParticleFireworks>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned int>::func(&cocos2d::CCParticleFireworks::initWithTotalParticles)), Default, cocos2d::CCParticleFireworks, initWithTotalParticles, unsigned int)
		}
	};
}
