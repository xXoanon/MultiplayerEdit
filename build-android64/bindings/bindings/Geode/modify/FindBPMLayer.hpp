...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FindBPMLayer> : ModifyBase<ModifyDerive<Der, FindBPMLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FindBPMLayer::create)), Default, FindBPMLayer, create, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCObject*>::func(&FindBPMLayer::onClose)), Default, FindBPMLayer, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&FindBPMLayer::playMusic)), Default, FindBPMLayer, playMusic, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&FindBPMLayer::registerTouch)), Default, FindBPMLayer, registerTouch, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCObject*>::func(&FindBPMLayer::onInfo)), Default, FindBPMLayer, onInfo, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCObject*>::func(&FindBPMLayer::onRecord)), Default, FindBPMLayer, onRecord, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&FindBPMLayer::recordingDidStop)), Default, FindBPMLayer, recordingDidStop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FindBPMLayer::calculateBPM)), Default, FindBPMLayer, calculateBPM, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&FindBPMLayer::init)), Default, FindBPMLayer, init, int)
		}
	};
}
