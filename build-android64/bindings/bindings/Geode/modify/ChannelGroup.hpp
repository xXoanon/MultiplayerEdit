...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FMOD::ChannelGroup> : ModifyBase<ModifyDerive<Der, FMOD::ChannelGroup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, FMOD::Channel**>::func(&FMOD::ChannelGroup::getChannel)), Default, FMOD::ChannelGroup, getChannel, int, FMOD::Channel**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::ChannelGroup::getNumGroups)), Default, FMOD::ChannelGroup, getNumGroups, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int*>::func(&FMOD::ChannelGroup::getNumChannels)), Default, FMOD::ChannelGroup, getNumChannels, int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::ChannelGroup**>::func(&FMOD::ChannelGroup::getParentGroup)), Default, FMOD::ChannelGroup, getParentGroup, FMOD::ChannelGroup**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char*, int>::func(&FMOD::ChannelGroup::getName)), Default, FMOD::ChannelGroup, getName, char*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMOD::ChannelGroup::release)), Default, FMOD::ChannelGroup, release, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::ChannelGroup*, bool, FMOD::DSPConnection**>::func(&FMOD::ChannelGroup::addGroup)), Default, FMOD::ChannelGroup, addGroup, FMOD::ChannelGroup*, bool, FMOD::DSPConnection**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, FMOD::ChannelGroup**>::func(&FMOD::ChannelGroup::getGroup)), Default, FMOD::ChannelGroup, getGroup, int, FMOD::ChannelGroup**)
		}
	};
}
