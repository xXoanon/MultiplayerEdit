...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTMXLayer> : ModifyBase<ModifyDerive<Der, cocos2d::CCTMXLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d10CCTMXLayerC2Ev")), Default, cocos2d::CCTMXLayer, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d10CCTMXLayerD2Ev")), Default, cocos2d::CCTMXLayer)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTMXLayer::getTileSet)), Default, cocos2d::CCTMXLayer, getTileSet, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTMXTilesetInfo*>::func(&cocos2d::CCTMXLayer::setTileSet)), Default, cocos2d::CCTMXLayer, setTileSet, cocos2d::CCTMXTilesetInfo*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTMXLayer::getProperties)), Default, cocos2d::CCTMXLayer, getProperties, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCDictionary*>::func(&cocos2d::CCTMXLayer::setProperties)), Default, cocos2d::CCTMXLayer, setProperties, cocos2d::CCDictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*, int, int>::func(&cocos2d::CCTMXLayer::addChild)), Default, cocos2d::CCTMXLayer, addChild, cocos2d::CCNode*, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*, bool>::func(&cocos2d::CCTMXLayer::removeChild)), Default, cocos2d::CCTMXLayer, removeChild, cocos2d::CCNode*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, cocos2d::CCPoint const&>::func(&cocos2d::CCTMXLayer::appendTileForGID)), Default, cocos2d::CCTMXLayer, appendTileForGID, unsigned int, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCTMXLayer::atlasIndexForExistantZ)), Default, cocos2d::CCTMXLayer, atlasIndexForExistantZ, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&cocos2d::CCTMXLayer::atlasIndexForNewZ)), Default, cocos2d::CCTMXLayer, atlasIndexForNewZ, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCTMXLayer::calculateLayerOffset)), Default, cocos2d::CCTMXLayer, calculateLayerOffset, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTMXTilesetInfo*, cocos2d::CCTMXLayerInfo*, cocos2d::CCTMXMapInfo*>::func(&cocos2d::CCTMXLayer::initWithTilesetInfo)), Default, cocos2d::CCTMXLayer, initWithTilesetInfo, cocos2d::CCTMXTilesetInfo*, cocos2d::CCTMXLayerInfo*, cocos2d::CCTMXMapInfo*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, cocos2d::CCPoint const&>::func(&cocos2d::CCTMXLayer::insertTileForGID)), Default, cocos2d::CCTMXLayer, insertTileForGID, unsigned int, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTMXLayer::parseInternalProperties)), Default, cocos2d::CCTMXLayer, parseInternalProperties, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCTMXLayer::positionAt)), Default, cocos2d::CCTMXLayer, positionAt, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCTMXLayer::positionForHexAt)), Default, cocos2d::CCTMXLayer, positionForHexAt, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCTMXLayer::positionForIsoAt)), Default, cocos2d::CCTMXLayer, positionForIsoAt, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCTMXLayer::positionForOrthoAt)), Default, cocos2d::CCTMXLayer, positionForOrthoAt, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCTMXLayer::propertyNamed)), Default, cocos2d::CCTMXLayer, propertyNamed, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTMXLayer::releaseMap)), Default, cocos2d::CCTMXLayer, releaseMap, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCTMXLayer::removeTileAt)), Default, cocos2d::CCTMXLayer, removeTileAt, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCRect>::func(&cocos2d::CCTMXLayer::reusedTileWithRect)), Default, cocos2d::CCTMXLayer, reusedTileWithRect, cocos2d::CCRect)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, cocos2d::CCPoint const&>::func(&cocos2d::CCTMXLayer::setTileGID)), Default, cocos2d::CCTMXLayer, setTileGID, unsigned int, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, cocos2d::CCPoint const&, cocos2d::ccTMXTileFlags>::func(&cocos2d::CCTMXLayer::setTileGID)), Default, cocos2d::CCTMXLayer, setTileGID, unsigned int, cocos2d::CCPoint const&, cocos2d::ccTMXTileFlags)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTMXLayer::setupTiles)), Default, cocos2d::CCTMXLayer, setupTiles, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSprite*, cocos2d::CCPoint, unsigned int>::func(&cocos2d::CCTMXLayer::setupTileSprite)), Default, cocos2d::CCTMXLayer, setupTileSprite, cocos2d::CCSprite*, cocos2d::CCPoint, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCTMXLayer::tileAt)), Default, cocos2d::CCTMXLayer, tileAt, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCTMXLayer::tileGIDAt)), Default, cocos2d::CCTMXLayer, tileGIDAt, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&, cocos2d::ccTMXTileFlags*>::func(&cocos2d::CCTMXLayer::tileGIDAt)), Default, cocos2d::CCTMXLayer, tileGIDAt, cocos2d::CCPoint const&, cocos2d::ccTMXTileFlags*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, cocos2d::CCPoint const&>::func(&cocos2d::CCTMXLayer::updateTileForGID)), Default, cocos2d::CCTMXLayer, updateTileForGID, unsigned int, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCTMXLayer::vertexZForPos)), Default, cocos2d::CCTMXLayer, vertexZForPos, cocos2d::CCPoint const&)
		}
	};
}
