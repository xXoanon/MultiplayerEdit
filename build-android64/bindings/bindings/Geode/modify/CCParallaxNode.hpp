...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCParallaxNode> : ModifyBase<ModifyDerive<Der, cocos2d::CCParallaxNode>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d14CCParallaxNodeC2Ev")), Default, cocos2d::CCParallaxNode, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d14CCParallaxNodeD2Ev")), Default, cocos2d::CCParallaxNode)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*, unsigned int, cocos2d::CCPoint const&, cocos2d::CCPoint const&>::func(&cocos2d::CCParallaxNode::addChild)), Default, cocos2d::CCParallaxNode, addChild, cocos2d::CCNode*, unsigned int, cocos2d::CCPoint const&, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*, unsigned int, int>::func(&cocos2d::CCParallaxNode::addChild)), Default, cocos2d::CCParallaxNode, addChild, cocos2d::CCNode*, unsigned int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*, bool>::func(&cocos2d::CCParallaxNode::removeChild)), Default, cocos2d::CCParallaxNode, removeChild, cocos2d::CCNode*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::CCParallaxNode::removeAllChildrenWithCleanup)), Default, cocos2d::CCParallaxNode, removeAllChildrenWithCleanup, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParallaxNode::visit)), Default, cocos2d::CCParallaxNode, visit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParallaxNode::absolutePosition)), Default, cocos2d::CCParallaxNode, absolutePosition, )
		}
	};
}
