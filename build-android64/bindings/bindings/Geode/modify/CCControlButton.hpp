...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::extension::CCControlButton> : ModifyBase<ModifyDerive<Der, cocos2d::extension::CCControlButton>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension15CCControlButtonC2Ev")), Default, cocos2d::extension::CCControlButton, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension15CCControlButtonD2Ev")), Default, cocos2d::extension::CCControlButton)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension15CCControlButton6createESsPKcf")), Default, cocos2d::extension::CCControlButton, create, gd::string, char const*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCControlButton::needsLayout)), Default, cocos2d::extension::CCControlButton, needsLayout, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::extension::CCControlButton::setEnabled)), Default, cocos2d::extension::CCControlButton, setEnabled, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::extension::CCControlButton::setSelected)), Default, cocos2d::extension::CCControlButton, setSelected, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::extension::CCControlButton::setHighlighted)), Default, cocos2d::extension::CCControlButton, setHighlighted, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCControlButton::getPreferredSize)), Default, cocos2d::extension::CCControlButton, getPreferredSize, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSize>::func(&cocos2d::extension::CCControlButton::setPreferredSize)), Default, cocos2d::extension::CCControlButton, setPreferredSize, cocos2d::CCSize)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCControlButton::getZoomOnTouchDown)), Default, cocos2d::extension::CCControlButton, getZoomOnTouchDown, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::extension::CCControlButton::setZoomOnTouchDown)), Default, cocos2d::extension::CCControlButton, setZoomOnTouchDown, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCControlButton::getLabelAnchorPoint)), Default, cocos2d::extension::CCControlButton, getLabelAnchorPoint, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCPoint>::func(&cocos2d::extension::CCControlButton::setLabelAnchorPoint)), Default, cocos2d::extension::CCControlButton, setLabelAnchorPoint, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCControlButton::getOpacity)), Default, cocos2d::extension::CCControlButton, getOpacity, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned char>::func(&cocos2d::extension::CCControlButton::setOpacity)), Default, cocos2d::extension::CCControlButton, setOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCControlButton::getColor)), Default, cocos2d::extension::CCControlButton, getColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor3B const&>::func(&cocos2d::extension::CCControlButton::setColor)), Default, cocos2d::extension::CCControlButton, setColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int, int>::func(&cocos2d::extension::CCControlButton::setMargins)), Default, cocos2d::extension::CCControlButton, setMargins, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCControlButton::init)), Default, cocos2d::extension::CCControlButton, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*, cocos2d::extension::CCScale9Sprite*>::func(&cocos2d::extension::CCControlButton::initWithLabelAndBackgroundSprite)), Default, cocos2d::extension::CCControlButton, initWithLabelAndBackgroundSprite, cocos2d::CCNode*, cocos2d::extension::CCScale9Sprite*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension15CCControlButton35initWithTitleAndFontNameAndFontSizeESsPKcf")), Default, cocos2d::extension::CCControlButton, initWithTitleAndFontNameAndFontSize, gd::string, char const*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::extension::CCScale9Sprite*>::func(&cocos2d::extension::CCControlButton::initWithBackgroundSprite)), Default, cocos2d::extension::CCControlButton, initWithBackgroundSprite, cocos2d::extension::CCScale9Sprite*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*, cocos2d::CCEvent*>::func(&cocos2d::extension::CCControlButton::ccTouchBegan)), Default, cocos2d::extension::CCControlButton, ccTouchBegan, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*, cocos2d::CCEvent*>::func(&cocos2d::extension::CCControlButton::ccTouchMoved)), Default, cocos2d::extension::CCControlButton, ccTouchMoved, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*, cocos2d::CCEvent*>::func(&cocos2d::extension::CCControlButton::ccTouchEnded)), Default, cocos2d::extension::CCControlButton, ccTouchEnded, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*, cocos2d::CCEvent*>::func(&cocos2d::extension::CCControlButton::ccTouchCancelled)), Default, cocos2d::extension::CCControlButton, ccTouchCancelled, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned int>::func(&cocos2d::extension::CCControlButton::getTitleForState)), Default, cocos2d::extension::CCControlButton, getTitleForState, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCString*, unsigned int>::func(&cocos2d::extension::CCControlButton::setTitleForState)), Default, cocos2d::extension::CCControlButton, setTitleForState, cocos2d::CCString*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned int>::func(&cocos2d::extension::CCControlButton::getTitleColorForState)), Default, cocos2d::extension::CCControlButton, getTitleColorForState, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor3B, unsigned int>::func(&cocos2d::extension::CCControlButton::setTitleColorForState)), Default, cocos2d::extension::CCControlButton, setTitleColorForState, cocos2d::ccColor3B, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned int>::func(&cocos2d::extension::CCControlButton::getTitleLabelForState)), Default, cocos2d::extension::CCControlButton, getTitleLabelForState, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*, unsigned int>::func(&cocos2d::extension::CCControlButton::setTitleLabelForState)), Default, cocos2d::extension::CCControlButton, setTitleLabelForState, cocos2d::CCNode*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<char const*, unsigned int>::func(&cocos2d::extension::CCControlButton::setTitleTTFForState)), Default, cocos2d::extension::CCControlButton, setTitleTTFForState, char const*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned int>::func(&cocos2d::extension::CCControlButton::getTitleTTFForState)), Default, cocos2d::extension::CCControlButton, getTitleTTFForState, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float, unsigned int>::func(&cocos2d::extension::CCControlButton::setTitleTTFSizeForState)), Default, cocos2d::extension::CCControlButton, setTitleTTFSizeForState, float, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned int>::func(&cocos2d::extension::CCControlButton::getTitleTTFSizeForState)), Default, cocos2d::extension::CCControlButton, getTitleTTFSizeForState, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<char const*, unsigned int>::func(&cocos2d::extension::CCControlButton::setTitleBMFontForState)), Default, cocos2d::extension::CCControlButton, setTitleBMFontForState, char const*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned int>::func(&cocos2d::extension::CCControlButton::getTitleBMFontForState)), Default, cocos2d::extension::CCControlButton, getTitleBMFontForState, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned int>::func(&cocos2d::extension::CCControlButton::getBackgroundSpriteForState)), Default, cocos2d::extension::CCControlButton, getBackgroundSpriteForState, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::extension::CCScale9Sprite*, unsigned int>::func(&cocos2d::extension::CCControlButton::setBackgroundSpriteForState)), Default, cocos2d::extension::CCControlButton, setBackgroundSpriteForState, cocos2d::extension::CCScale9Sprite*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSpriteFrame*, unsigned int>::func(&cocos2d::extension::CCControlButton::setBackgroundSpriteFrameForState)), Default, cocos2d::extension::CCControlButton, setBackgroundSpriteFrameForState, cocos2d::CCSpriteFrame*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCControlButton::doesAdjustBackgroundImage)), Default, cocos2d::extension::CCControlButton, doesAdjustBackgroundImage, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::extension::CCControlButton::setAdjustBackgroundImage)), Default, cocos2d::extension::CCControlButton, setAdjustBackgroundImage, bool)
		}
	};
}
