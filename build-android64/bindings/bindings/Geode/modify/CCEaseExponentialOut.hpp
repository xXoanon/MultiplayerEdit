...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCEaseExponentialOut> : ModifyBase<ModifyDerive<Der, cocos2d::CCEaseExponentialOut>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCEaseExponentialOut::copyWithZone)), Default, cocos2d::CCEaseExponentialOut, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCEaseExponentialOut::update)), Default, cocos2d::CCEaseExponentialOut, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCEaseExponentialOut::reverse)), Default, cocos2d::CCEaseExponentialOut, reverse, )
		}
	};
}
