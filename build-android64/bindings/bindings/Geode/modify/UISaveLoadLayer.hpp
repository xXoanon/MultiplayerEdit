...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UISaveLoadLayer> : ModifyBase<ModifyDerive<Der, UISaveLoadLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<UIOptionsLayer*>::func(&UISaveLoadLayer::create)), Default, UISaveLoadLayer, create, UIOptionsLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<UIOptionsLayer*>::func(&UISaveLoadLayer::init)), Default, UISaveLoadLayer, init, UIOptionsLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&UISaveLoadLayer::onLoad)), Default, UISaveLoadLayer, onLoad, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&UISaveLoadLayer::onSave)), Default, UISaveLoadLayer, onSave, cocos2d::CCObject*)
		}
	};
}
