...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCFlipX3D> : ModifyBase<ModifyDerive<Der, cocos2d::CCFlipX3D>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCFlipX3D::initWithDuration)), Default, cocos2d::CCFlipX3D, initWithDuration, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSize const&, float>::func(&cocos2d::CCFlipX3D::initWithSize)), Default, cocos2d::CCFlipX3D, initWithSize, cocos2d::CCSize const&, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCFlipX3D::copyWithZone)), Default, cocos2d::CCFlipX3D, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCFlipX3D::update)), Default, cocos2d::CCFlipX3D, update, float)
		}
	};
}
