...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCRepeatForever> : ModifyBase<ModifyDerive<Der, cocos2d::CCRepeatForever>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d15CCRepeatForeverD2Ev")), Default, cocos2d::CCRepeatForever)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCRepeatForever::copyWithZone)), Default, cocos2d::CCRepeatForever, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCRepeatForever::isDone)), Default, cocos2d::CCRepeatForever, isDone, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCRepeatForever::startWithTarget)), Default, cocos2d::CCRepeatForever, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCRepeatForever::step)), Default, cocos2d::CCRepeatForever, step, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCRepeatForever::reverse)), Default, cocos2d::CCRepeatForever, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCActionInterval*>::func(&cocos2d::CCRepeatForever::initWithAction)), Default, cocos2d::CCRepeatForever, initWithAction, cocos2d::CCActionInterval*)
		}
	};
}
