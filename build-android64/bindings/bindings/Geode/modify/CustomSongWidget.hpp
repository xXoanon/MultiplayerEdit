...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CustomSongWidget> : ModifyBase<ModifyDerive<Der, CustomSongWidget>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN16CustomSongWidgetD2Ev")), Default, CustomSongWidget)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<SongInfoObject*, CustomSongDelegate*, bool, bool, bool, bool, bool, bool, int>::func(&CustomSongWidget::create)), Default, CustomSongWidget, create, SongInfoObject*, CustomSongDelegate*, bool, bool, bool, bool, bool, bool, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<SongInfoObject*>::func(&CustomSongWidget::loadSongInfoFinished)), Default, CustomSongWidget, loadSongInfoFinished, SongInfoObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int, GJSongError>::func(&CustomSongWidget::loadSongInfoFailed)), Default, CustomSongWidget, loadSongInfoFailed, int, GJSongError)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int>::func(&CustomSongWidget::downloadSongStarted)), Default, CustomSongWidget, downloadSongStarted, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int>::func(&CustomSongWidget::downloadSongFinished)), Default, CustomSongWidget, downloadSongFinished, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int, GJSongError>::func(&CustomSongWidget::downloadSongFailed)), Default, CustomSongWidget, downloadSongFailed, int, GJSongError)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int>::func(&CustomSongWidget::downloadSFXFinished)), Default, CustomSongWidget, downloadSFXFinished, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int, GJSongError>::func(&CustomSongWidget::downloadSFXFailed)), Default, CustomSongWidget, downloadSFXFailed, int, GJSongError)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GJMusicAction>::func(&CustomSongWidget::musicActionFinished)), Default, CustomSongWidget, musicActionFinished, GJMusicAction)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GJMusicAction>::func(&CustomSongWidget::musicActionFailed)), Default, CustomSongWidget, musicActionFailed, GJMusicAction)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&CustomSongWidget::songStateChanged)), Default, CustomSongWidget, songStateChanged, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<FLAlertLayer*, bool>::func(&CustomSongWidget::FLAlert_Clicked)), Default, CustomSongWidget, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool, bool>::func(&CustomSongWidget::addExtraVisuals)), Default, CustomSongWidget, addExtraVisuals, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&CustomSongWidget::deleteSong)), Default, CustomSongWidget, deleteSong, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, GJAssetType, GJSongError>::func(&CustomSongWidget::downloadAssetFailed)), Default, CustomSongWidget, downloadAssetFailed, int, GJAssetType, GJSongError)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, GJAssetType>::func(&CustomSongWidget::downloadAssetFinished)), Default, CustomSongWidget, downloadAssetFinished, int, GJAssetType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&CustomSongWidget::downloadFailed)), Default, CustomSongWidget, downloadFailed, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&CustomSongWidget::getSongInfoIfUnloaded)), Default, CustomSongWidget, getSongInfoIfUnloaded, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<SongInfoObject*, CustomSongDelegate*, bool, bool, bool, bool, bool, bool, int>::func(&CustomSongWidget::init)), Default, CustomSongWidget, init, SongInfoObject*, CustomSongDelegate*, bool, bool, bool, bool, bool, bool, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&CustomSongWidget::onCancelDownload)), Default, CustomSongWidget, onCancelDownload, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&CustomSongWidget::onDelete)), Default, CustomSongWidget, onDelete, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&CustomSongWidget::onDownload)), Default, CustomSongWidget, onDownload, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&CustomSongWidget::onGetSongInfo)), Default, CustomSongWidget, onGetSongInfo, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&CustomSongWidget::onInfo)), Default, CustomSongWidget, onInfo, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&CustomSongWidget::onMore)), Default, CustomSongWidget, onMore, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&CustomSongWidget::onPlayback)), Default, CustomSongWidget, onPlayback, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&CustomSongWidget::onSelect)), Default, CustomSongWidget, onSelect, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&CustomSongWidget::positionInfoObjects)), Default, CustomSongWidget, positionInfoObjects, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&CustomSongWidget::processNextMultiAsset)), Default, CustomSongWidget, processNextMultiAsset, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&CustomSongWidget::showError)), Default, CustomSongWidget, showError, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&CustomSongWidget::startDownload)), Default, CustomSongWidget, startDownload, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&CustomSongWidget::startMonitorDownload)), Default, CustomSongWidget, startMonitorDownload, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&CustomSongWidget::startMultiAssetDownload)), Default, CustomSongWidget, startMultiAssetDownload, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&CustomSongWidget::toggleUpdateButton)), Default, CustomSongWidget, toggleUpdateButton, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&CustomSongWidget::updateDownloadProgress)), Default, CustomSongWidget, updateDownloadProgress, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<GJSongError>::func(&CustomSongWidget::updateError)), Default, CustomSongWidget, updateError, GJSongError)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&CustomSongWidget::updateLengthMod)), Default, CustomSongWidget, updateLengthMod, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&CustomSongWidget::updateMultiAssetInfo)), Default, CustomSongWidget, updateMultiAssetInfo, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&CustomSongWidget::updatePlaybackBtn)), Default, CustomSongWidget, updatePlaybackBtn, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&CustomSongWidget::updateProgressBar)), Default, CustomSongWidget, updateProgressBar, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&CustomSongWidget::updateSongInfo)), Default, CustomSongWidget, updateSongInfo, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<SongInfoObject*>::func(&CustomSongWidget::updateSongObject)), Default, CustomSongWidget, updateSongObject, SongInfoObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN16CustomSongWidget21updateWithMultiAssetsESsSsi")), Default, CustomSongWidget, updateWithMultiAssets, gd::string, gd::string, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&CustomSongWidget::verifySongID)), Default, CustomSongWidget, verifySongID, int)
		}
	};
}
