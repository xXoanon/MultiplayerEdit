...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCEaseOut> : ModifyBase<ModifyDerive<Der, cocos2d::CCEaseOut>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCEaseOut::copyWithZone)), Default, cocos2d::CCEaseOut, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCEaseOut::update)), Default, cocos2d::CCEaseOut, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCEaseOut::reverse)), Default, cocos2d::CCEaseOut, reverse, )
		}
	};
}
