...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCStopGrid> : ModifyBase<ModifyDerive<Der, cocos2d::CCStopGrid>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCStopGrid::startWithTarget)), Default, cocos2d::CCStopGrid, startWithTarget, cocos2d::CCNode*)
		}
	};
}
