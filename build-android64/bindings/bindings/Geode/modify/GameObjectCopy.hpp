...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameObjectCopy> : ModifyBase<ModifyDerive<Der, GameObjectCopy>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<GameObject*>::func(&GameObjectCopy::create)), Default, GameObjectCopy, create, GameObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<GameObject*>::func(&GameObjectCopy::init)), Default, GameObjectCopy, init, GameObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GameObjectCopy::resetObject)), Default, GameObjectCopy, resetObject, )
		}
	};
}
