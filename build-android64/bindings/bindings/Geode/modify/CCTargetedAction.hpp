...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTargetedAction> : ModifyBase<ModifyDerive<Der, cocos2d::CCTargetedAction>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d16CCTargetedActionC2Ev")), Default, cocos2d::CCTargetedAction, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d16CCTargetedActionD2Ev")), Default, cocos2d::CCTargetedAction)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCTargetedAction::copyWithZone)), Default, cocos2d::CCTargetedAction, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCTargetedAction::startWithTarget)), Default, cocos2d::CCTargetedAction, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTargetedAction::stop)), Default, cocos2d::CCTargetedAction, stop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCTargetedAction::update)), Default, cocos2d::CCTargetedAction, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCNode*, cocos2d::CCFiniteTimeAction*>::func(&cocos2d::CCTargetedAction::initWithTarget)), Default, cocos2d::CCTargetedAction, initWithTarget, cocos2d::CCNode*, cocos2d::CCFiniteTimeAction*)
		}
	};
}
