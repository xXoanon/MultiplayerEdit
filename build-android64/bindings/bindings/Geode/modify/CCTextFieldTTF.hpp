...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTextFieldTTF> : ModifyBase<ModifyDerive<Der, cocos2d::CCTextFieldTTF>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d14CCTextFieldTTFC2Ev")), Default, cocos2d::CCTextFieldTTF, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d14CCTextFieldTTFD2Ev")), Default, cocos2d::CCTextFieldTTF)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTextFieldTTF::draw)), Default, cocos2d::CCTextFieldTTF, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTextFieldTTF::getColorSpaceHolder)), Default, cocos2d::CCTextFieldTTF, getColorSpaceHolder, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const cocos2d::ccColor3B&>::func(&cocos2d::CCTextFieldTTF::setColorSpaceHolder)), Default, cocos2d::CCTextFieldTTF, setColorSpaceHolder, const cocos2d::ccColor3B&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTextFieldTTF::getPlaceHolder)), Default, cocos2d::CCTextFieldTTF, getPlaceHolder, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const char*>::func(&cocos2d::CCTextFieldTTF::setPlaceHolder)), Default, cocos2d::CCTextFieldTTF, setPlaceHolder, const char*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::CCTextFieldTTF::setSecureTextEntry)), Default, cocos2d::CCTextFieldTTF, setSecureTextEntry, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTextFieldTTF::isSecureTextEntry)), Default, cocos2d::CCTextFieldTTF, isSecureTextEntry, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const char*>::func(&cocos2d::CCTextFieldTTF::setString)), Default, cocos2d::CCTextFieldTTF, setString, const char*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTextFieldTTF::getString)), Default, cocos2d::CCTextFieldTTF, getString, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTextFieldTTF::attachWithIME)), Default, cocos2d::CCTextFieldTTF, attachWithIME, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTextFieldTTF::detachWithIME)), Default, cocos2d::CCTextFieldTTF, detachWithIME, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTextFieldTTF::canAttachWithIME)), Default, cocos2d::CCTextFieldTTF, canAttachWithIME, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTextFieldTTF::canDetachWithIME)), Default, cocos2d::CCTextFieldTTF, canDetachWithIME, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const char*, int, cocos2d::enumKeyCodes>::func(&cocos2d::CCTextFieldTTF::insertText)), Default, cocos2d::CCTextFieldTTF, insertText, const char*, int, cocos2d::enumKeyCodes)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTextFieldTTF::deleteBackward)), Default, cocos2d::CCTextFieldTTF, deleteBackward, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTextFieldTTF::deleteForward)), Default, cocos2d::CCTextFieldTTF, deleteForward, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTextFieldTTF::getContentText)), Default, cocos2d::CCTextFieldTTF, getContentText, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const char*, const char*, float>::func(&cocos2d::CCTextFieldTTF::initWithPlaceHolder)), Default, cocos2d::CCTextFieldTTF, initWithPlaceHolder, const char*, const char*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const char*, const cocos2d::CCSize&, cocos2d::CCTextAlignment, const char*, float>::func(&cocos2d::CCTextFieldTTF::initWithPlaceHolder)), Default, cocos2d::CCTextFieldTTF, initWithPlaceHolder, const char*, const cocos2d::CCSize&, cocos2d::CCTextAlignment, const char*, float)
		}
	};
}
