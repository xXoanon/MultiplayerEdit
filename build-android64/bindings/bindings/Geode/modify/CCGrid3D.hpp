...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCGrid3D> : ModifyBase<ModifyDerive<Der, cocos2d::CCGrid3D>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d8CCGrid3DC2Ev")), Default, cocos2d::CCGrid3D, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d8CCGrid3DD2Ev")), Default, cocos2d::CCGrid3D)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCGrid3D::blit)), Default, cocos2d::CCGrid3D, blit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCGrid3D::reuse)), Default, cocos2d::CCGrid3D, reuse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCGrid3D::calculateVertexPoints)), Default, cocos2d::CCGrid3D, calculateVertexPoints, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCGrid3D::originalVertex)), Default, cocos2d::CCGrid3D, originalVertex, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&, cocos2d::ccVertex3F const&>::func(&cocos2d::CCGrid3D::setVertex)), Default, cocos2d::CCGrid3D, setVertex, cocos2d::CCPoint const&, cocos2d::ccVertex3F const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCGrid3D::vertex)), Default, cocos2d::CCGrid3D, vertex, cocos2d::CCPoint const&)
		}
	};
}
