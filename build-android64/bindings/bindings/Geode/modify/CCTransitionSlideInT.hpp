...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionSlideInT> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionSlideInT>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCTransitionSlideInTC2Ev")), Default, cocos2d::CCTransitionSlideInT, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCTransitionSlideInTD2Ev")), Default, cocos2d::CCTransitionSlideInT)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionSlideInT::sceneOrder)), Default, cocos2d::CCTransitionSlideInT, sceneOrder, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionSlideInT::initScenes)), Default, cocos2d::CCTransitionSlideInT, initScenes, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionSlideInT::action)), Default, cocos2d::CCTransitionSlideInT, action, )
		}
	};
}
