...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCEGLViewProtocol> : ModifyBase<ModifyDerive<Der, cocos2d::CCEGLViewProtocol>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d17CCEGLViewProtocolC2Ev")), Default, cocos2d::CCEGLViewProtocol, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d17CCEGLViewProtocolD2Ev")), Default, cocos2d::CCEGLViewProtocol)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCEGLViewProtocol::getFrameSize)), Default, cocos2d::CCEGLViewProtocol, getFrameSize, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float, float>::func(&cocos2d::CCEGLViewProtocol::setFrameSize)), Default, cocos2d::CCEGLViewProtocol, setFrameSize, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCEGLViewProtocol::getVisibleSize)), Default, cocos2d::CCEGLViewProtocol, getVisibleSize, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCEGLViewProtocol::getVisibleOrigin)), Default, cocos2d::CCEGLViewProtocol, getVisibleOrigin, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float, float, ResolutionPolicy>::func(&cocos2d::CCEGLViewProtocol::setDesignResolutionSize)), Default, cocos2d::CCEGLViewProtocol, setDesignResolutionSize, float, float, ResolutionPolicy)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCEGLViewProtocol::getDesignResolutionSize)), Default, cocos2d::CCEGLViewProtocol, getDesignResolutionSize, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::EGLTouchDelegate*>::func(&cocos2d::CCEGLViewProtocol::setTouchDelegate)), Default, cocos2d::CCEGLViewProtocol, setTouchDelegate, cocos2d::EGLTouchDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float, float, float, float>::func(&cocos2d::CCEGLViewProtocol::setViewPortInPoints)), Default, cocos2d::CCEGLViewProtocol, setViewPortInPoints, float, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float, float, float, float>::func(&cocos2d::CCEGLViewProtocol::setScissorInPoints)), Default, cocos2d::CCEGLViewProtocol, setScissorInPoints, float, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCEGLViewProtocol::isScissorEnabled)), Default, cocos2d::CCEGLViewProtocol, isScissorEnabled, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCEGLViewProtocol::getScissorRect)), Default, cocos2d::CCEGLViewProtocol, getScissorRect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<char const*>::func(&cocos2d::CCEGLViewProtocol::setViewName)), Default, cocos2d::CCEGLViewProtocol, setViewName, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCEGLViewProtocol::pollInputEvents)), Default, cocos2d::CCEGLViewProtocol, pollInputEvents, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int, int*, float*, float*, double>::func(&cocos2d::CCEGLViewProtocol::handleTouchesBegin)), Default, cocos2d::CCEGLViewProtocol, handleTouchesBegin, int, int*, float*, float*, double)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int, int*, float*, float*, double>::func(&cocos2d::CCEGLViewProtocol::handleTouchesMove)), Default, cocos2d::CCEGLViewProtocol, handleTouchesMove, int, int*, float*, float*, double)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int, int*, float*, float*, double>::func(&cocos2d::CCEGLViewProtocol::handleTouchesEnd)), Default, cocos2d::CCEGLViewProtocol, handleTouchesEnd, int, int*, float*, float*, double)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int, int*, float*, float*, double>::func(&cocos2d::CCEGLViewProtocol::handleTouchesCancel)), Default, cocos2d::CCEGLViewProtocol, handleTouchesCancel, int, int*, float*, float*, double)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCEGLViewProtocol::getScaleX)), Default, cocos2d::CCEGLViewProtocol, getScaleX, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCEGLViewProtocol::getScaleY)), Default, cocos2d::CCEGLViewProtocol, getScaleY, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSet&, int, int*, float*, float*, double>::func(&cocos2d::CCEGLViewProtocol::getSetOfTouchesEndOrCancel)), Default, cocos2d::CCEGLViewProtocol, getSetOfTouchesEndOrCancel, cocos2d::CCSet&, int, int*, float*, float*, double)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCEGLViewProtocol::getViewName)), Default, cocos2d::CCEGLViewProtocol, getViewName, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCEGLViewProtocol::getViewPortRect)), Default, cocos2d::CCEGLViewProtocol, getViewPortRect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCEGLViewProtocol::updateDesignResolutionSize)), Default, cocos2d::CCEGLViewProtocol, updateDesignResolutionSize, )
		}
	};
}
