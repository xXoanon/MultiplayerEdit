...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCGridAction> : ModifyBase<ModifyDerive<Der, cocos2d::CCGridAction>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCGridAction::copyWithZone)), Default, cocos2d::CCGridAction, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCGridAction::startWithTarget)), Default, cocos2d::CCGridAction, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCGridAction::reverse)), Default, cocos2d::CCGridAction, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float, cocos2d::CCSize const&>::func(&cocos2d::CCGridAction::initWithDuration)), Default, cocos2d::CCGridAction, initWithDuration, float, cocos2d::CCSize const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCGridAction::getGrid)), Default, cocos2d::CCGridAction, getGrid, )
		}
	};
}
