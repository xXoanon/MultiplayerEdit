...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCRepeat> : ModifyBase<ModifyDerive<Der, cocos2d::CCRepeat>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d8CCRepeatD2Ev")), Default, cocos2d::CCRepeat)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCRepeat::copyWithZone)), Default, cocos2d::CCRepeat, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCRepeat::update)), Default, cocos2d::CCRepeat, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCRepeat::isDone)), Default, cocos2d::CCRepeat, isDone, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCRepeat::startWithTarget)), Default, cocos2d::CCRepeat, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCRepeat::stop)), Default, cocos2d::CCRepeat, stop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCRepeat::reverse)), Default, cocos2d::CCRepeat, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCFiniteTimeAction*, unsigned int>::func(&cocos2d::CCRepeat::initWithAction)), Default, cocos2d::CCRepeat, initWithAction, cocos2d::CCFiniteTimeAction*, unsigned int)
		}
	};
}
