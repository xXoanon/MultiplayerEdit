...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCEaseIn> : ModifyBase<ModifyDerive<Der, cocos2d::CCEaseIn>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCEaseIn::copyWithZone)), Default, cocos2d::CCEaseIn, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCEaseIn::update)), Default, cocos2d::CCEaseIn, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCEaseIn::reverse)), Default, cocos2d::CCEaseIn, reverse, )
		}
	};
}
