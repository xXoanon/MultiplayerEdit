...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionSlideInR> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionSlideInR>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCTransitionSlideInRC2Ev")), Default, cocos2d::CCTransitionSlideInR, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCTransitionSlideInRD2Ev")), Default, cocos2d::CCTransitionSlideInR)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionSlideInR::sceneOrder)), Default, cocos2d::CCTransitionSlideInR, sceneOrder, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionSlideInR::initScenes)), Default, cocos2d::CCTransitionSlideInR, initScenes, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionSlideInR::action)), Default, cocos2d::CCTransitionSlideInR, action, )
		}
	};
}
