...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCFadeTo> : ModifyBase<ModifyDerive<Der, cocos2d::CCFadeTo>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCFadeTo::copyWithZone)), Default, cocos2d::CCFadeTo, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCFadeTo::update)), Default, cocos2d::CCFadeTo, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCFadeTo::startWithTarget)), Default, cocos2d::CCFadeTo, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, unsigned char>::func(&cocos2d::CCFadeTo::initWithDuration)), Default, cocos2d::CCFadeTo, initWithDuration, float, unsigned char)
		}
	};
}
