...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCCamera> : ModifyBase<ModifyDerive<Der, cocos2d::CCCamera>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d8CCCameraC2Ev")), Default, cocos2d::CCCamera, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d8CCCameraD2Ev")), Default, cocos2d::CCCamera)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCCamera::description)), Default, cocos2d::CCCamera, description, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*, float*, float*>::func(&cocos2d::CCCamera::getCenterXYZ)), Default, cocos2d::CCCamera, getCenterXYZ, float*, float*, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*, float*, float*>::func(&cocos2d::CCCamera::getEyeXYZ)), Default, cocos2d::CCCamera, getEyeXYZ, float*, float*, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*, float*, float*>::func(&cocos2d::CCCamera::getUpXYZ)), Default, cocos2d::CCCamera, getUpXYZ, float*, float*, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCCamera::init)), Default, cocos2d::CCCamera, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCCamera::locate)), Default, cocos2d::CCCamera, locate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCCamera::restore)), Default, cocos2d::CCCamera, restore, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float>::func(&cocos2d::CCCamera::setCenterXYZ)), Default, cocos2d::CCCamera, setCenterXYZ, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float>::func(&cocos2d::CCCamera::setEyeXYZ)), Default, cocos2d::CCCamera, setEyeXYZ, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float>::func(&cocos2d::CCCamera::setUpXYZ)), Default, cocos2d::CCCamera, setUpXYZ, float, float, float)
		}
	};
}
