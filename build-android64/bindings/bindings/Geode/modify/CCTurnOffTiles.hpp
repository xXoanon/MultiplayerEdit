...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTurnOffTiles> : ModifyBase<ModifyDerive<Der, cocos2d::CCTurnOffTiles>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d14CCTurnOffTilesD2Ev")), Default, cocos2d::CCTurnOffTiles)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCTurnOffTiles::copyWithZone)), Default, cocos2d::CCTurnOffTiles, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCTurnOffTiles::update)), Default, cocos2d::CCTurnOffTiles, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCTurnOffTiles::startWithTarget)), Default, cocos2d::CCTurnOffTiles, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float, cocos2d::CCSize const&, unsigned int>::func(&cocos2d::CCTurnOffTiles::initWithDuration)), Default, cocos2d::CCTurnOffTiles, initWithDuration, float, cocos2d::CCSize const&, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int*, unsigned int>::func(&cocos2d::CCTurnOffTiles::shuffle)), Default, cocos2d::CCTurnOffTiles, shuffle, unsigned int*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCTurnOffTiles::turnOffTile)), Default, cocos2d::CCTurnOffTiles, turnOffTile, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCTurnOffTiles::turnOnTile)), Default, cocos2d::CCTurnOffTiles, turnOnTile, cocos2d::CCPoint const&)
		}
	};
}
