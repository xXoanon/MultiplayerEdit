...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCAccelAmplitude> : ModifyBase<ModifyDerive<Der, cocos2d::CCAccelAmplitude>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d16CCAccelAmplitudeD2Ev")), Default, cocos2d::CCAccelAmplitude)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCAccelAmplitude::startWithTarget)), Default, cocos2d::CCAccelAmplitude, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCAccelAmplitude::update)), Default, cocos2d::CCAccelAmplitude, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCAccelAmplitude::reverse)), Default, cocos2d::CCAccelAmplitude, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCAction*, float>::func(&cocos2d::CCAccelAmplitude::initWithAction)), Default, cocos2d::CCAccelAmplitude, initWithAction, cocos2d::CCAction*, float)
		}
	};
}
