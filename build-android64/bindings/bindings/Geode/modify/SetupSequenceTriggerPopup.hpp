...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupSequenceTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupSequenceTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<SequenceTriggerGameObject*>::func(&SetupSequenceTriggerPopup::create)), Default, SetupSequenceTriggerPopup, create, SequenceTriggerGameObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCObject*>::func(&SetupSequenceTriggerPopup::onCustomToggleTriggerValue)), Default, SetupSequenceTriggerPopup, onCustomToggleTriggerValue, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<SequenceTriggerGameObject*>::func(&SetupSequenceTriggerPopup::init)), Default, SetupSequenceTriggerPopup, init, SequenceTriggerGameObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupSequenceTriggerPopup::onAddChance)), Default, SetupSequenceTriggerPopup, onAddChance, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupSequenceTriggerPopup::onChangeOrder)), Default, SetupSequenceTriggerPopup, onChangeOrder, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupSequenceTriggerPopup::onDeleteSelected)), Default, SetupSequenceTriggerPopup, onDeleteSelected, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupSequenceTriggerPopup::onSelect)), Default, SetupSequenceTriggerPopup, onSelect, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupSequenceTriggerPopup::updateGroupIDButtons)), Default, SetupSequenceTriggerPopup, updateGroupIDButtons, )
		}
	};
}
