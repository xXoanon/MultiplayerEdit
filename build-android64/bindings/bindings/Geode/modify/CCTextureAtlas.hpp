...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTextureAtlas> : ModifyBase<ModifyDerive<Der, cocos2d::CCTextureAtlas>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d14CCTextureAtlasC2Ev")), Default, cocos2d::CCTextureAtlas, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d14CCTextureAtlasD2Ev")), Default, cocos2d::CCTextureAtlas)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTextureAtlas::getTotalQuads)), Default, cocos2d::CCTextureAtlas, getTotalQuads, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTextureAtlas::getCapacity)), Default, cocos2d::CCTextureAtlas, getCapacity, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTextureAtlas::getTexture)), Default, cocos2d::CCTextureAtlas, getTexture, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTexture2D*>::func(&cocos2d::CCTextureAtlas::setTexture)), Default, cocos2d::CCTextureAtlas, setTexture, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTextureAtlas::getQuads)), Default, cocos2d::CCTextureAtlas, getQuads, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccV3F_C4B_T2F_Quad*>::func(&cocos2d::CCTextureAtlas::setQuads)), Default, cocos2d::CCTextureAtlas, setQuads, cocos2d::ccV3F_C4B_T2F_Quad*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTextureAtlas::description)), Default, cocos2d::CCTextureAtlas, description, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCTextureAtlas::drawNumberOfQuads)), Default, cocos2d::CCTextureAtlas, drawNumberOfQuads, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, unsigned int>::func(&cocos2d::CCTextureAtlas::drawNumberOfQuads)), Default, cocos2d::CCTextureAtlas, drawNumberOfQuads, unsigned int, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTextureAtlas::drawQuads)), Default, cocos2d::CCTextureAtlas, drawQuads, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, unsigned int>::func(&cocos2d::CCTextureAtlas::fillWithEmptyQuadsFromIndex)), Default, cocos2d::CCTextureAtlas, fillWithEmptyQuadsFromIndex, unsigned int, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCTextureAtlas::increaseTotalQuadsWith)), Default, cocos2d::CCTextureAtlas, increaseTotalQuadsWith, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, unsigned int>::func(&cocos2d::CCTextureAtlas::initWithFile)), Default, cocos2d::CCTextureAtlas, initWithFile, char const*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTexture2D*, unsigned int>::func(&cocos2d::CCTextureAtlas::initWithTexture)), Default, cocos2d::CCTextureAtlas, initWithTexture, cocos2d::CCTexture2D*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::ccV3F_C4B_T2F_Quad*, unsigned int>::func(&cocos2d::CCTextureAtlas::insertQuad)), Default, cocos2d::CCTextureAtlas, insertQuad, cocos2d::ccV3F_C4B_T2F_Quad*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, unsigned int>::func(&cocos2d::CCTextureAtlas::insertQuadFromIndex)), Default, cocos2d::CCTextureAtlas, insertQuadFromIndex, unsigned int, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::ccV3F_C4B_T2F_Quad*, unsigned int, unsigned int>::func(&cocos2d::CCTextureAtlas::insertQuads)), Default, cocos2d::CCTextureAtlas, insertQuads, cocos2d::ccV3F_C4B_T2F_Quad*, unsigned int, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCTextureAtlas::listenBackToForeground)), Default, cocos2d::CCTextureAtlas, listenBackToForeground, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTextureAtlas::mapBuffers)), Default, cocos2d::CCTextureAtlas, mapBuffers, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, unsigned int>::func(&cocos2d::CCTextureAtlas::moveQuadsFromIndex)), Default, cocos2d::CCTextureAtlas, moveQuadsFromIndex, unsigned int, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, unsigned int, unsigned int>::func(&cocos2d::CCTextureAtlas::moveQuadsFromIndex)), Default, cocos2d::CCTextureAtlas, moveQuadsFromIndex, unsigned int, unsigned int, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTextureAtlas::removeAllQuads)), Default, cocos2d::CCTextureAtlas, removeAllQuads, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCTextureAtlas::removeQuadAtIndex)), Default, cocos2d::CCTextureAtlas, removeQuadAtIndex, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, unsigned int>::func(&cocos2d::CCTextureAtlas::removeQuadsAtIndex)), Default, cocos2d::CCTextureAtlas, removeQuadsAtIndex, unsigned int, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCTextureAtlas::resizeCapacity)), Default, cocos2d::CCTextureAtlas, resizeCapacity, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTextureAtlas::setupIndices)), Default, cocos2d::CCTextureAtlas, setupIndices, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTextureAtlas::setupVBO)), Default, cocos2d::CCTextureAtlas, setupVBO, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::ccV3F_C4B_T2F_Quad*, unsigned int>::func(&cocos2d::CCTextureAtlas::updateQuad)), Default, cocos2d::CCTextureAtlas, updateQuad, cocos2d::ccV3F_C4B_T2F_Quad*, unsigned int)
		}
	};
}
