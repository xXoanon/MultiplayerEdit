...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCMouseDispatcher> : ModifyBase<ModifyDerive<Der, cocos2d::CCMouseDispatcher>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d17CCMouseDispatcherC2Ev")), Default, cocos2d::CCMouseDispatcher, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d17CCMouseDispatcherD2Ev")), Default, cocos2d::CCMouseDispatcher)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCMouseDelegate*>::func(&cocos2d::CCMouseDispatcher::addDelegate)), Default, cocos2d::CCMouseDispatcher, addDelegate, cocos2d::CCMouseDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float>::func(&cocos2d::CCMouseDispatcher::dispatchScrollMSG)), Default, cocos2d::CCMouseDispatcher, dispatchScrollMSG, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCMouseDelegate*>::func(&cocos2d::CCMouseDispatcher::forceAddDelegate)), Default, cocos2d::CCMouseDispatcher, forceAddDelegate, cocos2d::CCMouseDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCMouseDelegate*>::func(&cocos2d::CCMouseDispatcher::forceRemoveDelegate)), Default, cocos2d::CCMouseDispatcher, forceRemoveDelegate, cocos2d::CCMouseDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCMouseDelegate*>::func(&cocos2d::CCMouseDispatcher::removeDelegate)), Default, cocos2d::CCMouseDispatcher, removeDelegate, cocos2d::CCMouseDelegate*)
		}
	};
}
