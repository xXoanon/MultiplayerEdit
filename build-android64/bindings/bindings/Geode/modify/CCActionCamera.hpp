...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCActionCamera> : ModifyBase<ModifyDerive<Der, cocos2d::CCActionCamera>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCActionCamera::startWithTarget)), Default, cocos2d::CCActionCamera, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCActionCamera::reverse)), Default, cocos2d::CCActionCamera, reverse, )
		}
	};
}
