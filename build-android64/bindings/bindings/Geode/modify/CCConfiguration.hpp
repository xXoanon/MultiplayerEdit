...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCConfiguration> : ModifyBase<ModifyDerive<Der, cocos2d::CCConfiguration>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d15CCConfigurationC2Ev")), Default, cocos2d::CCConfiguration, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d15CCConfigurationD2Ev")), Default, cocos2d::CCConfiguration)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d15CCConfiguration19checkForGLExtensionERKSs")), Default, cocos2d::CCConfiguration, checkForGLExtension, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCConfiguration::dumpInfo)), Default, cocos2d::CCConfiguration, dumpInfo, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCConfiguration::gatherGPUInfo)), Default, cocos2d::CCConfiguration, gatherGPUInfo, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, bool>::func(&cocos2d::CCConfiguration::getBool)), Default, cocos2d::CCConfiguration, getBool, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, char const*>::func(&cocos2d::CCConfiguration::getCString)), Default, cocos2d::CCConfiguration, getCString, char const*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCConfiguration::getMaxModelviewStackDepth)), Default, cocos2d::CCConfiguration, getMaxModelviewStackDepth, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCConfiguration::getMaxTextureSize)), Default, cocos2d::CCConfiguration, getMaxTextureSize, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCConfiguration::getMaxTextureUnits)), Default, cocos2d::CCConfiguration, getMaxTextureUnits, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, double>::func(&cocos2d::CCConfiguration::getNumber)), Default, cocos2d::CCConfiguration, getNumber, char const*, double)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCConfiguration::getObject)), Default, cocos2d::CCConfiguration, getObject, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCConfiguration::init)), Default, cocos2d::CCConfiguration, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCConfiguration::loadConfigFile)), Default, cocos2d::CCConfiguration, loadConfigFile, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, cocos2d::CCObject*>::func(&cocos2d::CCConfiguration::setObject)), Default, cocos2d::CCConfiguration, setObject, char const*, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCConfiguration::supportsBGRA8888)), Default, cocos2d::CCConfiguration, supportsBGRA8888, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCConfiguration::supportsDiscardFramebuffer)), Default, cocos2d::CCConfiguration, supportsDiscardFramebuffer, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCConfiguration::supportsNPOT)), Default, cocos2d::CCConfiguration, supportsNPOT, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCConfiguration::supportsPVRTC)), Default, cocos2d::CCConfiguration, supportsPVRTC, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCConfiguration::supportsShareableVAO)), Default, cocos2d::CCConfiguration, supportsShareableVAO, )
		}
	};
}
