...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretGame01Layer> : ModifyBase<ModifyDerive<Der, SecretGame01Layer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretGame01Layer::create)), Default, SecretGame01Layer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&SecretGame01Layer::update)), Default, SecretGame01Layer, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&SecretGame01Layer::init)), Default, SecretGame01Layer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<CCMenuItemSpriteExtra*>::func(&SecretGame01Layer::didSelectCorrectObject)), Default, SecretGame01Layer, didSelectCorrectObject, CCMenuItemSpriteExtra*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretGame01Layer::gameStep01)), Default, SecretGame01Layer, gameStep01, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretGame01Layer::gameStep02)), Default, SecretGame01Layer, gameStep02, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&SecretGame01Layer::getCountForDifficulty)), Default, SecretGame01Layer, getCountForDifficulty, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&SecretGame01Layer::getFrameForDifficulty)), Default, SecretGame01Layer, getFrameForDifficulty, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&SecretGame01Layer::getRowsForDifficulty)), Default, SecretGame01Layer, getRowsForDifficulty, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&SecretGame01Layer::getTimeForDifficulty)), Default, SecretGame01Layer, getTimeForDifficulty, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SecretGame01Layer::onSelectButton)), Default, SecretGame01Layer, onSelectButton, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretGame01Layer::resetGame)), Default, SecretGame01Layer, resetGame, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretGame01Layer::resetGameTimer)), Default, SecretGame01Layer, resetGameTimer, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&SecretGame01Layer::scaleOutGame)), Default, SecretGame01Layer, scaleOutGame, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretGame01Layer::showGameOver)), Default, SecretGame01Layer, showGameOver, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SecretGame01Layer::showGameWon)), Default, SecretGame01Layer, showGameWon, )
		}
	};
}
