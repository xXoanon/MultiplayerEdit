...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJStoreItem> : ModifyBase<ModifyDerive<Der, GJStoreItem>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int, int, int, ShopType>::func(&GJStoreItem::create)), Default, GJStoreItem, create, int, int, int, int, ShopType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJStoreItem::getCurrencyKey)), Default, GJStoreItem, getCurrencyKey, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int, int, int, ShopType>::func(&GJStoreItem::init)), Default, GJStoreItem, init, int, int, int, int, ShopType)
		}
	};
}
