...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionMoveInR> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionMoveInR>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d19CCTransitionMoveInRC2Ev")), Default, cocos2d::CCTransitionMoveInR, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d19CCTransitionMoveInRD2Ev")), Default, cocos2d::CCTransitionMoveInR)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionMoveInR::initScenes)), Default, cocos2d::CCTransitionMoveInR, initScenes, )
		}
	};
}
