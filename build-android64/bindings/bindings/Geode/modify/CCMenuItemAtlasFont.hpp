...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCMenuItemAtlasFont> : ModifyBase<ModifyDerive<Der, cocos2d::CCMenuItemAtlasFont>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, char const*, int, int, char, cocos2d::CCObject*, cocos2d::SEL_MenuHandler>::func(&cocos2d::CCMenuItemAtlasFont::initWithString)), Default, cocos2d::CCMenuItemAtlasFont, initWithString, char const*, char const*, int, int, char, cocos2d::CCObject*, cocos2d::SEL_MenuHandler)
		}
	};
}
