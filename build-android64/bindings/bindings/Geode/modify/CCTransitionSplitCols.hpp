...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionSplitCols> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionSplitCols>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d21CCTransitionSplitColsC2Ev")), Default, cocos2d::CCTransitionSplitCols, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d21CCTransitionSplitColsD2Ev")), Default, cocos2d::CCTransitionSplitCols)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionSplitCols::onEnter)), Default, cocos2d::CCTransitionSplitCols, onEnter, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionSplitCols::action)), Default, cocos2d::CCTransitionSplitCols, action, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCActionInterval*>::func(&cocos2d::CCTransitionSplitCols::easeActionWithAction)), Default, cocos2d::CCTransitionSplitCols, easeActionWithAction, cocos2d::CCActionInterval*)
		}
	};
}
