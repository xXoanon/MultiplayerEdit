...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTiledGrid3DAction> : ModifyBase<ModifyDerive<Der, cocos2d::CCTiledGrid3DAction>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTiledGrid3DAction::getGrid)), Default, cocos2d::CCTiledGrid3DAction, getGrid, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCTiledGrid3DAction::originalTile)), Default, cocos2d::CCTiledGrid3DAction, originalTile, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&, cocos2d::ccQuad3 const&>::func(&cocos2d::CCTiledGrid3DAction::setTile)), Default, cocos2d::CCTiledGrid3DAction, setTile, cocos2d::CCPoint const&, cocos2d::ccQuad3 const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCTiledGrid3DAction::tile)), Default, cocos2d::CCTiledGrid3DAction, tile, cocos2d::CCPoint const&)
		}
	};
}
