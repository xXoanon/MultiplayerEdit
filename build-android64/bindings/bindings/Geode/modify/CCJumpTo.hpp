...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCJumpTo> : ModifyBase<ModifyDerive<Der, cocos2d::CCJumpTo>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCJumpTo::copyWithZone)), Default, cocos2d::CCJumpTo, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCJumpTo::startWithTarget)), Default, cocos2d::CCJumpTo, startWithTarget, cocos2d::CCNode*)
		}
	};
}
