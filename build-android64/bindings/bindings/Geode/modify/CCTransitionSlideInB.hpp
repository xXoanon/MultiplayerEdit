...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionSlideInB> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionSlideInB>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCTransitionSlideInBC2Ev")), Default, cocos2d::CCTransitionSlideInB, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCTransitionSlideInBD2Ev")), Default, cocos2d::CCTransitionSlideInB)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionSlideInB::sceneOrder)), Default, cocos2d::CCTransitionSlideInB, sceneOrder, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionSlideInB::initScenes)), Default, cocos2d::CCTransitionSlideInB, initScenes, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionSlideInB::action)), Default, cocos2d::CCTransitionSlideInB, action, )
		}
	};
}
