...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCEaseRateAction> : ModifyBase<ModifyDerive<Der, cocos2d::CCEaseRateAction>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d16CCEaseRateActionD2Ev")), Default, cocos2d::CCEaseRateAction)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCEaseRateAction::copyWithZone)), Default, cocos2d::CCEaseRateAction, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCEaseRateAction::reverse)), Default, cocos2d::CCEaseRateAction, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCActionInterval*, float>::func(&cocos2d::CCEaseRateAction::initWithAction)), Default, cocos2d::CCEaseRateAction, initWithAction, cocos2d::CCActionInterval*, float)
		}
	};
}
