...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCEaseElastic> : ModifyBase<ModifyDerive<Der, cocos2d::CCEaseElastic>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCEaseElastic::copyWithZone)), Default, cocos2d::CCEaseElastic, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCEaseElastic::reverse)), Default, cocos2d::CCEaseElastic, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCActionInterval*, float>::func(&cocos2d::CCEaseElastic::initWithAction)), Default, cocos2d::CCEaseElastic, initWithAction, cocos2d::CCActionInterval*, float)
		}
	};
}
