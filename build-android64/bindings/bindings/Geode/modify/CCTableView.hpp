...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::extension::CCTableView> : ModifyBase<ModifyDerive<Der, cocos2d::extension::CCTableView>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension11CCTableViewC2Ev")), Default, cocos2d::extension::CCTableView, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension11CCTableViewD2Ev")), Default, cocos2d::extension::CCTableView)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::extension::CCScrollView*>::func(&cocos2d::extension::CCTableView::scrollViewDidScroll)), Default, cocos2d::extension::CCTableView, scrollViewDidScroll, cocos2d::extension::CCScrollView*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*, cocos2d::CCEvent*>::func(&cocos2d::extension::CCTableView::ccTouchBegan)), Default, cocos2d::extension::CCTableView, ccTouchBegan, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*, cocos2d::CCEvent*>::func(&cocos2d::extension::CCTableView::ccTouchMoved)), Default, cocos2d::extension::CCTableView, ccTouchMoved, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*, cocos2d::CCEvent*>::func(&cocos2d::extension::CCTableView::ccTouchEnded)), Default, cocos2d::extension::CCTableView, ccTouchEnded, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*, cocos2d::CCEvent*>::func(&cocos2d::extension::CCTableView::ccTouchCancelled)), Default, cocos2d::extension::CCTableView, ccTouchCancelled, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint>::func(&cocos2d::extension::CCTableView::__indexFromOffset)), Default, cocos2d::extension::CCTableView, __indexFromOffset, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::extension::CCTableView::__offsetFromIndex)), Default, cocos2d::extension::CCTableView, __offsetFromIndex, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::extension::CCTableViewCell*>::func(&cocos2d::extension::CCTableView::_addCellIfNecessary)), Default, cocos2d::extension::CCTableView, _addCellIfNecessary, cocos2d::extension::CCTableViewCell*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint>::func(&cocos2d::extension::CCTableView::_indexFromOffset)), Default, cocos2d::extension::CCTableView, _indexFromOffset, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::extension::CCTableViewCell*>::func(&cocos2d::extension::CCTableView::_moveCellOutOfSight)), Default, cocos2d::extension::CCTableView, _moveCellOutOfSight, cocos2d::extension::CCTableViewCell*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::extension::CCTableView::_offsetFromIndex)), Default, cocos2d::extension::CCTableView, _offsetFromIndex, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, cocos2d::extension::CCTableViewCell*>::func(&cocos2d::extension::CCTableView::_setIndexForCell)), Default, cocos2d::extension::CCTableView, _setIndexForCell, unsigned int, cocos2d::extension::CCTableViewCell*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCTableView::_updateCellPositions)), Default, cocos2d::extension::CCTableView, _updateCellPositions, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCTableView::_updateContentSize)), Default, cocos2d::extension::CCTableView, _updateContentSize, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::extension::CCTableView::cellAtIndex)), Default, cocos2d::extension::CCTableView, cellAtIndex, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCTableView::dequeueCell)), Default, cocos2d::extension::CCTableView, dequeueCell, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCTableView::getVerticalFillOrder)), Default, cocos2d::extension::CCTableView, getVerticalFillOrder, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSize, cocos2d::CCNode*>::func(&cocos2d::extension::CCTableView::initWithViewSize)), Default, cocos2d::extension::CCTableView, initWithViewSize, cocos2d::CCSize, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::extension::CCTableView::insertCellAtIndex)), Default, cocos2d::extension::CCTableView, insertCellAtIndex, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCTableView::reloadData)), Default, cocos2d::extension::CCTableView, reloadData, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::extension::CCTableView::removeCellAtIndex)), Default, cocos2d::extension::CCTableView, removeCellAtIndex, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::extension::CCTableViewVerticalFillOrder>::func(&cocos2d::extension::CCTableView::setVerticalFillOrder)), Default, cocos2d::extension::CCTableView, setVerticalFillOrder, cocos2d::extension::CCTableViewVerticalFillOrder)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCTableView::unregisterAllScriptHandler)), Default, cocos2d::extension::CCTableView, unregisterAllScriptHandler, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::extension::CCTableView::updateCellAtIndex)), Default, cocos2d::extension::CCTableView, updateCellAtIndex, unsigned int)
		}
	};
}
