...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, BrowseSmartKeyLayer> : ModifyBase<ModifyDerive<Der, BrowseSmartKeyLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN19BrowseSmartKeyLayer6createEP15GJSmartTemplateSs")), Default, BrowseSmartKeyLayer, create, GJSmartTemplate*, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCObject*>::func(&BrowseSmartKeyLayer::onBack)), Default, BrowseSmartKeyLayer, onBack, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, bool>::func(&BrowseSmartKeyLayer::addChanceToSelected)), Default, BrowseSmartKeyLayer, addChanceToSelected, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&BrowseSmartKeyLayer::createTemplateObjects)), Default, BrowseSmartKeyLayer, createTemplateObjects, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&BrowseSmartKeyLayer::deletedSelectedItems)), Default, BrowseSmartKeyLayer, deletedSelectedItems, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&BrowseSmartKeyLayer::getAllSelectedBlocks)), Default, BrowseSmartKeyLayer, getAllSelectedBlocks, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN19BrowseSmartKeyLayer4initEP15GJSmartTemplateSs")), Default, BrowseSmartKeyLayer, init, GJSmartTemplate*, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&BrowseSmartKeyLayer::onButton)), Default, BrowseSmartKeyLayer, onButton, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&BrowseSmartKeyLayer::onPrefabObject)), Default, BrowseSmartKeyLayer, onPrefabObject, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&BrowseSmartKeyLayer::updateChanceValues)), Default, BrowseSmartKeyLayer, updateChanceValues, )
		}
	};
}
