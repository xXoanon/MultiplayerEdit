...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCNotificationCenter> : ModifyBase<ModifyDerive<Der, cocos2d::CCNotificationCenter>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCNotificationCenterC2Ev")), Default, cocos2d::CCNotificationCenter, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCNotificationCenterD2Ev")), Default, cocos2d::CCNotificationCenter)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, cocos2d::SEL_CallFuncO, char const*, cocos2d::CCObject*>::func(&cocos2d::CCNotificationCenter::addObserver)), Default, cocos2d::CCNotificationCenter, addObserver, cocos2d::CCObject*, cocos2d::SEL_CallFuncO, char const*, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCNotificationCenter::getObserverHandlerByName)), Default, cocos2d::CCNotificationCenter, getObserverHandlerByName, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, char const*>::func(&cocos2d::CCNotificationCenter::observerExisted)), Default, cocos2d::CCNotificationCenter, observerExisted, cocos2d::CCObject*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCNotificationCenter::postNotification)), Default, cocos2d::CCNotificationCenter, postNotification, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, cocos2d::CCObject*>::func(&cocos2d::CCNotificationCenter::postNotification)), Default, cocos2d::CCNotificationCenter, postNotification, char const*, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, int, char const*>::func(&cocos2d::CCNotificationCenter::registerScriptObserver)), Default, cocos2d::CCNotificationCenter, registerScriptObserver, cocos2d::CCObject*, int, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCNotificationCenter::removeAllObservers)), Default, cocos2d::CCNotificationCenter, removeAllObservers, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, char const*>::func(&cocos2d::CCNotificationCenter::removeObserver)), Default, cocos2d::CCNotificationCenter, removeObserver, cocos2d::CCObject*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, char const*>::func(&cocos2d::CCNotificationCenter::unregisterScriptObserver)), Default, cocos2d::CCNotificationCenter, unregisterScriptObserver, cocos2d::CCObject*, char const*)
		}
	};
}
