...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTimer> : ModifyBase<ModifyDerive<Der, cocos2d::CCTimer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d7CCTimerC2Ev")), Default, cocos2d::CCTimer, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCTimer::update)), Default, cocos2d::CCTimer, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTimer::getInterval)), Default, cocos2d::CCTimer, getInterval, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTimer::getSelector)), Default, cocos2d::CCTimer, getSelector, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, float>::func(&cocos2d::CCTimer::initWithScriptHandler)), Default, cocos2d::CCTimer, initWithScriptHandler, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, cocos2d::SEL_SCHEDULE>::func(&cocos2d::CCTimer::initWithTarget)), Default, cocos2d::CCTimer, initWithTarget, cocos2d::CCObject*, cocos2d::SEL_SCHEDULE)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, cocos2d::SEL_SCHEDULE, float, unsigned int, float>::func(&cocos2d::CCTimer::initWithTarget)), Default, cocos2d::CCTimer, initWithTarget, cocos2d::CCObject*, cocos2d::SEL_SCHEDULE, float, unsigned int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCTimer::setInterval)), Default, cocos2d::CCTimer, setInterval, float)
		}
	};
}
