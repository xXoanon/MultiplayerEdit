...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCKeyboardHandler> : ModifyBase<ModifyDerive<Der, cocos2d::CCKeyboardHandler>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d17CCKeyboardHandlerD2Ev")), Default, cocos2d::CCKeyboardHandler)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCKeyboardDelegate*>::func(&cocos2d::CCKeyboardHandler::initWithDelegate)), Default, cocos2d::CCKeyboardHandler, initWithDelegate, cocos2d::CCKeyboardDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCKeyboardHandler::getDelegate)), Default, cocos2d::CCKeyboardHandler, getDelegate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCKeyboardDelegate*>::func(&cocos2d::CCKeyboardHandler::setDelegate)), Default, cocos2d::CCKeyboardHandler, setDelegate, cocos2d::CCKeyboardDelegate*)
		}
	};
}
