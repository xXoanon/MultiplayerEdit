...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCProfilingTimer> : ModifyBase<ModifyDerive<Der, cocos2d::CCProfilingTimer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d16CCProfilingTimerC2Ev")), Default, cocos2d::CCProfilingTimer, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d16CCProfilingTimerD2Ev")), Default, cocos2d::CCProfilingTimer)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCProfilingTimer::description)), Default, cocos2d::CCProfilingTimer, description, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCProfilingTimer::initWithName)), Default, cocos2d::CCProfilingTimer, initWithName, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCProfilingTimer::reset)), Default, cocos2d::CCProfilingTimer, reset, )
		}
	};
}
