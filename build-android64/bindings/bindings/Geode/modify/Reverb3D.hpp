...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FMOD::Reverb3D> : ModifyBase<ModifyDerive<Der, FMOD::Reverb3D>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void**>::func(&FMOD::Reverb3D::getUserData)), Default, FMOD::Reverb3D, getUserData, void**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void*>::func(&FMOD::Reverb3D::setUserData)), Default, FMOD::Reverb3D, setUserData, void*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_REVERB_PROPERTIES*>::func(&FMOD::Reverb3D::getProperties)), Default, FMOD::Reverb3D, getProperties, FMOD_REVERB_PROPERTIES*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_REVERB_PROPERTIES const*>::func(&FMOD::Reverb3D::setProperties)), Default, FMOD::Reverb3D, setProperties, FMOD_REVERB_PROPERTIES const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_VECTOR*, float*, float*>::func(&FMOD::Reverb3D::get3DAttributes)), Default, FMOD::Reverb3D, get3DAttributes, FMOD_VECTOR*, float*, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_VECTOR const*, float, float>::func(&FMOD::Reverb3D::set3DAttributes)), Default, FMOD::Reverb3D, set3DAttributes, FMOD_VECTOR const*, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&FMOD::Reverb3D::release)), Default, FMOD::Reverb3D, release, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool*>::func(&FMOD::Reverb3D::getActive)), Default, FMOD::Reverb3D, getActive, bool*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&FMOD::Reverb3D::setActive)), Default, FMOD::Reverb3D, setActive, bool)
		}
	};
}
