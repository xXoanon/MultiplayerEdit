...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ObjectToolbox> : ModifyBase<ModifyDerive<Der, ObjectToolbox>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&ObjectToolbox::sharedState)), Default, ObjectToolbox, sharedState, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&ObjectToolbox::init)), Default, ObjectToolbox, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&ObjectToolbox::allKeys)), Default, ObjectToolbox, allKeys, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&ObjectToolbox::gridNodeSizeForKey)), Default, ObjectToolbox, gridNodeSizeForKey, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&ObjectToolbox::intKeyToFrame)), Default, ObjectToolbox, intKeyToFrame, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&ObjectToolbox::perspectiveBlockFrame)), Default, ObjectToolbox, perspectiveBlockFrame, int)
		}
	};
}
