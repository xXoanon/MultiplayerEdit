...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::extension::CCScale9Sprite> : ModifyBase<ModifyDerive<Der, cocos2d::extension::CCScale9Sprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension14CCScale9SpriteC2Ev")), Default, cocos2d::extension::CCScale9Sprite, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension14CCScale9SpriteD2Ev")), Default, cocos2d::extension::CCScale9Sprite)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCScale9Sprite::init)), Default, cocos2d::extension::CCScale9Sprite, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const cocos2d::CCSize&>::func(&cocos2d::extension::CCScale9Sprite::setContentSize)), Default, cocos2d::extension::CCScale9Sprite, setContentSize, const cocos2d::CCSize&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCScale9Sprite::visit)), Default, cocos2d::extension::CCScale9Sprite, visit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCScale9Sprite::getOpacity)), Default, cocos2d::extension::CCScale9Sprite, getOpacity, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned char>::func(&cocos2d::extension::CCScale9Sprite::setOpacity)), Default, cocos2d::extension::CCScale9Sprite, setOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned char>::func(&cocos2d::extension::CCScale9Sprite::updateDisplayedOpacity)), Default, cocos2d::extension::CCScale9Sprite, updateDisplayedOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCScale9Sprite::getColor)), Default, cocos2d::extension::CCScale9Sprite, getColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const cocos2d::ccColor3B&>::func(&cocos2d::extension::CCScale9Sprite::setColor)), Default, cocos2d::extension::CCScale9Sprite, setColor, const cocos2d::ccColor3B&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const cocos2d::ccColor3B&>::func(&cocos2d::extension::CCScale9Sprite::updateDisplayedColor)), Default, cocos2d::extension::CCScale9Sprite, updateDisplayedColor, const cocos2d::ccColor3B&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::extension::CCScale9Sprite::setOpacityModifyRGB)), Default, cocos2d::extension::CCScale9Sprite, setOpacityModifyRGB, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCScale9Sprite::isOpacityModifyRGB)), Default, cocos2d::extension::CCScale9Sprite, isOpacityModifyRGB, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCScale9Sprite::getPreferredSize)), Default, cocos2d::extension::CCScale9Sprite, getPreferredSize, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSize>::func(&cocos2d::extension::CCScale9Sprite::setPreferredSize)), Default, cocos2d::extension::CCScale9Sprite, setPreferredSize, cocos2d::CCSize)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCScale9Sprite::getCapInsets)), Default, cocos2d::extension::CCScale9Sprite, getCapInsets, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCRect>::func(&cocos2d::extension::CCScale9Sprite::setCapInsets)), Default, cocos2d::extension::CCScale9Sprite, setCapInsets, cocos2d::CCRect)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCScale9Sprite::getInsetLeft)), Default, cocos2d::extension::CCScale9Sprite, getInsetLeft, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::extension::CCScale9Sprite::setInsetLeft)), Default, cocos2d::extension::CCScale9Sprite, setInsetLeft, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCScale9Sprite::getInsetTop)), Default, cocos2d::extension::CCScale9Sprite, getInsetTop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::extension::CCScale9Sprite::setInsetTop)), Default, cocos2d::extension::CCScale9Sprite, setInsetTop, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCScale9Sprite::getInsetRight)), Default, cocos2d::extension::CCScale9Sprite, getInsetRight, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::extension::CCScale9Sprite::setInsetRight)), Default, cocos2d::extension::CCScale9Sprite, setInsetRight, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCScale9Sprite::getInsetBottom)), Default, cocos2d::extension::CCScale9Sprite, getInsetBottom, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::extension::CCScale9Sprite::setInsetBottom)), Default, cocos2d::extension::CCScale9Sprite, setInsetBottom, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSpriteBatchNode*, cocos2d::CCRect, bool, cocos2d::CCRect>::func(&cocos2d::extension::CCScale9Sprite::initWithBatchNode)), Default, cocos2d::extension::CCScale9Sprite, initWithBatchNode, cocos2d::CCSpriteBatchNode*, cocos2d::CCRect, bool, cocos2d::CCRect)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSpriteBatchNode*, cocos2d::CCRect, cocos2d::CCRect>::func(&cocos2d::extension::CCScale9Sprite::initWithBatchNode)), Default, cocos2d::extension::CCScale9Sprite, initWithBatchNode, cocos2d::CCSpriteBatchNode*, cocos2d::CCRect, cocos2d::CCRect)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const char*, cocos2d::CCRect, cocos2d::CCRect>::func(&cocos2d::extension::CCScale9Sprite::initWithFile)), Default, cocos2d::extension::CCScale9Sprite, initWithFile, const char*, cocos2d::CCRect, cocos2d::CCRect)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const char*, cocos2d::CCRect>::func(&cocos2d::extension::CCScale9Sprite::initWithFile)), Default, cocos2d::extension::CCScale9Sprite, initWithFile, const char*, cocos2d::CCRect)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCRect, const char*>::func(&cocos2d::extension::CCScale9Sprite::initWithFile)), Default, cocos2d::extension::CCScale9Sprite, initWithFile, cocos2d::CCRect, const char*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const char*>::func(&cocos2d::extension::CCScale9Sprite::initWithFile)), Default, cocos2d::extension::CCScale9Sprite, initWithFile, const char*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSpriteFrame*, cocos2d::CCRect>::func(&cocos2d::extension::CCScale9Sprite::initWithSpriteFrame)), Default, cocos2d::extension::CCScale9Sprite, initWithSpriteFrame, cocos2d::CCSpriteFrame*, cocos2d::CCRect)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSpriteFrame*>::func(&cocos2d::extension::CCScale9Sprite::initWithSpriteFrame)), Default, cocos2d::extension::CCScale9Sprite, initWithSpriteFrame, cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const char*, cocos2d::CCRect>::func(&cocos2d::extension::CCScale9Sprite::initWithSpriteFrameName)), Default, cocos2d::extension::CCScale9Sprite, initWithSpriteFrameName, const char*, cocos2d::CCRect)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const char*>::func(&cocos2d::extension::CCScale9Sprite::initWithSpriteFrameName)), Default, cocos2d::extension::CCScale9Sprite, initWithSpriteFrameName, const char*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSpriteBatchNode*, cocos2d::CCRect, bool, cocos2d::CCRect>::func(&cocos2d::extension::CCScale9Sprite::updateWithBatchNode)), Default, cocos2d::extension::CCScale9Sprite, updateWithBatchNode, cocos2d::CCSpriteBatchNode*, cocos2d::CCRect, bool, cocos2d::CCRect)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSpriteFrame*>::func(&cocos2d::extension::CCScale9Sprite::setSpriteFrame)), Default, cocos2d::extension::CCScale9Sprite, setSpriteFrame, cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCRect>::func(&cocos2d::extension::CCScale9Sprite::resizableSpriteWithCapInsets)), Default, cocos2d::extension::CCScale9Sprite, resizableSpriteWithCapInsets, cocos2d::CCRect)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::extension::CCScale9Sprite::setBlendAdditive)), Default, cocos2d::extension::CCScale9Sprite, setBlendAdditive, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCScale9Sprite::updateCapInset)), Default, cocos2d::extension::CCScale9Sprite, updateCapInset, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCScale9Sprite::updatePositions)), Default, cocos2d::extension::CCScale9Sprite, updatePositions, )
		}
	};
}
