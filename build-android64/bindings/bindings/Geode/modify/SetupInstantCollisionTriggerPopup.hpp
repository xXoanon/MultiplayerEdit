...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupInstantCollisionTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupInstantCollisionTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<EffectGameObject*, cocos2d::CCArray*>::func(&SetupInstantCollisionTriggerPopup::create)), Default, SetupInstantCollisionTriggerPopup, create, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&SetupInstantCollisionTriggerPopup::updateDefaultTriggerValues)), Default, SetupInstantCollisionTriggerPopup, updateDefaultTriggerValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int, float>::func(&SetupInstantCollisionTriggerPopup::valueDidChange)), Default, SetupInstantCollisionTriggerPopup, valueDidChange, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<EffectGameObject*, cocos2d::CCArray*>::func(&SetupInstantCollisionTriggerPopup::init)), Default, SetupInstantCollisionTriggerPopup, init, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupInstantCollisionTriggerPopup::updateSpecialNodes)), Default, SetupInstantCollisionTriggerPopup, updateSpecialNodes, )
		}
	};
}
