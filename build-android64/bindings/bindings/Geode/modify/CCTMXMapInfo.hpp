...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTMXMapInfo> : ModifyBase<ModifyDerive<Der, cocos2d::CCTMXMapInfo>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCTMXMapInfoC2Ev")), Default, cocos2d::CCTMXMapInfo, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d12CCTMXMapInfoD2Ev")), Default, cocos2d::CCTMXMapInfo)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTMXMapInfo::getLayers)), Default, cocos2d::CCTMXMapInfo, getLayers, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCArray*>::func(&cocos2d::CCTMXMapInfo::setLayers)), Default, cocos2d::CCTMXMapInfo, setLayers, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTMXMapInfo::getTilesets)), Default, cocos2d::CCTMXMapInfo, getTilesets, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCArray*>::func(&cocos2d::CCTMXMapInfo::setTilesets)), Default, cocos2d::CCTMXMapInfo, setTilesets, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTMXMapInfo::getObjectGroups)), Default, cocos2d::CCTMXMapInfo, getObjectGroups, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCArray*>::func(&cocos2d::CCTMXMapInfo::setObjectGroups)), Default, cocos2d::CCTMXMapInfo, setObjectGroups, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTMXMapInfo::getProperties)), Default, cocos2d::CCTMXMapInfo, getProperties, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCDictionary*>::func(&cocos2d::CCTMXMapInfo::setProperties)), Default, cocos2d::CCTMXMapInfo, setProperties, cocos2d::CCDictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<void*, char const*, char const**>::func(&cocos2d::CCTMXMapInfo::startElement)), Default, cocos2d::CCTMXMapInfo, startElement, void*, char const*, char const**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<void*, char const*>::func(&cocos2d::CCTMXMapInfo::endElement)), Default, cocos2d::CCTMXMapInfo, endElement, void*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<void*, char const*, int>::func(&cocos2d::CCTMXMapInfo::textHandler)), Default, cocos2d::CCTMXMapInfo, textHandler, void*, char const*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTMXMapInfo::getTileProperties)), Default, cocos2d::CCTMXMapInfo, getTileProperties, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCTMXMapInfo::initWithTMXFile)), Default, cocos2d::CCTMXMapInfo, initWithTMXFile, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, char const*>::func(&cocos2d::CCTMXMapInfo::initWithXML)), Default, cocos2d::CCTMXMapInfo, initWithXML, char const*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, char const*>::func(&cocos2d::CCTMXMapInfo::internalInit)), Default, cocos2d::CCTMXMapInfo, internalInit, char const*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCTMXMapInfo::parseXMLFile)), Default, cocos2d::CCTMXMapInfo, parseXMLFile, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCTMXMapInfo::parseXMLString)), Default, cocos2d::CCTMXMapInfo, parseXMLString, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCDictionary*>::func(&cocos2d::CCTMXMapInfo::setTileProperties)), Default, cocos2d::CCTMXMapInfo, setTileProperties, cocos2d::CCDictionary*)
		}
	};
}
