...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCAnimate> : ModifyBase<ModifyDerive<Der, cocos2d::CCAnimate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9CCAnimateC2Ev")), Default, cocos2d::CCAnimate, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9CCAnimateD2Ev")), Default, cocos2d::CCAnimate)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCAnimate::copyWithZone)), Default, cocos2d::CCAnimate, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCAnimate::update)), Default, cocos2d::CCAnimate, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCAnimate::startWithTarget)), Default, cocos2d::CCAnimate, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCAnimate::stop)), Default, cocos2d::CCAnimate, stop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCAnimate::reverse)), Default, cocos2d::CCAnimate, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCAnimation*>::func(&cocos2d::CCAnimate::initWithAnimation)), Default, cocos2d::CCAnimate, initWithAnimation, cocos2d::CCAnimation*)
		}
	};
}
