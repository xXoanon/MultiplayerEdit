...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::extension::CCInvocation> : ModifyBase<ModifyDerive<Der, cocos2d::extension::CCInvocation>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension12CCInvocationC2EPNS_8CCObjectENS_9extension20SEL_CCControlHandlerENS2_14CCControlEventE")), Default, cocos2d::extension::CCInvocation, cocos2d::CCObject*, cocos2d::extension::SEL_CCControlHandler, cocos2d::extension::CCControlEvent)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::extension::CCInvocation::invoke)), Default, cocos2d::extension::CCInvocation, invoke, cocos2d::CCObject*)
		}
	};
}
