...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCStandardTouchHandler> : ModifyBase<ModifyDerive<Der, cocos2d::CCStandardTouchHandler>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouchDelegate*, int>::func(&cocos2d::CCStandardTouchHandler::initWithDelegate)), Default, cocos2d::CCStandardTouchHandler, initWithDelegate, cocos2d::CCTouchDelegate*, int)
		}
	};
}
