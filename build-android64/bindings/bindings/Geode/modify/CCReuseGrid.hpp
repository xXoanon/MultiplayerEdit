...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCReuseGrid> : ModifyBase<ModifyDerive<Der, cocos2d::CCReuseGrid>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCReuseGrid::startWithTarget)), Default, cocos2d::CCReuseGrid, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&cocos2d::CCReuseGrid::initWithTimes)), Default, cocos2d::CCReuseGrid, initWithTimes, int)
		}
	};
}
