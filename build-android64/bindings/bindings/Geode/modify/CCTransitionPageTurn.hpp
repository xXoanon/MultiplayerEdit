...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionPageTurn> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionPageTurn>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCTransitionPageTurnC2Ev")), Default, cocos2d::CCTransitionPageTurn, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCTransitionPageTurnD2Ev")), Default, cocos2d::CCTransitionPageTurn)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float, cocos2d::CCScene*, bool>::func(&cocos2d::CCTransitionPageTurn::initWithDuration)), Default, cocos2d::CCTransitionPageTurn, initWithDuration, float, cocos2d::CCScene*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionPageTurn::onEnter)), Default, cocos2d::CCTransitionPageTurn, onEnter, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionPageTurn::sceneOrder)), Default, cocos2d::CCTransitionPageTurn, sceneOrder, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSize const&>::func(&cocos2d::CCTransitionPageTurn::actionWithSize)), Default, cocos2d::CCTransitionPageTurn, actionWithSize, cocos2d::CCSize const&)
		}
	};
}
