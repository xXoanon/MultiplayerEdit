...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJMapObject> : ModifyBase<ModifyDerive<Der, GJMapObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCNode*>::func(&GJMapObject::create)), Default, GJMapObject, create, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJMapObject::createMonster)), Default, GJMapObject, createMonster, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCNode*>::func(&GJMapObject::init)), Default, GJMapObject, init, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJMapObject::monsterIdle)), Default, GJMapObject, monsterIdle, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJMapObject::monsterJump)), Default, GJMapObject, monsterJump, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJMapObject::moveFinished)), Default, GJMapObject, moveFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJMapObject::moveMonster)), Default, GJMapObject, moveMonster, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint, float>::func(&GJMapObject::moveMonster)), Default, GJMapObject, moveMonster, cocos2d::CCPoint, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJMapObject::playerJump)), Default, GJMapObject, playerJump, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint, float>::func(&GJMapObject::setObjectOrigin)), Default, GJMapObject, setObjectOrigin, cocos2d::CCPoint, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJMapObject::startMonsterJumpLoop)), Default, GJMapObject, startMonsterJumpLoop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJMapObject::startPlayerJumpLoop)), Default, GJMapObject, startPlayerJumpLoop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJMapObject::touchMonster)), Default, GJMapObject, touchMonster, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, cocos2d::CCPoint>::func(&GJMapObject::updateShadow)), Default, GJMapObject, updateShadow, float, float, cocos2d::CCPoint)
		}
	};
}
