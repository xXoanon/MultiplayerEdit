...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCScheduler> : ModifyBase<ModifyDerive<Der, cocos2d::CCScheduler>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCSchedulerC2Ev")), Default, cocos2d::CCScheduler, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCSchedulerD2Ev")), Default, cocos2d::CCScheduler)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCScheduler::update)), Default, cocos2d::CCScheduler, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::_listEntry**, cocos2d::CCObject*, bool>::func(&cocos2d::CCScheduler::appendIn)), Default, cocos2d::CCScheduler, appendIn, cocos2d::_listEntry**, cocos2d::CCObject*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCScheduler::isTargetPaused)), Default, cocos2d::CCScheduler, isTargetPaused, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCScheduler::pauseAllTargets)), Default, cocos2d::CCScheduler, pauseAllTargets, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&cocos2d::CCScheduler::pauseAllTargetsWithMinPriority)), Default, cocos2d::CCScheduler, pauseAllTargetsWithMinPriority, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCScheduler::pauseTarget)), Default, cocos2d::CCScheduler, pauseTarget, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::_listEntry**, cocos2d::CCObject*, int, bool>::func(&cocos2d::CCScheduler::priorityIn)), Default, cocos2d::CCScheduler, priorityIn, cocos2d::_listEntry**, cocos2d::CCObject*, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::_hashSelectorEntry*>::func(&cocos2d::CCScheduler::removeHashElement)), Default, cocos2d::CCScheduler, removeHashElement, cocos2d::_hashSelectorEntry*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::_listEntry*>::func(&cocos2d::CCScheduler::removeUpdateFromHash)), Default, cocos2d::CCScheduler, removeUpdateFromHash, cocos2d::_listEntry*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCScheduler::resumeTarget)), Default, cocos2d::CCScheduler, resumeTarget, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSet*>::func(&cocos2d::CCScheduler::resumeTargets)), Default, cocos2d::CCScheduler, resumeTargets, cocos2d::CCSet*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, float, bool>::func(&cocos2d::CCScheduler::scheduleScriptFunc)), Default, cocos2d::CCScheduler, scheduleScriptFunc, unsigned int, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::SEL_SCHEDULE, cocos2d::CCObject*, float, bool>::func(&cocos2d::CCScheduler::scheduleSelector)), Default, cocos2d::CCScheduler, scheduleSelector, cocos2d::SEL_SCHEDULE, cocos2d::CCObject*, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::SEL_SCHEDULE, cocos2d::CCObject*, float, unsigned int, float, bool>::func(&cocos2d::CCScheduler::scheduleSelector)), Default, cocos2d::CCScheduler, scheduleSelector, cocos2d::SEL_SCHEDULE, cocos2d::CCObject*, float, unsigned int, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, int, bool>::func(&cocos2d::CCScheduler::scheduleUpdateForTarget)), Default, cocos2d::CCScheduler, scheduleUpdateForTarget, cocos2d::CCObject*, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCScheduler::unscheduleAll)), Default, cocos2d::CCScheduler, unscheduleAll, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCScheduler::unscheduleAllForTarget)), Default, cocos2d::CCScheduler, unscheduleAllForTarget, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&cocos2d::CCScheduler::unscheduleAllWithMinPriority)), Default, cocos2d::CCScheduler, unscheduleAllWithMinPriority, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCScheduler::unscheduleScriptEntry)), Default, cocos2d::CCScheduler, unscheduleScriptEntry, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::SEL_SCHEDULE, cocos2d::CCObject*>::func(&cocos2d::CCScheduler::unscheduleSelector)), Default, cocos2d::CCScheduler, unscheduleSelector, cocos2d::SEL_SCHEDULE, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject const*>::func(&cocos2d::CCScheduler::unscheduleUpdateForTarget)), Default, cocos2d::CCScheduler, unscheduleUpdateForTarget, cocos2d::CCObject const*)
		}
	};
}
