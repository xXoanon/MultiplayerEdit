...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::extension::CCEditBox> : ModifyBase<ModifyDerive<Der, cocos2d::extension::CCEditBox>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension9CCEditBoxC2Ev")), Default, cocos2d::extension::CCEditBox, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension9CCEditBoxD2Ev")), Default, cocos2d::extension::CCEditBox)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::extension::CCEditBox::setPosition)), Default, cocos2d::extension::CCEditBox, setPosition, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::extension::CCEditBox::setVisible)), Default, cocos2d::extension::CCEditBox, setVisible, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSize const&>::func(&cocos2d::extension::CCEditBox::setContentSize)), Default, cocos2d::extension::CCEditBox, setContentSize, cocos2d::CCSize const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::extension::CCEditBox::setAnchorPoint)), Default, cocos2d::extension::CCEditBox, setAnchorPoint, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCEditBox::visit)), Default, cocos2d::extension::CCEditBox, visit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCEditBox::onEnter)), Default, cocos2d::extension::CCEditBox, onEnter, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCEditBox::onExit)), Default, cocos2d::extension::CCEditBox, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCIMEKeyboardNotificationInfo&>::func(&cocos2d::extension::CCEditBox::keyboardWillShow)), Default, cocos2d::extension::CCEditBox, keyboardWillShow, cocos2d::CCIMEKeyboardNotificationInfo&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCIMEKeyboardNotificationInfo&>::func(&cocos2d::extension::CCEditBox::keyboardDidShow)), Default, cocos2d::extension::CCEditBox, keyboardDidShow, cocos2d::CCIMEKeyboardNotificationInfo&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCIMEKeyboardNotificationInfo&>::func(&cocos2d::extension::CCEditBox::keyboardWillHide)), Default, cocos2d::extension::CCEditBox, keyboardWillHide, cocos2d::CCIMEKeyboardNotificationInfo&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCIMEKeyboardNotificationInfo&>::func(&cocos2d::extension::CCEditBox::keyboardDidHide)), Default, cocos2d::extension::CCEditBox, keyboardDidHide, cocos2d::CCIMEKeyboardNotificationInfo&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCEditBox::getDelegate)), Default, cocos2d::extension::CCEditBox, getDelegate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCEditBox::getMaxLength)), Default, cocos2d::extension::CCEditBox, getMaxLength, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCEditBox::getPlaceHolder)), Default, cocos2d::extension::CCEditBox, getPlaceHolder, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCEditBox::getText)), Default, cocos2d::extension::CCEditBox, getText, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSize const&, cocos2d::extension::CCScale9Sprite*>::func(&cocos2d::extension::CCEditBox::initWithSizeAndBackgroundSprite)), Default, cocos2d::extension::CCEditBox, initWithSizeAndBackgroundSprite, cocos2d::CCSize const&, cocos2d::extension::CCScale9Sprite*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&cocos2d::extension::CCEditBox::registerScriptEditBoxHandler)), Default, cocos2d::extension::CCEditBox, registerScriptEditBoxHandler, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::extension::CCEditBoxDelegate*>::func(&cocos2d::extension::CCEditBox::setDelegate)), Default, cocos2d::extension::CCEditBox, setDelegate, cocos2d::extension::CCEditBoxDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, int>::func(&cocos2d::extension::CCEditBox::setFont)), Default, cocos2d::extension::CCEditBox, setFont, char const*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::ccColor3B const&>::func(&cocos2d::extension::CCEditBox::setFontColor)), Default, cocos2d::extension::CCEditBox, setFontColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::extension::CCEditBox::setFontName)), Default, cocos2d::extension::CCEditBox, setFontName, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&cocos2d::extension::CCEditBox::setFontSize)), Default, cocos2d::extension::CCEditBox, setFontSize, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::extension::EditBoxInputFlag>::func(&cocos2d::extension::CCEditBox::setInputFlag)), Default, cocos2d::extension::CCEditBox, setInputFlag, cocos2d::extension::EditBoxInputFlag)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::extension::EditBoxInputMode>::func(&cocos2d::extension::CCEditBox::setInputMode)), Default, cocos2d::extension::CCEditBox, setInputMode, cocos2d::extension::EditBoxInputMode)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&cocos2d::extension::CCEditBox::setMaxLength)), Default, cocos2d::extension::CCEditBox, setMaxLength, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::extension::CCEditBox::setPlaceHolder)), Default, cocos2d::extension::CCEditBox, setPlaceHolder, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, int>::func(&cocos2d::extension::CCEditBox::setPlaceholderFont)), Default, cocos2d::extension::CCEditBox, setPlaceholderFont, char const*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::ccColor3B const&>::func(&cocos2d::extension::CCEditBox::setPlaceholderFontColor)), Default, cocos2d::extension::CCEditBox, setPlaceholderFontColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::extension::CCEditBox::setPlaceholderFontName)), Default, cocos2d::extension::CCEditBox, setPlaceholderFontName, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&cocos2d::extension::CCEditBox::setPlaceholderFontSize)), Default, cocos2d::extension::CCEditBox, setPlaceholderFontSize, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::extension::KeyboardReturnType>::func(&cocos2d::extension::CCEditBox::setReturnType)), Default, cocos2d::extension::CCEditBox, setReturnType, cocos2d::extension::KeyboardReturnType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::extension::CCEditBox::setText)), Default, cocos2d::extension::CCEditBox, setText, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, cocos2d::extension::CCControlEvent>::func(&cocos2d::extension::CCEditBox::touchDownAction)), Default, cocos2d::extension::CCEditBox, touchDownAction, cocos2d::CCObject*, cocos2d::extension::CCControlEvent)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCEditBox::unregisterScriptEditBoxHandler)), Default, cocos2d::extension::CCEditBox, unregisterScriptEditBoxHandler, )
		}
	};
}
