...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCLabelAtlas> : ModifyBase<ModifyDerive<Der, cocos2d::CCLabelAtlas>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLabelAtlas::updateAtlasValues)), Default, cocos2d::CCLabelAtlas, updateAtlasValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<char const*>::func(&cocos2d::CCLabelAtlas::setString)), Default, cocos2d::CCLabelAtlas, setString, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLabelAtlas::getString)), Default, cocos2d::CCLabelAtlas, getString, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, char const*>::func(&cocos2d::CCLabelAtlas::initWithString)), Default, cocos2d::CCLabelAtlas, initWithString, char const*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, char const*, unsigned int, unsigned int, unsigned int>::func(&cocos2d::CCLabelAtlas::initWithString)), Default, cocos2d::CCLabelAtlas, initWithString, char const*, char const*, unsigned int, unsigned int, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, cocos2d::CCTexture2D*, unsigned int, unsigned int, unsigned int>::func(&cocos2d::CCLabelAtlas::initWithString)), Default, cocos2d::CCLabelAtlas, initWithString, char const*, cocos2d::CCTexture2D*, unsigned int, unsigned int, unsigned int)
		}
	};
}
