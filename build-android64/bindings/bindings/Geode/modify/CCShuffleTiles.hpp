...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCShuffleTiles> : ModifyBase<ModifyDerive<Der, cocos2d::CCShuffleTiles>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d14CCShuffleTilesD2Ev")), Default, cocos2d::CCShuffleTiles)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float, cocos2d::CCSize const&, unsigned int>::func(&cocos2d::CCShuffleTiles::initWithDuration)), Default, cocos2d::CCShuffleTiles, initWithDuration, float, cocos2d::CCSize const&, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCShuffleTiles::startWithTarget)), Default, cocos2d::CCShuffleTiles, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCShuffleTiles::update)), Default, cocos2d::CCShuffleTiles, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCShuffleTiles::copyWithZone)), Default, cocos2d::CCShuffleTiles, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSize const&>::func(&cocos2d::CCShuffleTiles::getDelta)), Default, cocos2d::CCShuffleTiles, getDelta, cocos2d::CCSize const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&, cocos2d::Tile*>::func(&cocos2d::CCShuffleTiles::placeTile)), Default, cocos2d::CCShuffleTiles, placeTile, cocos2d::CCPoint const&, cocos2d::Tile*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int*, unsigned int>::func(&cocos2d::CCShuffleTiles::shuffle)), Default, cocos2d::CCShuffleTiles, shuffle, unsigned int*, unsigned int)
		}
	};
}
