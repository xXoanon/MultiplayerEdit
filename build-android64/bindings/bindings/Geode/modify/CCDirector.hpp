...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCDirector> : ModifyBase<ModifyDerive<Der, cocos2d::CCDirector>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d10CCDirectorC2Ev")), Default, cocos2d::CCDirector, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d10CCDirectorD2Ev")), Default, cocos2d::CCDirector)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCDirector::init)), Default, cocos2d::CCDirector, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCDirector::getScheduler)), Default, cocos2d::CCDirector, getScheduler, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCScheduler*>::func(&cocos2d::CCDirector::setScheduler)), Default, cocos2d::CCDirector, setScheduler, cocos2d::CCScheduler*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCDirector::getActionManager)), Default, cocos2d::CCDirector, getActionManager, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCActionManager*>::func(&cocos2d::CCDirector::setActionManager)), Default, cocos2d::CCDirector, setActionManager, cocos2d::CCActionManager*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCDirector::getTouchDispatcher)), Default, cocos2d::CCDirector, getTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouchDispatcher*>::func(&cocos2d::CCDirector::setTouchDispatcher)), Default, cocos2d::CCDirector, setTouchDispatcher, cocos2d::CCTouchDispatcher*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCDirector::getKeypadDispatcher)), Default, cocos2d::CCDirector, getKeypadDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCKeypadDispatcher*>::func(&cocos2d::CCDirector::setKeypadDispatcher)), Default, cocos2d::CCDirector, setKeypadDispatcher, cocos2d::CCKeypadDispatcher*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCDirector::getKeyboardDispatcher)), Default, cocos2d::CCDirector, getKeyboardDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCKeyboardDispatcher*>::func(&cocos2d::CCDirector::setKeyboardDispatcher)), Default, cocos2d::CCDirector, setKeyboardDispatcher, cocos2d::CCKeyboardDispatcher*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCDirector::getMouseDispatcher)), Default, cocos2d::CCDirector, getMouseDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCMouseDispatcher*>::func(&cocos2d::CCDirector::setMouseDispatcher)), Default, cocos2d::CCDirector, setMouseDispatcher, cocos2d::CCMouseDispatcher*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCDirector::getAccelerometer)), Default, cocos2d::CCDirector, getAccelerometer, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCAccelerometer*>::func(&cocos2d::CCDirector::setAccelerometer)), Default, cocos2d::CCDirector, setAccelerometer, cocos2d::CCAccelerometer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCDirector::getDeltaTime)), Default, cocos2d::CCDirector, getDeltaTime, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::applySmoothFix)), Default, cocos2d::CCDirector, applySmoothFix, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::calculateDeltaTime)), Default, cocos2d::CCDirector, calculateDeltaTime, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::calculateMPF)), Default, cocos2d::CCDirector, calculateMPF, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::checkSceneReference)), Default, cocos2d::CCDirector, checkSceneReference, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCDirector::convertToGL)), Default, cocos2d::CCDirector, convertToGL, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCDirector::convertToUI)), Default, cocos2d::CCDirector, convertToUI, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::createStatsLabel)), Default, cocos2d::CCDirector, createStatsLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::drawScene)), Default, cocos2d::CCDirector, drawScene, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::end)), Default, cocos2d::CCDirector, end, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getDelegate)), Default, cocos2d::CCDirector, getDelegate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned char**, unsigned int*>::func(&cocos2d::CCDirector::getFPSImageData)), Default, cocos2d::CCDirector, getFPSImageData, unsigned char**, unsigned int*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getNotificationNode)), Default, cocos2d::CCDirector, getNotificationNode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getVisibleOrigin)), Default, cocos2d::CCDirector, getVisibleOrigin, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getVisibleSize)), Default, cocos2d::CCDirector, getVisibleSize, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getWinSize)), Default, cocos2d::CCDirector, getWinSize, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getWinSizeInPixels)), Default, cocos2d::CCDirector, getWinSizeInPixels, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getZEye)), Default, cocos2d::CCDirector, getZEye, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCScene*>::func(&cocos2d::CCDirector::levelForSceneInStack)), Default, cocos2d::CCDirector, levelForSceneInStack, cocos2d::CCScene*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::pause)), Default, cocos2d::CCDirector, pause, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::popScene)), Default, cocos2d::CCDirector, popScene, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, cocos2d::PopTransition>::func(&cocos2d::CCDirector::popSceneWithTransition)), Default, cocos2d::CCDirector, popSceneWithTransition, float, cocos2d::PopTransition)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::popToRootScene)), Default, cocos2d::CCDirector, popToRootScene, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCScene*>::func(&cocos2d::CCDirector::popToSceneInStack)), Default, cocos2d::CCDirector, popToSceneInStack, cocos2d::CCScene*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&cocos2d::CCDirector::popToSceneStackLevel)), Default, cocos2d::CCDirector, popToSceneStackLevel, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::purgeCachedData)), Default, cocos2d::CCDirector, purgeCachedData, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::purgeDirector)), Default, cocos2d::CCDirector, purgeDirector, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCScene*>::func(&cocos2d::CCDirector::pushScene)), Default, cocos2d::CCDirector, pushScene, cocos2d::CCScene*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::removeStatsLabel)), Default, cocos2d::CCDirector, removeStatsLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCScene*>::func(&cocos2d::CCDirector::replaceScene)), Default, cocos2d::CCDirector, replaceScene, cocos2d::CCScene*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::resetSmoothFixCounter)), Default, cocos2d::CCDirector, resetSmoothFixCounter, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSize const&>::func(&cocos2d::CCDirector::reshapeProjection)), Default, cocos2d::CCDirector, reshapeProjection, cocos2d::CCSize const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::resume)), Default, cocos2d::CCDirector, resume, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCScene*>::func(&cocos2d::CCDirector::runWithScene)), Default, cocos2d::CCDirector, runWithScene, cocos2d::CCScene*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::sceneCount)), Default, cocos2d::CCDirector, sceneCount, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCDirector::setAlphaBlending)), Default, cocos2d::CCDirector, setAlphaBlending, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCDirector::setContentScaleFactor)), Default, cocos2d::CCDirector, setContentScaleFactor, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::setDefaultValues)), Default, cocos2d::CCDirector, setDefaultValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCDirectorDelegate*>::func(&cocos2d::CCDirector::setDelegate)), Default, cocos2d::CCDirector, setDelegate, cocos2d::CCDirectorDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCDirector::setDeltaTime)), Default, cocos2d::CCDirector, setDeltaTime, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCDirector::setDepthTest)), Default, cocos2d::CCDirector, setDepthTest, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::setGLDefaultValues)), Default, cocos2d::CCDirector, setGLDefaultValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCDirector::setNextDeltaTimeZero)), Default, cocos2d::CCDirector, setNextDeltaTimeZero, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::setNextScene)), Default, cocos2d::CCDirector, setNextScene, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCEGLView*>::func(&cocos2d::CCDirector::setOpenGLView)), Default, cocos2d::CCDirector, setOpenGLView, cocos2d::CCEGLView*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::ccDirectorProjection>::func(&cocos2d::CCDirector::setProjection)), Default, cocos2d::CCDirector, setProjection, cocos2d::ccDirectorProjection)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSize, cocos2d::CCSize, cocos2d::TextureQuality>::func(&cocos2d::CCDirector::setupScreenScale)), Default, cocos2d::CCDirector, setupScreenScale, cocos2d::CCSize, cocos2d::CCSize, cocos2d::TextureQuality)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::setViewport)), Default, cocos2d::CCDirector, setViewport, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::showFPSLabel)), Default, cocos2d::CCDirector, showFPSLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::showStats)), Default, cocos2d::CCDirector, showStats, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d10CCDirector13toggleShowFPSEbSsNS_7CCPointE")), Default, cocos2d::CCDirector, toggleShowFPS, bool, gd::string, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::TextureQuality>::func(&cocos2d::CCDirector::updateContentScale)), Default, cocos2d::CCDirector, updateContentScale, cocos2d::TextureQuality)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSize>::func(&cocos2d::CCDirector::updateScreenScale)), Default, cocos2d::CCDirector, updateScreenScale, cocos2d::CCSize)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCScene*>::func(&cocos2d::CCDirector::willSwitchToScene)), Default, cocos2d::CCDirector, willSwitchToScene, cocos2d::CCScene*)
		}
	};
}
