...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionFlipAngular> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionFlipAngular>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d23CCTransitionFlipAngularC2Ev")), Default, cocos2d::CCTransitionFlipAngular, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d23CCTransitionFlipAngularD2Ev")), Default, cocos2d::CCTransitionFlipAngular)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionFlipAngular::onEnter)), Default, cocos2d::CCTransitionFlipAngular, onEnter, )
		}
	};
}
