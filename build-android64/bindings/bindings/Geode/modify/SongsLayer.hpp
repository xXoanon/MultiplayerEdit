...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SongsLayer> : ModifyBase<ModifyDerive<Der, SongsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SongsLayer::create)), Default, SongsLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&SongsLayer::customSetup)), Default, SongsLayer, customSetup, )
		}
	};
}
