...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::extension::CCControlSlider> : ModifyBase<ModifyDerive<Der, cocos2d::extension::CCControlSlider>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension15CCControlSliderC2Ev")), Default, cocos2d::extension::CCControlSlider, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension15CCControlSliderD2Ev")), Default, cocos2d::extension::CCControlSlider)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::extension::CCControlSlider::setValue)), Default, cocos2d::extension::CCControlSlider, setValue, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::extension::CCControlSlider::setMinimumValue)), Default, cocos2d::extension::CCControlSlider, setMinimumValue, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::extension::CCControlSlider::setMaximumValue)), Default, cocos2d::extension::CCControlSlider, setMaximumValue, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::extension::CCControlSlider::setEnabled)), Default, cocos2d::extension::CCControlSlider, setEnabled, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*>::func(&cocos2d::extension::CCControlSlider::isTouchInside)), Default, cocos2d::extension::CCControlSlider, isTouchInside, cocos2d::CCTouch*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSprite*, cocos2d::CCSprite*, cocos2d::CCSprite*>::func(&cocos2d::extension::CCControlSlider::initWithSprites)), Default, cocos2d::extension::CCControlSlider, initWithSprites, cocos2d::CCSprite*, cocos2d::CCSprite*, cocos2d::CCSprite*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::extension::CCControlSlider::needsLayout)), Default, cocos2d::extension::CCControlSlider, needsLayout, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*, cocos2d::CCEvent*>::func(&cocos2d::extension::CCControlSlider::ccTouchBegan)), Default, cocos2d::extension::CCControlSlider, ccTouchBegan, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*, cocos2d::CCEvent*>::func(&cocos2d::extension::CCControlSlider::ccTouchMoved)), Default, cocos2d::extension::CCControlSlider, ccTouchMoved, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouch*, cocos2d::CCEvent*>::func(&cocos2d::extension::CCControlSlider::ccTouchEnded)), Default, cocos2d::extension::CCControlSlider, ccTouchEnded, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTouch*>::func(&cocos2d::extension::CCControlSlider::locationFromTouch)), Default, cocos2d::extension::CCControlSlider, locationFromTouch, cocos2d::CCTouch*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint>::func(&cocos2d::extension::CCControlSlider::sliderBegan)), Default, cocos2d::extension::CCControlSlider, sliderBegan, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint>::func(&cocos2d::extension::CCControlSlider::sliderEnded)), Default, cocos2d::extension::CCControlSlider, sliderEnded, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint>::func(&cocos2d::extension::CCControlSlider::sliderMoved)), Default, cocos2d::extension::CCControlSlider, sliderMoved, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint>::func(&cocos2d::extension::CCControlSlider::valueForLocation)), Default, cocos2d::extension::CCControlSlider, valueForLocation, cocos2d::CCPoint)
		}
	};
}
