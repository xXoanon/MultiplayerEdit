...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCScaleTo> : ModifyBase<ModifyDerive<Der, cocos2d::CCScaleTo>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCScaleTo::copyWithZone)), Default, cocos2d::CCScaleTo, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCScaleTo::update)), Default, cocos2d::CCScaleTo, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCScaleTo::startWithTarget)), Default, cocos2d::CCScaleTo, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float>::func(&cocos2d::CCScaleTo::initWithDuration)), Default, cocos2d::CCScaleTo, initWithDuration, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float>::func(&cocos2d::CCScaleTo::initWithDuration)), Default, cocos2d::CCScaleTo, initWithDuration, float, float, float)
		}
	};
}
