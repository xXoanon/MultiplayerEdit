...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSchedulerScriptHandlerEntry> : ModifyBase<ModifyDerive<Der, cocos2d::CCSchedulerScriptHandlerEntry>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d29CCSchedulerScriptHandlerEntryD2Ev")), Default, cocos2d::CCSchedulerScriptHandlerEntry)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, bool>::func(&cocos2d::CCSchedulerScriptHandlerEntry::init)), Default, cocos2d::CCSchedulerScriptHandlerEntry, init, float, bool)
		}
	};
}
