...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCEaseBounce> : ModifyBase<ModifyDerive<Der, cocos2d::CCEaseBounce>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCEaseBounce::copyWithZone)), Default, cocos2d::CCEaseBounce, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCEaseBounce::reverse)), Default, cocos2d::CCEaseBounce, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCEaseBounce::bounceTime)), Default, cocos2d::CCEaseBounce, bounceTime, float)
		}
	};
}
