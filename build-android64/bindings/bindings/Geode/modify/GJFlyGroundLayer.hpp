...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJFlyGroundLayer> : ModifyBase<ModifyDerive<Der, GJFlyGroundLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJFlyGroundLayer::create)), Default, GJFlyGroundLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJFlyGroundLayer::init)), Default, GJFlyGroundLayer, init, )
		}
	};
}
