...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCEaseBackIn> : ModifyBase<ModifyDerive<Der, cocos2d::CCEaseBackIn>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCEaseBackIn::copyWithZone)), Default, cocos2d::CCEaseBackIn, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCEaseBackIn::update)), Default, cocos2d::CCEaseBackIn, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCEaseBackIn::reverse)), Default, cocos2d::CCEaseBackIn, reverse, )
		}
	};
}
