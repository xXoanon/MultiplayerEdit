...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTouchHandler> : ModifyBase<ModifyDerive<Der, cocos2d::CCTouchHandler>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d14CCTouchHandlerD2Ev")), Default, cocos2d::CCTouchHandler)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTouchDelegate*, int>::func(&cocos2d::CCTouchHandler::initWithDelegate)), Default, cocos2d::CCTouchHandler, initWithDelegate, cocos2d::CCTouchDelegate*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTouchHandler::getDelegate)), Default, cocos2d::CCTouchHandler, getDelegate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTouchHandler::getEnabledSelectors)), Default, cocos2d::CCTouchHandler, getEnabledSelectors, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTouchHandler::getPriority)), Default, cocos2d::CCTouchHandler, getPriority, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTouchDelegate*>::func(&cocos2d::CCTouchHandler::setDelegate)), Default, cocos2d::CCTouchHandler, setDelegate, cocos2d::CCTouchDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&cocos2d::CCTouchHandler::setEnalbedSelectors)), Default, cocos2d::CCTouchHandler, setEnalbedSelectors, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&cocos2d::CCTouchHandler::setPriority)), Default, cocos2d::CCTouchHandler, setPriority, int)
		}
	};
}
