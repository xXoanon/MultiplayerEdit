...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCArray> : ModifyBase<ModifyDerive<Der, cocos2d::CCArray>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCArray::addObjectNew)), Default, cocos2d::CCArray, addObjectNew, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCArray::fastRemoveObjectAtIndexChild)), Default, cocos2d::CCArray, fastRemoveObjectAtIndexChild, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCArray::fastRemoveObjectAtIndexNew)), Default, cocos2d::CCArray, fastRemoveObjectAtIndexNew, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCArray::recreateNewIndexes)), Default, cocos2d::CCArray, recreateNewIndexes, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, bool>::func(&cocos2d::CCArray::removeObjectAtIndexChild)), Default, cocos2d::CCArray, removeObjectAtIndexChild, unsigned int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCArray::stringAtIndex)), Default, cocos2d::CCArray, stringAtIndex, unsigned int)
		}
	};
}
