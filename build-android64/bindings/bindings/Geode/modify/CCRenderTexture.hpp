...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCRenderTexture> : ModifyBase<ModifyDerive<Der, cocos2d::CCRenderTexture>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d15CCRenderTextureC2Ev")), Default, cocos2d::CCRenderTexture, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d15CCRenderTextureD2Ev")), Default, cocos2d::CCRenderTexture)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCRenderTexture::draw)), Default, cocos2d::CCRenderTexture, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCRenderTexture::visit)), Default, cocos2d::CCRenderTexture, visit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCRenderTexture::getSprite)), Default, cocos2d::CCRenderTexture, getSprite, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSprite*>::func(&cocos2d::CCRenderTexture::setSprite)), Default, cocos2d::CCRenderTexture, setSprite, cocos2d::CCSprite*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCRenderTexture::begin)), Default, cocos2d::CCRenderTexture, begin, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float, float>::func(&cocos2d::CCRenderTexture::beginWithClear)), Default, cocos2d::CCRenderTexture, beginWithClear, float, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float, float, float>::func(&cocos2d::CCRenderTexture::beginWithClear)), Default, cocos2d::CCRenderTexture, beginWithClear, float, float, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float, float, float, int>::func(&cocos2d::CCRenderTexture::beginWithClear)), Default, cocos2d::CCRenderTexture, beginWithClear, float, float, float, float, float, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float, float, float, int, unsigned int>::func(&cocos2d::CCRenderTexture::beginWithClear)), Default, cocos2d::CCRenderTexture, beginWithClear, float, float, float, float, float, int, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float, float>::func(&cocos2d::CCRenderTexture::clear)), Default, cocos2d::CCRenderTexture, clear, float, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCRenderTexture::clearDepth)), Default, cocos2d::CCRenderTexture, clearDepth, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&cocos2d::CCRenderTexture::clearStencil)), Default, cocos2d::CCRenderTexture, clearStencil, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCRenderTexture::end)), Default, cocos2d::CCRenderTexture, end, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCRenderTexture::getClearColor)), Default, cocos2d::CCRenderTexture, getClearColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCRenderTexture::getClearDepth)), Default, cocos2d::CCRenderTexture, getClearDepth, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCRenderTexture::getClearFlags)), Default, cocos2d::CCRenderTexture, getClearFlags, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCRenderTexture::getClearStencil)), Default, cocos2d::CCRenderTexture, getClearStencil, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int, cocos2d::CCTexture2DPixelFormat>::func(&cocos2d::CCRenderTexture::initWithWidthAndHeight)), Default, cocos2d::CCRenderTexture, initWithWidthAndHeight, int, int, cocos2d::CCTexture2DPixelFormat)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int, cocos2d::CCTexture2DPixelFormat, unsigned int>::func(&cocos2d::CCRenderTexture::initWithWidthAndHeight)), Default, cocos2d::CCRenderTexture, initWithWidthAndHeight, int, int, cocos2d::CCTexture2DPixelFormat, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCRenderTexture::isAutoDraw)), Default, cocos2d::CCRenderTexture, isAutoDraw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCRenderTexture::listenToBackground)), Default, cocos2d::CCRenderTexture, listenToBackground, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCRenderTexture::listenToForeground)), Default, cocos2d::CCRenderTexture, listenToForeground, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCRenderTexture::newCCImage)), Default, cocos2d::CCRenderTexture, newCCImage, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCRenderTexture::saveToFile)), Default, cocos2d::CCRenderTexture, saveToFile, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, cocos2d::eImageFormat>::func(&cocos2d::CCRenderTexture::saveToFile)), Default, cocos2d::CCRenderTexture, saveToFile, char const*, cocos2d::eImageFormat)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCRenderTexture::setAutoDraw)), Default, cocos2d::CCRenderTexture, setAutoDraw, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::ccColor4F const&>::func(&cocos2d::CCRenderTexture::setClearColor)), Default, cocos2d::CCRenderTexture, setClearColor, cocos2d::ccColor4F const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCRenderTexture::setClearDepth)), Default, cocos2d::CCRenderTexture, setClearDepth, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCRenderTexture::setClearFlags)), Default, cocos2d::CCRenderTexture, setClearFlags, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCRenderTexture::setClearStencil)), Default, cocos2d::CCRenderTexture, setClearStencil, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float>::func(&cocos2d::CCRenderTexture::updateInternalScale)), Default, cocos2d::CCRenderTexture, updateInternalScale, float, float)
		}
	};
}
