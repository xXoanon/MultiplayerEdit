...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ObjectDecoder> : ModifyBase<ModifyDerive<Der, ObjectDecoder>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&ObjectDecoder::init)), Default, ObjectDecoder, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, DS_Dictionary*>::func(&ObjectDecoder::getDecodedObject)), Default, ObjectDecoder, getDecodedObject, int, DS_Dictionary*)
		}
	};
}
