...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTMXTiledMap> : ModifyBase<ModifyDerive<Der, cocos2d::CCTMXTiledMap>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d13CCTMXTiledMapC2Ev")), Default, cocos2d::CCTMXTiledMap, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d13CCTMXTiledMapD2Ev")), Default, cocos2d::CCTMXTiledMap)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTMXTiledMap::getObjectGroups)), Default, cocos2d::CCTMXTiledMap, getObjectGroups, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCArray*>::func(&cocos2d::CCTMXTiledMap::setObjectGroups)), Default, cocos2d::CCTMXTiledMap, setObjectGroups, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTMXTiledMap::getProperties)), Default, cocos2d::CCTMXTiledMap, getProperties, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCDictionary*>::func(&cocos2d::CCTMXTiledMap::setProperties)), Default, cocos2d::CCTMXTiledMap, setProperties, cocos2d::CCDictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTMXMapInfo*>::func(&cocos2d::CCTMXTiledMap::buildWithMapInfo)), Default, cocos2d::CCTMXTiledMap, buildWithMapInfo, cocos2d::CCTMXMapInfo*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCTMXTiledMap::initWithTMXFile)), Default, cocos2d::CCTMXTiledMap, initWithTMXFile, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, char const*>::func(&cocos2d::CCTMXTiledMap::initWithXML)), Default, cocos2d::CCTMXTiledMap, initWithXML, char const*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCTMXTiledMap::layerNamed)), Default, cocos2d::CCTMXTiledMap, layerNamed, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCTMXTiledMap::objectGroupNamed)), Default, cocos2d::CCTMXTiledMap, objectGroupNamed, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTMXLayerInfo*, cocos2d::CCTMXMapInfo*>::func(&cocos2d::CCTMXTiledMap::parseLayer)), Default, cocos2d::CCTMXTiledMap, parseLayer, cocos2d::CCTMXLayerInfo*, cocos2d::CCTMXMapInfo*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&cocos2d::CCTMXTiledMap::propertiesForGID)), Default, cocos2d::CCTMXTiledMap, propertiesForGID, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCTMXTiledMap::propertyNamed)), Default, cocos2d::CCTMXTiledMap, propertyNamed, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTMXLayerInfo*, cocos2d::CCTMXMapInfo*>::func(&cocos2d::CCTMXTiledMap::tilesetForLayer)), Default, cocos2d::CCTMXTiledMap, tilesetForLayer, cocos2d::CCTMXLayerInfo*, cocos2d::CCTMXMapInfo*)
		}
	};
}
