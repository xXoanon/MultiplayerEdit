...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionFadeBL> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionFadeBL>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d18CCTransitionFadeBLC2Ev")), Default, cocos2d::CCTransitionFadeBL, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d18CCTransitionFadeBLD2Ev")), Default, cocos2d::CCTransitionFadeBL)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSize const&>::func(&cocos2d::CCTransitionFadeBL::actionWithSize)), Default, cocos2d::CCTransitionFadeBL, actionWithSize, cocos2d::CCSize const&)
		}
	};
}
