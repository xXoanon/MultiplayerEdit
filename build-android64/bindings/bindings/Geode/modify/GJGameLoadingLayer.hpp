...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJGameLoadingLayer> : ModifyBase<ModifyDerive<Der, GJGameLoadingLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<GJGameLevel*, bool>::func(&GJGameLoadingLayer::create)), Default, GJGameLoadingLayer, create, GJGameLevel*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<GJGameLevel*, bool>::func(&GJGameLoadingLayer::transitionToLoadingLayer)), Default, GJGameLoadingLayer, transitionToLoadingLayer, GJGameLevel*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJGameLoadingLayer::onEnter)), Default, GJGameLoadingLayer, onEnter, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJGameLoadingLayer::onEnterTransitionDidFinish)), Default, GJGameLoadingLayer, onEnterTransitionDidFinish, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJGameLoadingLayer::gameLayerDidUnload)), Default, GJGameLoadingLayer, gameLayerDidUnload, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<GJGameLevel*, bool>::func(&GJGameLoadingLayer::init)), Default, GJGameLoadingLayer, init, GJGameLevel*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJGameLoadingLayer::loadLevel)), Default, GJGameLoadingLayer, loadLevel, )
		}
	};
}
