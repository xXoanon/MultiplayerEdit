...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCFadeOutBLTiles> : ModifyBase<ModifyDerive<Der, cocos2d::CCFadeOutBLTiles>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSize const&, float>::func(&cocos2d::CCFadeOutBLTiles::testFunc)), Default, cocos2d::CCFadeOutBLTiles, testFunc, cocos2d::CCSize const&, float)
		}
	};
}
