...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTileMapAtlas> : ModifyBase<ModifyDerive<Der, cocos2d::CCTileMapAtlas>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d14CCTileMapAtlasC2Ev")), Default, cocos2d::CCTileMapAtlas, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d14CCTileMapAtlasD2Ev")), Default, cocos2d::CCTileMapAtlas)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTileMapAtlas::getTGAInfo)), Default, cocos2d::CCTileMapAtlas, getTGAInfo, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::sImageTGA*>::func(&cocos2d::CCTileMapAtlas::setTGAInfo)), Default, cocos2d::CCTileMapAtlas, setTGAInfo, cocos2d::sImageTGA*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTileMapAtlas::updateAtlasValues)), Default, cocos2d::CCTileMapAtlas, updateAtlasValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTileMapAtlas::calculateItemsToRender)), Default, cocos2d::CCTileMapAtlas, calculateItemsToRender, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, char const*, int, int>::func(&cocos2d::CCTileMapAtlas::initWithTileFile)), Default, cocos2d::CCTileMapAtlas, initWithTileFile, char const*, char const*, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCTileMapAtlas::loadTGAfile)), Default, cocos2d::CCTileMapAtlas, loadTGAfile, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTileMapAtlas::releaseMap)), Default, cocos2d::CCTileMapAtlas, releaseMap, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::ccColor3B const&, cocos2d::CCPoint const&>::func(&cocos2d::CCTileMapAtlas::setTile)), Default, cocos2d::CCTileMapAtlas, setTile, cocos2d::ccColor3B const&, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCTileMapAtlas::tileAt)), Default, cocos2d::CCTileMapAtlas, tileAt, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint const&, cocos2d::ccColor3B const&, unsigned int>::func(&cocos2d::CCTileMapAtlas::updateAtlasValueAt)), Default, cocos2d::CCTileMapAtlas, updateAtlasValueAt, cocos2d::CCPoint const&, cocos2d::ccColor3B const&, unsigned int)
		}
	};
}
