...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTMXLayerInfo> : ModifyBase<ModifyDerive<Der, cocos2d::CCTMXLayerInfo>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d14CCTMXLayerInfoC2Ev")), Default, cocos2d::CCTMXLayerInfo, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d14CCTMXLayerInfoD2Ev")), Default, cocos2d::CCTMXLayerInfo)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTMXLayerInfo::getProperties)), Default, cocos2d::CCTMXLayerInfo, getProperties, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCDictionary*>::func(&cocos2d::CCTMXLayerInfo::setProperties)), Default, cocos2d::CCTMXLayerInfo, setProperties, cocos2d::CCDictionary*)
		}
	};
}
