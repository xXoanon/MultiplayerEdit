...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJSmartBlockPreviewSprite> : ModifyBase<ModifyDerive<Der, GJSmartBlockPreviewSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJSmartBlockPreviewSprite::create)), Default, GJSmartBlockPreviewSprite, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJSmartBlockPreviewSprite::init)), Default, GJSmartBlockPreviewSprite, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJSmartBlockPreviewSprite::visit)), Default, GJSmartBlockPreviewSprite, visit, )
		}
	};
}
