...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCParticleSystem> : ModifyBase<ModifyDerive<Der, cocos2d::CCParticleSystem>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d16CCParticleSystemC2Ev")), Default, cocos2d::CCParticleSystem, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d16CCParticleSystemD2Ev")), Default, cocos2d::CCParticleSystem)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::update)), Default, cocos2d::CCParticleSystem, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::init)), Default, cocos2d::CCParticleSystem, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setScaleX)), Default, cocos2d::CCParticleSystem, setScaleX, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setScaleY)), Default, cocos2d::CCParticleSystem, setScaleY, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setScale)), Default, cocos2d::CCParticleSystem, setScale, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::CCParticleSystem::setVisible)), Default, cocos2d::CCParticleSystem, setVisible, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setRotation)), Default, cocos2d::CCParticleSystem, setRotation, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getBatchNode)), Default, cocos2d::CCParticleSystem, getBatchNode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCParticleBatchNode*>::func(&cocos2d::CCParticleSystem::setBatchNode)), Default, cocos2d::CCParticleSystem, setBatchNode, cocos2d::CCParticleBatchNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getParticleCount)), Default, cocos2d::CCParticleSystem, getParticleCount, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getDuration)), Default, cocos2d::CCParticleSystem, getDuration, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setDuration)), Default, cocos2d::CCParticleSystem, setDuration, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getSourcePosition)), Default, cocos2d::CCParticleSystem, getSourcePosition, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCParticleSystem::setSourcePosition)), Default, cocos2d::CCParticleSystem, setSourcePosition, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getPosVar)), Default, cocos2d::CCParticleSystem, getPosVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCParticleSystem::setPosVar)), Default, cocos2d::CCParticleSystem, setPosVar, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getLife)), Default, cocos2d::CCParticleSystem, getLife, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setLife)), Default, cocos2d::CCParticleSystem, setLife, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getLifeVar)), Default, cocos2d::CCParticleSystem, getLifeVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setLifeVar)), Default, cocos2d::CCParticleSystem, setLifeVar, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getAngle)), Default, cocos2d::CCParticleSystem, getAngle, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setAngle)), Default, cocos2d::CCParticleSystem, setAngle, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getAngleVar)), Default, cocos2d::CCParticleSystem, getAngleVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setAngleVar)), Default, cocos2d::CCParticleSystem, setAngleVar, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::updateEmissionRate)), Default, cocos2d::CCParticleSystem, updateEmissionRate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getGravity)), Default, cocos2d::CCParticleSystem, getGravity, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCPoint const&>::func(&cocos2d::CCParticleSystem::setGravity)), Default, cocos2d::CCParticleSystem, setGravity, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getSpeed)), Default, cocos2d::CCParticleSystem, getSpeed, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setSpeed)), Default, cocos2d::CCParticleSystem, setSpeed, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getSpeedVar)), Default, cocos2d::CCParticleSystem, getSpeedVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setSpeedVar)), Default, cocos2d::CCParticleSystem, setSpeedVar, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getTangentialAccel)), Default, cocos2d::CCParticleSystem, getTangentialAccel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setTangentialAccel)), Default, cocos2d::CCParticleSystem, setTangentialAccel, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getTangentialAccelVar)), Default, cocos2d::CCParticleSystem, getTangentialAccelVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setTangentialAccelVar)), Default, cocos2d::CCParticleSystem, setTangentialAccelVar, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getRadialAccel)), Default, cocos2d::CCParticleSystem, getRadialAccel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setRadialAccel)), Default, cocos2d::CCParticleSystem, setRadialAccel, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getRadialAccelVar)), Default, cocos2d::CCParticleSystem, getRadialAccelVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setRadialAccelVar)), Default, cocos2d::CCParticleSystem, setRadialAccelVar, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getRotationIsDir)), Default, cocos2d::CCParticleSystem, getRotationIsDir, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::CCParticleSystem::setRotationIsDir)), Default, cocos2d::CCParticleSystem, setRotationIsDir, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getStartRadius)), Default, cocos2d::CCParticleSystem, getStartRadius, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setStartRadius)), Default, cocos2d::CCParticleSystem, setStartRadius, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getStartRadiusVar)), Default, cocos2d::CCParticleSystem, getStartRadiusVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setStartRadiusVar)), Default, cocos2d::CCParticleSystem, setStartRadiusVar, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getEndRadius)), Default, cocos2d::CCParticleSystem, getEndRadius, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setEndRadius)), Default, cocos2d::CCParticleSystem, setEndRadius, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getEndRadiusVar)), Default, cocos2d::CCParticleSystem, getEndRadiusVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setEndRadiusVar)), Default, cocos2d::CCParticleSystem, setEndRadiusVar, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getRotatePerSecond)), Default, cocos2d::CCParticleSystem, getRotatePerSecond, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setRotatePerSecond)), Default, cocos2d::CCParticleSystem, setRotatePerSecond, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getRotatePerSecondVar)), Default, cocos2d::CCParticleSystem, getRotatePerSecondVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setRotatePerSecondVar)), Default, cocos2d::CCParticleSystem, setRotatePerSecondVar, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::isActive)), Default, cocos2d::CCParticleSystem, isActive, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::isBlendAdditive)), Default, cocos2d::CCParticleSystem, isBlendAdditive, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::CCParticleSystem::setBlendAdditive)), Default, cocos2d::CCParticleSystem, setBlendAdditive, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getStartSize)), Default, cocos2d::CCParticleSystem, getStartSize, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setStartSize)), Default, cocos2d::CCParticleSystem, setStartSize, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getStartSizeVar)), Default, cocos2d::CCParticleSystem, getStartSizeVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setStartSizeVar)), Default, cocos2d::CCParticleSystem, setStartSizeVar, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getEndSize)), Default, cocos2d::CCParticleSystem, getEndSize, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setEndSize)), Default, cocos2d::CCParticleSystem, setEndSize, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getEndSizeVar)), Default, cocos2d::CCParticleSystem, getEndSizeVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setEndSizeVar)), Default, cocos2d::CCParticleSystem, setEndSizeVar, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getStartColor)), Default, cocos2d::CCParticleSystem, getStartColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor4F const&>::func(&cocos2d::CCParticleSystem::setStartColor)), Default, cocos2d::CCParticleSystem, setStartColor, cocos2d::ccColor4F const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getStartColorVar)), Default, cocos2d::CCParticleSystem, getStartColorVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor4F const&>::func(&cocos2d::CCParticleSystem::setStartColorVar)), Default, cocos2d::CCParticleSystem, setStartColorVar, cocos2d::ccColor4F const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getEndColor)), Default, cocos2d::CCParticleSystem, getEndColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor4F const&>::func(&cocos2d::CCParticleSystem::setEndColor)), Default, cocos2d::CCParticleSystem, setEndColor, cocos2d::ccColor4F const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getEndColorVar)), Default, cocos2d::CCParticleSystem, getEndColorVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor4F const&>::func(&cocos2d::CCParticleSystem::setEndColorVar)), Default, cocos2d::CCParticleSystem, setEndColorVar, cocos2d::ccColor4F const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getStartSpin)), Default, cocos2d::CCParticleSystem, getStartSpin, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setStartSpin)), Default, cocos2d::CCParticleSystem, setStartSpin, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getStartSpinVar)), Default, cocos2d::CCParticleSystem, getStartSpinVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setStartSpinVar)), Default, cocos2d::CCParticleSystem, setStartSpinVar, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getEndSpin)), Default, cocos2d::CCParticleSystem, getEndSpin, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setEndSpin)), Default, cocos2d::CCParticleSystem, setEndSpin, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getEndSpinVar)), Default, cocos2d::CCParticleSystem, getEndSpinVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setEndSpinVar)), Default, cocos2d::CCParticleSystem, setEndSpinVar, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getEmissionRate)), Default, cocos2d::CCParticleSystem, getEmissionRate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setEmissionRate)), Default, cocos2d::CCParticleSystem, setEmissionRate, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getTotalParticles)), Default, cocos2d::CCParticleSystem, getTotalParticles, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned int>::func(&cocos2d::CCParticleSystem::setTotalParticles)), Default, cocos2d::CCParticleSystem, setTotalParticles, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getOpacityModifyRGB)), Default, cocos2d::CCParticleSystem, getOpacityModifyRGB, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::CCParticleSystem::setOpacityModifyRGB)), Default, cocos2d::CCParticleSystem, setOpacityModifyRGB, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getPositionType)), Default, cocos2d::CCParticleSystem, getPositionType, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::tCCPositionType>::func(&cocos2d::CCParticleSystem::setPositionType)), Default, cocos2d::CCParticleSystem, setPositionType, cocos2d::tCCPositionType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::isAutoRemoveOnFinish)), Default, cocos2d::CCParticleSystem, isAutoRemoveOnFinish, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::CCParticleSystem::setAutoRemoveOnFinish)), Default, cocos2d::CCParticleSystem, setAutoRemoveOnFinish, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getEmitterMode)), Default, cocos2d::CCParticleSystem, getEmitterMode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int>::func(&cocos2d::CCParticleSystem::setEmitterMode)), Default, cocos2d::CCParticleSystem, setEmitterMode, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned int, bool>::func(&cocos2d::CCParticleSystem::initWithTotalParticles)), Default, cocos2d::CCParticleSystem, initWithTotalParticles, unsigned int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::sCCParticle*, cocos2d::CCPoint const&>::func(&cocos2d::CCParticleSystem::updateQuadWithParticle)), Default, cocos2d::CCParticleSystem, updateQuadWithParticle, cocos2d::sCCParticle*, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::postStep)), Default, cocos2d::CCParticleSystem, postStep, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::updateWithNoTime)), Default, cocos2d::CCParticleSystem, updateWithNoTime, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::updateBlendFunc)), Default, cocos2d::CCParticleSystem, updateBlendFunc, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccBlendFunc>::func(&cocos2d::CCParticleSystem::setBlendFunc)), Default, cocos2d::CCParticleSystem, setBlendFunc, cocos2d::ccBlendFunc)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getBlendFunc)), Default, cocos2d::CCParticleSystem, getBlendFunc, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getTexture)), Default, cocos2d::CCParticleSystem, getTexture, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCTexture2D*>::func(&cocos2d::CCParticleSystem::setTexture)), Default, cocos2d::CCParticleSystem, setTexture, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::addParticle)), Default, cocos2d::CCParticleSystem, addParticle, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::calculateWorldSpace)), Default, cocos2d::CCParticleSystem, calculateWorldSpace, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getParticleDrawCost)), Default, cocos2d::CCParticleSystem, getParticleDrawCost, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getTimeElapsed)), Default, cocos2d::CCParticleSystem, getTimeElapsed, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::sCCParticle*>::func(&cocos2d::CCParticleSystem::initParticle)), Default, cocos2d::CCParticleSystem, initParticle, cocos2d::sCCParticle*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCDictionary*, bool>::func(&cocos2d::CCParticleSystem::initWithDictionary)), Default, cocos2d::CCParticleSystem, initWithDictionary, cocos2d::CCDictionary*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCDictionary*, char const*, bool>::func(&cocos2d::CCParticleSystem::initWithDictionary)), Default, cocos2d::CCParticleSystem, initWithDictionary, cocos2d::CCDictionary*, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, bool>::func(&cocos2d::CCParticleSystem::initWithFile)), Default, cocos2d::CCParticleSystem, initWithFile, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::isFull)), Default, cocos2d::CCParticleSystem, isFull, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::loadDefaults)), Default, cocos2d::CCParticleSystem, loadDefaults, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::loadScaledDefaults)), Default, cocos2d::CCParticleSystem, loadScaledDefaults, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::resetSystem)), Default, cocos2d::CCParticleSystem, resetSystem, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::resumeSystem)), Default, cocos2d::CCParticleSystem, resumeSystem, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::saveDefaults)), Default, cocos2d::CCParticleSystem, saveDefaults, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::stopSystem)), Default, cocos2d::CCParticleSystem, stopSystem, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::updateVisible)), Default, cocos2d::CCParticleSystem, updateVisible, )
		}
	};
}
