...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCContentManager> : ModifyBase<ModifyDerive<Der, CCContentManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, bool>::func(&CCContentManager::addDict)), Default, CCContentManager, addDict, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&CCContentManager::addDictDS)), Default, CCContentManager, addDictDS, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&CCContentManager::clearCache)), Default, CCContentManager, clearCache, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&CCContentManager::init)), Default, CCContentManager, init, )
		}
	};
}
