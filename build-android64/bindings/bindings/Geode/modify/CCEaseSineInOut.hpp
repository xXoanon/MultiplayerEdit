...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCEaseSineInOut> : ModifyBase<ModifyDerive<Der, cocos2d::CCEaseSineInOut>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCEaseSineInOut::copyWithZone)), Default, cocos2d::CCEaseSineInOut, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCEaseSineInOut::update)), Default, cocos2d::CCEaseSineInOut, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCEaseSineInOut::reverse)), Default, cocos2d::CCEaseSineInOut, reverse, )
		}
	};
}
