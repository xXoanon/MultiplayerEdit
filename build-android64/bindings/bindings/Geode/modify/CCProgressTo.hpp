...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCProgressTo> : ModifyBase<ModifyDerive<Der, cocos2d::CCProgressTo>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCProgressTo::copyWithZone)), Default, cocos2d::CCProgressTo, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCProgressTo::startWithTarget)), Default, cocos2d::CCProgressTo, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCProgressTo::update)), Default, cocos2d::CCProgressTo, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float>::func(&cocos2d::CCProgressTo::initWithDuration)), Default, cocos2d::CCProgressTo, initWithDuration, float, float)
		}
	};
}
