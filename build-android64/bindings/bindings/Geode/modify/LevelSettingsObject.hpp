...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LevelSettingsObject> : ModifyBase<ModifyDerive<Der, LevelSettingsObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&LevelSettingsObject::create)), Default, LevelSettingsObject, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCDictionary*>::func(&LevelSettingsObject::objectFromDict)), Default, LevelSettingsObject, objectFromDict, cocos2d::CCDictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN19LevelSettingsObject16objectFromStringERKSs")), Default, LevelSettingsObject, objectFromString, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&LevelSettingsObject::init)), Default, LevelSettingsObject, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&LevelSettingsObject::getSaveString)), Default, LevelSettingsObject, getSaveString, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCDictionary*>::func(&LevelSettingsObject::setupColorsFromLegacyMode)), Default, LevelSettingsObject, setupColorsFromLegacyMode, cocos2d::CCDictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&LevelSettingsObject::shouldUseYSection)), Default, LevelSettingsObject, shouldUseYSection, )
		}
	};
}
