...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCLabelTTF> : ModifyBase<ModifyDerive<Der, cocos2d::CCLabelTTF>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d10CCLabelTTFC2Ev")), Default, cocos2d::CCLabelTTF, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d10CCLabelTTFD2Ev")), Default, cocos2d::CCLabelTTF)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLabelTTF::init)), Default, cocos2d::CCLabelTTF, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<char const*>::func(&cocos2d::CCLabelTTF::setString)), Default, cocos2d::CCLabelTTF, setString, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCLabelTTF::getString)), Default, cocos2d::CCLabelTTF, getString, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCLabelTTF::_prepareTextDefinition)), Default, cocos2d::CCLabelTTF, _prepareTextDefinition, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::ccFontDefinition&, bool>::func(&cocos2d::CCLabelTTF::_updateWithTextDefinition)), Default, cocos2d::CCLabelTTF, _updateWithTextDefinition, cocos2d::ccFontDefinition&, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCLabelTTF::description)), Default, cocos2d::CCLabelTTF, description, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCLabelTTF::disableShadow)), Default, cocos2d::CCLabelTTF, disableShadow, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCLabelTTF::disableStroke)), Default, cocos2d::CCLabelTTF, disableStroke, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSize const&, float, float, bool>::func(&cocos2d::CCLabelTTF::enableShadow)), Default, cocos2d::CCLabelTTF, enableShadow, cocos2d::CCSize const&, float, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::ccColor3B const&, float, bool>::func(&cocos2d::CCLabelTTF::enableStroke)), Default, cocos2d::CCLabelTTF, enableStroke, cocos2d::ccColor3B const&, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCLabelTTF::getFontName)), Default, cocos2d::CCLabelTTF, getFontName, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCLabelTTF::getTextDefinition)), Default, cocos2d::CCLabelTTF, getTextDefinition, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, char const*, float>::func(&cocos2d::CCLabelTTF::initWithString)), Default, cocos2d::CCLabelTTF, initWithString, char const*, char const*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, char const*, float, cocos2d::CCSize const&, cocos2d::CCTextAlignment>::func(&cocos2d::CCLabelTTF::initWithString)), Default, cocos2d::CCLabelTTF, initWithString, char const*, char const*, float, cocos2d::CCSize const&, cocos2d::CCTextAlignment)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, char const*, float, cocos2d::CCSize const&, cocos2d::CCTextAlignment, cocos2d::CCVerticalTextAlignment>::func(&cocos2d::CCLabelTTF::initWithString)), Default, cocos2d::CCLabelTTF, initWithString, char const*, char const*, float, cocos2d::CCSize const&, cocos2d::CCTextAlignment, cocos2d::CCVerticalTextAlignment)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, cocos2d::ccFontDefinition&>::func(&cocos2d::CCLabelTTF::initWithStringAndTextDefinition)), Default, cocos2d::CCLabelTTF, initWithStringAndTextDefinition, char const*, cocos2d::ccFontDefinition&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::ccColor3B const&, bool>::func(&cocos2d::CCLabelTTF::setFontFillColor)), Default, cocos2d::CCLabelTTF, setFontFillColor, cocos2d::ccColor3B const&, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCLabelTTF::setFontName)), Default, cocos2d::CCLabelTTF, setFontName, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::ccFontDefinition*>::func(&cocos2d::CCLabelTTF::setTextDefinition)), Default, cocos2d::CCLabelTTF, setTextDefinition, cocos2d::ccFontDefinition*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCLabelTTF::updateTexture)), Default, cocos2d::CCLabelTTF, updateTexture, )
		}
	};
}
