...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCLiquid> : ModifyBase<ModifyDerive<Der, cocos2d::CCLiquid>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCLiquid::copyWithZone)), Default, cocos2d::CCLiquid, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCLiquid::update)), Default, cocos2d::CCLiquid, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, cocos2d::CCSize const&, unsigned int, float>::func(&cocos2d::CCLiquid::initWithDuration)), Default, cocos2d::CCLiquid, initWithDuration, float, cocos2d::CCSize const&, unsigned int, float)
		}
	};
}
