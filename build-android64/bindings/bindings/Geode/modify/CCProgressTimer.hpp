...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCProgressTimer> : ModifyBase<ModifyDerive<Der, cocos2d::CCProgressTimer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d15CCProgressTimerC2Ev")), Default, cocos2d::CCProgressTimer, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d15CCProgressTimerD2Ev")), Default, cocos2d::CCProgressTimer)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCProgressTimer::getColor)), Default, cocos2d::CCProgressTimer, getColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCProgressTimer::getOpacity)), Default, cocos2d::CCProgressTimer, getOpacity, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCProgressTimer::draw)), Default, cocos2d::CCProgressTimer, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCProgressTimer::getMidpoint)), Default, cocos2d::CCProgressTimer, getMidpoint, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCPoint>::func(&cocos2d::CCProgressTimer::setMidpoint)), Default, cocos2d::CCProgressTimer, setMidpoint, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor3B const&>::func(&cocos2d::CCProgressTimer::setColor)), Default, cocos2d::CCProgressTimer, setColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned char>::func(&cocos2d::CCProgressTimer::setOpacity)), Default, cocos2d::CCProgressTimer, setOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char>::func(&cocos2d::CCProgressTimer::boundaryTexCoord)), Default, cocos2d::CCProgressTimer, boundaryTexCoord, char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSprite*>::func(&cocos2d::CCProgressTimer::initWithSprite)), Default, cocos2d::CCProgressTimer, initWithSprite, cocos2d::CCSprite*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint>::func(&cocos2d::CCProgressTimer::setAnchorPoint)), Default, cocos2d::CCProgressTimer, setAnchorPoint, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCProgressTimer::setPercentage)), Default, cocos2d::CCProgressTimer, setPercentage, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCProgressTimer::setReverseProgress)), Default, cocos2d::CCProgressTimer, setReverseProgress, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSprite*>::func(&cocos2d::CCProgressTimer::setSprite)), Default, cocos2d::CCProgressTimer, setSprite, cocos2d::CCSprite*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCProgressTimerType>::func(&cocos2d::CCProgressTimer::setType)), Default, cocos2d::CCProgressTimer, setType, cocos2d::CCProgressTimerType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint>::func(&cocos2d::CCProgressTimer::textureCoordFromAlphaPoint)), Default, cocos2d::CCProgressTimer, textureCoordFromAlphaPoint, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCProgressTimer::updateBar)), Default, cocos2d::CCProgressTimer, updateBar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCProgressTimer::updateColor)), Default, cocos2d::CCProgressTimer, updateColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCProgressTimer::updateProgress)), Default, cocos2d::CCProgressTimer, updateProgress, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCProgressTimer::updateRadial)), Default, cocos2d::CCProgressTimer, updateRadial, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint>::func(&cocos2d::CCProgressTimer::vertexFromAlphaPoint)), Default, cocos2d::CCProgressTimer, vertexFromAlphaPoint, cocos2d::CCPoint)
		}
	};
}
