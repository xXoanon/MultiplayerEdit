...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LoadingCircle> : ModifyBase<ModifyDerive<Der, LoadingCircle>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&LoadingCircle::create)), Default, LoadingCircle, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&LoadingCircle::init)), Default, LoadingCircle, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&LoadingCircle::draw)), Default, LoadingCircle, draw, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&LoadingCircle::registerWithTouchDispatcher)), Default, LoadingCircle, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&LoadingCircle::fadeAndRemove)), Default, LoadingCircle, fadeAndRemove, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&LoadingCircle::show)), Default, LoadingCircle, show, )
		}
	};
}
