...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionZoomFlipAngular> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionZoomFlipAngular>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d27CCTransitionZoomFlipAngularC2Ev")), Default, cocos2d::CCTransitionZoomFlipAngular, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d27CCTransitionZoomFlipAngularD2Ev")), Default, cocos2d::CCTransitionZoomFlipAngular)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionZoomFlipAngular::onEnter)), Default, cocos2d::CCTransitionZoomFlipAngular, onEnter, )
		}
	};
}
