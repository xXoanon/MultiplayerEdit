...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSpawn> : ModifyBase<ModifyDerive<Der, cocos2d::CCSpawn>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d7CCSpawnD2Ev")), Default, cocos2d::CCSpawn)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCFiniteTimeAction*, va_list>::func(&cocos2d::CCSpawn::createWithVariableList)), Default, cocos2d::CCSpawn, createWithVariableList, cocos2d::CCFiniteTimeAction*, va_list)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCSpawn::copyWithZone)), Default, cocos2d::CCSpawn, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCSpawn::update)), Default, cocos2d::CCSpawn, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCSpawn::startWithTarget)), Default, cocos2d::CCSpawn, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCSpawn::stop)), Default, cocos2d::CCSpawn, stop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCSpawn::reverse)), Default, cocos2d::CCSpawn, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCFiniteTimeAction*, cocos2d::CCFiniteTimeAction*>::func(&cocos2d::CCSpawn::initWithTwoActions)), Default, cocos2d::CCSpawn, initWithTwoActions, cocos2d::CCFiniteTimeAction*, cocos2d::CCFiniteTimeAction*)
		}
	};
}
