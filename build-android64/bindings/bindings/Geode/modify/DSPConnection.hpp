...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FMOD::DSPConnection> : ModifyBase<ModifyDerive<Der, FMOD::DSPConnection>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void**>::func(&FMOD::DSPConnection::getUserData)), Default, FMOD::DSPConnection, getUserData, void**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void*>::func(&FMOD::DSPConnection::setUserData)), Default, FMOD::DSPConnection, setUserData, void*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*, int*, int*, int>::func(&FMOD::DSPConnection::getMixMatrix)), Default, FMOD::DSPConnection, getMixMatrix, float*, int*, int*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*, int, int, int>::func(&FMOD::DSPConnection::setMixMatrix)), Default, FMOD::DSPConnection, setMixMatrix, float*, int, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float*>::func(&FMOD::DSPConnection::getMix)), Default, FMOD::DSPConnection, getMix, float*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&FMOD::DSPConnection::setMix)), Default, FMOD::DSPConnection, setMix, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD_DSPCONNECTION_TYPE*>::func(&FMOD::DSPConnection::getType)), Default, FMOD::DSPConnection, getType, FMOD_DSPCONNECTION_TYPE*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::DSP**>::func(&FMOD::DSPConnection::getInput)), Default, FMOD::DSPConnection, getInput, FMOD::DSP**)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<FMOD::DSP**>::func(&FMOD::DSPConnection::getOutput)), Default, FMOD::DSPConnection, getOutput, FMOD::DSP**)
		}
	};
}
