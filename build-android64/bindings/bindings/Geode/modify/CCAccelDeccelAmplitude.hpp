...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCAccelDeccelAmplitude> : ModifyBase<ModifyDerive<Der, cocos2d::CCAccelDeccelAmplitude>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d22CCAccelDeccelAmplitudeD2Ev")), Default, cocos2d::CCAccelDeccelAmplitude)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCAccelDeccelAmplitude::startWithTarget)), Default, cocos2d::CCAccelDeccelAmplitude, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCAccelDeccelAmplitude::update)), Default, cocos2d::CCAccelDeccelAmplitude, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCAccelDeccelAmplitude::reverse)), Default, cocos2d::CCAccelDeccelAmplitude, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCAction*, float>::func(&cocos2d::CCAccelDeccelAmplitude::initWithAction)), Default, cocos2d::CCAccelDeccelAmplitude, initWithAction, cocos2d::CCAction*, float)
		}
	};
}
