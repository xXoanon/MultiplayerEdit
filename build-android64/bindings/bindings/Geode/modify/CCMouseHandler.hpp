...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCMouseHandler> : ModifyBase<ModifyDerive<Der, cocos2d::CCMouseHandler>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d14CCMouseHandlerD2Ev")), Default, cocos2d::CCMouseHandler)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCMouseDelegate*>::func(&cocos2d::CCMouseHandler::initWithDelegate)), Default, cocos2d::CCMouseHandler, initWithDelegate, cocos2d::CCMouseDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCMouseHandler::getDelegate)), Default, cocos2d::CCMouseHandler, getDelegate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCMouseDelegate*>::func(&cocos2d::CCMouseHandler::setDelegate)), Default, cocos2d::CCMouseHandler, setDelegate, cocos2d::CCMouseDelegate*)
		}
	};
}
