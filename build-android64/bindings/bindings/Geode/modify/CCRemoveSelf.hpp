...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCRemoveSelf> : ModifyBase<ModifyDerive<Der, cocos2d::CCRemoveSelf>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCRemoveSelf::copyWithZone)), Default, cocos2d::CCRemoveSelf, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCRemoveSelf::update)), Default, cocos2d::CCRemoveSelf, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCRemoveSelf::reverse)), Default, cocos2d::CCRemoveSelf, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCRemoveSelf::init)), Default, cocos2d::CCRemoveSelf, init, bool)
		}
	};
}
