...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetGroupIDLayer> : ModifyBase<ModifyDerive<Der, SetGroupIDLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15SetGroupIDLayerD2Ev")), Default, SetGroupIDLayer)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<ConfigureValuePopup*, float>::func(&SetGroupIDLayer::valuePopupClosed)), Default, SetGroupIDLayer, valuePopupClosed, ConfigureValuePopup*, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetGroupIDLayer::onGroupIDOptions)), Default, SetGroupIDLayer, onGroupIDOptions, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetGroupIDLayer::onToggleTraceIn)), Default, SetGroupIDLayer, onToggleTraceIn, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetGroupIDLayer::onToggleTraceOut)), Default, SetGroupIDLayer, onToggleTraceOut, cocos2d::CCObject*)
