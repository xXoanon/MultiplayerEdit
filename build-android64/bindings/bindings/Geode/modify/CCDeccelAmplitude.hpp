...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCDeccelAmplitude> : ModifyBase<ModifyDerive<Der, cocos2d::CCDeccelAmplitude>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d17CCDeccelAmplitudeD2Ev")), Default, cocos2d::CCDeccelAmplitude)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCDeccelAmplitude::startWithTarget)), Default, cocos2d::CCDeccelAmplitude, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCDeccelAmplitude::update)), Default, cocos2d::CCDeccelAmplitude, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCDeccelAmplitude::reverse)), Default, cocos2d::CCDeccelAmplitude, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCAction*, float>::func(&cocos2d::CCDeccelAmplitude::initWithAction)), Default, cocos2d::CCDeccelAmplitude, initWithAction, cocos2d::CCAction*, float)
		}
	};
}
