...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCEaseBounceInOut> : ModifyBase<ModifyDerive<Der, cocos2d::CCEaseBounceInOut>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCEaseBounceInOut::copyWithZone)), Default, cocos2d::CCEaseBounceInOut, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCEaseBounceInOut::update)), Default, cocos2d::CCEaseBounceInOut, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCEaseBounceInOut::reverse)), Default, cocos2d::CCEaseBounceInOut, reverse, )
		}
	};
}
