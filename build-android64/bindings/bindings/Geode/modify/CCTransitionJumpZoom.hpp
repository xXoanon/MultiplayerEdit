...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionJumpZoom> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionJumpZoom>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCTransitionJumpZoomC2Ev")), Default, cocos2d::CCTransitionJumpZoom, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCTransitionJumpZoomD2Ev")), Default, cocos2d::CCTransitionJumpZoom)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionJumpZoom::onEnter)), Default, cocos2d::CCTransitionJumpZoom, onEnter, )
		}
	};
}
