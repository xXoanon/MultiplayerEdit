...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCFollow> : ModifyBase<ModifyDerive<Der, cocos2d::CCFollow>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d8CCFollowD2Ev")), Default, cocos2d::CCFollow)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCFollow::copyWithZone)), Default, cocos2d::CCFollow, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCFollow::step)), Default, cocos2d::CCFollow, step, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCFollow::isDone)), Default, cocos2d::CCFollow, isDone, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCFollow::stop)), Default, cocos2d::CCFollow, stop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCNode*, cocos2d::CCRect const&>::func(&cocos2d::CCFollow::initWithTarget)), Default, cocos2d::CCFollow, initWithTarget, cocos2d::CCNode*, cocos2d::CCRect const&)
		}
	};
}
