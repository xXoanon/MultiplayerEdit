...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCCatmullRomTo> : ModifyBase<ModifyDerive<Der, cocos2d::CCCatmullRomTo>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, cocos2d::CCPointArray*>::func(&cocos2d::CCCatmullRomTo::initWithDuration)), Default, cocos2d::CCCatmullRomTo, initWithDuration, float, cocos2d::CCPointArray*)
		}
	};
}
