...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCRotateTo> : ModifyBase<ModifyDerive<Der, cocos2d::CCRotateTo>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float, float, float>::func(&cocos2d::CCRotateTo::initWithDuration)), Default, cocos2d::CCRotateTo, initWithDuration, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCRotateTo::copyWithZone)), Default, cocos2d::CCRotateTo, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCRotateTo::update)), Default, cocos2d::CCRotateTo, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCRotateTo::startWithTarget)), Default, cocos2d::CCRotateTo, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float>::func(&cocos2d::CCRotateTo::initWithDuration)), Default, cocos2d::CCRotateTo, initWithDuration, float, float)
		}
	};
}
