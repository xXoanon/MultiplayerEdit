...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTouchScriptHandlerEntry> : ModifyBase<ModifyDerive<Der, cocos2d::CCTouchScriptHandlerEntry>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d25CCTouchScriptHandlerEntryD2Ev")), Default, cocos2d::CCTouchScriptHandlerEntry)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool, int, bool>::func(&cocos2d::CCTouchScriptHandlerEntry::init)), Default, cocos2d::CCTouchScriptHandlerEntry, init, bool, int, bool)
		}
	};
}
