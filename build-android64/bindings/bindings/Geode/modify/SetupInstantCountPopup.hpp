...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupInstantCountPopup> : ModifyBase<ModifyDerive<Der, SetupInstantCountPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<CountTriggerGameObject*, cocos2d::CCArray*>::func(&SetupInstantCountPopup::create)), Default, SetupInstantCountPopup, create, CountTriggerGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&SetupInstantCountPopup::determineStartValues)), Default, SetupInstantCountPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCObject*>::func(&SetupInstantCountPopup::onClose)), Default, SetupInstantCountPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<CCTextInputNode*>::func(&SetupInstantCountPopup::textChanged)), Default, SetupInstantCountPopup, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<CountTriggerGameObject*, cocos2d::CCArray*>::func(&SetupInstantCountPopup::init)), Default, SetupInstantCountPopup, init, CountTriggerGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupInstantCountPopup::onCountType)), Default, SetupInstantCountPopup, onCountType, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupInstantCountPopup::onEnableGroup)), Default, SetupInstantCountPopup, onEnableGroup, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupInstantCountPopup::onTargetCountArrow)), Default, SetupInstantCountPopup, onTargetCountArrow, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupInstantCountPopup::onTargetID2Arrow)), Default, SetupInstantCountPopup, onTargetID2Arrow, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&SetupInstantCountPopup::onTargetIDArrow)), Default, SetupInstantCountPopup, onTargetIDArrow, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupInstantCountPopup::updateCountTextInputLabel)), Default, SetupInstantCountPopup, updateCountTextInputLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupInstantCountPopup::updateItemID)), Default, SetupInstantCountPopup, updateItemID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupInstantCountPopup::updateItemIDInputLabel)), Default, SetupInstantCountPopup, updateItemIDInputLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupInstantCountPopup::updateTargetCount)), Default, SetupInstantCountPopup, updateTargetCount, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupInstantCountPopup::updateTargetID)), Default, SetupInstantCountPopup, updateTargetID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&SetupInstantCountPopup::updateTargetIDInputLabel)), Default, SetupInstantCountPopup, updateTargetIDInputLabel, )
		}
	};
}
