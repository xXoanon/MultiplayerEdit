...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCScaleBy> : ModifyBase<ModifyDerive<Der, cocos2d::CCScaleBy>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCScaleBy::copyWithZone)), Default, cocos2d::CCScaleBy, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCScaleBy::startWithTarget)), Default, cocos2d::CCScaleBy, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCScaleBy::reverse)), Default, cocos2d::CCScaleBy, reverse, )
		}
	};
}
