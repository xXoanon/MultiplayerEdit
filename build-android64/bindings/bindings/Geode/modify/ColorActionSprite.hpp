...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ColorActionSprite> : ModifyBase<ModifyDerive<Der, ColorActionSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&ColorActionSprite::create)), Default, ColorActionSprite, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&ColorActionSprite::init)), Default, ColorActionSprite, init, )
		}
	};
}
