...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCCardinalSplineBy> : ModifyBase<ModifyDerive<Der, cocos2d::CCCardinalSplineBy>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d18CCCardinalSplineByC2Ev")), Default, cocos2d::CCCardinalSplineBy, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCCardinalSplineBy::startWithTarget)), Default, cocos2d::CCCardinalSplineBy, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCCardinalSplineBy::reverse)), Default, cocos2d::CCCardinalSplineBy, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCPoint&>::func(&cocos2d::CCCardinalSplineBy::updatePosition)), Default, cocos2d::CCCardinalSplineBy, updatePosition, cocos2d::CCPoint&)
		}
	};
}
