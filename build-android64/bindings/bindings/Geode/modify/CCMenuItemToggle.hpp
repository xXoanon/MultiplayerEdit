...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCMenuItemToggle> : ModifyBase<ModifyDerive<Der, cocos2d::CCMenuItemToggle>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d16CCMenuItemToggleD2Ev")), Default, cocos2d::CCMenuItemToggle)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCMenuItemToggle::getSelectedIndex)), Default, cocos2d::CCMenuItemToggle, getSelectedIndex, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned int>::func(&cocos2d::CCMenuItemToggle::setSelectedIndex)), Default, cocos2d::CCMenuItemToggle, setSelectedIndex, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCMenuItemToggle::getSubItems)), Default, cocos2d::CCMenuItemToggle, getSubItems, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCArray*>::func(&cocos2d::CCMenuItemToggle::setSubItems)), Default, cocos2d::CCMenuItemToggle, setSubItems, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCMenuItemToggle::activate)), Default, cocos2d::CCMenuItemToggle, activate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCMenuItemToggle::selected)), Default, cocos2d::CCMenuItemToggle, selected, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCMenuItemToggle::unselected)), Default, cocos2d::CCMenuItemToggle, unselected, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::CCMenuItemToggle::setEnabled)), Default, cocos2d::CCMenuItemToggle, setEnabled, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCMenuItem*>::func(&cocos2d::CCMenuItemToggle::addSubItem)), Default, cocos2d::CCMenuItemToggle, addSubItem, cocos2d::CCMenuItem*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCMenuItem*>::func(&cocos2d::CCMenuItemToggle::initWithItem)), Default, cocos2d::CCMenuItemToggle, initWithItem, cocos2d::CCMenuItem*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, cocos2d::SEL_MenuHandler, cocos2d::CCMenuItem*, va_list>::func(&cocos2d::CCMenuItemToggle::initWithTarget)), Default, cocos2d::CCMenuItemToggle, initWithTarget, cocos2d::CCObject*, cocos2d::SEL_MenuHandler, cocos2d::CCMenuItem*, va_list)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCMenuItemToggle::selectedItem)), Default, cocos2d::CCMenuItemToggle, selectedItem, )
		}
	};
}
