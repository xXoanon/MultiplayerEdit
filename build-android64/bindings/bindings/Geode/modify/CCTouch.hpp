...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTouch> : ModifyBase<ModifyDerive<Der, cocos2d::CCTouch>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTouch::getDelta)), Default, cocos2d::CCTouch, getDelta, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTouch::getLocation)), Default, cocos2d::CCTouch, getLocation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTouch::getLocationInView)), Default, cocos2d::CCTouch, getLocationInView, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTouch::getPreviousLocation)), Default, cocos2d::CCTouch, getPreviousLocation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTouch::getPreviousLocationInView)), Default, cocos2d::CCTouch, getPreviousLocationInView, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTouch::getStartLocation)), Default, cocos2d::CCTouch, getStartLocation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCTouch::getStartLocationInView)), Default, cocos2d::CCTouch, getStartLocationInView, )
		}
	};
}
