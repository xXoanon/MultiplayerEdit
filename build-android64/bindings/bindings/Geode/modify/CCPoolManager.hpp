...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCPoolManager> : ModifyBase<ModifyDerive<Der, cocos2d::CCPoolManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d13CCPoolManagerC2Ev")), Default, cocos2d::CCPoolManager, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d13CCPoolManagerD2Ev")), Default, cocos2d::CCPoolManager)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCPoolManager::addObject)), Default, cocos2d::CCPoolManager, addObject, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCPoolManager::finalize)), Default, cocos2d::CCPoolManager, finalize, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCPoolManager::getCurReleasePool)), Default, cocos2d::CCPoolManager, getCurReleasePool, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCPoolManager::pop)), Default, cocos2d::CCPoolManager, pop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCPoolManager::push)), Default, cocos2d::CCPoolManager, push, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCPoolManager::removeObject)), Default, cocos2d::CCPoolManager, removeObject, cocos2d::CCObject*)
		}
	};
}
