...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionFlipX> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionFlipX>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d17CCTransitionFlipXC2Ev")), Default, cocos2d::CCTransitionFlipX, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d17CCTransitionFlipXD2Ev")), Default, cocos2d::CCTransitionFlipX)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCTransitionFlipX::onEnter)), Default, cocos2d::CCTransitionFlipX, onEnter, )
		}
	};
}
