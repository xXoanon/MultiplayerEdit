...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCScriptHandlerEntry> : ModifyBase<ModifyDerive<Der, cocos2d::CCScriptHandlerEntry>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d20CCScriptHandlerEntryD2Ev")), Default, cocos2d::CCScriptHandlerEntry)
