...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJUnlockableItem> : ModifyBase<ModifyDerive<Der, GJUnlockableItem>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJUnlockableItem::create)), Default, GJUnlockableItem, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJUnlockableItem::init)), Default, GJUnlockableItem, init, )
		}
	};
}
