...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LabelGameObject> : ModifyBase<ModifyDerive<Der, LabelGameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&LabelGameObject::create)), Default, LabelGameObject, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&LabelGameObject::init)), Default, LabelGameObject, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned char>::func(&LabelGameObject::setOpacity)), Default, LabelGameObject, setOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15LabelGameObject18setupCustomSpritesESs")), Default, LabelGameObject, setupCustomSprites, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&LabelGameObject::addMainSpriteToParent)), Default, LabelGameObject, addMainSpriteToParent, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&LabelGameObject::resetObject)), Default, LabelGameObject, resetObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15LabelGameObject17customObjectSetupERSt6vectorISsSaISsEERS0_IPvSaIS4_EE")), Default, LabelGameObject, customObjectSetup, gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GJBaseGameLayer*>::func(&LabelGameObject::getSaveString)), Default, LabelGameObject, getSaveString, GJBaseGameLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::ccColor3B const&>::func(&LabelGameObject::setObjectColor)), Default, LabelGameObject, setObjectColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int>::func(&LabelGameObject::updateTextKerning)), Default, LabelGameObject, updateTextKerning, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&LabelGameObject::getTextKerning)), Default, LabelGameObject, getTextKerning, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15LabelGameObject11createLabelESs")), Default, LabelGameObject, createLabel, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15LabelGameObject16queueUpdateLabelESs")), Default, LabelGameObject, queueUpdateLabel, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&LabelGameObject::removeLabel)), Default, LabelGameObject, removeLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&LabelGameObject::unlockLabelColor)), Default, LabelGameObject, unlockLabelColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&LabelGameObject::updateLabel)), Default, LabelGameObject, updateLabel, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15LabelGameObject11updateLabelESs")), Default, LabelGameObject, updateLabel, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&LabelGameObject::updateLabelAlign)), Default, LabelGameObject, updateLabelAlign, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&LabelGameObject::updateLabelIfDirty)), Default, LabelGameObject, updateLabelIfDirty, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&LabelGameObject::updatePreviewLabel)), Default, LabelGameObject, updatePreviewLabel, )
		}
	};
}
