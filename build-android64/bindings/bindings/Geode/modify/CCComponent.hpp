...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCComponent> : ModifyBase<ModifyDerive<Der, cocos2d::CCComponent>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCComponentC2Ev")), Default, cocos2d::CCComponent, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCComponentD2Ev")), Default, cocos2d::CCComponent)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCComponent::init)), Default, cocos2d::CCComponent, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCComponent::onEnter)), Default, cocos2d::CCComponent, onEnter, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCComponent::onExit)), Default, cocos2d::CCComponent, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCComponent::update)), Default, cocos2d::CCComponent, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<void*>::func(&cocos2d::CCComponent::serialize)), Default, cocos2d::CCComponent, serialize, void*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCComponent::isEnabled)), Default, cocos2d::CCComponent, isEnabled, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::CCComponent::setEnabled)), Default, cocos2d::CCComponent, setEnabled, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCComponent::getName)), Default, cocos2d::CCComponent, getName, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCComponent::getOwner)), Default, cocos2d::CCComponent, getOwner, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*>::func(&cocos2d::CCComponent::setName)), Default, cocos2d::CCComponent, setName, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCComponent::setOwner)), Default, cocos2d::CCComponent, setOwner, cocos2d::CCNode*)
		}
	};
}
