...
namespace geode::modifier {
	...
	#ifndef GEODE_STATICS_showUnlockAnimation
		#define GEODE_STATICS_showUnlockAnimation
		GEODE_AS_STATIC_FUNCTION(showUnlockAnimation) 
	#endif
	...
	struct ModifyDerive<Der, GauntletNode> : ModifyBase<ModifyDerive<Der, GauntletNode>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GauntletNode::generateNode)), Default, GauntletNode, generateNode, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GauntletNode::onUnlock)), Default, GauntletNode, onUnlock, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GauntletNode::showUnlockAnimation)), Default, GauntletNode, showUnlockAnimation, )
		}
	};
}
