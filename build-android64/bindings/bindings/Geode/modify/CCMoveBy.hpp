...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCMoveBy> : ModifyBase<ModifyDerive<Der, cocos2d::CCMoveBy>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCZone*>::func(&cocos2d::CCMoveBy::copyWithZone)), Default, cocos2d::CCMoveBy, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&cocos2d::CCMoveBy::update)), Default, cocos2d::CCMoveBy, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCMoveBy::startWithTarget)), Default, cocos2d::CCMoveBy, startWithTarget, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCMoveBy::reverse)), Default, cocos2d::CCMoveBy, reverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, cocos2d::CCPoint const&>::func(&cocos2d::CCMoveBy::initWithDuration)), Default, cocos2d::CCMoveBy, initWithDuration, float, cocos2d::CCPoint const&)
		}
	};
}
