...
auto DrawGridLayer::loadTimeMarkers(gd::string markers) -> decltype(loadTimeMarkers(markers)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN13DrawGridLayer15loadTimeMarkersESs")), tulip::hook::TulipConvention::Default);
