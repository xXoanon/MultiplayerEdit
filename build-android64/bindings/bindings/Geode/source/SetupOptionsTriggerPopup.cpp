...
auto SetupOptionsTriggerPopup::addOption(int property, gd::string label) -> decltype(addOption(property, label)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN24SetupOptionsTriggerPopup9addOptionEiSs")), tulip::hook::TulipConvention::Default);
