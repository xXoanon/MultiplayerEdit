...
CreateGuidelinesLayer::~CreateGuidelinesLayer() {
	...
	if (!geode::DestructorLock::isLocked(this)) {
		...
		static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN21CreateGuidelinesLayerD2Ev")), tulip::hook::TulipConvention::Default);
...
auto CreateGuidelinesLayer::getMergedRecordString(gd::string str1, gd::string str2) -> decltype(getMergedRecordString(str1, str2)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN21CreateGuidelinesLayer21getMergedRecordStringESsSs")), tulip::hook::TulipConvention::Default);
