...
AchievementsLayer::AchievementsLayer() : AchievementsLayer(geode::CutoffConstructor, sizeof(AchievementsLayer)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN17AchievementsLayerC2Ev")), tulip::hook::TulipConvention::Default);
