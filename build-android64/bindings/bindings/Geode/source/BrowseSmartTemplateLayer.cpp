...
BrowseSmartTemplateLayer::~BrowseSmartTemplateLayer() {
	...
	if (!geode::DestructorLock::isLocked(this)) {
		...
		static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN24BrowseSmartTemplateLayerD2Ev")), tulip::hook::TulipConvention::Default);
...
auto BrowseSmartTemplateLayer::createPrefab(gd::string key, int id) -> decltype(createPrefab(key, id)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN24BrowseSmartTemplateLayer12createPrefabESsi")), tulip::hook::TulipConvention::Default);
