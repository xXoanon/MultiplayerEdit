...
cocos2d::CCCardinalSplineBy::CCCardinalSplineBy() : cocos2d::CCCardinalSplineBy(geode::CutoffConstructor, sizeof(cocos2d::CCCardinalSplineBy)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d18CCCardinalSplineByC2Ev")), tulip::hook::TulipConvention::Default);
