...
cocos2d::CCMouseHandler::~CCMouseHandler() {
	...
	if (!geode::DestructorLock::isLocked(this)) {
		...
		static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d14CCMouseHandlerD2Ev")), tulip::hook::TulipConvention::Default);
