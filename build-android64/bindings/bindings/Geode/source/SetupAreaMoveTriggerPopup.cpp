...
SetupAreaMoveTriggerPopup::~SetupAreaMoveTriggerPopup() {
	...
	if (!geode::DestructorLock::isLocked(this)) {
		...
		static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN25SetupAreaMoveTriggerPopupD2Ev")), tulip::hook::TulipConvention::Default);
