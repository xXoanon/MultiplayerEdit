...
auto KeyframeObject::setupSpline(gd::vector<KeyframeObject*>& objects) -> decltype(setupSpline(objects)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN14KeyframeObject11setupSplineERSt6vectorIPS_SaIS1_EE")), tulip::hook::TulipConvention::Default);
