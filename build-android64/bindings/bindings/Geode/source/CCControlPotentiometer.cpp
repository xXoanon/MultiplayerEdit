...
cocos2d::extension::CCControlPotentiometer::CCControlPotentiometer() : cocos2d::extension::CCControlPotentiometer(geode::CutoffConstructor, sizeof(cocos2d::extension::CCControlPotentiometer)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension22CCControlPotentiometerC2Ev")), tulip::hook::TulipConvention::Default);
...
cocos2d::extension::CCControlPotentiometer::~CCControlPotentiometer() {
	...
	if (!geode::DestructorLock::isLocked(this)) {
		using FunctionType = void(*)(cocos2d::extension::CCControlPotentiometer*);
		static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d9extension22CCControlPotentiometerD2Ev")), tulip::hook::TulipConvention::Default);
		reinterpret_cast<FunctionType>(func)(this);
